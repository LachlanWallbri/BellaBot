...
import com.unsw.bellabot.serialize.ChargeState;
import com.unsw.bellabot.serialize.WheelError;
...
public class CANBus {
  ...
  /**
   * Retrieves the current instance of the dataQueue associated with the CANBus.
   *
   * @return The DataQueue instance currently associated with the CANBus.
   */
  public ArrayBlockingQueue<byte[]> getDataQueue() {

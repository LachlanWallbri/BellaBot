...
import net.lucode.hackware.magicindicator.C8000R;
...
public class CommonNavigator extends FrameLayout implements IPagerNavigator, NavigatorHelper.OnNavigatorScrollListener {
    ...
    public void init() {
        ...
        removeAllViews();
        if (this.mAdjustMode) {
            inflate = LayoutInflater.from(getContext()).inflate(C8000R.layout.pager_navigator_layout_no_scroll, this);
        } else {
            inflate = LayoutInflater.from(getContext()).inflate(C8000R.layout.pager_navigator_layout, this);
        }
        this.mScrollView = (HorizontalScrollView) inflate.findViewById(C8000R.id.scroll_view);
        this.mTitleContainer = (LinearLayout) inflate.findViewById(C8000R.id.title_container);
        this.mTitleContainer.setPadding(this.mLeftPadding, 0, this.mRightPadding, 0);
        this.mIndicatorContainer = (LinearLayout) inflate.findViewById(C8000R.id.indicator_container);

            ...
            public final Caller<? extends Member> invoke() {
                ...
                if (constructor instanceof Constructor) {
                    ...
                    if (!Modifier.isStatic(method2.getModifiers())) {
                        ...
                        createJvmStaticInObjectCaller = KFunctionImpl.this.getDescriptor().getAnnotations().mo5455findAnnotation(UtilKt.getJVM_STATIC()) != null ? KFunctionImpl.this.createJvmStaticInObjectCaller(method2) : KFunctionImpl.this.createStaticMethodCaller(method2);
                    }
        ...
        this.defaultCaller = ReflectProperties.lazy(new Function0<Caller<? extends Member>>() { // from class: kotlin.reflect.jvm.internal.KFunctionImpl$defaultCaller$2
            ...
            public final Caller<? extends Member> invoke() {
                ...
                if (mapSignature instanceof JvmFunctionSignature.KotlinFunction) {
                    ...
                    if (KFunctionImpl.this.getCaller().mo5452getMember() == 0) {
                        Intrinsics.throwNpe();
                    }
                ...
                if (constructor instanceof Constructor) {
                    ...
                    if (KFunctionImpl.this.getDescriptor().getAnnotations().mo5455findAnnotation(UtilKt.getJVM_STATIC()) != null) {

...
public class JvmClassName {
    ...
    public static JvmClassName byClassId(ClassId classId) {
        ...
        return new JvmClassName(packageFqName.asString().replace(FilenameUtils.EXTENSION_SEPARATOR, '/') + "/" + replace);
    }
    ...
    public static JvmClassName byFqNameWithoutInnerClasses(FqName fqName) {
        ...
        JvmClassName jvmClassName = new JvmClassName(fqName.asString().replace(FilenameUtils.EXTENSION_SEPARATOR, '/'));
    ...
    public FqName getPackageFqName() {
        ...
        return new FqName(this.internalName.substring(0, lastIndexOf).replace('/', FilenameUtils.EXTENSION_SEPARATOR));
    }

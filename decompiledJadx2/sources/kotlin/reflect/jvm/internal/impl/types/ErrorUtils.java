...
public class ErrorUtils {
    ...
    public static class ErrorScope implements MemberScope {
        ...
        */
        ...
        public ClassifierDescriptor mo5462getContributedClassifier(Name name, LookupLocation lookupLocation) {
            if (name == null) {
                $$$reportNull$$$0(1);
            }
    ...
    public static class UninferredParameterTypeConstructor implements TypeConstructor {
        ...
        /* renamed from: getSupertypes */
        public Collection<KotlinType> mo5461getSupertypes() {
            Collection<KotlinType> mo5461getSupertypes = this.errorTypeConstructor.mo5461getSupertypes();
            if (mo5461getSupertypes == null) {
                $$$reportNull$$$0(3);
            }
        ...
        /* renamed from: getDeclarationDescriptor */
        public ClassifierDescriptor mo5460getDeclarationDescriptor() {
            return this.errorTypeConstructor.mo5460getDeclarationDescriptor();
        }

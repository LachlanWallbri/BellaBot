...
public class Flags {
    ...
    */
    ...
    static {
        ...
        BooleanFlagField booleanAfter11 = FlagField.booleanAfter(MEMBER_KIND);
        ...
        BooleanFlagField booleanAfter19 = FlagField.booleanAfter(HAS_ANNOTATIONS);
        ...
        BooleanFlagField booleanAfter21 = FlagField.booleanAfter(MODALITY);
    ...
    public static class BooleanFlagField extends FlagField<Boolean> {
        private static /* synthetic */ void $$$reportNull$$$0(int i) {
            throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "kotlin/reflect/jvm/internal/impl/metadata/deserialization/Flags$BooleanFlagField", TmpConstant.PROPERTY_IDENTIFIER_GET));
        }

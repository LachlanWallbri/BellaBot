...
public final class DescriptorRendererImpl extends DescriptorRenderer implements DescriptorRendererOptions {
    ...
    public DescriptorRendererImpl(DescriptorRendererOptionsImpl options) {
        ...
        boolean isLocked = options.isLocked();
    ...
    /* renamed from: lt */
    private final String m3982lt() {
        return escape("<");
    }

    /* renamed from: gt */
    private final String m3981gt() {
        return escape(">");
    }
    ...
    */
    ...
    public String renderTypeConstructor(TypeConstructor typeConstructor) {
        ...
        if ((mo5460getDeclarationDescriptor instanceof TypeParameterDescriptor) || (mo5460getDeclarationDescriptor instanceof ClassDescriptor) || (mo5460getDeclarationDescriptor instanceof TypeAliasDescriptor)) {
            return renderClassifierName(mo5460getDeclarationDescriptor);
        }
        if (mo5460getDeclarationDescriptor == null) {
            return typeConstructor.toString();
        }
        throw new IllegalStateException(("Unexpected classifier: " + mo5460getDeclarationDescriptor.getClass()).toString());
    }
    ...
    private final void appendTypeProjections(StringBuilder sb, List<? extends TypeProjection> list) {
        CollectionsKt.joinTo(list, sb, (r14 & 2) != 0 ? ", " : ", ", (r14 & 4) != 0 ? "" : null, (r14 & 8) != 0 ? "" : null, (r14 & 16) != 0 ? -1 : 0, (r14 & 32) != 0 ? "..." : null, (r14 & 64) != 0 ? (Function1) null : new Function1<TypeProjection, CharSequence>() { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRendererImpl$appendTypeProjections$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
    ...
    public String renderAnnotation(AnnotationDescriptor annotation, AnnotationUseSiteTarget annotationUseSiteTarget) {
        ...
        if (getVerbose() && (KotlinTypeKt.isError(type) || (type.getConstructor().mo5460getDeclarationDescriptor() instanceof NotFoundClasses.MockClassDescriptor))) {
    ...
    private final List<String> renderAndSortAnnotationArguments(AnnotationDescriptor annotationDescriptor) {
        ...
        if (annotationClass != null && (mo5454getUnsubstitutedPrimaryConstructor = annotationClass.mo5454getUnsubstitutedPrimaryConstructor()) != null && (valueParameters = mo5454getUnsubstitutedPrimaryConstructor.getValueParameters()) != null) {
    ...
    */
            ...
            if (z3 || getAlwaysRenderModifiers()) {
                ...
                if (functionDescriptor.isInfix()) {
                    ...
                    if (!(collection2 instanceof Collection) || !collection2.isEmpty()) {
                        for (FunctionDescriptor it2 : collection2) {
    ...
    public final void renderConstructor(ConstructorDescriptor constructorDescriptor, StringBuilder sb) {
        ...
        if (getRenderConstructorDelegation() && !constructorDescriptor.isPrimary() && (containingDeclaration instanceof ClassDescriptor) && (mo5454getUnsubstitutedPrimaryConstructor = ((ClassDescriptor) containingDeclaration).mo5454getUnsubstitutedPrimaryConstructor()) != null) {
            List<ValueParameterDescriptor> valueParameters2 = mo5454getUnsubstitutedPrimaryConstructor.getValueParameters();
            ...
            if (!arrayList2.isEmpty()) {
                ...
                sb.append(CollectionsKt.joinToString$default(arrayList2, ", ", "(", ")", 0, null, new Function1<ValueParameterDescriptor, String>() { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRendererImpl$renderConstructor$1
                    @Override // kotlin.jvm.functions.Function1
    ...
    private final void renderWhereSuffix(List<? extends TypeParameterDescriptor> list, StringBuilder sb) {
        ...
        sb.append(" ");
        CollectionsKt.joinTo(arrayList, sb, (r14 & 2) != 0 ? ", " : ", ", (r14 & 4) != 0 ? "" : null, (r14 & 8) != 0 ? "" : null, (r14 & 16) != 0 ? -1 : 0, (r14 & 32) != 0 ? "..." : null, (r14 & 64) != 0 ? (Function1) null : null);
    }
    ...
    */
    ...
    private final void renderInitializer(VariableDescriptor variableDescriptor, StringBuilder sb) {
        ...
        if (!getIncludePropertyConstant() || (constant = variableDescriptor.mo5456getCompileTimeInitializer()) == null) {
            return;
        }
        sb.append(" = ");
    ...
    public final void renderClass(ClassDescriptor classDescriptor, StringBuilder sb) {
        ...
        if (!kind2.isSingleton() && getClassWithPrimaryConstructor() && (mo5454getUnsubstitutedPrimaryConstructor = classDescriptor.mo5454getUnsubstitutedPrimaryConstructor()) != null) {
            sb.append(" ");
            renderAnnotations$default(this, sb, mo5454getUnsubstitutedPrimaryConstructor, null, 2, null);
            Visibility visibility2 = mo5454getUnsubstitutedPrimaryConstructor.getVisibility();
            Intrinsics.checkExpressionValueIsNotNull(visibility2, "primaryConstructor.visibility");
            renderVisibility(visibility2, sb);
            sb.append(renderKeyword("constructor"));
            List<ValueParameterDescriptor> valueParameters = mo5454getUnsubstitutedPrimaryConstructor.getValueParameters();
            Intrinsics.checkExpressionValueIsNotNull(valueParameters, "primaryConstructor.valueParameters");
            renderValueParameters(valueParameters, mo5454getUnsubstitutedPrimaryConstructor.hasSynthesizedParameterNames(), sb);
        }
    ...
    private final void renderSuperTypes(ClassDescriptor classDescriptor, StringBuilder sb) {
        ...
        Intrinsics.checkExpressionValueIsNotNull(mo5461getSupertypes, "klass.typeConstructor.supertypes");
        if (mo5461getSupertypes.isEmpty()) {
            return;
        }
        if (mo5461getSupertypes.size() == 1 && KotlinBuiltIns.isAnyOrNullableAny(mo5461getSupertypes.iterator().next())) {
            return;
        }
        renderSpaceIfNeeded(sb);
        sb.append(": ");
        CollectionsKt.joinTo(mo5461getSupertypes, sb, (r14 & 2) != 0 ? ", " : ", ", (r14 & 4) != 0 ? "" : null, (r14 & 8) != 0 ? "" : null, (r14 & 16) != 0 ? -1 : 0, (r14 & 32) != 0 ? "..." : null, (r14 & 64) != 0 ? (Function1) null : new Function1<KotlinType, String>() { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRendererImpl$renderSuperTypes$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }

...
public abstract class KotlinBuiltIns {
    ...
    private static /* synthetic */ void $$$reportNull$$$0(int i) {
        ...
        switch (i) {
            case 1:
            case 71:
                objArr[0] = AUserTrack.UTKEY_MODULE;
                break;
            case 2:
            case 3:
            case 4:
    ...
    public KotlinBuiltIns(StorageManager storageManager) {
        ...
        this.builtInClassesByName = storageManager.createMemoizedFunction(new Function1<Name, ClassDescriptor>() { // from class: kotlin.reflect.jvm.internal.impl.builtins.KotlinBuiltIns.3
            ...
            public ClassDescriptor invoke(Name name) {
                ClassifierDescriptor contributedClassifier = KotlinBuiltIns.this.getBuiltInsPackageScope().mo5462getContributedClassifier(name, NoLookupLocation.FROM_BUILTINS);
    ...
    public static class FqNames {
        ...
        public final FqName deprecated = fqName(AttributeLayout.ATTRIBUTE_DEPRECATED);
    ...
    public SimpleType getPrimitiveArrayKotlinTypeByPrimitiveKotlinType(KotlinType kotlinType) {
        ...
        if (!UnsignedTypes.INSTANCE.isUnsignedType(kotlinType) || TypeUtils.isNullableType(kotlinType) || (containingModuleOrNull = DescriptorUtils.getContainingModuleOrNull(kotlinType)) == null) {
            return null;
        }
        ClassDescriptor findClassAcrossModuleDependencies = FindClassInModuleKt.findClassAcrossModuleDependencies(containingModuleOrNull, UnsignedTypes.INSTANCE.getUnsignedArrayClassIdByUnsignedClassId(DescriptorUtilsKt.getClassId(kotlinType.getConstructor().mo5460getDeclarationDescriptor())));
    ...
    public static boolean isPrimitiveArray(KotlinType kotlinType) {
        ...
        ClassifierDescriptor mo5460getDeclarationDescriptor = kotlinType.getConstructor().mo5460getDeclarationDescriptor();
        return (mo5460getDeclarationDescriptor == null || getPrimitiveArrayType(mo5460getDeclarationDescriptor) == null) ? false : true;
    }
    ...
    public static boolean isPrimitiveTypeOrNullablePrimitiveType(KotlinType kotlinType) {
        ...
        ClassifierDescriptor mo5460getDeclarationDescriptor = kotlinType.getConstructor().mo5460getDeclarationDescriptor();
        return (mo5460getDeclarationDescriptor instanceof ClassDescriptor) && isPrimitiveClass((ClassDescriptor) mo5460getDeclarationDescriptor);
    }
    ...
    public static boolean isTypeConstructorForGivenClass(TypeConstructor typeConstructor, FqNameUnsafe fqNameUnsafe) {
        ...
        return (mo5460getDeclarationDescriptor instanceof ClassDescriptor) && classFqNameEquals(mo5460getDeclarationDescriptor, fqNameUnsafe);
    }

...
public final class ClassId {
    ...
    public static ClassId fromString(String str, boolean z) {
        ...
        return new ClassId(new FqName(StringsKt.substringBeforeLast(str, '/', "").replace('/', FilenameUtils.EXTENSION_SEPARATOR)), new FqName(StringsKt.substringAfterLast(str, '/', str)), z);
    }
    ...
    public String asString() {
        ...
        String str = this.packageFqName.asString().replace(FilenameUtils.EXTENSION_SEPARATOR, '/') + "/" + this.relativeClassName.asString();
        if (str == null) {
            $$$reportNull$$$0(14);
        }
        return str;

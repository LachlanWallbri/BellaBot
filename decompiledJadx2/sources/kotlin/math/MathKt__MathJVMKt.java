...
public class MathKt__MathJVMKt extends MathKt__MathHKt {
    ...
    /* renamed from: ln */
    private static final double m3979ln(double d) {
        return Math.log(d);
    }
    ...
    /* renamed from: ln */
    private static final float m3980ln(float f) {

...
public class _NestedScrollView extends NestedScrollView {
    ...
    public static /* synthetic */ View lparams$default(_NestedScrollView _nestedscrollview, View receiver$0, int i, int i2, Function1 init, int i3, Object obj) {
        if (obj != null) {
    ...
    public static /* synthetic */ View lparams$default(_NestedScrollView _nestedscrollview, View receiver$0, int i, int i2, int i3, Object obj) {
        if (obj != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: lparams");
        }
        if ((i3 & 1) != 0) {
    ...
    public static /* synthetic */ View lparams$default(_NestedScrollView _nestedscrollview, View receiver$0, int i, int i2, int i3, Function1 init, int i4, Object obj) {
        if (obj != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: lparams");
        }
        if ((i4 & 1) != 0) {
    ...
    public static /* synthetic */ View lparams$default(_NestedScrollView _nestedscrollview, View receiver$0, int i, int i2, int i3, int i4, Object obj) {
        if (obj != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: lparams");
        }
        if ((i4 & 1) != 0) {

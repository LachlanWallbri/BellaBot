...
public class _LinearLayout extends LinearLayout {
    ...
    public static /* synthetic */ View lparams$default(_LinearLayout _linearlayout, View receiver$0, int i, int i2, Function1 init, int i3, Object obj) {
        if (obj != null) {
    ...
    public static /* synthetic */ View lparams$default(_LinearLayout _linearlayout, View receiver$0, int i, int i2, int i3, Object obj) {
        if (obj != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: lparams");
        }
        if ((i3 & 1) != 0) {
    ...
    public static /* synthetic */ View lparams$default(_LinearLayout _linearlayout, View receiver$0, int i, int i2, float f, Function1 init, int i3, Object obj) {
        if (obj != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: lparams");
        }
        if ((i3 & 1) != 0) {
    ...
    public static /* synthetic */ View lparams$default(_LinearLayout _linearlayout, View receiver$0, int i, int i2, float f, int i3, Object obj) {
        if (obj != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: lparams");
        }
        if ((i3 & 1) != 0) {

...
public class MqttAsyncClient implements IMqttAsyncClient {
    ...
    static {
        String name = MqttAsyncClient.class.getName();
        CLASS_NAME = name;
    ...
    public IMqttToken disconnect(long j, Object obj, IMqttActionListener iMqttActionListener) throws MqttException {
        log.fine(CLASS_NAME, MqttServiceConstants.DISCONNECT_ACTION, "104", new Object[]{new Long(j), obj, iMqttActionListener});
        MqttToken mqttToken = new MqttToken(getClientId());
    ...
    public class MqttReconnectActionListener implements IMqttActionListener {
        ...
        private void rescheduleReconnectCycle(int i) {
            MqttAsyncClient.log.fine(MqttAsyncClient.CLASS_NAME, this.methodName + ":rescheduleReconnectCycle", "505", new Object[]{MqttAsyncClient.this.clientId, String.valueOf(MqttAsyncClient.reconnectDelay)});
            synchronized (MqttAsyncClient.clientLock) {
                if (MqttAsyncClient.this.connOpts.isAutomaticReconnect()) {
                    if (MqttAsyncClient.this.reconnectTimer != null) {
                        MqttAsyncClient.this.reconnectTimer.schedule(new ReconnectTask(), i);
                    } else {

    ...
    private ASN1Primitive encode(int[] iArr, byte[][] bArr, byte[][] bArr2, byte[][][] bArr3, byte[][][] bArr4, byte[][][] bArr5, Treehash[][] treehashArr, Treehash[][] treehashArr2, Vector[] vectorArr, Vector[] vectorArr2, Vector[][] vectorArr3, Vector[][] vectorArr4, GMSSLeaf[] gMSSLeafArr, GMSSLeaf[] gMSSLeafArr2, GMSSLeaf[] gMSSLeafArr3, int[] iArr2, byte[][] bArr6, GMSSRootCalc[] gMSSRootCalcArr, byte[][] bArr7, GMSSRootSig[] gMSSRootSigArr, GMSSParameters gMSSParameters, AlgorithmIdentifier[] algorithmIdentifierArr) {
        ...
        while (i6 < treehashArr3.length) {
            ...
            while (i7 < treehashArr3[i6].length) {
                ...
                aSN1EncodableVector19.add(new ASN1Integer(treehashArr3[i6][i7].getStatInt()[0]));
                aSN1EncodableVector19.add(new ASN1Integer(i8));
                aSN1EncodableVector19.add(new ASN1Integer(treehashArr3[i6][i7].getStatInt()[2]));
                aSN1EncodableVector19.add(new ASN1Integer(treehashArr3[i6][i7].getStatInt()[3]));
                aSN1EncodableVector19.add(new ASN1Integer(treehashArr3[i6][i7].getStatInt()[4]));
                aSN1EncodableVector19.add(new ASN1Integer(treehashArr3[i6][i7].getStatInt()[5]));
                int i10 = 0;
                while (i10 < i8) {
                    aSN1EncodableVector19.add(new ASN1Integer(treehashArr3[i6][i7].getStatInt()[i10 + 6]));
                    i10++;
        ...
        while (i11 < treehashArr2.length) {
            ...
            for (int i12 = 0; i12 < treehashArr2[i11].length; i12++) {
                ...
                aSN1EncodableVector30.add(new ASN1Integer(treehashArr2[i11][i12].getStatInt()[0]));
                aSN1EncodableVector30.add(new ASN1Integer(i13));
                aSN1EncodableVector30.add(new ASN1Integer(treehashArr2[i11][i12].getStatInt()[2]));
                aSN1EncodableVector30.add(new ASN1Integer(treehashArr2[i11][i12].getStatInt()[3]));
                aSN1EncodableVector30.add(new ASN1Integer(treehashArr2[i11][i12].getStatInt()[4]));
                aSN1EncodableVector30.add(new ASN1Integer(treehashArr2[i11][i12].getStatInt()[5]));
                for (int i15 = 0; i15 < i13; i15++) {
                    aSN1EncodableVector30.add(new ASN1Integer(treehashArr2[i11][i12].getStatInt()[i15 + 6]));
                }
        ...
        for (int i28 = 0; i28 < gMSSLeafArr.length; i28++) {
            ...
            aSN1EncodableVector57.add(new ASN1Integer(statInt[0]));
            aSN1EncodableVector57.add(new ASN1Integer(statInt[1]));
            aSN1EncodableVector57.add(new ASN1Integer(statInt[2]));
            aSN1EncodableVector57.add(new ASN1Integer(statInt[3]));
        ...
        for (int i29 = 0; i29 < gMSSLeafArr2.length; i29++) {
            ...
            aSN1EncodableVector62.add(new ASN1Integer(statInt2[0]));
            aSN1EncodableVector62.add(new ASN1Integer(statInt2[1]));
            aSN1EncodableVector62.add(new ASN1Integer(statInt2[2]));
            aSN1EncodableVector62.add(new ASN1Integer(statInt2[3]));
        ...
        for (int i30 = 0; i30 < gMSSLeafArr3.length; i30++) {
            ...
            aSN1EncodableVector67.add(new ASN1Integer(statInt3[0]));
            aSN1EncodableVector67.add(new ASN1Integer(statInt3[1]));
            aSN1EncodableVector67.add(new ASN1Integer(statInt3[2]));
            aSN1EncodableVector67.add(new ASN1Integer(statInt3[3]));
        ...
        for (int i31 : iArr2) {
            aSN1EncodableVector69.add(new ASN1Integer(i31));
        }
        ...
        while (i32 < gMSSRootCalcArr.length) {
            ...
            aSN1EncodableVector78.add(new ASN1Integer(i33));
            aSN1EncodableVector78.add(new ASN1Integer(gMSSRootCalcArr[i32].getStatInt()[1]));
            aSN1EncodableVector78.add(new ASN1Integer(gMSSRootCalcArr[i32].getStatInt()[2]));
            aSN1EncodableVector78.add(new ASN1Integer(gMSSRootCalcArr[i32].getStatInt()[3]));
            aSN1EncodableVector78.add(new ASN1Integer(gMSSRootCalcArr[i32].getStatInt()[4]));
            aSN1EncodableVector78.add(new ASN1Integer(gMSSRootCalcArr[i32].getStatInt()[5]));
            aSN1EncodableVector78.add(new ASN1Integer(gMSSRootCalcArr[i32].getStatInt()[6]));
            aSN1EncodableVector78.add(new ASN1Integer(i34));
            for (int i37 = 0; i37 < i33; i37++) {
                aSN1EncodableVector78.add(new ASN1Integer(gMSSRootCalcArr[i32].getStatInt()[i37 + 8]));
            }
            for (int i38 = 0; i38 < i34; i38++) {
                aSN1EncodableVector78.add(new ASN1Integer(gMSSRootCalcArr[i32].getStatInt()[i33 + 8 + i38]));
            }
            ...
            if (gMSSRootCalcArr[i32].getTreehash() != null) {
                ...
                while (i39 < gMSSRootCalcArr[i32].getTreehash().length) {
                    ...
                    aSN1EncodableVector85.add(new ASN1Integer(gMSSRootCalcArr[i32].getTreehash()[i39].getStatInt()[0]));
                    aSN1EncodableVector85.add(new ASN1Integer(i40));
                    aSN1EncodableVector85.add(new ASN1Integer(gMSSRootCalcArr[i32].getTreehash()[i39].getStatInt()[2]));
                    aSN1EncodableVector85.add(new ASN1Integer(gMSSRootCalcArr[i32].getTreehash()[i39].getStatInt()[3]));
                    aSN1EncodableVector85.add(new ASN1Integer(gMSSRootCalcArr[i32].getTreehash()[i39].getStatInt()[4]));
                    aSN1EncodableVector85.add(new ASN1Integer(gMSSRootCalcArr[i32].getTreehash()[i39].getStatInt()[5]));
                    for (int i42 = 0; i42 < i40; i42++) {
                        aSN1EncodableVector85.add(new ASN1Integer(gMSSRootCalcArr[i32].getTreehash()[i39].getStatInt()[i42 + 6]));
                    }
            ...
            if (gMSSRootCalcArr[i32].getRetain() != null) {
                ...
                for (int i43 = 0; i43 < gMSSRootCalcArr[i32].getRetain().length; i43++) {
                    for (int i44 = 0; i44 < gMSSRootCalcArr[i32].getRetain()[i43].size(); i44++) {
                        aSN1EncodableVector95.add(new DEROctetString((byte[]) gMSSRootCalcArr[i32].getRetain()[i43].elementAt(i44)));
                    }
        ...
        aSN1EncodableVector96.add(new DERSequence(aSN1EncodableVector71));
        ASN1EncodableVector aSN1EncodableVector97 = new ASN1EncodableVector();
        for (byte[] bArr11 : bArr7) {
            aSN1EncodableVector97.add(new DEROctetString(bArr11));
        }
        ...
        for (int i45 = 0; i45 < gMSSRootSigArr.length; i45++) {
            aSN1EncodableVector102.add(new DERSequence(algorithmIdentifierArr[0]));
            new ASN1EncodableVector();
            aSN1EncodableVector100.add(new DEROctetString(gMSSRootSigArr[i45].getStatByte()[0]));
            aSN1EncodableVector100.add(new DEROctetString(gMSSRootSigArr[i45].getStatByte()[1]));
            aSN1EncodableVector100.add(new DEROctetString(gMSSRootSigArr[i45].getStatByte()[2]));
            aSN1EncodableVector100.add(new DEROctetString(gMSSRootSigArr[i45].getStatByte()[3]));
            aSN1EncodableVector100.add(new DEROctetString(gMSSRootSigArr[i45].getStatByte()[4]));
            aSN1EncodableVector102.add(new DERSequence(aSN1EncodableVector100));
            aSN1EncodableVector100 = new ASN1EncodableVector();
            aSN1EncodableVector101.add(new ASN1Integer(gMSSRootSigArr[i45].getStatInt()[0]));
            aSN1EncodableVector101.add(new ASN1Integer(gMSSRootSigArr[i45].getStatInt()[1]));
            aSN1EncodableVector101.add(new ASN1Integer(gMSSRootSigArr[i45].getStatInt()[2]));
            aSN1EncodableVector101.add(new ASN1Integer(gMSSRootSigArr[i45].getStatInt()[3]));
            aSN1EncodableVector101.add(new ASN1Integer(gMSSRootSigArr[i45].getStatInt()[4]));
            aSN1EncodableVector101.add(new ASN1Integer(gMSSRootSigArr[i45].getStatInt()[5]));
            aSN1EncodableVector101.add(new ASN1Integer(gMSSRootSigArr[i45].getStatInt()[6]));
            aSN1EncodableVector101.add(new ASN1Integer(gMSSRootSigArr[i45].getStatInt()[7]));
            aSN1EncodableVector101.add(new ASN1Integer(gMSSRootSigArr[i45].getStatInt()[8]));
        ...
        for (int i46 = 0; i46 < gMSSParameters.getHeightOfTrees().length; i46++) {
            aSN1EncodableVector104.add(new ASN1Integer(gMSSParameters.getHeightOfTrees()[i46]));
            aSN1EncodableVector105.add(new ASN1Integer(gMSSParameters.getWinternitzParameter()[i46]));
            aSN1EncodableVector106.add(new ASN1Integer(gMSSParameters.getK()[i46]));
        }
        aSN1EncodableVector103.add(new ASN1Integer(gMSSParameters.getNumOfLayers()));
        ...
        for (AlgorithmIdentifier algorithmIdentifier : algorithmIdentifierArr) {
            aSN1EncodableVector107.add(algorithmIdentifier);
        }

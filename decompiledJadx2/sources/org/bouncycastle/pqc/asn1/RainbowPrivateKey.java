...
public class RainbowPrivateKey extends ASN1Object {
    ...
    /* renamed from: b1 */
    private byte[] f9868b1;

    /* renamed from: b2 */
    private byte[] f9869b2;
    private byte[][] invA1;
    private byte[][] invA2;
    ...
    private RainbowPrivateKey(ASN1Sequence aSN1Sequence) {
        ...
        this.f9868b1 = ((ASN1OctetString) ((ASN1Sequence) aSN1Sequence.getObjectAt(2)).getObjectAt(0)).getOctets();
        ...
        this.f9869b2 = ((ASN1OctetString) ((ASN1Sequence) aSN1Sequence.getObjectAt(4)).getObjectAt(0)).getOctets();
        this.f9870vi = ((ASN1OctetString) ((ASN1Sequence) aSN1Sequence.getObjectAt(5)).getObjectAt(0)).getOctets();
        ...
        int length = this.f9870vi.length - 1;
        this.layers = new Layer[length];
        int i10 = 0;
        while (i10 < length) {
            byte[] bArr5 = this.f9870vi;
            int i11 = i10 + 1;
    ...
    public RainbowPrivateKey(short[][] sArr, short[] sArr2, short[][] sArr3, short[] sArr4, int[] iArr, Layer[] layerArr) {
        ...
        this.f9868b1 = RainbowUtil.convertArray(sArr2);
        this.invA2 = RainbowUtil.convertArray(sArr3);
        this.f9869b2 = RainbowUtil.convertArray(sArr4);
        this.f9870vi = RainbowUtil.convertIntArray(iArr);
    ...
    public short[] getB1() {
        return RainbowUtil.convertArray(this.f9868b1);
    }

    public short[] getB2() {
        return RainbowUtil.convertArray(this.f9869b2);
    }
    ...
    public int[] getVi() {
        return RainbowUtil.convertArraytoInt(this.f9870vi);
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector3.add(new DEROctetString(this.f9868b1));
        ...
        aSN1EncodableVector5.add(new DEROctetString(this.f9869b2));
        aSN1EncodableVector.add(new DERSequence(aSN1EncodableVector5));
        ASN1EncodableVector aSN1EncodableVector6 = new ASN1EncodableVector();
        aSN1EncodableVector6.add(new DEROctetString(this.f9870vi));

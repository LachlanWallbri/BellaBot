...
public class PolynomialRingGF2m {
    ...
    /* renamed from: p */
    private PolynomialGF2mSmallM f9965p;
    ...
    public PolynomialRingGF2m(GF2mField gF2mField, PolynomialGF2mSmallM polynomialGF2mSmallM) {
        ...
        this.f9965p = polynomialGF2mSmallM;
    ...
    private void computeSquareRootMatrix() {
        int coefficient;
        int degree = this.f9965p.getDegree();
    ...
    private void computeSquaringMatrix() {
        ...
        while (i < degree) {
            ...
            iArr2[i4] = 1;
            this.sqMatrix[i] = new PolynomialGF2mSmallM(this.field, iArr2).mod(this.f9965p);
            i++;
        }
    }

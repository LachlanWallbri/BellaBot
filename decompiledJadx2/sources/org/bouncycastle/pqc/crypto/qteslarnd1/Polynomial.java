...
class Polynomial {
    ...
    private static void inverseNumberTheoreticTransform(int[] iArr, int[] iArr2, int i, int i2, long j, int i3, int i4, int i5) {
        ...
        while (i6 < i) {
            ...
            while (i9 < i) {
                ...
                while (i11 < i9 + i6) {
                    ...
                    iArr[i11 + i6] = montgomery((i12 - iArr[r12]) * j2, i2, j);
                    i11++;
                    i6 = i6;
                }
                i9 = i11 + i6;
        ...
        for (int i13 = 0; i13 < i / 2; i13++) {
            iArr[i13] = montgomery(i3 * iArr[i13], i2, j);
        }
    }
    ...
    private static void inverseNumberTheoreticTransformI(int[] iArr, int[] iArr2) {
        ...
        while (i < 512) {
            ...
            while (i4 < 512) {
                ...
                while (i6 < i4 + i) {
                    int i7 = i6 + i;
                    iArr[i6] = iArr[i7] + iArr[i6];
                    iArr[i7] = montgomery((r11 - iArr[i7]) * j, Parameter.Q_I, Parameter.Q_INVERSE_I);
                    i6++;
                }
                i4 = i6 + i;
                i3 = i5;
        ...
        for (int i8 = 0; i8 < 256; i8++) {
            iArr[i8] = montgomery(iArr[i8] * 1081347, Parameter.Q_I, Parameter.Q_INVERSE_I);
        }
    }
        ...
        while (i3 < 2048) {
            ...
            while (i6 < 2048) {
                ...
                while (i8 < i6 + i3) {
                    ...
                    long j2 = jArr[i9];
                    int i10 = i9 + i3;
                    jArr[i9] = barrett(jArr[i10] + j2, Parameter.Q_III_P, 15, 34);
                    jArr[i10] = barrett(montgomeryP((j2 + (2259451906L - jArr[i10])) * j, Parameter.Q_III_P, Parameter.Q_INVERSE_III_P), Parameter.Q_III_P, 15, 34);
                    i8++;
                }
                i6 = i8 + i3;
                i5 = i7;
        ...
        while (true) {
            ...
            for (int i13 = 1024; i12 < i13; i13 = 1024) {
                ...
                while (i15 < i12 + i11) {
                    ...
                    long j4 = jArr[i16];
                    int i17 = i16 + i11;
                    jArr[i16] = barrett(j4 + jArr[i17], Parameter.Q_I_P, 1, 29);
    ...
    private static void numberTheoreticTransformIIIP(long[] jArr, long[] jArr2) {
        ...
        while (i > 0) {
            ...
            while (i4 < 2048) {
                ...
                while (i7 < i4 + i) {
                    int i8 = i7 + i;
                    long barrett = barrett(montgomeryP(i6 * jArr[i8], Parameter.Q_III_P, Parameter.Q_INVERSE_III_P), Parameter.Q_III_P, 15, 34);
                    jArr[i8] = barrett(jArr[i7] + (2259451906L - barrett), Parameter.Q_III_P, 15, 34);
                    jArr[i7] = barrett(jArr[i7] + barrett, Parameter.Q_III_P, 15, 34);
                    i7++;
                }
                i4 = i7 + i;
                i3 = i5;
    ...
    public static void polynomialUniform(int[] iArr, byte[] bArr, int i, int i2, int i3, long j, int i4, int i5, int i6) {
        ...
        byte[] bArr4 = bArr3;
        HashUtils.customizableSecureHashAlgorithmKECCAK128Simple(bArr3, 0, i14, (short) 0, bArr, i, 32);
        int i15 = i5;
        short s = (short) 1;
        int i16 = 0;
        int i17 = 0;
        while (i16 < i2) {
            ...
            byte[] bArr5 = bArr4;
            int load32 = CommonFunction.load32(bArr5, i8) & i13;
            int i18 = i8 + i11;
            int load322 = CommonFunction.load32(bArr5, i18) & i13;
            int i19 = i18 + i11;
            int load323 = CommonFunction.load32(bArr5, i19) & i13;
            int i20 = i19 + i11;
            int load324 = CommonFunction.load32(bArr5, i20) & i13;
            int i21 = i20 + i11;
            if (load32 >= i3 || i16 >= i2) {
                bArr2 = bArr5;
                i9 = i21;
                ...
                i9 = i21;
                i10 = i7;
                iArr[i16] = montgomery(load32 * i6, i3, j);
                i16++;
            }
    ...
    public static void polynomialUniform(long[] jArr, byte[] bArr, int i, int i2, int i3, int i4, long j, int i5, int i6, int i7) {
        ...
        HashUtils.customizableSecureHashAlgorithmKECCAK128Simple(bArr4, 0, i13, (short) 0, bArr, i, 32);
        int i14 = i6;
        short s = (short) 1;
        int i15 = 0;
        int i16 = 0;
        while (true) {
            ...
            if (load32 >= i4 || i15 >= i8) {
                ...
                i10 = i14;
                bArr3 = bArr2;
                jArr[i15] = montgomeryP(load32 * i7, i4, j);
                i15++;
            }
            if (load322 < i4 && i15 < i8) {
                jArr[i15] = montgomeryP(load322 * i7, i4, j);
                i15++;
            }
            if (load323 < i4 && i15 < i8) {
                jArr[i15] = montgomeryP(load323 * i7, i4, j);
                i15++;
            }
            if (load324 >= i4 || i15 >= i8) {
                i14 = i10;
            } else {
                jArr[i15] = montgomeryP(load324 * i7, i4, j);
                i14 = i10;
                i15++;
            }
            i16 = i9;

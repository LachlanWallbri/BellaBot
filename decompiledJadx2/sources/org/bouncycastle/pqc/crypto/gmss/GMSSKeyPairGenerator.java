...
public class GMSSKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
    ...
    private AsymmetricCipherKeyPair genKeyPair() {
        ...
        while (true) {
            ...
            bArr[i4] = (byte[][]) Array.newInstance((Class<?>) byte.class, this.heightOfTrees[i4], this.mdLength);
            int[] iArr = this.heightOfTrees;
            treehashArr[i4] = new Treehash[iArr[i4] - this.f9871K[i4]];
            if (i4 > 0) {
                int i5 = i4 - 1;
                bArr2[i5] = (byte[][]) Array.newInstance((Class<?>) byte.class, iArr[i4], this.mdLength);
                treehashArr2[i5] = new Treehash[this.heightOfTrees[i4] - this.f9871K[i4]];
            }
        ...
        byte[][] bArr6 = bArr4;
        this.currentRootSigs = (byte[][]) Array.newInstance((Class<?>) byte.class, i2 - 1, this.mdLength);
        int i7 = this.numLayer - 1;
        while (i7 >= 0) {
            GMSSRootCalc generateCurrentAuthpathAndRoot = i7 == this.numLayer + (-1) ? generateCurrentAuthpathAndRoot(null, vectorArr[i7], bArr5[i7], i7) : generateCurrentAuthpathAndRoot(bArr3[i7 + 1], vectorArr[i7], bArr5[i7], i7);
            int i8 = 0;
            while (i8 < this.heightOfTrees[i7]) {
                System.arraycopy(generateCurrentAuthpathAndRoot.getAuthPath()[i8], 0, bArr[i7][i8], 0, this.mdLength);
                i8++;
                vectorArr = vectorArr;
            }
            vectorArr3[i7] = generateCurrentAuthpathAndRoot.getRetain();
            treehashArr[i7] = generateCurrentAuthpathAndRoot.getTreehash();
            System.arraycopy(generateCurrentAuthpathAndRoot.getRoot(), 0, bArr3[i7], 0, this.mdLength);
            i7--;
            vectorArr = vectorArr;
        }
        ...
        while (i9 >= 0) {
            ...
            treehashArr3[i9] = generateNextAuthpathAndRoot.getTreehash();
        ...
        return new AsymmetricCipherKeyPair((AsymmetricKeyParameter) new GMSSPublicKeyParameters(bArr3[0], this.gmssPS), (AsymmetricKeyParameter) new GMSSPrivateKeyParameters(this.currentSeeds, this.nextNextSeeds, bArr, bArr2, treehashArr, treehashArr3, vectorArr5, vectorArr2, vectorArr3, vectorArr4, bArr6, this.currentRootSigs, this.gmssPS, this.digestProvider));
    }
    ...
    private GMSSRootCalc generateCurrentAuthpathAndRoot(byte[] bArr, Vector vector, byte[] bArr2, int i) {
        ...
        GMSSRootCalc gMSSRootCalc = new GMSSRootCalc(this.heightOfTrees[i], this.f9871K[i], this.digestProvider);
        ...
        while (true) {
            ...
            if (i5 == i4 && i3 < iArr[i] - this.f9871K[i]) {
    ...
    private GMSSRootCalc generateNextAuthpathAndRoot(Vector vector, byte[] bArr, int i) {
        ...
        while (true) {
            ...
            if (i2 == i3 && i4 < iArr[i] - this.f9871K[i]) {

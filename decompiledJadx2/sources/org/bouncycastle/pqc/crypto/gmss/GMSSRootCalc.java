...
public class GMSSRootCalc {
    ...
    public GMSSRootCalc(int i, int i2, GMSSDigestProvider gMSSDigestProvider) {
        ...
        this.retain = new Vector[this.f9877K - 1];
    ...
    public void initialize(Vector vector) {
        int i;
        this.treehash = new Treehash[this.heightOfTree - this.f9877K];
        int i2 = 0;
        while (true) {
            i = this.heightOfTree;
            if (i2 >= i - this.f9877K) {
        ...
        this.retain = new Vector[this.f9877K - 1];
        for (int i4 = 0; i4 < this.f9877K - 1; i4++) {
    ...
    public void update(byte[] bArr) {
        ...
        } else if (iArr[0] == 3 && this.heightOfTree > this.f9877K) {
            this.treehash[0].setFirstNode(bArr);
        }
        int[] iArr2 = this.index;
        if ((iArr2[0] - 3) % 2 == 0 && iArr2[0] >= 3 && this.heightOfTree == this.f9877K) {
        ...
        while (this.tailStack.size() > 0 && i2 == ((Integer) this.heightOfNodes.lastElement()).intValue()) {
            ...
            if (i2 < this.heightOfTree) {
                ...
                if (i2 >= this.heightOfTree - this.f9877K) {
                    if (i2 == 0) {
                        System.out.println("M���P");
                    }
                    int[] iArr4 = this.index;
                    if ((iArr4[i2] - 3) % 2 == 0 && iArr4[i2] >= 3) {
                        this.retain[i2 - (this.heightOfTree - this.f9877K)].insertElementAt(bArr2, 0);
                    }
    ...
    public void update(byte[] bArr, byte[] bArr2) {
        ...
        if (i < this.heightOfTree - this.f9877K && this.indexForNextSeed - 2 == this.index[0]) {

...
class ErrorCorrection {
    ...
    static short LDDecode(int i, int i2, int i3, int i4) {
        return (short) (((((m4121g(i) + m4121g(i2)) + m4121g(i3)) + m4121g(i4)) - 98312) >>> 31);
    }
    ...
    /* renamed from: f */
    static int m4120f(int[] iArr, int i, int i2, int i3) {
        int i4 = (i3 * 2730) >> 25;
    ...
    public static void helpRec(short[] sArr, short[] sArr2, byte[] bArr, byte b) {
        ...
        while (i < 256) {
            ...
            int i5 = i + 512;
            int i6 = i + 768;
            int m4120f = (24577 - (((m4120f(iArr, 0, 4, (sArr2[i2] * s) + i3) + m4120f(iArr, 1, 5, (sArr2[i4] * s) + i3)) + m4120f(iArr, 2, 6, (sArr2[i5] * s) + i3)) + m4120f(iArr, 3, 7, (sArr2[i6] * 8) + i3))) >> 31;
            int i7 = ~m4120f;
            iArr2[0] = (i7 & iArr[0]) ^ (m4120f & iArr[4]);
            iArr2[1] = (i7 & iArr[1]) ^ (m4120f & iArr[5]);
            iArr2[2] = (i7 & iArr[2]) ^ (m4120f & iArr[6]);
            iArr2[3] = (iArr[7] & m4120f) ^ (i7 & iArr[3]);
            sArr[i2] = (short) ((iArr2[0] - iArr2[3]) & 3);
            sArr[i4] = (short) ((iArr2[1] - iArr2[3]) & 3);
            sArr[i5] = (short) ((iArr2[2] - iArr2[3]) & 3);
            sArr[i6] = (short) (((-m4120f) + (iArr2[3] * 2)) & 3);
            i++;
            s = 8;
        }
    }

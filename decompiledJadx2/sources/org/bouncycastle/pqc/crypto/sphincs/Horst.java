...
class Horst {
    ...
    public static int horst_verify(HashFunctions hashFunctions, byte[] bArr, byte[] bArr2, int i, byte[] bArr3, byte[] bArr4) {
        ...
        for (int i16 = 0; i16 < 32; i16++) {
            hashFunctions.hash_2n_n_mask(bArr5, i16 * 32, bArr2, i + (i16 * 2 * 32), bArr3, DimensionsKt.XXXHDPI);
        }
        for (int i17 = 0; i17 < 16; i17++) {
            hashFunctions.hash_2n_n_mask(bArr5, i17 * 32, bArr5, i17 * 2 * 32, bArr3, TypedValues.Transition.TYPE_AUTO_TRANSITION);
        }

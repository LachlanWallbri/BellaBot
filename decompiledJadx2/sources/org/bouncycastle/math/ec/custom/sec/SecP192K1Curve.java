...
public class SecP192K1Curve extends ECCurve.AbstractFp {
    ...
    /* renamed from: q */
    public static final BigInteger f9763q = SecP192K1FieldElement.f9766Q;
    ...
    public SecP192K1Curve() {
        ...
        this.f9716b = fromBigInteger(BigInteger.valueOf(3L));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat192.copy(((SecP192K1FieldElement) eCPoint.getRawXCoord()).f9767x, 0, iArr, i3);
            int i5 = i3 + 6;
            Nat192.copy(((SecP192K1FieldElement) eCPoint.getRawYCoord()).f9767x, 0, iArr, i5);
            i3 = i5 + 6;
        }

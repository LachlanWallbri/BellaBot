...
public class SecP128R1Curve extends ECCurve.AbstractFp {
    ...
    /* renamed from: q */
    public static final BigInteger f9746q = SecP128R1FieldElement.f9749Q;
    ...
    public SecP128R1Curve() {
        ...
        this.f9715a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("FFFFFFFDFFFFFFFFFFFFFFFFFFFFFFFC")));
        this.f9716b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("E87579C11079F43DD824993C2CEE5ED3")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat128.copy(((SecP128R1FieldElement) eCPoint.getRawXCoord()).f9750x, 0, iArr, i3);
            int i5 = i3 + 4;
            Nat128.copy(((SecP128R1FieldElement) eCPoint.getRawYCoord()).f9750x, 0, iArr, i5);
            i3 = i5 + 4;
        }

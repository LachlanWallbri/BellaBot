...
public class SecT131R2Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (add3.isZero()) {
                return new SecT131R2Point(curve, add3, curve.getB().sqrt());
            }
            ...
            if (multiply.isZero()) {
                return new SecT131R2Point(curve, multiply, curve.getB().sqrt());
            }
        ...
        return new SecT131R2Point(curve, multiply, squarePlusProduct, new ECFieldElement[]{multiply2});
    }

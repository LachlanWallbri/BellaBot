...
public class SecT131R1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (add3.isZero()) {
                return new SecT131R1Point(curve, add3, curve.getB().sqrt());
            }
            ...
            if (multiply.isZero()) {
                return new SecT131R1Point(curve, multiply, curve.getB().sqrt());
            }
        ...
        return new SecT131R1Point(curve, multiply, squarePlusProduct, new ECFieldElement[]{multiply2});
    }

...
public class SecP224R1Field {
    ...
    /* renamed from: M */
    private static final long f9780M = 4294967295L;

    /* renamed from: P6 */
    private static final int f9782P6 = -1;
    private static final int PExt13 = -1;

    /* renamed from: P */
    static final int[] f9781P = {1, 0, 0, -1, -1, -1, -1};
    static final int[] PExt = {1, 0, 0, -2, -1, -1, 0, 2, 0, 0, -2, -1, -1, -1};
    private static final int[] PExtInv = {-1, -1, -1, 1, 0, 0, -1, -3, -1, -1, 1};

    public static void add(int[] iArr, int[] iArr2, int[] iArr3) {
        if (Nat224.add(iArr, iArr2, iArr3) != 0 || (iArr3[6] == -1 && Nat224.gte(iArr3, f9781P))) {
            addPInvTo(iArr3);
        }
    }
    ...
    public static void addOne(int[] iArr, int[] iArr2) {
        if (Nat.inc(7, iArr, iArr2) != 0 || (iArr2[6] == -1 && Nat224.gte(iArr2, f9781P))) {
            addPInvTo(iArr2);
        }
    }
    ...
    public static int[] fromBigInteger(BigInteger bigInteger) {
        ...
        if (fromBigInteger[6] == -1 && Nat224.gte(fromBigInteger, f9781P)) {
            Nat224.subFrom(f9781P, fromBigInteger);
        }
    ...
    public static void half(int[] iArr, int[] iArr2) {
        if ((iArr[0] & 1) == 0) {
            ...
            Nat.shiftDownBit(7, iArr2, Nat224.add(iArr, f9781P, iArr2));
        }
    }
    ...
    public static void reduce(int[] iArr, int[] iArr2) {
        ...
        iArr2[3] = (int) j18;
        if (((j18 >> 32) == 0 || Nat.incAt(7, iArr2, 4) == 0) && !(iArr2[6] == -1 && Nat224.gte(iArr2, f9781P))) {
            return;
        }
        addPInvTo(iArr2);
    }
    ...
    public static void reduce32(int i, int[] iArr) {
        ...
        if ((j == 0 || Nat.incAt(7, iArr, 4) == 0) && !(iArr[6] == -1 && Nat224.gte(iArr, f9781P))) {
            return;
        }
        addPInvTo(iArr);
    }
    ...
    public static void twice(int[] iArr, int[] iArr2) {
        if (Nat.shiftUpBit(7, iArr, 0, iArr2) != 0 || (iArr2[6] == -1 && Nat224.gte(iArr2, f9781P))) {
            addPInvTo(iArr2);
        }
    }
}

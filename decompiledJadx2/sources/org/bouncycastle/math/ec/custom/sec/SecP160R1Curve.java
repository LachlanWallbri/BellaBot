...
public class SecP160R1Curve extends ECCurve.AbstractFp {
    ...
    /* renamed from: q */
    public static final BigInteger f9752q = SecP160R1FieldElement.f9756Q;
    ...
    public SecP160R1Curve() {
        ...
        this.f9715a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF7FFFFFFC")));
        this.f9716b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("1C97BEFC54BD7A8B65ACF89F81D4D4ADC565FA45")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat160.copy(((SecP160R1FieldElement) eCPoint.getRawXCoord()).f9757x, 0, iArr, i3);
            int i5 = i3 + 5;
            Nat160.copy(((SecP160R1FieldElement) eCPoint.getRawYCoord()).f9757x, 0, iArr, i5);
            i3 = i5 + 5;
        }

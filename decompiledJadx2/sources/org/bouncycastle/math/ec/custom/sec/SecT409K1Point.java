...
public class SecT409K1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (add3.isZero()) {
                return new SecT409K1Point(curve, add3, curve.getB());
            }
            ...
            if (multiply.isZero()) {
                return new SecT409K1Point(curve, multiply, curve.getB());
            }
        ...
        return new SecT409K1Point(curve, multiply, squarePlusProduct, new ECFieldElement[]{multiply2});
    }

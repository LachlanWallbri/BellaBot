...
public class SecT283R1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (addOne.isZero()) {
                return new SecT283R1Point(curve, addOne, curve.getB().sqrt());
            }
            ...
            if (multiply.isZero()) {
                return new SecT283R1Point(curve, multiply, curve.getB().sqrt());
            }
        ...
        return new SecT283R1Point(curve, multiply, squarePlusProduct, new ECFieldElement[]{multiply2});
    }

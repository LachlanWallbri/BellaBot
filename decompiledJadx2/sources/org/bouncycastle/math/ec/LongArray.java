...
public class LongArray implements Cloneable {
    ...
    */
    ...
    public LongArray modInverse(int i, int[] iArr) {
        ...
        LongArray longArray4 = new LongArray(i2);
        int[] iArr2 = new int[2];
        iArr2[0] = degree;
        iArr2[1] = i + 1;
    ...
    public LongArray modMultiply(LongArray longArray, int i, int[] iArr) {
        ...
        if (i2 == 1) {
            ...
            multiplyWord(j, longArray3.m_ints, i3, jArr2, 0);
            return reduceResult(jArr2, 0, i4, i, iArr);
        }
        int i5 = ((degree2 + 7) + 63) >>> 6;
        int[] iArr2 = new int[16];
        long[] jArr3 = new long[i5 << 4];
        iArr2[1] = i5;
        System.arraycopy(longArray3.m_ints, 0, jArr3, i5, i3);
        int i6 = 2;
        int i7 = i5;
        while (i6 < 16) {
            i7 += i5;
            ...
            if ((i6 & 1) == 0) {
                jArr = jArr3;
                shiftUp(jArr3, i7 >>> 1, jArr3, i7, i5, 1);
            } else {
                jArr = jArr3;
                add(jArr, i5, jArr, i7 - i5, jArr, i7, i5);
            }
            i6++;
            jArr3 = jArr;
        }
        ...
        for (int i8 = 0; i8 < i2; i8++) {
            ...
            while (true) {
                int i10 = ((int) j2) & 15;
                long j3 = j2 >>> 4;
                addBoth(jArr7, i9, jArr4, iArr2[i10], jArr5, iArr2[((int) j3) & 15], i5);
                j2 = j3 >>> 4;
                if (j2 == 0) {
                    break;
                }
        ...
        while (true) {
            length -= i4;
            if (length == 0) {
                return reduceResult(jArr7, 0, i4, i, iArr);
            }
            addShiftedUp(jArr7, length - i4, jArr7, length, i4, 8);
        }
    }
    ...
    public LongArray modMultiplyAlt(LongArray longArray, int i, int[] iArr) {
        ...
        if (i2 == 1) {
            ...
            multiplyWord(j, longArray3.m_ints, i3, jArr, 0);
            return reduceResult(jArr, 0, i4, i, iArr);
        }
        int i5 = 15;
        int i6 = ((degree2 + 15) + 63) >>> 6;
        int i7 = i6 * 8;
        int[] iArr2 = new int[16];
        iArr2[0] = i2;
        int i8 = i2 + i7;
        ...
        int i11 = i7;
        interleave(longArray2.m_ints, 0, jArr2, 0, i2, 4);
        System.arraycopy(longArray3.m_ints, 0, jArr2, i2, i3);
        int i12 = i2;
        int i13 = 1;
        while (i13 < 8) {
            int i14 = i12 + i6;
            shiftUp(jArr2, i2, jArr2, i14, i6, i13);
            i13++;
            i12 = i14;
        }
        int i15 = 0;
        while (true) {
            int i16 = 0;
            do {
                long j2 = jArr2[i16] >>> i15;
                int i17 = i2;
                int i18 = 0;
                while (true) {
                    int i19 = ((int) j2) & i5;
                    if (i19 != 0) {
                        add(jArr2, iArr2[i19] + i16, jArr2, i17, i6);
                    }
                    i18++;
                    if (i18 == 8) {
                        break;
        ...
        while (true) {
            length--;
            if (length <= 1) {
                return reduceResult(jArr2, iArr2[1], i4, i, iArr);
            }
            if ((length & 1) == 0) {
                addShiftedUp(jArr2, iArr2[length >>> 1], jArr2, iArr2[length], i4, 16);
            } else {
                distribute(jArr2, iArr2[length], iArr2[length - 1], iArr2[1], i4);
            }
        }
    }
    ...
    public LongArray modMultiplyLD(LongArray longArray, int i, int[] iArr) {
        ...
        iArr2[1] = i6;
        System.arraycopy(longArray3.m_ints, 0, jArr3, i6, i3);
        int i7 = 2;
        int i8 = i6;
        while (i7 < 16) {
            i8 += i6;
        ...
        while (true) {
            ...
            int i11 = i5;
            while (i11 < i2) {
                int i12 = (int) (jArr6[i11] >>> i9);
                addBoth(jArr7, i11 - 1, jArr4, iArr2[i12 & 15], jArr5, iArr2[(i12 >>> 4) & 15], i6);
                i11 += 2;
                i10 = i10;
            }
            shiftUp(jArr7, 0, i4, i10);
            i9 -= 8;
            i5 = 1;
        }
        for (int i13 = 56; i13 >= 0; i13 -= 8) {
            for (int i14 = 0; i14 < i2; i14 += 2) {
                ...
                addBoth(jArr7, i14, jArr4, iArr2[i15 & 15], jArr5, iArr2[(i15 >>> 4) & 15], i6);
            }
            if (i13 > 0) {
                shiftUp(jArr7, 0, i4, 8);
            }
        }
        return reduceResult(jArr7, 0, i4, i, iArr);
    }
    ...
    public LongArray multiply(LongArray longArray, int i, int[] iArr) {
        ...
        if (i2 == 1) {
            ...
            long[] jArr2 = new long[i4];
            multiplyWord(j, longArray3.m_ints, i3, jArr2, 0);
            return new LongArray(jArr2, 0, i4);
        }
        int i5 = ((degree2 + 7) + 63) >>> 6;
        int[] iArr2 = new int[16];
        long[] jArr3 = new long[i5 << 4];
        ...
        for (int i8 = 0; i8 < i2; i8++) {
            ...
            while (true) {
                long j3 = j2 >>> 4;
                addBoth(jArr7, i9, jArr4, iArr2[((int) j2) & 15], jArr5, iArr2[((int) j3) & 15], i5);
                j2 = j3 >>> 4;
                if (j2 == 0) {
                    break;
                }
        ...
        while (true) {
            length -= i4;
            if (length == 0) {
                return new LongArray(jArr7, 0, i4);
            }
            addShiftedUp(jArr7, length - i4, jArr7, length, i4, 8);
        }
    }

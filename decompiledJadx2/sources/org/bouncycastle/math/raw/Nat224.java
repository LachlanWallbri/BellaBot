...
public abstract class Nat224 {
    ...
    /* renamed from: M */
    private static final long f9849M = 4294967295L;
    ...
    /* renamed from: eq */
    public static boolean m4118eq(int[] iArr, int[] iArr2) {
        for (int i = 6; i >= 0; i--) {
            if (iArr[i] != iArr2[i]) {
                return false;
            }
    ...
    public static void mul(int[] iArr, int i, int[] iArr2, int i2, int[] iArr3, int i3) {
        ...
        while (i6 < 7) {
            ...
            long j17 = (j16 * j) + (iArr3[r24] & 4294967295L) + 0;
            iArr3[i5 + 0] = (int) j17;
            long j18 = j6;
            long j19 = (j17 >>> 32) + (j16 * j2) + (iArr3[r15] & 4294967295L);
            iArr3[i5 + 1] = (int) j19;
            long j20 = (j19 >>> 32) + (j16 * j3) + (iArr3[r15] & 4294967295L);
            iArr3[i5 + 2] = (int) j20;
            long j21 = (j20 >>> 32) + (j16 * j4) + (iArr3[r7] & 4294967295L);
            iArr3[i5 + 3] = (int) j21;
            long j22 = (j21 >>> 32) + (j16 * j5) + (iArr3[r7] & 4294967295L);
            iArr3[i5 + 4] = (int) j22;
            long j23 = (j22 >>> 32) + (j16 * j18) + (iArr3[r7] & 4294967295L);
            iArr3[i5 + 5] = (int) j23;
    ...
    public static void mul(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        for (int i2 = 7; i < i2; i2 = 7) {
            ...
            long j17 = (j16 * j) + (iArr3[r5] & 4294967295L) + 0;
            iArr3[i + 0] = (int) j17;
            int i3 = i + 1;
            long j18 = j2;
            ...
            iArr3[i3] = (int) j19;
            int i4 = i;
            long j20 = (j19 >>> 32) + (j16 * j3) + (iArr3[r6] & 4294967295L);
            iArr3[i + 2] = (int) j20;
            long j21 = (j20 >>> 32) + (j16 * j4) + (iArr3[r5] & 4294967295L);
            iArr3[i4 + 3] = (int) j21;
            long j22 = (j21 >>> 32) + (j16 * j5) + (iArr3[r5] & 4294967295L);
            iArr3[i4 + 4] = (int) j22;
            long j23 = (j22 >>> 32) + (j16 * j6) + (iArr3[r5] & 4294967295L);
            iArr3[i4 + 5] = (int) j23;
            long j24 = (j23 >>> 32) + (j16 * j7) + (iArr3[r3] & 4294967295L);
            iArr3[i4 + 6] = (int) j24;
            iArr3[i4 + 7] = (int) (j24 >>> 32);
            i = i3;
            j = j;
            j2 = j18;
        }
    ...
    public static int mulAddTo(int[] iArr, int i, int[] iArr2, int i2, int[] iArr3, int i3) {
        ...
        int i5 = 0;
        while (i5 < 7) {
            long j9 = iArr[i + i5] & 4294967295L;
            long j10 = j;
            long j11 = (j9 * j) + (iArr3[r25] & 4294967295L) + 0;
            iArr3[i4 + 0] = (int) j11;
            int i6 = i4 + 1;
            long j12 = (j11 >>> 32) + (j9 * j2) + (iArr3[i6] & 4294967295L);
            iArr3[i6] = (int) j12;
            long j13 = j3;
            long j14 = (j12 >>> 32) + (j9 * j3) + (iArr3[r23] & 4294967295L);
            iArr3[i4 + 2] = (int) j14;
            int i7 = i4;
            long j15 = (j14 >>> 32) + (j9 * j4) + (iArr3[r6] & 4294967295L);
            iArr3[i4 + 3] = (int) j15;
            long j16 = (j15 >>> 32) + (j9 * j5) + (iArr3[r5] & 4294967295L);
            iArr3[i7 + 4] = (int) j16;
            long j17 = (j16 >>> 32) + (j9 * j6) + (iArr3[r5] & 4294967295L);
            iArr3[i7 + 5] = (int) j17;
            long j18 = (j17 >>> 32) + (j9 * j7) + (iArr3[r3] & 4294967295L);
            iArr3[i7 + 6] = (int) j18;
            long j19 = (j18 >>> 32) + (iArr3[r3] & 4294967295L) + j8;
            iArr3[i7 + 7] = (int) j19;
            j8 = j19 >>> 32;
            i5++;
            i4 = i6;
    ...
    public static void square(int[] iArr, int i, int[] iArr2, int i2) {
        ...
        while (true) {
            ...
            if (i6 <= 0) {
                ...
                int i29 = i28 >>> 31;
                int i30 = i2 + 13;
                iArr2[i30] = i29 | ((iArr2[i30] + ((int) (j49 >>> 32))) << 1);
                return;
            }
            i4 = i8;
            i5 = i6;
    ...
    public static void square(int[] iArr, int[] iArr2) {
        ...
        while (true) {
            ...
            if (i4 <= 0) {
                ...
                long j33 = (j25 & 4294967295L) + (j30 * j);
                int i13 = (int) j33;
                iArr2[5] = i12 | (i13 << 1);
                int i14 = i13 >>> 31;
                long j34 = (j26 & 4294967295L) + (j33 >>> 32) + (j30 * j6);
                long j35 = j29 + (j34 >>> 32) + (j30 * j9);
                long j36 = (j28 & 4294967295L) + (j35 >>> 32) + (j30 * j13);
                long j37 = (j31 & 4294967295L) + (j36 >>> 32) + (j30 * j20);
                long j38 = j32 + (j37 >>> 32);
                long j39 = j37 & 4294967295L;
                long j40 = iArr[6] & 4294967295L;
                long j41 = (iArr2[11] & 4294967295L) + (j38 >>> 32);
                long j42 = j38 & 4294967295L;
                long j43 = (iArr2[12] & 4294967295L) + (j41 >>> 32);
                long j44 = 4294967295L & j41;
                long j45 = (j34 & 4294967295L) + (j40 * j);
                int i15 = (int) j45;
                iArr2[6] = i14 | (i15 << 1);
                int i16 = i15 >>> 31;
                long j46 = (j35 & 4294967295L) + (j45 >>> 32) + (j6 * j40);
                long j47 = (j36 & 4294967295L) + (j46 >>> 32) + (j40 * j9);
                long j48 = j39 + (j47 >>> 32) + (j40 * j13);
                long j49 = j42 + (j48 >>> 32) + (j40 * j20);
                long j50 = j44 + (j49 >>> 32) + (j40 * j30);
                long j51 = j43 + (j50 >>> 32);
                int i17 = (int) j46;
                iArr2[7] = i16 | (i17 << 1);
                int i18 = (int) j47;
                ...
                int i26 = (int) j51;
                iArr2[12] = i25 | (i26 << 1);
                iArr2[13] = ((iArr2[13] + ((int) (j51 >>> 32))) << 1) | (i26 >>> 31);
                return;
            }
            i3 = i4;
            i = i6;

...
public abstract class Nat160 {
    ...
    /* renamed from: M */
    private static final long f9847M = 4294967295L;
    ...
    /* renamed from: eq */
    public static boolean m4116eq(int[] iArr, int[] iArr2) {
        for (int i = 4; i >= 0; i--) {
            if (iArr[i] != iArr2[i]) {
                return false;
            }
    ...
    public static int mulAddTo(int[] iArr, int i, int[] iArr2, int i2, int[] iArr3, int i3) {
        ...
        while (i4 < 5) {
            ...
            iArr3[i5 + 4] = (int) j15;
            long j16 = (j15 >>> 32) + (iArr3[r17] & 4294967295L) + j7;
            iArr3[i5 + 5] = (int) j16;
            j7 = j16 >>> 32;
            i4++;
            i5 = i6;
    ...
    public static void square(int[] iArr, int i, int[] iArr2, int i2) {
        ...
        while (true) {
            ...
            if (i6 <= 0) {
                ...
                int i17 = i16 >>> 31;
                int i18 = (int) j26;
                iArr2[i2 + 7] = i17 | (i18 << 1);
                int i19 = i18 >>> 31;
                int i20 = (int) j27;
                iArr2[i2 + 8] = i19 | (i20 << 1);
                int i21 = i20 >>> 31;
                int i22 = i2 + 9;
                iArr2[i22] = i21 | ((iArr2[i22] + ((int) (j27 >>> 32))) << 1);
                return;
            }
            i4 = i8;
            i5 = i6;
    ...
    public static void square(int[] iArr, int[] iArr2) {
        ...
        while (true) {
            ...
            if (i4 <= 0) {
                ...
                int i10 = (int) j24;
                iArr2[4] = (i9 >>> 31) | (i10 << 1);
                long j25 = (j24 >>> 32) + (j6 * j20) + (j18 & 4294967295L);

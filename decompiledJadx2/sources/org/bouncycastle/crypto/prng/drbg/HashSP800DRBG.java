...
public class HashSP800DRBG implements SP80090DRBG {
    ...
    /* renamed from: _C */
    private byte[] f9629_C;

    /* renamed from: _V */
    private byte[] f9630_V;
    ...
    public HashSP800DRBG(Digest digest, int i, EntropySource entropySource, byte[] bArr, byte[] bArr2) {
        ...
        this.f9630_V = Utils.hash_df(this._digest, Arrays.concatenate(getEntropy(), bArr2, bArr), this._seedLength);
        byte[] bArr3 = this.f9630_V;
        byte[] bArr4 = new byte[bArr3.length + 1];
        System.arraycopy(bArr3, 0, bArr4, 1, bArr3.length);
        this.f9629_C = Utils.hash_df(this._digest, bArr4, this._seedLength);
    ...
    public int generate(byte[] bArr, byte[] bArr2, boolean z) {
        ...
        if (bArr2 != null) {
            ...
            bArr4[0] = 2;
            System.arraycopy(bArr3, 0, bArr4, 1, bArr3.length);
            System.arraycopy(bArr2, 0, bArr4, this.f9630_V.length + 1, bArr2.length);
            addTo(this.f9630_V, hash(bArr4));
        }
        byte[] hashgen = hashgen(this.f9630_V, length);
        byte[] bArr5 = this.f9630_V;
        byte[] bArr6 = new byte[bArr5.length + 1];
        System.arraycopy(bArr5, 0, bArr6, 1, bArr5.length);
        bArr6[0] = 3;
        addTo(this.f9630_V, hash(bArr6));
        addTo(this.f9630_V, this.f9629_C);
        addTo(this.f9630_V, new byte[]{(byte) (r6 >> 24), (byte) (r6 >> 16), (byte) (r6 >> 8), (byte) this._reseedCounter});
        this._reseedCounter++;
    ...
    public void reseed(byte[] bArr) {
        this.f9630_V = Utils.hash_df(this._digest, Arrays.concatenate(ONE, this.f9630_V, getEntropy(), bArr), this._seedLength);
        byte[] bArr2 = this.f9630_V;
        byte[] bArr3 = new byte[bArr2.length + 1];
        bArr3[0] = 0;
        System.arraycopy(bArr2, 0, bArr3, 1, bArr2.length);
        this.f9629_C = Utils.hash_df(this._digest, bArr3, this._seedLength);
        this._reseedCounter = 1L;
    }
}

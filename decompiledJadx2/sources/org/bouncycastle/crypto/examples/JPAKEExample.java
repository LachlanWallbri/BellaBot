...
public class JPAKEExample {
    ...
    public static void main(String[] strArr) throws CryptoException {
        ...
        System.out.println("");
        System.out.println("(Secret passwords used by Alice and Bob: \"" + CognitoUserPoolsSignInProvider.AttributeKeys.PASSWORD + "\" and \"" + CognitoUserPoolsSignInProvider.AttributeKeys.PASSWORD + "\")\n");
        SHA256Digest sHA256Digest = new SHA256Digest();
        SecureRandom secureRandom = new SecureRandom();
        JPAKEParticipant jPAKEParticipant = new JPAKEParticipant("alice", CognitoUserPoolsSignInProvider.AttributeKeys.PASSWORD.toCharArray(), jPAKEPrimeOrderGroup, sHA256Digest, secureRandom);
        JPAKEParticipant jPAKEParticipant2 = new JPAKEParticipant("bob", CognitoUserPoolsSignInProvider.AttributeKeys.PASSWORD.toCharArray(), jPAKEPrimeOrderGroup, sHA256Digest, secureRandom);

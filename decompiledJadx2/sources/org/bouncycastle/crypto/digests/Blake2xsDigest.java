...
public class Blake2xsDigest implements Xof {
    ...
    public Blake2xsDigest(Blake2xsDigest blake2xsDigest) {
        ...
        this.f9176h0 = Arrays.clone(blake2xsDigest.f9176h0);
    ...
    public int doOutput(byte[] bArr, int i, int i2) {
        if (this.f9176h0 == null) {
            this.f9176h0 = new byte[this.hash.getDigestSize()];
            this.hash.doFinal(this.f9176h0, 0);
        }

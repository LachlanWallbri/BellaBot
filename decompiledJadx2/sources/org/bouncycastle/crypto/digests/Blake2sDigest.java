...
public class Blake2sDigest implements ExtendedDigest {
    ...
    public Blake2sDigest(Blake2sDigest blake2sDigest) {
        ...
        this.f9174t0 = blake2sDigest.f9174t0;
        this.f9175t1 = blake2sDigest.f9175t1;
        this.f9173f0 = blake2sDigest.f9173f0;
    ...
    /* renamed from: G */
    private void m4013G(int i, int i2, int i3, int i4, int i5, int i6) {
    ...
    private void compress(byte[] bArr, int i) {
        ...
        for (int i4 = 0; i4 < 10; i4++) {
            ...
            m4013G(iArr[bArr2[i4][0]], iArr[bArr2[i4][1]], 0, 4, 8, 12);
            byte[][] bArr3 = blake2s_sigma;
            m4013G(iArr[bArr3[i4][2]], iArr[bArr3[i4][3]], 1, 5, 9, 13);
            byte[][] bArr4 = blake2s_sigma;
            m4013G(iArr[bArr4[i4][4]], iArr[bArr4[i4][5]], 2, 6, 10, 14);
            byte[][] bArr5 = blake2s_sigma;
            m4013G(iArr[bArr5[i4][6]], iArr[bArr5[i4][7]], 3, 7, 11, 15);
            byte[][] bArr6 = blake2s_sigma;
            m4013G(iArr[bArr6[i4][8]], iArr[bArr6[i4][9]], 0, 5, 10, 15);
            byte[][] bArr7 = blake2s_sigma;
            m4013G(iArr[bArr7[i4][10]], iArr[bArr7[i4][11]], 1, 6, 11, 12);
            byte[][] bArr8 = blake2s_sigma;
            m4013G(iArr[bArr8[i4][12]], iArr[bArr8[i4][13]], 2, 7, 8, 13);
            byte[][] bArr9 = blake2s_sigma;
            m4013G(iArr[bArr9[i4][14]], iArr[bArr9[i4][15]], 3, 4, 9, 14);
        }
        while (true) {
    ...
    private void initializeInternalState() {
        ...
        iArr2[12] = i ^ iArr3[4];
        iArr2[13] = this.f9175t1 ^ iArr3[5];
        iArr2[14] = this.f9173f0 ^ iArr3[6];
        iArr2[15] = iArr3[7];
    }

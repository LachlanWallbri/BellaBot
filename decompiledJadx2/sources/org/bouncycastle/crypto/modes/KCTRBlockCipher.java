...
public class KCTRBlockCipher extends StreamBlockCipher {
    ...
    public KCTRBlockCipher(BlockCipher blockCipher) {
        ...
        this.f9524iv = new byte[blockCipher.getBlockSize()];
    ...
    public void init(boolean z, CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        byte[] bArr = this.f9524iv;
        int length = bArr.length - iv.length;
        Arrays.fill(bArr, (byte) 0);
        System.arraycopy(iv, 0, this.f9524iv, length, iv.length);
    ...
    public void reset() {
        if (this.initialised) {
            this.engine.processBlock(this.f9524iv, 0, this.ofbV, 0);
        }
        this.engine.reset();
        this.byteCount = 0;
    }

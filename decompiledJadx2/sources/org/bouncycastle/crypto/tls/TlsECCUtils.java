    ...
    public static ECDomainParameters readECParameters(int[] iArr, short[] sArr, InputStream inputStream) throws IOException {
        ...
        try {
            ...
            if (readUint8 == 1) {
                ...
                ECCurve.C8419Fp c8419Fp = new ECCurve.C8419Fp(readECParameter, readECFieldElement, readECFieldElement2, readECParameter2, readECParameter3);
                return new ECDomainParameters(c8419Fp, deserializeECPoint(sArr, c8419Fp, readOpaque8), readECParameter2, readECParameter3);
            }
            if (readUint8 != 2) {
                if (readUint8 != 3) {
                    throw new TlsFatalAlert((short) 47);

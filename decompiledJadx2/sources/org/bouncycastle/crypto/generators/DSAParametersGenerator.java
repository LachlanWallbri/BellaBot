...
public class DSAParametersGenerator {
        ...
        while (true) {
            ...
            if (isProbablePrime(bigInteger)) {
                ...
                for (int i4 = 0; i4 < 4096; i4++) {
                    ...
                    if (subtract.bitLength() == this.f9449L && isProbablePrime(subtract)) {
    ...
    private DSAParameters generateParameters_FIPS186_3() {
        ...
        byte[] bArr = new byte[this.f9450N / 8];
        int i2 = this.f9449L;
        ...
        loop0: while (true) {
            ...
            bit = new BigInteger(1, bArr3).mod(ONE.shiftLeft(this.f9450N - 1)).setBit(0).setBit(this.f9450N - 1);
            if (isProbablePrime(bit)) {
                byte[] clone = Arrays.clone(bArr);
                int i5 = this.f9449L * 4;
                i = 0;
                while (i < i5) {
    ...
    public void init(int i, int i2, SecureRandom secureRandom) {
        this.f9449L = i;
        this.f9450N = getDefaultN(i);
        this.certainty = i2;
        this.iterations = Math.max(getMinimumIterations(this.f9449L), (i2 + 1) / 2);

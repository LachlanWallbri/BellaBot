...
public class KDFCounterBytesGenerator implements MacDerivationFunction {
    ...
    public KDFCounterBytesGenerator(Mac mac) {
        this.prf = mac;
        this.f9451h = mac.getMacSize();
        this.f9452k = new byte[this.f9451h];
    }

    private void generateNext() {
        int i = (this.generatedBytes / this.f9451h) + 1;
        byte[] bArr = this.ios;
        ...
        this.prf.doFinal(this.f9452k, 0);
    }
    ...
    public int generateBytes(byte[] bArr, int i, int i2) throws DataLengthException, IllegalArgumentException {
        ...
        System.arraycopy(this.f9452k, i7, bArr, i, min);
        ...
        while (true) {
            ...
            generateNext();
            min = Math.min(this.f9451h, i8);
            System.arraycopy(this.f9452k, 0, bArr, i, min);
            this.generatedBytes += min;
            i8 -= min;
        }
    }
    ...
    public void init(DerivationParameters derivationParameters) {
        ...
        BigInteger multiply = TWO.pow(r).multiply(BigInteger.valueOf(this.f9451h));

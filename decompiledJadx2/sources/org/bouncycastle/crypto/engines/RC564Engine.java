...
public class RC564Engine implements BlockCipher {
    ...
    private int decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        for (int i3 = this._noRounds; i3 >= 1; i3--) {
            int i4 = i3 * 2;
            bytesToWord2 = rotateRight(bytesToWord2 - this.f9404_S[i4 + 1], bytesToWord) ^ bytesToWord;
            bytesToWord = rotateRight(bytesToWord - this.f9404_S[i4], bytesToWord2) ^ bytesToWord2;
        }
        wordToBytes(bytesToWord - this.f9404_S[0], bArr2, i2);
        wordToBytes(bytesToWord2 - this.f9404_S[1], bArr2, i2 + 8);
        return 16;
    }

    private int encryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        long bytesToWord = bytesToWord(bArr, i) + this.f9404_S[0];
        long bytesToWord2 = bytesToWord(bArr, i + 8) + this.f9404_S[1];
        for (int i3 = 1; i3 <= this._noRounds; i3++) {
            int i4 = i3 * 2;
            bytesToWord = rotateLeft(bytesToWord ^ bytesToWord2, bytesToWord2) + this.f9404_S[i4];
            bytesToWord2 = rotateLeft(bytesToWord2 ^ bytesToWord, bytesToWord) + this.f9404_S[i4 + 1];
        }
    ...
    private void setKey(byte[] bArr) {
        ...
        this.f9404_S = new long[(this._noRounds + 1) * 2];
        this.f9404_S[0] = -5196783011329398165L;
        int i3 = 1;
        while (true) {
            jArr = this.f9404_S;
            if (i3 >= jArr.length) {
        ...
        for (int i6 = 0; i6 < length; i6++) {
            long[] jArr3 = this.f9404_S;
            j2 = rotateLeft(jArr3[i5] + j2 + j, 3L);
            jArr3[i5] = j2;
            j = rotateLeft(jArr2[i4] + j2 + j, j + j2);
            jArr2[i4] = j;
            i5 = (i5 + 1) % this.f9404_S.length;

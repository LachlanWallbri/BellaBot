...
public class GOST28147Engine implements BlockCipher {
    ...
    /* renamed from: S */
    private byte[] f9386S = Sbox_Default;
    ...
    private void GOST28147Func(int[] iArr, byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        if (this.forEncryption) {
            ...
            i3 = bytesToint;
            while (i5 > 0) {
                int GOST28147_mainStep2 = i4 ^ GOST28147_mainStep(i3, iArr[i5]);
                i5--;
                int i10 = i3;
                i3 = GOST28147_mainStep2;
                i4 = i10;
            }
        } else {
            int i11 = bytesToint2;
            int i12 = 0;
            while (i12 < 8) {
                int GOST28147_mainStep3 = i11 ^ GOST28147_mainStep(bytesToint, iArr[i12]);
                i12++;
                int i13 = bytesToint;
            ...
            while (i14 < 3) {
                ...
                int i18 = i3;
                int i19 = 7;
                while (i19 >= 0 && (i14 != 2 || i19 != 0)) {
                    int GOST28147_mainStep4 = i17 ^ GOST28147_mainStep(i18, iArr[i19]);
                    i19--;
                    i17 = i18;
                    i18 = GOST28147_mainStep4;
                }
                i14++;
                i3 = i18;
                i16 = i17;
        ...
        int GOST28147_mainStep5 = GOST28147_mainStep(i3, iArr[0]) ^ i4;

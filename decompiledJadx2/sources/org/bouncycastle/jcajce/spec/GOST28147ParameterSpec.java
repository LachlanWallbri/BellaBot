...
public class GOST28147ParameterSpec implements AlgorithmParameterSpec {
    ...
    public GOST28147ParameterSpec(byte[] bArr, byte[] bArr2) {
        this(bArr);
        this.f9679iv = new byte[bArr2.length];
        System.arraycopy(bArr2, 0, this.f9679iv, 0, bArr2.length);
    }
    ...
    public byte[] getIV() {
        return Arrays.clone(this.f9679iv);
    }

...
class X509CertificateObject extends X509CertificateImpl implements PKCS12BagAttributeCarrier {
    ...
    private X509CertificateInternal getInternalCertificate() {
        ...
        synchronized (this.cacheLock) {
            ...
            X509CertificateInternal x509CertificateInternal2 = new X509CertificateInternal(this.bcHelper, this.f9666c, this.basicConstraints, this.keyUsage, bArr);
            synchronized (this.cacheLock) {
                if (this.internalCertificateValue == null) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof X509CertificateObject) {
            ...
            } else if ((this.internalCertificateValue == null || x509CertificateObject.internalCertificateValue == null) && (signature = this.f9666c.getSignature()) != null && !signature.equals((ASN1Primitive) x509CertificateObject.f9666c.getSignature())) {
                return false;
            }
        }

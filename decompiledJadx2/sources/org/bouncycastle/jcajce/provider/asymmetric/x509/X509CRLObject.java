...
class X509CRLObject extends X509CRLImpl {
    ...
    private X509CRLInternal getInternalCRL() {
        ...
        synchronized (this.cacheLock) {
            ...
            X509CRLInternal x509CRLInternal2 = new X509CRLInternal(this.bcHelper, this.f9665c, this.sigAlgName, this.sigAlgParams, this.isIndirect, bArr);
            synchronized (this.cacheLock) {
                if (this.internalCRLValue == null) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof X509CRLObject) {
            ...
            } else if ((this.internalCRLValue == null || x509CRLObject.internalCRLValue == null) && (signature = this.f9665c.getSignature()) != null && !signature.equals((ASN1Primitive) x509CRLObject.f9665c.getSignature())) {
                return false;
            }
        }

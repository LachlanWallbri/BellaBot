...
abstract class X509CRLImpl extends X509CRL {
    ...
    /* renamed from: c */
    protected CertificateList f9665c;
    ...
    private void doVerify(PublicKey publicKey, Signature signature) throws CRLException, NoSuchAlgorithmException, InvalidKeyException, SignatureException {
        if (!this.f9665c.getSignatureAlgorithm().equals(this.f9665c.getTBSCertList().getSignature())) {
        ...
        try {
            ...
            this.f9665c.getTBSCertList().encodeTo(bufferedOutputStream, ASN1Encoding.DER);
    ...
    private Set getExtensionOIDs(boolean z) {
        ...
        if (getVersion() != 2 || (extensions = this.f9665c.getTBSCertList().getExtensions()) == null) {
            return null;
        }
    ...
    private Set loadCRLEntries() {
        Extension extension;
        HashSet hashSet = new HashSet();
        Enumeration revokedCertificateEnumeration = this.f9665c.getRevokedCertificateEnumeration();
    ...
    public byte[] getEncoded() throws CRLException {
        try {
            return this.f9665c.getEncoded(ASN1Encoding.DER);
        } catch (IOException e) {
    ...
    public byte[] getExtensionValue(String str) {
        ASN1OctetString extensionValue = getExtensionValue(this.f9665c, str);
        if (extensionValue == null) {
            return null;
        }
        try {
    ...
    public Principal getIssuerDN() {
        return new X509Principal(X500Name.getInstance(this.f9665c.getIssuer().toASN1Primitive()));
    }

    @Override // java.security.cert.X509CRL
    public X500Principal getIssuerX500Principal() {
        try {
            return new X500Principal(this.f9665c.getIssuer().getEncoded());
    ...
    public Date getNextUpdate() {
        if (this.f9665c.getNextUpdate() != null) {
            return this.f9665c.getNextUpdate().getDate();
        }
        return null;
    }
    ...
    public String getSigAlgOID() {
        return this.f9665c.getSignatureAlgorithm().getAlgorithm().getId();
    }
    ...
    public byte[] getSignature() {
        return this.f9665c.getSignature().getOctets();
    }

    @Override // java.security.cert.X509CRL
    public byte[] getTBSCertList() throws CRLException {
        try {
            return this.f9665c.getTBSCertList().getEncoded(ASN1Encoding.DER);
        } catch (IOException e) {
            throw new CRLException(e.toString());
        }
    }
    ...
    public Date getThisUpdate() {
        return this.f9665c.getThisUpdate().getDate();
    }

    @Override // java.security.cert.X509CRL
    public int getVersion() {
        return this.f9665c.getVersionNumber();
    }
    ...
    public boolean isRevoked(Certificate certificate) {
        ...
        Enumeration revokedCertificateEnumeration = this.f9665c.getRevokedCertificateEnumeration();
        X500Name issuer2 = this.f9665c.getIssuer();

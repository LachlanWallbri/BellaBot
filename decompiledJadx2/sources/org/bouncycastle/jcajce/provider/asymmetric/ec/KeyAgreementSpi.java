...
public class KeyAgreementSpi extends BaseAgreementSpi {
    ...
    /* loaded from: classes9.dex */
    public static class C8379DH extends KeyAgreementSpi {
        public C8379DH() {
    ...
    private void initFromKey(Key key, AlgorithmParameterSpec algorithmParameterSpec) throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        if (obj instanceof ECMQVBasicAgreement) {
            ...
            if (z) {
                ...
                eCPublicKeyParameters = mQVPrivateKey.getEphemeralPublicKey() != null ? (ECPublicKeyParameters) ECUtils.generatePublicKeyParameter(mQVPrivateKey.getEphemeralPublicKey()) : null;

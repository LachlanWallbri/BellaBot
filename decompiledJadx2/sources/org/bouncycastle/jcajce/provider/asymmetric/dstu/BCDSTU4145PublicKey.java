    ...
    private void populateFromPubKeyInfo(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        try {
            ...
            if (aSN1Sequence.getObjectAt(0) instanceof ASN1Integer) {
                X9ECParameters x9ECParameters2 = X9ECParameters.getInstance(aSN1Sequence);
                x9ECParameters = x9ECParameters2;
                eCParameterSpec = new org.bouncycastle.jce.spec.ECParameterSpec(x9ECParameters2.getCurve(), x9ECParameters2.getG(), x9ECParameters2.getN(), x9ECParameters2.getH(), x9ECParameters2.getSeed());
            } else {
            ...
            if (this.dstuParams != null) {
                ...
                this.ecSpec = this.dstuParams.isNamedCurve() ? new ECNamedCurveSpec(this.dstuParams.getNamedCurve().getId(), convertCurve, convertPoint, eCParameterSpec.getN(), eCParameterSpec.getH()) : new ECParameterSpec(convertCurve, convertPoint, eCParameterSpec.getN(), eCParameterSpec.getH().intValue());
            } else {

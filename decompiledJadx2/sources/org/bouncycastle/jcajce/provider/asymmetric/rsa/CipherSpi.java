...
public class CipherSpi extends BaseCipherSpi {
    ...
    protected void engineInit(int i, Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        CipherParameters parametersWithRandom = !(this.cipher instanceof RSABlindedEngine) ? secureRandom != null ? new ParametersWithRandom(generatePrivateKeyParameter, secureRandom) : new ParametersWithRandom(generatePrivateKeyParameter, CryptoServicesRegistrar.getSecureRandom()) : generatePrivateKeyParameter;
        this.bOut.reset();
        if (i != 1) {
            if (i != 2) {
                if (i != 3) {
    ...
    protected void engineSetMode(String str) throws NoSuchAlgorithmException {
        ...
        if (upperCase.equals("NONE") || upperCase.equals(AES.MODE_ECB)) {
            return;
        }

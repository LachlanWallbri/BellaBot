...
import org.bouncycastle.asn1.p080bc.BCObjectIdentifiers;
...
public final class AES {
    ...
    public static class Mappings extends SymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            configurableProvider.addAlgorithm("Alg.Alias.AlgorithmParameters.2.16.840.1.101.3.4.22", JceEncryptionConstants.SYMMETRIC_KEY_ALGORITHM);
            configurableProvider.addAlgorithm("Alg.Alias.AlgorithmParameters.2.16.840.1.101.3.4.42", JceEncryptionConstants.SYMMETRIC_KEY_ALGORITHM);
            configurableProvider.addAlgorithm("Alg.Alias.AlgorithmParameters." + NISTObjectIdentifiers.id_aes128_CBC, JceEncryptionConstants.SYMMETRIC_KEY_ALGORITHM);
            configurableProvider.addAlgorithm("Alg.Alias.AlgorithmParameters." + NISTObjectIdentifiers.id_aes192_CBC, JceEncryptionConstants.SYMMETRIC_KEY_ALGORITHM);
            configurableProvider.addAlgorithm("Alg.Alias.AlgorithmParameters." + NISTObjectIdentifiers.id_aes256_CBC, JceEncryptionConstants.SYMMETRIC_KEY_ALGORITHM);
            ...
            configurableProvider.addAlgorithm("Alg.Alias.AlgorithmParameterGenerator.2.16.840.1.101.3.4.22", JceEncryptionConstants.SYMMETRIC_KEY_ALGORITHM);
            configurableProvider.addAlgorithm("Alg.Alias.AlgorithmParameterGenerator.2.16.840.1.101.3.4.42", JceEncryptionConstants.SYMMETRIC_KEY_ALGORITHM);
            configurableProvider.addAlgorithm("Alg.Alias.AlgorithmParameterGenerator." + NISTObjectIdentifiers.id_aes128_CBC, JceEncryptionConstants.SYMMETRIC_KEY_ALGORITHM);
            configurableProvider.addAlgorithm("Alg.Alias.AlgorithmParameterGenerator." + NISTObjectIdentifiers.id_aes192_CBC, JceEncryptionConstants.SYMMETRIC_KEY_ALGORITHM);
            configurableProvider.addAlgorithm("Alg.Alias.AlgorithmParameterGenerator." + NISTObjectIdentifiers.id_aes256_CBC, JceEncryptionConstants.SYMMETRIC_KEY_ALGORITHM);
            ...
            addGMacAlgorithm(configurableProvider, JceEncryptionConstants.SYMMETRIC_KEY_ALGORITHM, PREFIX + "$AESGMAC", PREFIX + "$KeyGen128");
            addPoly1305Algorithm(configurableProvider, JceEncryptionConstants.SYMMETRIC_KEY_ALGORITHM, PREFIX + "$Poly1305", PREFIX + "$Poly1305KeyGen");
        }
    }

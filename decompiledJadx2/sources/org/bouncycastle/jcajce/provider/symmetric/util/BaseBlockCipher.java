...
public class BaseBlockCipher extends BaseWrapCipher implements PBE {
    ...
    /* JADX WARN: Removed duplicated region for block: B:75:0x0503 A[Catch: Exception -> 0x04ee, IllegalArgumentException -> 0x04f0, TryCatch #4 {IllegalArgumentException -> 0x04f0, Exception -> 0x04ee, blocks: (B:70:0x04d2, B:71:0x04ed, B:72:0x04f2, B:73:0x04fd, B:75:0x0503, B:77:0x0507, B:81:0x04f8), top: B:65:0x04c9 }] */
    ...
    */
    protected void engineInit(int i, Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        if (i2 == 2 || (key instanceof PKCS12Key)) {
            ...
            keyParameter = cipherParameters4;
        } else {
            ...
            if (algorithmParameterSpec instanceof AEADParameterSpec) {
                ...
                if (this.ivLength != 0) {
                    ...
                    if (str != null && str.equals(AES.MODE_ECB)) {
            ...
            try {
                if (this.ivLength != 0 && !(keyParameter instanceof ParametersWithIV) && !(keyParameter instanceof AEADParameters)) {
                    ...
                    if (i == 1 || i == 3) {
                        ...
                        cipherParameters2 = new ParametersWithIV(keyParameter, bArr);
    ...
    protected void engineSetMode(String str) throws NoSuchAlgorithmException {
        ...
        if (this.modeName.equals(AES.MODE_ECB)) {
            this.ivLength = 0;
            aEADGenericBlockCipher2 = new BufferedGenericBlockCipher(this.baseEngine);
        } else if (this.modeName.equals(AES.MODE_CBC)) {
            this.ivLength = this.baseEngine.getBlockSize();
            ...
            if (!this.modeName.startsWith("CFB")) {
                if (this.modeName.startsWith("PGP")) {
                    ...
                    aEADGenericBlockCipher = blockCipher4 instanceof DSTU7624Engine ? new AEADGenericBlockCipher(new KGCMBlockCipher(blockCipher4)) : new AEADGenericBlockCipher(new GCMBlockCipher(blockCipher4));
                }
                this.cipher = aEADGenericBlockCipher;
                return;
            }

...
import org.bouncycastle.asn1.p080bc.EncryptedObjectStoreData;
import org.bouncycastle.asn1.p080bc.EncryptedPrivateKeyData;
import org.bouncycastle.asn1.p080bc.EncryptedSecretKeyData;
import org.bouncycastle.asn1.p080bc.ObjectData;
import org.bouncycastle.asn1.p080bc.ObjectDataSequence;
import org.bouncycastle.asn1.p080bc.ObjectStore;
import org.bouncycastle.asn1.p080bc.ObjectStoreData;
import org.bouncycastle.asn1.p080bc.ObjectStoreIntegrityCheck;
import org.bouncycastle.asn1.p080bc.PbkdMacIntegrityCheck;
import org.bouncycastle.asn1.p080bc.SecretKeyData;
import org.bouncycastle.asn1.p080bc.SignatureCheck;
...
public class BcFKSKeyStoreSpi extends KeyStoreSpi {
    ...
    private Cipher createCipher(String str, byte[] bArr) throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException, NoSuchProviderException {
        ...
        createCipher.init(1, new SecretKeySpec(bArr, JceEncryptionConstants.SYMMETRIC_KEY_ALGORITHM));
        return createCipher;
    }
    ...
    private byte[] decryptData(String str, AlgorithmIdentifier algorithmIdentifier, char[] cArr, byte[] bArr) throws IOException {
        ...
        try {
            ...
            createCipher.init(2, new SecretKeySpec(generateKey(keyDerivationFunc, str, cArr, 32), JceEncryptionConstants.SYMMETRIC_KEY_ALGORITHM), algorithmParameters);
    ...
    public void engineSetKeyEntry(String str, Key key, char[] cArr, Certificate[] certificateArr) throws KeyStoreException {
        ...
        if (key instanceof PrivateKey) {
            ...
            try {
                ...
                if (upperCase.indexOf(JceEncryptionConstants.SYMMETRIC_KEY_ALGORITHM) > -1) {
                    ...
                    if (aSN1ObjectIdentifier != null) {
                        ...
                        ASN1ObjectIdentifier aSN1ObjectIdentifier2 = oidMap.get(upperCase + "." + (encoded2.length * 8));

...
public interface X509AttributeIdentifiers {
    ...
    public static final ASN1ObjectIdentifier id_pe_ac_auditIdentity = X509ObjectIdentifiers.id_pe.branch(TmpConstant.MODEL_TYPE_ALI_LCA_CLOUD);
    ...
    public static final ASN1ObjectIdentifier id_aca_group = id_aca.branch(TmpConstant.MODEL_TYPE_ALI_LCA_CLOUD);

...
public class IDEACBCPar extends ASN1Object {
    ...
    /* renamed from: iv */
    ASN1OctetString f9044iv;

    private IDEACBCPar(ASN1Sequence aSN1Sequence) {
        this.f9044iv = aSN1Sequence.size() == 1 ? (ASN1OctetString) aSN1Sequence.getObjectAt(0) : null;
    }

    public IDEACBCPar(byte[] bArr) {
        this.f9044iv = new DEROctetString(bArr);
    }
    ...
    public byte[] getIV() {
        ASN1OctetString aSN1OctetString = this.f9044iv;

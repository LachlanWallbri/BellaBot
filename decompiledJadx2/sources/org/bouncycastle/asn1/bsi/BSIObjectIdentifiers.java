...
public interface BSIObjectIdentifiers {
    ...
    public static final ASN1ObjectIdentifier id_ecc = bsi_de.branch(BuildConfig.VERSION_NAME);
    ...
    public static final ASN1ObjectIdentifier ecdsa_plain_SHA384 = ecdsa_plain_signatures.branch(TmpConstant.MODEL_TYPE_ALI_LCA_CLOUD);
    ...
    public static final ASN1ObjectIdentifier ecka_eg_X963kdf_SHA384 = ecka_eg_X963kdf.branch(TmpConstant.MODEL_TYPE_ALI_LCA_CLOUD);
    ...
    public static final ASN1ObjectIdentifier ecka_eg_SessionKDF_AES256 = ecka_eg_SessionKDF.branch(TmpConstant.MODEL_TYPE_ALI_LCA_CLOUD);
}

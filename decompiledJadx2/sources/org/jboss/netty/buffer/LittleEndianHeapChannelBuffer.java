...
public class LittleEndianHeapChannelBuffer extends HeapChannelBuffer {
    ...
    public short getShort(int i) {
        return (short) ((this.array[i + 1] << 8) | (this.array[i] & 255));
    }

    @Override // org.jboss.netty.buffer.ChannelBuffer
    public int getUnsignedMedium(int i) {
        return ((this.array[i + 2] & 255) << 16) | ((this.array[i] & 255) << 0) | ((this.array[i + 1] & 255) << 8);
    }

    @Override // org.jboss.netty.buffer.ChannelBuffer
    public int getInt(int i) {
        return ((this.array[i + 3] & 255) << 24) | ((this.array[i] & 255) << 0) | ((this.array[i + 1] & 255) << 8) | ((this.array[i + 2] & 255) << 16);
    }

    @Override // org.jboss.netty.buffer.ChannelBuffer
    public long getLong(int i) {
        return ((this.array[i] & 255) << 0) | ((this.array[i + 1] & 255) << 8) | ((this.array[i + 2] & 255) << 16) | ((this.array[i + 3] & 255) << 24) | ((this.array[i + 4] & 255) << 32) | ((this.array[i + 5] & 255) << 40) | ((this.array[i + 6] & 255) << 48) | ((255 & this.array[i + 7]) << 56);
    }

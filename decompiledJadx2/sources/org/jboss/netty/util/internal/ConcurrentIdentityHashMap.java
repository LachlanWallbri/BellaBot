...
public final class ConcurrentIdentityHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
            ...
            do {
                ...
                if (i >= 0) {
                    ...
                    while (this.nextSegmentIndex >= 0) {
                        Segment<K, V>[] segmentArr = ConcurrentIdentityHashMap.this.segments;
    ...
    /* loaded from: classes7.dex */
    final class KeyIterator extends ConcurrentIdentityHashMap<K, V>.HashIterator implements ReusableIterator<K>, Enumeration<K> {
        KeyIterator() {
            super();
        }
    ...
    /* loaded from: classes7.dex */
    final class ValueIterator extends ConcurrentIdentityHashMap<K, V>.HashIterator implements ReusableIterator<V>, Enumeration<V> {
        ValueIterator() {
            super();
        }
    ...
    static class SimpleEntry<K, V> implements Map.Entry<K, V> {
        ...
        public boolean equals(Object obj) {
            ...
            return m4161eq(this.key, entry.getKey()) && m4161eq(this.value, entry.getValue());
        }
        ...
        /* renamed from: eq */
        private static boolean m4161eq(Object obj, Object obj2) {
            if (obj == null) {
                return obj2 == null;
            }
    ...
    public final class WriteThroughEntry extends SimpleEntry<K, V> {
        ...
        public V setValue(V v) {
            ...
            ConcurrentIdentityHashMap.this.put(getKey(), v);
            return v2;
        }
    }

    /* loaded from: classes7.dex */
    final class EntryIterator extends ConcurrentIdentityHashMap<K, V>.HashIterator implements ReusableIterator<Map.Entry<K, V>> {
        EntryIterator() {
            super();
        }

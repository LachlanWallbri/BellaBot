...
public final class ConcurrentIdentityWeakKeyHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    /* loaded from: classes7.dex */
    final class KeyIterator extends ConcurrentIdentityWeakKeyHashMap<K, V>.HashIterator implements ReusableIterator<K>, Enumeration<K> {
        KeyIterator() {
            super();
        }
    ...
    /* loaded from: classes7.dex */
    final class ValueIterator extends ConcurrentIdentityWeakKeyHashMap<K, V>.HashIterator implements ReusableIterator<V>, Enumeration<V> {
        ValueIterator() {
            super();
        }
    ...
    static class SimpleEntry<K, V> implements Map.Entry<K, V> {
        ...
        public boolean equals(Object obj) {
            ...
            return m4162eq(this.key, entry.getKey()) && m4162eq(this.value, entry.getValue());
        }
        ...
        /* renamed from: eq */
        private static boolean m4162eq(Object obj, Object obj2) {
            if (obj == null) {
                return obj2 == null;
            }
    ...
    /* loaded from: classes7.dex */
    final class EntryIterator extends ConcurrentIdentityWeakKeyHashMap<K, V>.HashIterator implements ReusableIterator<Map.Entry<K, V>> {
        EntryIterator() {
            super();
        }

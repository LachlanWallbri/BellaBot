...
import com.amazonaws.services.p048s3.internal.crypto.S3KeyWrapScheme;
...
public final class OpenSSLProvider extends Provider {
    ...
    public OpenSSLProvider(String str, boolean z, String str2) {
        ...
        Platform.setup();
        String str4 = PREFIX + "OpenSSLContextImpl";
        ...
        put("SSLContext.SSL", str4 + str3);
        put("SSLContext.TLS", str4 + str3);
        put("SSLContext.TLSv1", str4 + "$TLSv1");
        put("SSLContext.TLSv1.1", str4 + "$TLSv11");
        put("SSLContext.TLSv1.2", str4 + "$TLSv12");
        put("SSLContext.TLSv1.3", str4 + "$TLSv13");
        put("SSLContext.Default", PREFIX + "DefaultSSLContextImpl" + str3);
        if (z) {
        ...
        put("Alg.Alias.AlgorithmParameters.2.16.840.1.101.3.4.1.2", JceEncryptionConstants.SYMMETRIC_KEY_ALGORITHM);
        put("Alg.Alias.AlgorithmParameters.2.16.840.1.101.3.4.1.22", JceEncryptionConstants.SYMMETRIC_KEY_ALGORITHM);
        put("Alg.Alias.AlgorithmParameters.2.16.840.1.101.3.4.1.42", JceEncryptionConstants.SYMMETRIC_KEY_ALGORITHM);
        ...
        put("Alg.Alias.KeyGenerator.1.2.840.113549.2.7", Constants.HMAC_SHA1_ALGORITHM);
        put("Alg.Alias.KeyGenerator.1.3.6.1.5.5.8.1.2", Constants.HMAC_SHA1_ALGORITHM);
        put("Alg.Alias.KeyGenerator.HMAC-SHA1", Constants.HMAC_SHA1_ALGORITHM);
        put("Alg.Alias.KeyGenerator.HMAC/SHA1", Constants.HMAC_SHA1_ALGORITHM);
        ...
        putRSACipherImplClass(S3KeyWrapScheme.RSA_ECB_OAEP_WITH_SHA256_AND_MGF1_PADDING, "OpenSSLCipherRSA$OAEP$SHA256");
        put("Alg.Alias.Cipher.RSA/None/OAEPWithSHA-256AndMGF1Padding", S3KeyWrapScheme.RSA_ECB_OAEP_WITH_SHA256_AND_MGF1_PADDING);
        ...
        put("Alg.Alias.Mac.HMAC/MD5", "HmacMD5");
        putMacImplClass(Constants.HMAC_SHA1_ALGORITHM, "OpenSSLMac$HmacSHA1");
        put("Alg.Alias.Mac.1.2.840.113549.2.7", Constants.HMAC_SHA1_ALGORITHM);
        put("Alg.Alias.Mac.1.3.6.1.5.5.8.1.2", Constants.HMAC_SHA1_ALGORITHM);
        put("Alg.Alias.Mac.HMAC-SHA1", Constants.HMAC_SHA1_ALGORITHM);
        put("Alg.Alias.Mac.HMAC/SHA1", Constants.HMAC_SHA1_ALGORITHM);

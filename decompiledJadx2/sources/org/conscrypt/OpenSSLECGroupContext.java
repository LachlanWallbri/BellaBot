...
public final class OpenSSLECGroupContext {
    ...
    public static OpenSSLECGroupContext getInstance(ECParameterSpec eCParameterSpec) throws InvalidAlgorithmParameterException {
        ...
        if (field instanceof ECFieldFp) {
            ...
            try {
                long EC_GROUP_new_arbitrary = NativeCrypto.EC_GROUP_new_arbitrary(p.toByteArray(), curve.getA().toByteArray(), b.toByteArray(), affineX.toByteArray(), affineY.toByteArray(), eCParameterSpec.getOrder().toByteArray(), eCParameterSpec.getCofactor());

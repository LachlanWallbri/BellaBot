...
public class SwitchGenerator {
    ...
    /* renamed from: P */
    private CodePrinter f10272P;

    /* renamed from: R */
    private ToolErrorReporter f10273R;
    ...
    public void setReporter(ToolErrorReporter toolErrorReporter) {
        this.f10273R = toolErrorReporter;
    }
    ...
    private void generate_body(int i, int i2, int i3) {
        this.f10272P.indent(i3);
        this.f10272P.m4188p(this.v_switch_label);
        this.f10272P.m4188p(": { ");
        this.f10272P.m4188p(this.v_id);
        this.f10272P.m4188p(" = ");
        this.f10272P.m4188p(this.default_value);
        this.f10272P.m4188p("; String ");
        this.f10272P.m4188p(this.v_guess);
        this.f10272P.m4188p(" = null;");
        this.c_was_defined = false;
        int offset = this.f10272P.getOffset();
        this.f10272P.m4188p(" int ");
        this.f10272P.m4188p(this.v_c);
        this.f10272P.m4186p(';');
        int offset2 = this.f10272P.getOffset();
        this.f10272P.m4185nl();
        int i4 = i3 + 1;
        generate_length_switch(i, i2, i4);
        if (!this.c_was_defined) {
            this.f10272P.erase(offset, offset2);
        }
        this.f10272P.indent(i4);
        this.f10272P.m4188p("if (");
        this.f10272P.m4188p(this.v_guess);
        this.f10272P.m4188p("!=null && ");
        this.f10272P.m4188p(this.v_guess);
        this.f10272P.m4188p("!=");
        this.f10272P.m4188p(this.v_s);
        this.f10272P.m4188p(" && !");
        this.f10272P.m4188p(this.v_guess);
        this.f10272P.m4188p(".equals(");
        this.f10272P.m4188p(this.v_s);
        this.f10272P.m4188p(")) ");
        this.f10272P.m4188p(this.v_id);
        this.f10272P.m4188p(" = ");
        this.f10272P.m4188p(this.default_value);
        this.f10272P.m4188p(VoiceWakeuperAidl.PARAMS_SEPARATE);
        this.f10272P.m4185nl();
        this.f10272P.indent(i4);
        this.f10272P.m4188p("break ");
        this.f10272P.m4188p(this.v_switch_label);
        this.f10272P.m4188p(VoiceWakeuperAidl.PARAMS_SEPARATE);
        this.f10272P.m4185nl();
        this.f10272P.line(i3, "}");
    }
    ...
    private void generate_length_switch(int i, int i2, int i3) {
        ...
        if (count_different_lengths <= this.use_if_threshold) {
            if (count_different_lengths != 1) {
                ...
                this.f10272P.m4188p("int ");
                this.f10272P.m4188p(this.v_s);
                this.f10272P.m4188p(this.v_length_suffix);
                this.f10272P.m4188p(" = ");
                this.f10272P.m4188p(this.v_s);
                this.f10272P.m4188p(".length();");
                this.f10272P.m4185nl();
            }
            z = true;
        } else {
            this.f10272P.indent(i3);
            this.f10272P.m4188p(this.v_label);
            this.f10272P.m4188p(": switch (");
            this.f10272P.m4188p(this.v_s);
            this.f10272P.m4188p(".length()) {");
            this.f10272P.m4185nl();
            z = false;
        ...
        while (true) {
            ...
            if (z) {
                ...
                this.f10272P.m4187p(i6);
                this.f10272P.m4188p(") {");
            } else {
                this.f10272P.indent(i3);
                this.f10272P.m4188p("case ");
                this.f10272P.m4187p(i6);
                this.f10272P.m4188p(":");
            }
    ...
    private boolean generate_letter_switch_r(int i, int i2, int i3, int i4, boolean z, boolean z2) {
        ...
        if (i + 1 == i2) {
            ...
            if (i3 > this.char_tail_test_threshold) {
                this.f10272P.m4188p(this.v_guess);
                this.f10272P.m4188p("=");
                this.f10272P.qstring(idValuePair.f10269id);
                this.f10272P.m4188p(VoiceWakeuperAidl.PARAMS_SEPARATE);
                this.f10272P.m4188p(this.v_id);
                this.f10272P.m4188p("=");
                this.f10272P.m4188p(idValuePair.value);
                this.f10272P.m4188p(VoiceWakeuperAidl.PARAMS_SEPARATE);
            } else if (i3 == 0) {
                this.f10272P.m4188p(this.v_id);
                this.f10272P.m4188p("=");
                ...
                this.f10272P.m4188p(this.v_s);
                this.f10272P.m4188p(".charAt(");
                this.f10272P.m4187p(i7);
                this.f10272P.m4188p(")==");
                this.f10272P.qchar(idValuePair.f10269id.charAt(i7));
                while (i6 != i3) {
                    this.f10272P.m4188p(" && ");
                    int i8 = this.columns[i6];
                    this.f10272P.m4188p(this.v_s);
                    this.f10272P.m4188p(".charAt(");
                    this.f10272P.m4187p(i8);
                    this.f10272P.m4188p(")==");
                    this.f10272P.qchar(idValuePair.f10269id.charAt(i8));
                    i6++;
                }
                this.f10272P.m4188p(") {");
                this.f10272P.m4188p(this.v_id);
        ...
        char charAt = this.pairs[i].f10269id.charAt(i9);
        int i11 = i;
        int i12 = i11;
        char c = 0;
        while (true) {
            int i13 = i12 + 1;
            if (i13 == i2 || (c = this.pairs[i13].f10269id.charAt(i9)) != charAt) {
                char c2 = c;
                if (z5) {
                    this.f10272P.m4185nl();
                    this.f10272P.indent(i4);
    ...
    private int count_different_chars(int i, int i2, int i3) {
        ...
        char c = 65535;
        while (i != i2) {
            char charAt = this.pairs[i].f10269id.charAt(i3);
            if (charAt != c) {
                i4++;
                c = charAt;
            }
    ...
    private void check_all_is_different(int i, int i2) {
        ...
        while (true) {
            ...
            if (idValuePair.f10269id.equals(idValuePair2.f10269id)) {
    ...
    private EvaluatorException on_same_pair_fail(IdValuePair idValuePair, IdValuePair idValuePair2) {
        ...
        return this.f10273R.runtimeError(ToolErrorReporter.getMessage("msg.idswitch.same_string", idValuePair.f10269id, new Integer(lineNumber)), this.source_file, i, null, 0);
    }
    ...
    private static boolean bigger(IdValuePair idValuePair, IdValuePair idValuePair2, int i) {
        if (i >= 0) {
            return idValuePair.f10269id.charAt(i) > idValuePair2.f10269id.charAt(i);
        }
        int i2 = idValuePair.idLength - idValuePair2.idLength;
        return i2 != 0 ? i2 > 0 : idValuePair.f10269id.compareTo(idValuePair2.f10269id) > 0;
    }

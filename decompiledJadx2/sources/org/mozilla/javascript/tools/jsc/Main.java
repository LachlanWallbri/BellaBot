...
public class Main {
    ...
    public String[] processOptions(String[] strArr) {
        ...
        m4191p(ToolErrorReporter.getMessage("msg.no.file"));
        return null;
    }
    ...
    public void processSource(String[] strArr) {
        loop0: for (int i = 0; i != strArr.length; i++) {
            ...
            String str2 = this.targetName;
            if (str2 == null) {
                str2 = getClassName(file.getName().substring(0, r5.length() - 3));
            }
            ...
            for (int i2 = 0; i2 != compileToClassFiles.length; i2 += 2) {
                ...
                try {
                    FileOutputStream fileOutputStream = new FileOutputStream(getOutputFile(file2, str3));
                    try {
    ...
    private File getOutputFile(File file, String str) {
        File file2 = new File(file, str.replace(FilenameUtils.EXTENSION_SEPARATOR, File.separatorChar).concat(".class"));
    ...
    /* renamed from: p */
    private static void m4191p(String str) {

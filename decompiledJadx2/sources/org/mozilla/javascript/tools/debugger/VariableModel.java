...
class VariableModel implements TreeTableModel {
    ...
    public Object getValue(VariableNode variableNode) {
        try {
            return this.debugger.getObjectProperty(variableNode.object, variableNode.f10268id);
    ...
    public static class VariableNode {
        ...
        public String toString() {
            Object obj = this.f10268id;
            if (obj instanceof String) {
                return (String) obj;
            }
            return "[" + ((Integer) this.f10268id).intValue() + "]";
        }
    }
}

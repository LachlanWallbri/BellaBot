...
public class Dim {
    ...
    /* renamed from: GO */
    public static final int f10262GO = 3;
        ...
        public Object run(Context context) {
            switch (this.type) {
                ...
                case 5:
                    ...
                    return null;
                case 6:
                    this.objectResult = this.dim.getObjectPropertyImpl(context, this.object, this.f10263id);
                    return null;
                case 7:

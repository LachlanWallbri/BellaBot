    ...
    public static Object coerceTypeImpl(Class<?> cls, Object obj) {
        ...
        switch (getJSTypeCode(obj)) {
            ...
            case 3:
                ...
                if (cls == ScriptRuntime.ObjectClass) {
                    if (Context.getCurrentContext().hasFeature(18) && Math.round(toDouble(obj)) == toDouble(obj)) {

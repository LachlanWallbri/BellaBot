...
public class Namespace extends IdScriptableObject {
    ...
    /* renamed from: ns */
    private XmlNode.Namespace f10284ns;
    ...
    public static Namespace create(Scriptable scriptable, Namespace namespace, XmlNode.Namespace namespace2) {
        ...
        namespace3.f10284ns = namespace2;
        return namespace3;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public final XmlNode.Namespace getDelegate() {
        return this.f10284ns;
    }
    ...
    public String uri() {
        return this.f10284ns.getUri();
    }

    public String prefix() {
        return this.f10284ns.getPrefix();
    }
    ...
    public String getInstanceIdName(int i) {
        ...
        return maxInstanceId != 1 ? maxInstanceId != 2 ? super.getInstanceIdName(i) : "uri" : RequestParameters.PREFIX;
    }
    ...
    public Object getInstanceIdValue(int i) {
        int maxInstanceId = i - super.getMaxInstanceId();
        if (maxInstanceId == 1) {
            return this.f10284ns.getPrefix() == null ? Undefined.instance : this.f10284ns.getPrefix();
        }
        if (maxInstanceId == 2) {
            return this.f10284ns.getUri();
        }
    ...
    private String js_toSource() {
        ...
        sb.append('(');
        toSourceImpl(this.f10284ns.getPrefix(), this.f10284ns.getUri(), sb);
        sb.append(')');
        return sb.toString();
    }

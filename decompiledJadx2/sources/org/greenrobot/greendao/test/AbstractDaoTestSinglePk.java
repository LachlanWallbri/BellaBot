...
public abstract class AbstractDaoTestSinglePk<D extends AbstractDao<T, K>, T, K> extends AbstractDaoTest<D, T, K> {
    ...
    public void testReadWithOffset() {
        K nextPk = nextPk();
        this.dao.insert(createEntity(nextPk));
        Cursor queryWithDummyColumnsInFront = queryWithDummyColumnsInFront(5, RoomMasterTable.DEFAULT_ID, nextPk);
        try {
    ...
    protected void runLoadPkTest(int i) {
        K nextPk = nextPk();
        this.dao.insert(createEntity(nextPk));
        Cursor queryWithDummyColumnsInFront = queryWithDummyColumnsInFront(i, RoomMasterTable.DEFAULT_ID, nextPk);
        try {
    ...
    protected Cursor queryWithDummyColumnsInFront(int i, String str, K k) {
        ...
        Cursor rawQuery = this.f10007db.rawQuery(sb.toString(), null);
    ...
    protected boolean checkKeyIsNullable() {
        ...
        DaoLog.m4136d("Test is not available for entities with non-null keys");
        return false;
    }

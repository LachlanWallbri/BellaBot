...
public class ChunkedInputStream extends InputStream {
    ...
    /* renamed from: in */
    private final SessionInputBuffer f9004in;
    private long pos;
    private int state;
    ...
    public ChunkedInputStream(SessionInputBuffer sessionInputBuffer, MessageConstraints messageConstraints) {
        ...
        this.f9004in = (SessionInputBuffer) Args.notNull(sessionInputBuffer, "Session input buffer");
        this.pos = 0L;
    ...
    public int available() throws IOException {
        if (this.f9004in instanceof BufferInfo) {
    ...
    public int read(byte[] bArr, int i, int i2) throws IOException {
        ...
        int read = this.f9004in.read(bArr, i, (int) Math.min(i2, this.chunkSize - this.pos));
        if (read != -1) {
            this.pos += read;
            if (this.pos >= this.chunkSize) {
                this.state = 3;
    ...
    private long getChunkSize() throws IOException {
        ...
        if (i != 1) {
            if (i == 3) {
                this.buffer.clear();
                if (this.f9004in.readLine(this.buffer) == -1) {
    ...
    private void parseTrailerHeaders() throws IOException {
        try {
            this.footers = AbstractMessageParser.parseHeaders(this.f9004in, this.constraints.getMaxHeaderCount(), this.constraints.getMaxLineLength(), null);

...
public class ServerBootstrap {
    ...
    */
    public HttpServer create() {
        ...
        HttpConnectionFactory httpConnectionFactory2 = this.connectionFactory;
        if (httpConnectionFactory2 == null) {
            ...
            httpConnectionFactory2 = DefaultBHttpServerConnectionFactory.INSTANCE;
        }
        ...
        return new HttpServer(i2, inetAddress2, socketConfig, serverSocketFactory2, httpService, httpConnectionFactory, this.sslSetupHandler, exceptionLogger22);
    }
}

    ...
    public void process(HttpResponse httpResponse, HttpContext httpContext) throws HttpException, IOException {
        ...
        if (httpHost != null && authState != null) {
            ...
            if (isCachable(authState)) {
                ...
                int i = C81421.$SwitchMap$org$apache$http$auth$AuthProtocolState[authState.getState().ordinal()];
                if (i == 1) {
        ...
        if (isCachable(authState2)) {
            ...
            int i2 = C81421.$SwitchMap$org$apache$http$auth$AuthProtocolState[authState2.getState().ordinal()];
            if (i2 == 1) {

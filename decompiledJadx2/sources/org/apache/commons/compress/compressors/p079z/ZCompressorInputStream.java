package org.apache.commons.compress.compressors.p079z;
...
public class ZCompressorInputStream extends LZWInputStream {
    ...
    public ZCompressorInputStream(InputStream inputStream, int i) throws IOException {
        ...
        int readBits = (int) this.f8942in.readBits(8);
        int readBits2 = (int) this.f8942in.readBits(8);
        int readBits3 = (int) this.f8942in.readBits(8);
        if (readBits != 31 || readBits2 != 157 || readBits3 < 0) {
            throw new IOException("Input is not in .Z format");
        }
        this.blockMode = (readBits3 & 128) != 0;
        this.maxCodeSize = readBits3 & 31;
        if (this.blockMode) {
            setClearCode(9);
        }
        initializeTables(this.maxCodeSize, i);
        clearEntries();
    }

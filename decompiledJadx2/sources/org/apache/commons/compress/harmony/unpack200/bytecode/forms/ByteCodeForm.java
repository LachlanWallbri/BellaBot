...
public abstract class ByteCodeForm {
    ...
    static {
        ...
        byteCodeArray[203] = new ThisFieldRefForm(HttpStatus.SC_NON_AUTHORITATIVE_INFORMATION, "putstatic_this", new int[]{179, -1, -1});
        byteCodeArray[204] = new ThisFieldRefForm(204, "getfield_this", new int[]{180, -1, -1});
        byteCodeArray[205] = new ThisFieldRefForm(HttpStatus.SC_RESET_CONTENT, "putfield_this", new int[]{181, -1, -1});
        byteCodeArray[206] = new ThisMethodRefForm(HttpStatus.SC_PARTIAL_CONTENT, "invokevirtual_this", new int[]{182, -1, -1});
        byteCodeArray[207] = new ThisMethodRefForm(HttpStatus.SC_MULTI_STATUS, "invokespecial_this", new int[]{183, -1, -1});
        ...
        byteCodeArray[211] = new ThisFieldRefForm(Primes.SMALL_FACTOR_LIMIT, "aload_0_getfield_this", new int[]{42, 180, -1, -1});
        byteCodeArray[212] = new ThisFieldRefForm(212, "aload_0_putfield_this", new int[]{42, 181, -1, -1});
        byteCodeArray[213] = new ThisMethodRefForm(DimensionsKt.TVDPI, "aload_0_invokevirtual_this", new int[]{42, 182, -1, -1});
        ...
        while (true) {
            ByteCodeForm[] byteCodeFormArr = byteCodeArray;
            if (i >= byteCodeFormArr.length) {
                return;
            }
            ByteCodeForm byteCodeForm = byteCodeFormArr[i];

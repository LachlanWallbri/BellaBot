...
import androidx.databinding.library.C0323R;
...
public abstract class ViewDataBinding extends BaseObservable {
    ...
    public void setRootTag(View view) {
        view.setTag(C0323R.id.dataBinding, this);
    }
    ...
    public static ViewDataBinding getBinding(View view) {
        if (view != null) {
            return (ViewDataBinding) view.getTag(C0323R.id.dataBinding);
        }
        return null;
    }
    ...
    private static void mapBindings(DataBindingComponent dataBindingComponent, View view, Object[] objArr, IncludedLayouts includedLayouts, SparseIntArray sparseIntArray, boolean z) {
        ...
        if (z && str != null && str.startsWith("layout")) {
            ...
            if (lastIndexOf > 0) {
                ...
                if (isNumeric(str, i7)) {
                    int parseTagInt = parseTagInt(str, i7);

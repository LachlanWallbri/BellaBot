...
public class ComponentActivity extends androidx.core.app.ComponentActivity implements ContextAware, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, OnBackPressedDispatcherOwner, ActivityResultRegistryOwner, ActivityResultCaller {
    ...
    /* loaded from: classes.dex */
    class C00365 implements LifecycleEventObserver {
        C00365() {
        }
    ...
    /* loaded from: classes.dex */
    class C00376 implements SavedStateRegistry.SavedStateProvider {
        C00376() {
        }
        ...
        public Bundle saveState() {
            ...
            ComponentActivity.access$100(ComponentActivity.this).onSaveInstanceState(bundle);
            return bundle;
        }
    }
    ...
    /* loaded from: classes.dex */
    class C00387 implements OnContextAvailableListener {
        C00387() {
        }
        ...
        public void onContextAvailable(Context context) {
            ...
            if (consumeRestoredStateForKey != null) {
                ComponentActivity.access$100(ComponentActivity.this).onRestoreInstanceState(consumeRestoredStateForKey);
            }
        }
    }

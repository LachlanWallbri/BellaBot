...
public abstract class FragmentManager implements FragmentResultOwner {
    ...
    public static Fragment getViewFragment(View view) {
        Object tag = view.getTag(C0351R.id.fragment_container_view_tag);
    ...
    */
    private void executeOpsTogether(ArrayList<BackStackRecord> arrayList, ArrayList<Boolean> arrayList2, int i, int i2) {
        ...
        if (!z3 && this.mCurState >= 1) {
                    ...
                    if (z3) {
                        for (int i11 = i; i11 < i2; i11++) {
                            ...
                            if (booleanValue) {
                                ...
                                Iterator<FragmentTransaction.C0409Op> it = backStackRecord2.mOps.iterator();
                                while (it.hasNext()) {
            ...
            for (int i12 = i; i12 < i2; i12++) {
                Iterator<FragmentTransaction.C0409Op> it2 = arrayList.get(i12).mOps.iterator();
                while (it2.hasNext()) {
    ...
    private Set<SpecialEffectsController> collectChangedControllers(ArrayList<BackStackRecord> arrayList, int i, int i2) {
        ...
        while (i < i2) {
            Iterator<FragmentTransaction.C0409Op> it = arrayList.get(i).mOps.iterator();
            while (it.hasNext()) {
    ...
    private void setVisibleRemovingFragment(Fragment fragment) {
        ...
        if (fragmentContainer != null) {
            if (fragmentContainer.getTag(C0351R.id.visible_removing_fragment_view_tag) == null) {
                fragmentContainer.setTag(C0351R.id.visible_removing_fragment_view_tag, fragment);
            }
            ((Fragment) fragmentContainer.getTag(C0351R.id.visible_removing_fragment_view_tag)).setNextAnim(fragment.getNextAnim());
        }
    }

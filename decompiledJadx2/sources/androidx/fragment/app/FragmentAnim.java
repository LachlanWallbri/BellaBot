...
public class FragmentAnim {
    ...
    public static AnimationOrAnimator loadAnimation(Context context, Fragment fragment, boolean z) {
        ...
        if (fragment.mContainer != null && fragment.mContainer.getTag(C0351R.id.visible_removing_fragment_view_tag) != null) {
            fragment.mContainer.setTag(C0351R.id.visible_removing_fragment_view_tag, null);
        }
    ...
    private static int transitToAnimResourceId(int i, boolean z) {
        if (i == 4097) {
            return z ? C0351R.anim.fragment_open_enter : C0351R.anim.fragment_open_exit;
        }
        if (i == 4099) {
            return z ? C0351R.anim.fragment_fade_enter : C0351R.anim.fragment_fade_exit;
        }
        if (i != 8194) {
            return -1;
        }
        return z ? C0351R.anim.fragment_close_enter : C0351R.anim.fragment_close_exit;
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes.dex */
    public static class EnterViewTransitionAnimation extends AnimationSet {
        /* JADX INFO: Access modifiers changed from: package-private */
        public EnterViewTransitionAnimation(Animation animation) {
            super(false);

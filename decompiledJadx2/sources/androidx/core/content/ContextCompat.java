    ...
    public static final class LegacyServiceMapHolder {
        ...
        static {
            ...
            if (Build.VERSION.SDK_INT >= 18) {
                SERVICES.put(BluetoothManager.class, SpeechConstant.BLUETOOTH);
            }
            ...
            SERVICES.put(AudioManager.class, InternalConstant.DTYPE_AUDIO);
            ...
            SERVICES.put(LocationManager.class, RequestParameters.SUBRESOURCE_LOCATION);
            SERVICES.put(NfcManager.class, "nfc");
            SERVICES.put(NotificationManager.class, TransferService.INTENT_KEY_NOTIFICATION);
            SERVICES.put(PowerManager.class, "power");
            SERVICES.put(SearchManager.class, "search");
            SERVICES.put(SensorManager.class, ConfigJson.SENSOR);

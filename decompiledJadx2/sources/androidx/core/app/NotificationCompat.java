...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        private Bitmap reduceLargeIconSize(Bitmap bitmap) {
            ...
            int dimensionPixelSize = resources.getDimensionPixelSize(C0209R.dimen.compat_notification_large_icon_max_width);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0209R.dimen.compat_notification_large_icon_max_height);
    ...
    public static abstract class Style {
        ...
        private static String getCompatStyleName(String str) {
        ...
        private static Class<? extends Style> getCompatStyleClass(String str) {
            Class<? extends Style>[] clsArr = {BigTextStyle.class, BigPictureStyle.class, InboxStyle.class, DecoratedCustomViewStyle.class, MessagingStyle.class};
            for (int i = 0; i < 5; i++) {
        ...
        private static Style constructStyleForExtras(Bundle bundle) {
            String string = bundle.getString(NotificationCompat.EXTRA_COMPAT_TEMPLATE);
            if (string == null) {
                string = getCompatStyleName(bundle.getString(NotificationCompat.EXTRA_TEMPLATE));
            }
            if (string == null) {
            ...
            Class<? extends Style> compatStyleClass = getCompatStyleClass(string);
            if (compatStyleClass == null) {
                return null;
            }
            try {
                Constructor<? extends Style> declaredConstructor = compatStyleClass.getDeclaredConstructor(new Class[0]);
                declaredConstructor.setAccessible(true);
                Style newInstance = declaredConstructor.newInstance(new Object[0]);
                newInstance.restoreFromCompatExtras(bundle);
                return newInstance;
        ...
        */
        public RemoteViews applyStandardTemplate(boolean z, int i, boolean z2) {
            ...
            if (Build.VERSION.SDK_INT >= 16 && Build.VERSION.SDK_INT < 21) {
                if (z6) {
                    remoteViews.setInt(C0209R.id.notification_background, "setBackgroundResource", C0209R.drawable.notification_bg_low);
                    remoteViews.setInt(C0209R.id.icon, "setBackgroundResource", C0209R.drawable.notification_template_icon_low_bg);
                } else {
                    remoteViews.setInt(C0209R.id.notification_background, "setBackgroundResource", C0209R.drawable.notification_bg);
                    remoteViews.setInt(C0209R.id.icon, "setBackgroundResource", C0209R.drawable.notification_template_icon_bg);
                }
            }
            if (this.mBuilder.mLargeIcon != null) {
                if (Build.VERSION.SDK_INT >= 16) {
                    remoteViews.setViewVisibility(C0209R.id.icon, 0);
                    remoteViews.setImageViewBitmap(C0209R.id.icon, this.mBuilder.mLargeIcon);
                } else {
                    remoteViews.setViewVisibility(C0209R.id.icon, 8);
                }
                if (z && this.mBuilder.mNotification.icon != 0) {
                    int dimensionPixelSize = resources.getDimensionPixelSize(C0209R.dimen.notification_right_icon_size);
                    int dimensionPixelSize2 = dimensionPixelSize - (resources.getDimensionPixelSize(C0209R.dimen.notification_small_icon_background_padding) * 2);
                    if (Build.VERSION.SDK_INT >= 21) {
                        remoteViews.setImageViewBitmap(C0209R.id.right_icon, createIconWithBackground(this.mBuilder.mNotification.icon, dimensionPixelSize, dimensionPixelSize2, this.mBuilder.getColor()));
                    } else {
                        remoteViews.setImageViewBitmap(C0209R.id.right_icon, createColoredBitmap(this.mBuilder.mNotification.icon, -1));
                    }
                    remoteViews.setViewVisibility(C0209R.id.right_icon, 0);
                }
            } else if (z && this.mBuilder.mNotification.icon != 0) {
                remoteViews.setViewVisibility(C0209R.id.icon, 0);
                if (Build.VERSION.SDK_INT >= 21) {
                    remoteViews.setImageViewBitmap(C0209R.id.icon, createIconWithBackground(this.mBuilder.mNotification.icon, resources.getDimensionPixelSize(C0209R.dimen.notification_large_icon_width) - resources.getDimensionPixelSize(C0209R.dimen.notification_big_circle_margin), resources.getDimensionPixelSize(C0209R.dimen.notification_small_icon_size_as_large), this.mBuilder.getColor()));
                } else {
                    remoteViews.setImageViewBitmap(C0209R.id.icon, createColoredBitmap(this.mBuilder.mNotification.icon, -1));
                }
            }
            if (this.mBuilder.mContentTitle != null) {
                remoteViews.setTextViewText(C0209R.id.title, this.mBuilder.mContentTitle);
            }
            if (this.mBuilder.mContentText != null) {
                remoteViews.setTextViewText(C0209R.id.text, this.mBuilder.mContentText);
                z3 = true;
            } else {
                z3 = false;
            }
            ...
            if (this.mBuilder.mContentInfo != null) {
                remoteViews.setTextViewText(C0209R.id.info, this.mBuilder.mContentInfo);
                remoteViews.setViewVisibility(C0209R.id.info, 0);
            } else if (this.mBuilder.mNumber > 0) {
                if (this.mBuilder.mNumber > resources.getInteger(C0209R.integer.status_bar_notification_info_maxnum)) {
                    remoteViews.setTextViewText(C0209R.id.info, resources.getString(C0209R.string.status_bar_notification_info_overflow));
                } else {
                    remoteViews.setTextViewText(C0209R.id.info, NumberFormat.getIntegerInstance().format(this.mBuilder.mNumber));
                }
                remoteViews.setViewVisibility(C0209R.id.info, 0);
            } else {
                remoteViews.setViewVisibility(C0209R.id.info, 8);
                if (this.mBuilder.mSubText != null && Build.VERSION.SDK_INT >= 16) {
                    remoteViews.setTextViewText(C0209R.id.text, this.mBuilder.mSubText);
                    if (this.mBuilder.mContentText == null) {
                        remoteViews.setTextViewText(C0209R.id.text2, this.mBuilder.mContentText);
                        remoteViews.setViewVisibility(C0209R.id.text2, 0);
                        z4 = true;
                        if (z4 && Build.VERSION.SDK_INT >= 16) {
                            if (z2) {
                                remoteViews.setTextViewTextSize(C0209R.id.text, 0, resources.getDimensionPixelSize(C0209R.dimen.notification_subtext_size));
                            }
                            remoteViews.setViewPadding(C0209R.id.line1, 0, 0, 0, 0);
                        }
                        if (this.mBuilder.getWhenIfShowing() == 0) {
                            z5 = z7;
                        } else if (this.mBuilder.mUseChronometer && Build.VERSION.SDK_INT >= 16) {
                            remoteViews.setViewVisibility(C0209R.id.chronometer, 0);
                            remoteViews.setLong(C0209R.id.chronometer, "setBase", this.mBuilder.getWhenIfShowing() + (SystemClock.elapsedRealtime() - System.currentTimeMillis()));
                            remoteViews.setBoolean(C0209R.id.chronometer, "setStarted", true);
                            if (this.mBuilder.mChronometerCountDown && Build.VERSION.SDK_INT >= 24) {
                                remoteViews.setChronometerCountDown(C0209R.id.chronometer, this.mBuilder.mChronometerCountDown);
                            }
                        } else {
                            remoteViews.setViewVisibility(C0209R.id.time, 0);
                            remoteViews.setLong(C0209R.id.time, "setTime", this.mBuilder.getWhenIfShowing());
                        }
                        remoteViews.setViewVisibility(C0209R.id.right_side, z5 ? 0 : 8);
                        remoteViews.setViewVisibility(C0209R.id.line3, z3 ? 0 : 8);
                        return remoteViews;
                    }
                    remoteViews.setViewVisibility(C0209R.id.text2, 8);
                }
                z4 = false;
                if (z4) {
                    if (z2) {
        ...
        private Bitmap createIconWithBackground(int i, int i2, int i3, int i4) {
            int i5 = C0209R.drawable.notification_icon_background;
            if (i4 == 0) {
                i4 = 0;
            }
        ...
        public void buildIntoRemoteViews(RemoteViews remoteViews, RemoteViews remoteViews2) {
            ...
            remoteViews.removeAllViews(C0209R.id.notification_main_column);
            remoteViews.addView(C0209R.id.notification_main_column, remoteViews2.clone());
            remoteViews.setViewVisibility(C0209R.id.notification_main_column, 0);
            if (Build.VERSION.SDK_INT >= 21) {
                remoteViews.setViewPadding(C0209R.id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
            }
        }

        private void hideNormalContent(RemoteViews remoteViews) {
            remoteViews.setViewVisibility(C0209R.id.title, 8);
            remoteViews.setViewVisibility(C0209R.id.text2, 8);
            remoteViews.setViewVisibility(C0209R.id.text, 8);
        }

        private int calculateTopPadding() {
            Resources resources = this.mBuilder.mContext.getResources();
            int dimensionPixelSize = resources.getDimensionPixelSize(C0209R.dimen.notification_top_pad);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0209R.dimen.notification_top_pad_large_text);
    ...
    public static class BigPictureStyle extends Style {
        ...
        protected void restoreFromCompatExtras(Bundle bundle) {
            ...
            if (bundle.containsKey(NotificationCompat.EXTRA_LARGE_ICON_BIG)) {
                this.mBigLargeIcon = (Bitmap) bundle.getParcelable(NotificationCompat.EXTRA_LARGE_ICON_BIG);
                this.mBigLargeIconSet = true;
            }
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z) {
            int min;
            boolean z2 = true;
            RemoteViews applyStandardTemplate = applyStandardTemplate(true, C0209R.layout.notification_template_custom_big, false);
            applyStandardTemplate.removeAllViews(C0209R.id.actions);
            ...
            if (!z || nonContextualActions == null || (min = Math.min(nonContextualActions.size(), 3)) <= 0) {
                ...
                for (int i = 0; i < min; i++) {
                    applyStandardTemplate.addView(C0209R.id.actions, generateActionButton(nonContextualActions.get(i)));
                }
            }
            int i2 = z2 ? 0 : 8;
            applyStandardTemplate.setViewVisibility(C0209R.id.actions, i2);
            applyStandardTemplate.setViewVisibility(C0209R.id.action_divider, i2);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            if (z) {
                i = C0209R.layout.notification_action_tombstone;
            } else {
                i = C0209R.layout.notification_action;
            }
            RemoteViews remoteViews = new RemoteViews(packageName, i);
            IconCompat iconCompat = action.getIconCompat();
            if (iconCompat != null) {
                remoteViews.setImageViewBitmap(C0209R.id.action_image, createColoredBitmap(iconCompat, this.mBuilder.mContext.getResources().getColor(C0209R.color.notification_action_color_filter)));
            }
            remoteViews.setTextViewText(C0209R.id.action_text, action.title);
            if (!z) {
                remoteViews.setOnClickPendingIntent(C0209R.id.action_container, action.actionIntent);
            }
            if (Build.VERSION.SDK_INT >= 15) {
                remoteViews.setContentDescription(C0209R.id.action_container, action.title);
            }
            return remoteViews;
        }
    }
    ...
    public static class Action {
        ...
        public static final class WearableExtender implements Extender {
            ...
            public WearableExtender m4263clone() {
    ...
    public static final class WearableExtender implements Extender {
        ...
        /* renamed from: clone, reason: merged with bridge method [inline-methods] */
        public WearableExtender m4264clone() {
            WearableExtender wearableExtender = new WearableExtender();

...
public class WindowInsetsCompat {
    ...
    public boolean hasInsets() {
        return (getInsets(Type.all()).equals(Insets.NONE) && getInsetsIgnoringVisibility(Type.all()).equals(Insets.NONE) && getDisplayCutout() == null) ? false : true;
    }
    ...
    public static class Impl {
        ...
        void setRootViewData(Rect rect, int i) {
        }
    ...
    public static class Impl20 extends Impl {
        ...
        protected Insets getInsetsForType(int i, boolean z) {
            ...
            if (i == 2) {
                if (z) {
                    ...
                    return Insets.m5of(Math.max(rootStableInsets.left, stableInsets.left), 0, Math.max(rootStableInsets.right, stableInsets.right), Math.max(rootStableInsets.bottom, stableInsets.bottom));
                }
                Insets systemWindowInsets = getSystemWindowInsets();
                WindowInsetsCompat windowInsetsCompat = this.mRootWindowInsets;
                Insets stableInsets2 = windowInsetsCompat != null ? windowInsetsCompat.getStableInsets() : null;
                int i3 = systemWindowInsets.bottom;
                if (stableInsets2 != null) {
                    i3 = Math.min(i3, stableInsets2.bottom);
                }
                return Insets.m5of(systemWindowInsets.left, 0, systemWindowInsets.right, i3);
            }
            if (i == 8) {
                Insets systemWindowInsets2 = getSystemWindowInsets();
                Insets rootStableInsets2 = getRootStableInsets();
                if (systemWindowInsets2.bottom > rootStableInsets2.bottom) {
                    return Insets.m5of(0, 0, 0, systemWindowInsets2.bottom);
                }
                Rect rect = this.mRootViewVisibleFrame;
                if (rect != null && !rect.isEmpty() && (i2 = this.mRootViewHeight - this.mRootViewVisibleFrame.bottom) > rootStableInsets2.bottom) {
                    return Insets.m5of(0, 0, 0, i2);
                }
                return Insets.NONE;
            }
            if (i == 16) {
            ...
            if (i == 128) {
                ...
                if (displayCutout != null) {
                    return Insets.m5of(displayCutout.getSafeInsetLeft(), displayCutout.getSafeInsetTop(), displayCutout.getSafeInsetRight(), displayCutout.getSafeInsetBottom());
                }
                return Insets.NONE;
            }
            return Insets.NONE;
        ...
        void copyWindowDataInto(WindowInsetsCompat windowInsetsCompat) {
            ...
            windowInsetsCompat.setRootViewData(this.mRootViewVisibleFrame, this.mRootViewHeight);
        }
        ...
        @Override // androidx.core.view.WindowInsetsCompat.Impl
        void setRootViewData(Rect rect, int i) {
            this.mRootViewVisibleFrame = rect;
    ...
    public static Insets insetInsets(Insets insets, int i, int i2, int i3, int i4) {
        ...
        return (max == i && max2 == i2 && max3 == i3 && max4 == i4) ? insets : Insets.m5of(max, max2, max3, max4);
    }
    ...
    void setRootViewData(Rect rect, int i) {
        this.mImpl.setRootViewData(rect, i);
    }

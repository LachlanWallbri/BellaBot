...
public class ViewCompat {
    ...
    private static final int[] ACCESSIBILITY_ACTIONS_RESOURCE_IDS = {C0209R.id.accessibility_custom_action_0, C0209R.id.accessibility_custom_action_1, C0209R.id.accessibility_custom_action_2, C0209R.id.accessibility_custom_action_3, C0209R.id.accessibility_custom_action_4, C0209R.id.accessibility_custom_action_5, C0209R.id.accessibility_custom_action_6, C0209R.id.accessibility_custom_action_7, C0209R.id.accessibility_custom_action_8, C0209R.id.accessibility_custom_action_9, C0209R.id.accessibility_custom_action_10, C0209R.id.accessibility_custom_action_11, C0209R.id.accessibility_custom_action_12, C0209R.id.accessibility_custom_action_13, C0209R.id.accessibility_custom_action_14, C0209R.id.accessibility_custom_action_15, C0209R.id.accessibility_custom_action_16, C0209R.id.accessibility_custom_action_17, C0209R.id.accessibility_custom_action_18, C0209R.id.accessibility_custom_action_19, C0209R.id.accessibility_custom_action_20, C0209R.id.accessibility_custom_action_21, C0209R.id.accessibility_custom_action_22, C0209R.id.accessibility_custom_action_23, C0209R.id.accessibility_custom_action_24, C0209R.id.accessibility_custom_action_25, C0209R.id.accessibility_custom_action_26, C0209R.id.accessibility_custom_action_27, C0209R.id.accessibility_custom_action_28, C0209R.id.accessibility_custom_action_29, C0209R.id.accessibility_custom_action_30, C0209R.id.accessibility_custom_action_31};
    ...
    private static List<AccessibilityNodeInfoCompat.AccessibilityActionCompat> getActionList(View view) {
        ArrayList arrayList = (ArrayList) view.getTag(C0209R.id.tag_accessibility_actions);
        if (arrayList != null) {
            return arrayList;
        }
        ArrayList arrayList2 = new ArrayList();
        view.setTag(C0209R.id.tag_accessibility_actions, arrayList2);
        return arrayList2;
    }
            ...
            if (onApplyWindowInsetsListener == null) {
                ...
                view.setOnApplyWindowInsetsListener(new View.OnApplyWindowInsetsListener() { // from class: androidx.core.view.ViewCompat.1
                    ...
                    public WindowInsets onApplyWindowInsets(View view2, WindowInsets windowInsets) {
                        return OnApplyWindowInsetsListener.this.onApplyWindowInsets(view2, WindowInsetsCompat.toWindowInsetsCompat(windowInsets, view2)).toWindowInsets();
                    }
                });
            }
        }
    ...
    static class CompatImplApi28 {
        ...
        static void addOnUnhandledKeyEventListener(View view, final OnUnhandledKeyEventListenerCompat onUnhandledKeyEventListenerCompat) {
            SimpleArrayMap simpleArrayMap = (SimpleArrayMap) view.getTag(C0209R.id.tag_unhandled_key_listeners);
            if (simpleArrayMap == null) {
                simpleArrayMap = new SimpleArrayMap();
                view.setTag(C0209R.id.tag_unhandled_key_listeners, simpleArrayMap);
            }
    ...
    public static void addOnUnhandledKeyEventListener(View view, OnUnhandledKeyEventListenerCompat onUnhandledKeyEventListenerCompat) {
        ...
        ArrayList arrayList = (ArrayList) view.getTag(C0209R.id.tag_unhandled_key_listeners);
        if (arrayList == null) {
            arrayList = new ArrayList();
            view.setTag(C0209R.id.tag_unhandled_key_listeners, arrayList);
        }
    ...
    public static boolean dispatchUnhandledKeyEventBeforeHierarchy(View view, KeyEvent keyEvent) {
        ...
        return UnhandledKeyEventManager.m12at(view).preDispatch(keyEvent);
    }
    ...
    public static boolean dispatchUnhandledKeyEventBeforeCallback(View view, KeyEvent keyEvent) {
        ...
        return UnhandledKeyEventManager.m12at(view).dispatch(view, keyEvent);
    }
    ...
    private static AccessibilityViewProperty<Boolean> screenReaderFocusableProperty() {
        return new AccessibilityViewProperty<Boolean>(C0209R.id.tag_screen_reader_focusable, Boolean.class, 28) { // from class: androidx.core.view.ViewCompat.2
            /* JADX INFO: Access modifiers changed from: package-private */
    ...
    private static AccessibilityViewProperty<CharSequence> paneTitleProperty() {
        return new AccessibilityViewProperty<CharSequence>(C0209R.id.tag_accessibility_pane_title, CharSequence.class, 8, 28) { // from class: androidx.core.view.ViewCompat.3
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // androidx.core.view.ViewCompat.AccessibilityViewProperty
    ...
    private static AccessibilityViewProperty<CharSequence> stateDescriptionProperty() {
        return new AccessibilityViewProperty<CharSequence>(C0209R.id.tag_state_description, CharSequence.class, 64, 30) { // from class: androidx.core.view.ViewCompat.4
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // androidx.core.view.ViewCompat.AccessibilityViewProperty
            public CharSequence frameworkGet(View view) {
    ...
    private static AccessibilityViewProperty<Boolean> accessibilityHeadingProperty() {
        return new AccessibilityViewProperty<Boolean>(C0209R.id.tag_accessibility_heading, Boolean.class, 28) { // from class: androidx.core.view.ViewCompat.5
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // androidx.core.view.ViewCompat.AccessibilityViewProperty
            public Boolean frameworkGet(View view) {
    ...
    static class UnhandledKeyEventManager {
        ...
        /* renamed from: at */
        static UnhandledKeyEventManager m12at(View view) {
            UnhandledKeyEventManager unhandledKeyEventManager = (UnhandledKeyEventManager) view.getTag(C0209R.id.tag_unhandled_key_event_manager);
            if (unhandledKeyEventManager != null) {
                return unhandledKeyEventManager;
            }
            UnhandledKeyEventManager unhandledKeyEventManager2 = new UnhandledKeyEventManager();
            view.setTag(C0209R.id.tag_unhandled_key_event_manager, unhandledKeyEventManager2);
    ...
    private static class Api21Impl {
        ...
        /* loaded from: classes.dex */
        class ViewOnApplyWindowInsetsListenerC02601 implements View.OnApplyWindowInsetsListener {
            WindowInsetsCompat mLastInsets = null;
            final /* synthetic */ OnApplyWindowInsetsListener val$listener;
            final /* synthetic */ View val$v;

            ViewOnApplyWindowInsetsListenerC02601(View view, OnApplyWindowInsetsListener onApplyWindowInsetsListener) {
                this.val$v = view;

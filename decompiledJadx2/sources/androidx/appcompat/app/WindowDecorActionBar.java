...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    private void init(View view) {
        ...
        this.mDecorToolbar = getDecorToolbar(view.findViewById(C0048R.id.action_bar));
        this.mContextView = (ActionBarContextView) view.findViewById(C0048R.id.action_context_bar);
        ...
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(null, C0048R.styleable.ActionBar, C0048R.attr.actionBarStyle, 0);
        if (obtainStyledAttributes.getBoolean(C0048R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0048R.styleable.ActionBar_elevation, 0);
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0048R.attr.actionBarWidgetTheme, typedValue, true);

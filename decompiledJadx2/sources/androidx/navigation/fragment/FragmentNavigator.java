    ...
    */
    ...
    public static class Destination extends NavDestination {
        ...
        public void onInflate(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, C0531R.styleable.FragmentNavigator);
            String string = obtainAttributes.getString(C0531R.styleable.FragmentNavigator_android_name);
            if (string != null) {
                setClassName(string);
            }

...
public class NavGraph extends NavDestination implements Iterable<NavDestination> {
    ...
    public void onInflate(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, C0528R.styleable.NavGraphNavigator);
        setStartDestination(obtainAttributes.getResourceId(C0528R.styleable.NavGraphNavigator_startDestination, 0));

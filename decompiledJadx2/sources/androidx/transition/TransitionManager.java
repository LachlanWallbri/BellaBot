...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition mo4266clone = transition.mo4266clone();
        mo4266clone.setSceneRoot(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            mo4266clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, mo4266clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, mo4266clone);
    }
    ...
    /* renamed from: go */
    public static void m22go(Scene scene) {
        changeScene(scene, sDefaultTransition);
    }

    /* renamed from: go */
    public static void m23go(Scene scene, Transition transition) {
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition mo4266clone = transition.mo4266clone();
        sceneChangeSetup(viewGroup, mo4266clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, mo4266clone);
    }

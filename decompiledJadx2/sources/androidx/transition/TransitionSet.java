...
public class TransitionSet extends Transition {
    ...
    @Override // androidx.transition.Transition
    /* renamed from: clone */
    public Transition mo4266clone() {
        TransitionSet transitionSet = (TransitionSet) super.mo4266clone();
        transitionSet.mTransitions = new ArrayList<>();
        int size = this.mTransitions.size();
        for (int i = 0; i < size; i++) {
            transitionSet.addTransitionInternal(this.mTransitions.get(i).mo4266clone());
        }

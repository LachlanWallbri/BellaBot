...
public class HorizontalWidgetRun extends WidgetRun {
    ...
    static /* synthetic */ class C01911 {
        ...
        static final /* synthetic */ int[] f81xbf6f0c8e;
        ...
        static {
            ...
            try {
                f81xbf6f0c8e[WidgetRun.RunType.END.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f81xbf6f0c8e[WidgetRun.RunType.CENTER.ordinal()] = 3;
    ...
    */
    public void update(Dependency dependency) {
        ...
        float f2;
        int i;
        int i2 = C01911.f81xbf6f0c8e[this.mRunType.ordinal()];
        if (i2 == 1) {

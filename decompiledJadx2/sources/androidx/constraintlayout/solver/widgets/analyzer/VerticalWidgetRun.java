...
public class VerticalWidgetRun extends WidgetRun {
    ...
    static /* synthetic */ class C01921 {
        ...
        static final /* synthetic */ int[] f82xbf6f0c8e;
        ...
        static {
            ...
            try {
                f82xbf6f0c8e[WidgetRun.RunType.END.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f82xbf6f0c8e[WidgetRun.RunType.CENTER.ordinal()] = 3;
    ...
    public void update(Dependency dependency) {
        ...
        float f2;
        int i;
        int i2 = C01921.f82xbf6f0c8e[this.mRunType.ordinal()];
        if (i2 == 1) {

...
public class MonotonicCurveFit extends CurveFit {
    ...
    /* renamed from: mT */
    private double[] f59mT;
    private double[][] mTangent;

    /* renamed from: mY */
    private double[][] f60mY;
    ...
    public void getPos(double d, double[] dArr) {
        double[] dArr2 = this.f59mT;
        int length = dArr2.length;
        int i = 0;
        int length2 = this.f60mY[0].length;
        if (d <= dArr2[0]) {
            for (int i2 = 0; i2 < length2; i2++) {
                dArr[i2] = this.f60mY[0][i2];
            }
            return;
        }
        int i3 = length - 1;
        ...
        while (i4 < i3) {
            if (d == this.f59mT[i4]) {
                for (int i5 = 0; i5 < length2; i5++) {
                    dArr[i5] = this.f60mY[i4][i5];
                }
            }
            double[] dArr3 = this.f59mT;
            int i6 = i4 + 1;
            if (d < dArr3[i6]) {
                double d2 = dArr3[i6] - dArr3[i4];
                double d3 = (d - dArr3[i4]) / d2;
                while (i < length2) {
                    double[][] dArr4 = this.f60mY;
    ...
    public void getPos(double d, float[] fArr) {
        double[] dArr = this.f59mT;
        int length = dArr.length;
        int i = 0;
        int length2 = this.f60mY[0].length;
        if (d <= dArr[0]) {
            for (int i2 = 0; i2 < length2; i2++) {
                fArr[i2] = (float) this.f60mY[0][i2];
            }
            return;
        }
        int i3 = length - 1;
        ...
        while (i4 < i3) {
            if (d == this.f59mT[i4]) {
                for (int i5 = 0; i5 < length2; i5++) {
                    fArr[i5] = (float) this.f60mY[i4][i5];
                }
            }
            double[] dArr2 = this.f59mT;
            int i6 = i4 + 1;
    ...
    public double getPos(double d, int i) {
        ...
        int i2 = 0;
        if (d <= dArr[0]) {
            return this.f60mY[0][i];
        }
        int i3 = length - 1;
        if (d >= dArr[i3]) {
            return this.f60mY[i3][i];
        }
        while (i2 < i3) {
            double[] dArr2 = this.f59mT;
            if (d == dArr2[i2]) {
                return this.f60mY[i2][i];
            }
            int i4 = i2 + 1;
            if (d < dArr2[i4]) {

...
public class MotionPaths implements Comparable<MotionPaths> {
    ...
    void initCartesian(KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f8 = motionPaths.f66x;
        float f9 = motionPaths.f67y;
        float f10 = (motionPaths2.f66x + (f4 / 2.0f)) - ((f5 / 2.0f) + f8);
        float f11 = (motionPaths2.f67y + (f6 / 2.0f)) - (f9 + (f7 / 2.0f));
        float f12 = ((f4 - f5) * f2) / 2.0f;
        this.f66x = (int) ((f8 + (f10 * f)) - f12);
        float f13 = ((f6 - f7) * f3) / 2.0f;
        this.f67y = (int) ((f9 + (f11 * f)) - f13);
        ...
        this.mMode = 2;
        this.f66x = (int) (((motionPaths.f66x + (f14 * f10)) + (f16 * f11)) - f12);
        this.f67y = (int) (((motionPaths.f67y + (f10 * f15)) + (f11 * f)) - f13);
    ...
    void initScreen(int i, int i2, KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f8 = motionPaths.f66x;
        float f9 = motionPaths.f67y;
        float f10 = motionPaths2.f66x + (f4 / 2.0f);
        float f11 = motionPaths2.f67y + (f6 / 2.0f);
        float f12 = (f4 - f5) * f2;
        this.f66x = (int) ((f8 + ((f10 - ((f5 / 2.0f) + f8)) * f)) - (f12 / 2.0f));
        float f13 = (f6 - f7) * f3;
        this.f67y = (int) ((f9 + ((f11 - (f9 + (f7 / 2.0f))) * f)) - (f13 / 2.0f));
        this.width = (int) (f5 + f12);
        this.height = (int) (f7 + f13);
        this.mMode = 3;
        if (!Float.isNaN(keyPosition.mPercentX)) {
            this.f66x = (int) (keyPosition.mPercentX * ((int) (i - this.width)));
        }
        if (!Float.isNaN(keyPosition.mPercentY)) {
            this.f67y = (int) (keyPosition.mPercentY * ((int) (i2 - this.height)));
        }
        this.mKeyFrameEasing = Easing.getInterpolator(keyPosition.mTransitionEasing);
        this.mPathMotionArc = keyPosition.mPathMotionArc;
    }
    ...
    void initPath(KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f6 = motionPaths.f66x;
        float f7 = motionPaths.width;
        float f8 = motionPaths.f67y;
        float f9 = motionPaths.height;
        float f10 = (motionPaths2.f66x + (motionPaths2.width / 2.0f)) - ((f7 / 2.0f) + f6);
        float f11 = (motionPaths2.f67y + (motionPaths2.height / 2.0f)) - ((f9 / 2.0f) + f8);
        float f12 = f10 * f;
        float f13 = (f4 * f2) / 2.0f;
        this.f66x = (int) ((f6 + f12) - f13);
        float f14 = f * f11;
        float f15 = (f5 * f3) / 2.0f;
        this.f67y = (int) ((f8 + f14) - f15);
        this.width = (int) (f7 + r7);
        this.height = (int) (f9 + r8);
        float f16 = Float.isNaN(keyPosition.mPercentY) ? 0.0f : keyPosition.mPercentY;
        this.mMode = 1;
        float f17 = (int) ((motionPaths.f66x + f12) - f13);
        this.f66x = f17;
        float f18 = (int) ((motionPaths.f67y + f14) - f15);
        this.f67y = f18;
        this.f66x = f17 + ((-f11) * f16);
        this.f67y = f18 + (f10 * f16);
        this.mKeyFrameEasing = Easing.getInterpolator(keyPosition.mTransitionEasing);
        this.mPathMotionArc = keyPosition.mPathMotionArc;
    }
    ...
    public void different(MotionPaths motionPaths, boolean[] zArr, String[] strArr, boolean z) {
        ...
        zArr[1] = zArr[1] | diff(this.f66x, motionPaths.f66x) | z;
        zArr[2] = z | diff(this.f67y, motionPaths.f67y) | zArr[2];
    ...
    public void fillStandard(double[] dArr, int[] iArr) {
        float[] fArr = {this.position, this.f66x, this.f67y, this.width, this.height, this.mPathRotate};
        int i = 0;
        for (int i2 = 0; i2 < iArr.length; i2++) {
            if (iArr[i2] < 6) {
                dArr[i] = fArr[iArr[i2]];

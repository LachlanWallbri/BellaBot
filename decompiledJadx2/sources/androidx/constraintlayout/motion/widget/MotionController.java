...
public class MotionController {
    ...
    public float getStartX() {
        return this.mStartMotionPath.f66x;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public float getStartY() {
        return this.mStartMotionPath.f67y;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public float getFinalX() {
        return this.mEndMotionPath.f66x;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public float getFinalY() {
        return this.mEndMotionPath.f67y;
    }
    ...
    public KeyPositionBase getPositionKeyframe(int i, int i2, float f, float f2) {
        ...
        rectF.left = this.mStartMotionPath.f66x;
        rectF.top = this.mStartMotionPath.f67y;
        rectF.right = rectF.left + this.mStartMotionPath.width;
        rectF.bottom = rectF.top + this.mStartMotionPath.height;
        RectF rectF2 = new RectF();
        rectF2.left = this.mEndMotionPath.f66x;
        rectF2.top = this.mEndMotionPath.f67y;
    ...
    public float getKeyFrameParameter(int i, float f, float f2) {
        float f3 = this.mEndMotionPath.f66x - this.mStartMotionPath.f66x;
        float f4 = this.mEndMotionPath.f67y - this.mStartMotionPath.f67y;
        float f5 = this.mStartMotionPath.f66x + (this.mStartMotionPath.width / 2.0f);
        float f6 = this.mStartMotionPath.f67y + (this.mStartMotionPath.height / 2.0f);
    ...
    public void setup(int i, int i2, float f, long j) {
        ...
        if (motionPathsArr[0].mPathMotionArc != Key.UNSET) {
            ...
            for (int i18 = 0; i18 < size; i18++) {
                ...
                dArr6[i18][0] = motionPathsArr[i18].f66x;
                dArr6[i18][1] = motionPathsArr[i18].f67y;
            }
    ...
    public String toString() {
        return " start: x: " + this.mStartMotionPath.f66x + " y: " + this.mStartMotionPath.f67y + " end: x: " + this.mEndMotionPath.f66x + " y: " + this.mEndMotionPath.f67y;
    }
    ...
    public boolean interpolate(View view, float f, long j, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            float f2 = this.mStartMotionPath.f66x + ((this.mEndMotionPath.f66x - this.mStartMotionPath.f66x) * adjustedPosition);
            float f3 = this.mStartMotionPath.f67y + ((this.mEndMotionPath.f67y - this.mStartMotionPath.f67y) * adjustedPosition);
            float f4 = f2 + 0.5f;
            int i3 = (int) f4;
            float f5 = f3 + 0.5f;
            int i4 = (int) f5;
    ...
    public void getDpDt(float f, float f2, float f3, float[] fArr) {
        ...
        float f5 = this.mEndMotionPath.f66x - this.mStartMotionPath.f66x;
        float f6 = this.mEndMotionPath.f67y - this.mStartMotionPath.f67y;
    ...
    /* loaded from: classes.dex */
    class InterpolatorC01701 implements Interpolator {
        final /* synthetic */ androidx.constraintlayout.core.motion.utils.Easing val$easing;

        InterpolatorC01701(final androidx.constraintlayout.core.motion.utils.Easing val$easing) {

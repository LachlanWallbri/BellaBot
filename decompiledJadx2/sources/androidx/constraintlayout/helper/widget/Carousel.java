    ...
    protected void onAttachedToWindow() {
        ...
        if (getParent() instanceof MotionLayout) {
            ...
            if (this.touchUpMode == 2) {
                MotionScene.Transition transition = this.mMotionLayout.getTransition(this.forwardTransition);
                if (transition != null) {

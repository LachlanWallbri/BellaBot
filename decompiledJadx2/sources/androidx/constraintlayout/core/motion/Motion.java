...
public class Motion {
    ...
    private float getPreCycleDistance() {
        ...
        while (i < 100) {
            ...
            if (easing != null) {
                ...
                d3 = (((float) easing.get((f3 - f5) / r6)) * (f4 - f5)) + f5;
            }
    ...
    MotionKeyPosition getPositionKeyframe(int i, int i2, float f, float f2) {
        ...
        floatRect.left = this.mStartMotionPath.f18x;
        floatRect.top = this.mStartMotionPath.f19y;
        ...
        floatRect2.left = this.mEndMotionPath.f18x;
        floatRect2.top = this.mEndMotionPath.f19y;
    ...
    float getKeyFrameParameter(int i, float f, float f2) {
        float f3 = this.mEndMotionPath.f18x - this.mStartMotionPath.f18x;
        float f4 = this.mEndMotionPath.f19y - this.mStartMotionPath.f19y;
        float f5 = this.mStartMotionPath.f18x + (this.mStartMotionPath.width / 2.0f);
        float f6 = this.mStartMotionPath.f19y + (this.mStartMotionPath.height / 2.0f);
    ...
    public void setup(int i, int i2, float f, long j) {
            ...
            for (int i17 = 0; i17 < motionPathsArr.length; i17++) {
                if (motionPathsArr[i17].hasCustomData(str8)) {
                    if (dArr4 == null) {
                        ...
                        dArr4 = (double[][]) Array.newInstance((Class<?>) double.class, motionPathsArr.length, motionPathsArr[i17].getCustomDataCount(str8));
                    }
        ...
        if (motionPathsArr[0].mPathMotionArc != -1) {
            ...
            for (int i18 = 0; i18 < length; i18++) {
                ...
                dArr6[i18][0] = motionPathsArr[i18].f18x;
                dArr6[i18][1] = motionPathsArr[i18].f19y;
            }
    ...
    private static DifferentialInterpolator getInterpolator(int i, String str, int i2) {
        ...
        return new DifferentialInterpolator() { // from class: androidx.constraintlayout.core.motion.Motion.1
            ...
            public float getVelocity() {
                return (float) Easing.this.getDiff(this.f15mX);
            }
        };
    }
    ...
    public boolean interpolate(MotionWidget motionWidget, float f, long j, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            float f6 = this.mStartMotionPath.f18x + ((this.mEndMotionPath.f18x - this.mStartMotionPath.f18x) * f5) + 0.5f;
            float f7 = this.mStartMotionPath.f19y + ((this.mEndMotionPath.f19y - this.mStartMotionPath.f19y) * f5) + 0.5f;
    ...
    void getDpDt(float f, float f2, float f3, float[] fArr) {
        ...
        float f5 = this.mEndMotionPath.f18x - this.mStartMotionPath.f18x;
        float f6 = this.mEndMotionPath.f19y - this.mStartMotionPath.f19y;

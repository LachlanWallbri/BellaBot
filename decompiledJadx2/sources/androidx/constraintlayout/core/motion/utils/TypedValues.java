...
public interface TypedValues {
    ...
    public interface Position {
        ...
        public static final String[] KEY_WORDS = {S_TRANSITION_EASING, S_DRAWPATH, S_PERCENT_WIDTH, S_PERCENT_HEIGHT, S_SIZE_PERCENT, S_PERCENT_X, S_PERCENT_Y};
        ...
        static int getId(String str) {
            ...
            switch (str.hashCode()) {
                case -1812823328:
                    if (str.equals(S_TRANSITION_EASING)) {
                        c = 0;
                        break;
                    }
                    c = 65535;
                ...
                case -1127236479:
                    ...
                    break;
                case -1017587252:
                    if (str.equals(S_PERCENT_HEIGHT)) {
                        c = 3;
                        break;
                    }
                    c = 65535;
    ...
    public interface Custom {
        ...
        public static final String[] KEY_WORDS = {"float", S_COLOR, "string", "boolean", S_DIMENSION, S_REFERENCE};
    ...
    public interface MotionScene {
        ...
        static int getId(String str) {
            ...
            if (hashCode != 6076149) {
                if (hashCode == 1028758976 && str.equals(S_LAYOUT_DURING_TRANSITION)) {
                    z = true;
                }
                z = -1;
            } else {

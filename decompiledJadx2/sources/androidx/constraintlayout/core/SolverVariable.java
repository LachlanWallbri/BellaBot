...
public class SolverVariable implements Comparable<SolverVariable> {
    ...
    private static String getUniqueName(Type type, String str) {
        ...
        int i = C01511.$SwitchMap$androidx$constraintlayout$core$SolverVariable$Type[type.ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C01511 {
        static final /* synthetic */ int[] $SwitchMap$androidx$constraintlayout$core$SolverVariable$Type = new int[Type.values().length];

        static {
            try {
                $SwitchMap$androidx$constraintlayout$core$SolverVariable$Type[Type.UNRESTRICTED.ordinal()] = 1;
    ...
    public void setSynonym(LinearSystem linearSystem, SolverVariable solverVariable, float f) {
        this.isSynonym = true;
        this.synonym = solverVariable.f13id;
        this.synonymDelta = f;
        int i = this.mClientEquationsCount;
        this.definitionId = -1;
        for (int i2 = 0; i2 < i; i2++) {
    ...
    public int compareTo(SolverVariable solverVariable) {
        return this.f13id - solverVariable.f13id;
    }

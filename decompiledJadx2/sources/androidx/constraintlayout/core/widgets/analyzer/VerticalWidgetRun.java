...
public class VerticalWidgetRun extends WidgetRun {
    ...
    /* loaded from: classes.dex */
    static /* synthetic */ class C01661 {

        /* renamed from: $SwitchMap$androidx$constraintlayout$core$widgets$analyzer$WidgetRun$RunType */
        static final /* synthetic */ int[] f46x56910102 = new int[WidgetRun.RunType.values().length];

        static {
            try {
                f46x56910102[WidgetRun.RunType.START.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f46x56910102[WidgetRun.RunType.END.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f46x56910102[WidgetRun.RunType.CENTER.ordinal()] = 3;
    ...
    public void update(Dependency dependency) {
        ...
        float f2;
        int i;
        int i2 = C01661.f46x56910102[this.mRunType.ordinal()];
        if (i2 == 1) {

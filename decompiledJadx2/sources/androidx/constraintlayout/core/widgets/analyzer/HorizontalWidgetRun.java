...
public class HorizontalWidgetRun extends WidgetRun {
    ...
    void apply() {
        ...
        if (this.dimensionBehavior == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT && (i = this.widget.mMatchConstraintDefaultWidth) != 0) {
            if (i == 2) {
    ...
    static /* synthetic */ class C01651 {
        ...
        static final /* synthetic */ int[] f45x56910102 = new int[WidgetRun.RunType.values().length];

        static {
            try {
                f45x56910102[WidgetRun.RunType.START.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f45x56910102[WidgetRun.RunType.END.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f45x56910102[WidgetRun.RunType.CENTER.ordinal()] = 3;
    ...
    */
    public void update(Dependency dependency) {
        ...
        float f2;
        int i;
        int i2 = C01651.f45x56910102[this.mRunType.ordinal()];
        if (i2 == 1) {

...
public abstract class WidgetRun implements Dependency {
    ...
    public final DependencyNode getTarget(ConstraintAnchor constraintAnchor) {
        ...
        int i = C01671.f48x6930e354[constraintAnchor.mTarget.mType.ordinal()];
        if (i == 1) {
    ...
    public static /* synthetic */ class C01671 {
        ...
        static final /* synthetic */ int[] f48x6930e354 = new int[ConstraintAnchor.Type.values().length];

        static {
            try {
                f48x6930e354[ConstraintAnchor.Type.LEFT.ordinal()] = 1;
    ...
    public final DependencyNode getTarget(ConstraintAnchor constraintAnchor, int i) {
        ...
        int i2 = C01671.f48x6930e354[constraintAnchor.mTarget.mType.ordinal()];
        if (i2 != 1) {
            if (i2 != 2) {
                if (i2 != 3) {
                    if (i2 != 5) {

...
public class LinearSystem {
    ...
    public SolverVariable createObjectVariable(Object obj) {
        ...
        if (obj instanceof ConstraintAnchor) {
            ...
            if (solverVariable.f13id == -1 || solverVariable.f13id > this.mVariablesID || this.mCache.mIndexedVariables[solverVariable.f13id] == null) {
                if (solverVariable.f13id != -1) {
                    solverVariable.reset();
                }
                this.mVariablesID++;
                this.mNumColumns++;
                solverVariable.f13id = this.mVariablesID;
    ...
    public SolverVariable createSlackVariable() {
        ...
        this.mVariablesID++;
        this.mNumColumns++;
        acquireSolverVariable.f13id = this.mVariablesID;
    ...
    private final int optimize(Row row, boolean z) {
        ...
        while (!z2) {
            ...
            if (row.getKey() != null) {
                this.mAlreadyTestedCandidates[row.getKey().f13id] = true;
            }
            SolverVariable pivotCandidate = row.getPivotCandidate(this, this.mAlreadyTestedCandidates);
            if (pivotCandidate != null) {
                if (this.mAlreadyTestedCandidates[pivotCandidate.f13id]) {
                    return i2;
                }
                this.mAlreadyTestedCandidates[pivotCandidate.f13id] = true;
            }
            if (pivotCandidate != null) {
    ...
    public void addEquality(SolverVariable solverVariable, int i) {
        if (USE_BASIC_SYNONYMS && solverVariable.definitionId == -1) {
            ...
            for (int i2 = 0; i2 < this.mVariablesID + 1; i2++) {
                SolverVariable solverVariable2 = this.mCache.mIndexedVariables[i2];
                if (solverVariable2 != null && solverVariable2.isSynonym && solverVariable2.synonym == solverVariable.f13id) {

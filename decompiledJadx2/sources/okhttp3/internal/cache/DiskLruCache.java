...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    public static final class Companion {
        ...
        public final DiskLruCache create(FileSystem fileSystem, File directory, int appVersion, int valueCount, long maxSize) {
            ...
            return new DiskLruCache(fileSystem, directory, appVersion, valueCount, maxSize, new ThreadPoolExecutor(0, 1, 60L, TimeUnit.SECONDS, new LinkedBlockingQueue(), Util.threadFactory("OkHttp DiskLruCache", true)));
        }
    }

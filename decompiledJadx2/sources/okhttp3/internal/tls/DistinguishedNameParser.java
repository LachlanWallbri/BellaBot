...
final class DistinguishedNameParser {
    ...
    private String nextAT() {
        ...
        int i4 = this.pos;
        if (i4 >= this.length) {
            throw new IllegalStateException("Unexpected end of DN: " + this.f8896dn);
        }
        this.end = i4;
        if (this.chars[i4] == ' ') {
            while (true) {
    ...
    */
    ...
    private int getByte(int i) {
        ...
        int i4 = i + 1;
        if (i4 >= this.length) {
            throw new IllegalStateException("Malformed DN: " + this.f8896dn);
        }
        char c = this.chars[i];
        if (c >= '0' && c <= '9') {
            i2 = c - '0';
    ...
    public String findMostSpecific(String str) {
        ...
        this.end = 0;
        this.cur = 0;
        this.chars = this.f8896dn.toCharArray();

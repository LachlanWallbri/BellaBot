...
public final class MetricDescriptor extends GeneratedMessageV3 implements MetricDescriptorOrBuilder {
                ...
                try {
                    try {
                        ...
                        switch (readTag) {
                            ...
                            case 82:
                                MetricDescriptorMetadata.Builder builder = this.metadata_ != null ? this.metadata_.toBuilder() : null;
                                this.metadata_ = (MetricDescriptorMetadata) codedInputStream.readMessage(MetricDescriptorMetadata.parser(), extensionRegistryLite);
                                if (builder != null) {
    ...
    public static final class MetricDescriptorMetadata extends GeneratedMessageV3 implements MetricDescriptorMetadataOrBuilder {
                ...
                try {
                    try {
                        ...
                        if (readTag != 0) {
                            if (readTag != 8) {
                                if (readTag == 18) {
                                    builder = this.samplePeriod_ != null ? this.samplePeriod_.toBuilder() : null;
                                    this.samplePeriod_ = (Duration) codedInputStream.readMessage(Duration.parser(), extensionRegistryLite);
                                    if (builder != null) {
                                        builder.mergeFrom(this.samplePeriod_);
                                        this.samplePeriod_ = builder.buildPartial();
                                    }
                                } else if (readTag == 26) {
                                    builder = this.ingestDelay_ != null ? this.ingestDelay_.toBuilder() : null;
                                    this.ingestDelay_ = (Duration) codedInputStream.readMessage(Duration.parser(), extensionRegistryLite);
                                    if (builder != null) {
                                        builder.mergeFrom(this.ingestDelay_);
        ...
        public static final Descriptors.Descriptor getDescriptor() {
            return MetricProto.f1325x4c8dfdfc;
        }

        @Override // com.google.protobuf.GeneratedMessageV3
        protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
            return MetricProto.f1326x280d687a.ensureFieldAccessorsInitialized(MetricDescriptorMetadata.class, Builder.class);
        }

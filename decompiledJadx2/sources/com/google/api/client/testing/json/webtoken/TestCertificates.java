...
public class TestCertificates {
    ...
    public static JsonWebSignature getJsonWebSignature() throws IOException {
        if (jsonWebSignature == null) {
            ...
            jsonWebSignature = new JsonWebSignature(header, payload, Base64.decodeBase64(JWS_SIGNATURE.substring(indexOf + 1)), StringUtils.getBytesUtf8(JWS_SIGNATURE.substring(0, indexOf)));
        }

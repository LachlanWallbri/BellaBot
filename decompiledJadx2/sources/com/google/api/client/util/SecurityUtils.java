...
public final class SecurityUtils {
    ...
    public static KeyStore createMtlsKeyStore(InputStream inputStream) throws GeneralSecurityException, IOException {
        ...
        keyStore.setKeyEntry(ConfigJson.ALIAS, KeyFactory.getInstance(x509Certificate.getPublicKey().getAlgorithm()).generatePrivate(new PKCS8EncodedKeySpec(section2.getBase64DecodedBytes())), new char[0], new X509Certificate[]{x509Certificate});
        return keyStore;
    }

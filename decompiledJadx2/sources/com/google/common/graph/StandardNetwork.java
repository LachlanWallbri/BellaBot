...
public class StandardNetwork<N, E> extends AbstractNetwork<N, E> {
    ...
    public StandardNetwork(NetworkBuilder<? super N, ? super E> networkBuilder) {
        this(networkBuilder, networkBuilder.nodeOrder.createMap(networkBuilder.expectedNodeCount.mo604or((Optional<Integer>) 10).intValue()), networkBuilder.edgeOrder.createMap(networkBuilder.expectedEdgeCount.mo604or((Optional<Integer>) 20).intValue()));
    }
    ...
    public EndpointPair<N> incidentNodes(E e) {
        ...
        return EndpointPair.m733of(this, checkedReferenceNode, this.nodeConnections.get(checkedReferenceNode).adjacentNode(e));
    }

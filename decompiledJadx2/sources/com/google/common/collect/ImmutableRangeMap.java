...
public class ImmutableRangeMap<K extends Comparable<?>, V> implements RangeMap<K, V>, Serializable {
    private static final ImmutableRangeMap<Comparable<?>, Object> EMPTY = new ImmutableRangeMap<>(ImmutableList.m634of(), ImmutableList.m634of());
    ...
    /* renamed from: of */
    public static <K extends Comparable<?>, V> ImmutableRangeMap<K, V> m672of() {
        return (ImmutableRangeMap<K, V>) EMPTY;
    }

    /* renamed from: of */
    public static <K extends Comparable<?>, V> ImmutableRangeMap<K, V> m673of(Range<K> range, V v) {
        return new ImmutableRangeMap<>(ImmutableList.m635of(range), ImmutableList.m635of(v));
    }
    ...
    public ImmutableRangeMap<K, V> subRangeMap(final Range<K> range) {
        ...
        return (ImmutableRangeMap<K, V>) new ImmutableRangeMap<K, V>(this, new ImmutableList<Range<K>>() { // from class: com.google.common.collect.ImmutableRangeMap.1
            ...
            public ImmutableRangeMap<K, V> subRangeMap(Range<K> range2) {
                ...
                return ImmutableRangeMap.m672of();
            }
        };
    }

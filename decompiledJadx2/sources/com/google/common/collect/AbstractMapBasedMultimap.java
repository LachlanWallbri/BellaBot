...
public abstract class AbstractMapBasedMultimap<K, V> extends AbstractMultimap<K, V> implements Serializable {
    ...
    public static /* synthetic */ Spliterator lambda$entrySpliterator$1(Map.Entry entry) {
        ...
        return CollectSpliterators.map(((Collection) entry.getValue()).spliterator(), new Function() { // from class: com.google.common.collect.-$$Lambda$AbstractMapBasedMultimap$nHy3qNCNcmGNwH0dGmWVXukPHuo
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
    ...
    public void forEach(final BiConsumer<? super K, ? super V> biConsumer) {
        ...
        this.map.forEach(new BiConsumer() { // from class: com.google.common.collect.-$$Lambda$AbstractMapBasedMultimap$rpup2BUHOGvd5Do9G61ew3zVES8
            ...
            public final void accept(Object obj, Object obj2) {
                ((Collection) obj2).forEach(new Consumer() { // from class: com.google.common.collect.-$$Lambda$AbstractMapBasedMultimap$K6eu4GZuSxXfMkjoEQhIcP28JLo
    ...
    public class AsMap extends Maps.ViewCachingAbstractMap<K, Collection<V>> {
        ...
        class AsMapEntries extends Maps.EntrySet<K, Collection<V>> {
            ...
            public Spliterator<Map.Entry<K, Collection<V>>> spliterator() {
                ...
                return CollectSpliterators.map(spliterator, new Function() { // from class: com.google.common.collect.-$$Lambda$IlCt6YHMNbjdh9aTmFntexV042I
                    @Override // java.util.function.Function
                    public final Object apply(Object obj) {

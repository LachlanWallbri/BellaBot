...
public final class TypeResolver {
    ...
    private static class WildcardCapturer {
        ...
        /* renamed from: id */
        private final AtomicInteger f2001id;
        ...
        TypeVariable<?> captureAsTypeVariable(Type[] typeArr) {
            int incrementAndGet = this.f2001id.incrementAndGet();
            String join = Joiner.m608on(Typography.amp).join(typeArr);
        ...
        private WildcardCapturer forTypeVariable(final TypeVariable<?> typeVariable) {
            return new WildcardCapturer(this, this.f2001id) { // from class: com.google.common.reflect.TypeResolver.WildcardCapturer.1
        ...
        private WildcardCapturer notForTypeVariable() {
            return new WildcardCapturer(this.f2001id);
        }

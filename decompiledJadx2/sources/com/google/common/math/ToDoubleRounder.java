...
abstract class ToDoubleRounder<X extends Number & Comparable<X>> {
    ...
    public final double roundToDouble(X x, RoundingMode roundingMode) {
        ...
        if (Double.isInfinite(roundToDoubleArbitrarily)) {
            switch (C30561.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
                case 1:
                case 2:
                case 3:
                case 4:
        ...
        switch (C30561.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            ...
            case 4:
                ...
                int i = C30561.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()];
                if (i == 2) {

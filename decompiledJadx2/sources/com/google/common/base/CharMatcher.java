...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    /* renamed from: is */
    public static CharMatcher m606is(char c) {
        return new C2664Is(c);
    }
    ...
    public static CharMatcher anyOf(CharSequence charSequence) {
        ...
        if (length == 1) {
            return m606is(charSequence.charAt(0));
        }
        if (length == 2) {
    ...
    /* renamed from: or */
    public CharMatcher mo607or(CharMatcher charMatcher) {
        return new C2665Or(this, charMatcher);
    }
    ...
    private static CharMatcher precomputedPositive(int i, BitSet bitSet, String str) {
        ...
        if (i == 1) {
            return m606is((char) bitSet.nextSetBit(0));
        }
        if (i == 2) {
    ...
    /* loaded from: classes3.dex */
    public static final class C2665Or extends CharMatcher {
        final CharMatcher first;
        final CharMatcher second;
        ...
        C2665Or(CharMatcher charMatcher, CharMatcher charMatcher2) {
            this.first = (CharMatcher) Preconditions.checkNotNull(charMatcher);
            this.second = (CharMatcher) Preconditions.checkNotNull(charMatcher2);
        }
    ...
    /* loaded from: classes3.dex */
    public static final class C2664Is extends FastMatcher {
        ...
        /* renamed from: or */
        public CharMatcher mo607or(CharMatcher charMatcher) {
            return charMatcher.matches(this.match) ? charMatcher : super.mo607or(charMatcher);
        }

...
public final class CacheBuilderSpec {
    private static final Splitter KEYS_SPLITTER = Splitter.m615on(',').trimResults();
    private static final Splitter KEY_VALUE_SPLITTER = Splitter.m615on('=').trimResults();
    ...
    public CacheBuilder<Object, Object> toCacheBuilder() {
        ...
        if (this.keyStrength != null) {
            if (C26911.$SwitchMap$com$google$common$cache$LocalCache$Strength[this.keyStrength.ordinal()] == 1) {
                newBuilder.weakKeys();
            } else {
        ...
        if (this.valueStrength != null) {
            int i = C26911.$SwitchMap$com$google$common$cache$LocalCache$Strength[this.valueStrength.ordinal()];
            if (i == 1) {
    ...
    /* loaded from: classes3.dex */
    public static /* synthetic */ class C26911 {

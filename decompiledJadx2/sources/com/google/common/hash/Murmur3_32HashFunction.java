...
public final class Murmur3_32HashFunction extends AbstractHashFunction implements Serializable {
    ...
    /* renamed from: C1 */
    private static final int f1966C1 = -862048943;

    /* renamed from: C2 */
    private static final int f1967C2 = 461845907;
    ...
    public static long charToThreeUtf8Bytes(char c) {
        return (((c & '?') | 128) << 16) | (((c >>> '\f') | DimensionsKt.XXHDPI) & 255) | ((((c >>> 6) & 63) | 128) << 8);
    }
    ...
    public static int mixK1(int i) {
        return Integer.rotateLeft(i * f1966C1, 15) * f1967C2;
    }
    ...
    private static final class Murmur3_32Hasher extends AbstractHasher {
        ...
        private void update(int i, long j) {
            ...
            this.length += i;
            if (this.shift >= 32) {
                this.f1968h1 = Murmur3_32HashFunction.mixH1(this.f1968h1, Murmur3_32HashFunction.mixK1((int) this.buffer));
                this.buffer >>>= 32;
                this.shift -= 32;
            }
        }
        ...
        public HashCode hash() {
            ...
            this.isDone = true;
            this.f1968h1 ^= Murmur3_32HashFunction.mixK1((int) this.buffer);
            return Murmur3_32HashFunction.fmix(this.f1968h1, this.length);
        }
    }
}

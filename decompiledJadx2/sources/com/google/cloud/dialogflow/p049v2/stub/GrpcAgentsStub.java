...
public class GrpcAgentsStub extends AgentsStub {
    ...
    private static final MethodDescriptor<DeleteAgentRequest, Empty> deleteAgentMethodDescriptor = MethodDescriptor.newBuilder().setType(MethodDescriptor.MethodType.UNARY).setFullMethodName("google.cloud.dialogflow.v2.Agents/DeleteAgent").setRequestMarshaller(ProtoUtils.marshaller(DeleteAgentRequest.getDefaultInstance())).setResponseMarshaller(ProtoUtils.marshaller(Empty.getDefaultInstance())).build();
    ...
    private static final MethodDescriptor<ExportAgentRequest, Operation> exportAgentMethodDescriptor = MethodDescriptor.newBuilder().setType(MethodDescriptor.MethodType.UNARY).setFullMethodName("google.cloud.dialogflow.v2.Agents/ExportAgent").setRequestMarshaller(ProtoUtils.marshaller(ExportAgentRequest.getDefaultInstance())).setResponseMarshaller(ProtoUtils.marshaller(Operation.getDefaultInstance())).build();
    ...
    private static final MethodDescriptor<RestoreAgentRequest, Operation> restoreAgentMethodDescriptor = MethodDescriptor.newBuilder().setType(MethodDescriptor.MethodType.UNARY).setFullMethodName("google.cloud.dialogflow.v2.Agents/RestoreAgent").setRequestMarshaller(ProtoUtils.marshaller(RestoreAgentRequest.getDefaultInstance())).setResponseMarshaller(ProtoUtils.marshaller(Operation.getDefaultInstance())).build();
    ...
    /* JADX WARN: Type inference failed for: r1v1, types: [com.google.cloud.dialogflow.v2.stub.AgentsStubSettings] */
    ...
    protected GrpcAgentsStub(AgentsStubSettings agentsStubSettings, ClientContext clientContext, GrpcStubCallableFactory grpcStubCallableFactory) throws IOException {
        ...
        GrpcCallSettings build = GrpcCallSettings.newBuilder().setMethodDescriptor(setAgentMethodDescriptor).setParamsExtractor(new RequestParamsExtractor<SetAgentRequest>() { // from class: com.google.cloud.dialogflow.v2.stub.GrpcAgentsStub.1
        ...
        GrpcCallSettings build2 = GrpcCallSettings.newBuilder().setMethodDescriptor(deleteAgentMethodDescriptor).setParamsExtractor(new RequestParamsExtractor<DeleteAgentRequest>() { // from class: com.google.cloud.dialogflow.v2.stub.GrpcAgentsStub.2
            @Override // com.google.api.gax.rpc.RequestParamsExtractor
        ...
        GrpcCallSettings build3 = GrpcCallSettings.newBuilder().setMethodDescriptor(getAgentMethodDescriptor).setParamsExtractor(new RequestParamsExtractor<GetAgentRequest>() { // from class: com.google.cloud.dialogflow.v2.stub.GrpcAgentsStub.3
            @Override // com.google.api.gax.rpc.RequestParamsExtractor
        ...
        GrpcCallSettings build4 = GrpcCallSettings.newBuilder().setMethodDescriptor(searchAgentsMethodDescriptor).setParamsExtractor(new RequestParamsExtractor<SearchAgentsRequest>() { // from class: com.google.cloud.dialogflow.v2.stub.GrpcAgentsStub.4
            @Override // com.google.api.gax.rpc.RequestParamsExtractor
        ...
        GrpcCallSettings build5 = GrpcCallSettings.newBuilder().setMethodDescriptor(trainAgentMethodDescriptor).setParamsExtractor(new RequestParamsExtractor<TrainAgentRequest>() { // from class: com.google.cloud.dialogflow.v2.stub.GrpcAgentsStub.5
            @Override // com.google.api.gax.rpc.RequestParamsExtractor
        ...
        GrpcCallSettings build6 = GrpcCallSettings.newBuilder().setMethodDescriptor(exportAgentMethodDescriptor).setParamsExtractor(new RequestParamsExtractor<ExportAgentRequest>() { // from class: com.google.cloud.dialogflow.v2.stub.GrpcAgentsStub.6
            @Override // com.google.api.gax.rpc.RequestParamsExtractor
        ...
        GrpcCallSettings build7 = GrpcCallSettings.newBuilder().setMethodDescriptor(importAgentMethodDescriptor).setParamsExtractor(new RequestParamsExtractor<ImportAgentRequest>() { // from class: com.google.cloud.dialogflow.v2.stub.GrpcAgentsStub.7
            @Override // com.google.api.gax.rpc.RequestParamsExtractor
        ...
        GrpcCallSettings build8 = GrpcCallSettings.newBuilder().setMethodDescriptor(restoreAgentMethodDescriptor).setParamsExtractor(new RequestParamsExtractor<RestoreAgentRequest>() { // from class: com.google.cloud.dialogflow.v2.stub.GrpcAgentsStub.8
            @Override // com.google.api.gax.rpc.RequestParamsExtractor
        ...
        GrpcCallSettings build9 = GrpcCallSettings.newBuilder().setMethodDescriptor(getValidationResultMethodDescriptor).setParamsExtractor(new RequestParamsExtractor<GetValidationResultRequest>() { // from class: com.google.cloud.dialogflow.v2.stub.GrpcAgentsStub.9
            @Override // com.google.api.gax.rpc.RequestParamsExtractor
    ...
    @Override // com.google.cloud.dialogflow.p049v2.stub.AgentsStub
    ...
    @Override // com.google.cloud.dialogflow.p049v2.stub.AgentsStub, java.lang.AutoCloseable

...
public class ContextsStubSettings extends StubSettings<ContextsStubSettings> {
    ...
    private static final PagedListDescriptor<ListContextsRequest, ListContextsResponse, Context> LIST_CONTEXTS_PAGE_STR_DESC = new PagedListDescriptor<ListContextsRequest, ListContextsResponse, Context>() { // from class: com.google.cloud.dialogflow.v2.stub.ContextsStubSettings.1

...
import com.google.cloud.dialogflow.p049v2.BatchDeleteIntentsRequest;
import com.google.cloud.dialogflow.p049v2.BatchUpdateIntentsRequest;
import com.google.cloud.dialogflow.p049v2.BatchUpdateIntentsResponse;
import com.google.cloud.dialogflow.p049v2.CreateIntentRequest;
import com.google.cloud.dialogflow.p049v2.DeleteIntentRequest;
import com.google.cloud.dialogflow.p049v2.GetIntentRequest;
import com.google.cloud.dialogflow.p049v2.Intent;
import com.google.cloud.dialogflow.p049v2.IntentsClient;
import com.google.cloud.dialogflow.p049v2.ListIntentsRequest;
import com.google.cloud.dialogflow.p049v2.ListIntentsResponse;
import com.google.cloud.dialogflow.p049v2.UpdateIntentRequest;
...
public class GrpcIntentsStub extends IntentsStub {
    ...
    private static final MethodDescriptor<CreateIntentRequest, Intent> createIntentMethodDescriptor = MethodDescriptor.newBuilder().setType(MethodDescriptor.MethodType.UNARY).setFullMethodName("google.cloud.dialogflow.v2.Intents/CreateIntent").setRequestMarshaller(ProtoUtils.marshaller(CreateIntentRequest.getDefaultInstance())).setResponseMarshaller(ProtoUtils.marshaller(Intent.getDefaultInstance())).build();
    private static final MethodDescriptor<UpdateIntentRequest, Intent> updateIntentMethodDescriptor = MethodDescriptor.newBuilder().setType(MethodDescriptor.MethodType.UNARY).setFullMethodName("google.cloud.dialogflow.v2.Intents/UpdateIntent").setRequestMarshaller(ProtoUtils.marshaller(UpdateIntentRequest.getDefaultInstance())).setResponseMarshaller(ProtoUtils.marshaller(Intent.getDefaultInstance())).build();
    private static final MethodDescriptor<DeleteIntentRequest, Empty> deleteIntentMethodDescriptor = MethodDescriptor.newBuilder().setType(MethodDescriptor.MethodType.UNARY).setFullMethodName("google.cloud.dialogflow.v2.Intents/DeleteIntent").setRequestMarshaller(ProtoUtils.marshaller(DeleteIntentRequest.getDefaultInstance())).setResponseMarshaller(ProtoUtils.marshaller(Empty.getDefaultInstance())).build();
    private static final MethodDescriptor<BatchUpdateIntentsRequest, Operation> batchUpdateIntentsMethodDescriptor = MethodDescriptor.newBuilder().setType(MethodDescriptor.MethodType.UNARY).setFullMethodName("google.cloud.dialogflow.v2.Intents/BatchUpdateIntents").setRequestMarshaller(ProtoUtils.marshaller(BatchUpdateIntentsRequest.getDefaultInstance())).setResponseMarshaller(ProtoUtils.marshaller(Operation.getDefaultInstance())).build();
    private static final MethodDescriptor<BatchDeleteIntentsRequest, Operation> batchDeleteIntentsMethodDescriptor = MethodDescriptor.newBuilder().setType(MethodDescriptor.MethodType.UNARY).setFullMethodName("google.cloud.dialogflow.v2.Intents/BatchDeleteIntents").setRequestMarshaller(ProtoUtils.marshaller(BatchDeleteIntentsRequest.getDefaultInstance())).setResponseMarshaller(ProtoUtils.marshaller(Operation.getDefaultInstance())).build();
    ...
    /* JADX WARN: Type inference failed for: r1v1, types: [com.google.cloud.dialogflow.v2.stub.IntentsStubSettings] */
    ...
    protected GrpcIntentsStub(IntentsStubSettings intentsStubSettings, ClientContext clientContext, GrpcStubCallableFactory grpcStubCallableFactory) throws IOException {
        ...
        GrpcCallSettings build = GrpcCallSettings.newBuilder().setMethodDescriptor(listIntentsMethodDescriptor).setParamsExtractor(new RequestParamsExtractor<ListIntentsRequest>() { // from class: com.google.cloud.dialogflow.v2.stub.GrpcIntentsStub.1
        ...
        GrpcCallSettings build2 = GrpcCallSettings.newBuilder().setMethodDescriptor(getIntentMethodDescriptor).setParamsExtractor(new RequestParamsExtractor<GetIntentRequest>() { // from class: com.google.cloud.dialogflow.v2.stub.GrpcIntentsStub.2
            @Override // com.google.api.gax.rpc.RequestParamsExtractor
        ...
        GrpcCallSettings build3 = GrpcCallSettings.newBuilder().setMethodDescriptor(createIntentMethodDescriptor).setParamsExtractor(new RequestParamsExtractor<CreateIntentRequest>() { // from class: com.google.cloud.dialogflow.v2.stub.GrpcIntentsStub.3
            @Override // com.google.api.gax.rpc.RequestParamsExtractor
        ...
        GrpcCallSettings build4 = GrpcCallSettings.newBuilder().setMethodDescriptor(updateIntentMethodDescriptor).setParamsExtractor(new RequestParamsExtractor<UpdateIntentRequest>() { // from class: com.google.cloud.dialogflow.v2.stub.GrpcIntentsStub.4
            @Override // com.google.api.gax.rpc.RequestParamsExtractor
        ...
        GrpcCallSettings build5 = GrpcCallSettings.newBuilder().setMethodDescriptor(deleteIntentMethodDescriptor).setParamsExtractor(new RequestParamsExtractor<DeleteIntentRequest>() { // from class: com.google.cloud.dialogflow.v2.stub.GrpcIntentsStub.5
            @Override // com.google.api.gax.rpc.RequestParamsExtractor
        ...
        GrpcCallSettings build6 = GrpcCallSettings.newBuilder().setMethodDescriptor(batchUpdateIntentsMethodDescriptor).setParamsExtractor(new RequestParamsExtractor<BatchUpdateIntentsRequest>() { // from class: com.google.cloud.dialogflow.v2.stub.GrpcIntentsStub.6
            @Override // com.google.api.gax.rpc.RequestParamsExtractor
        ...
        GrpcCallSettings build7 = GrpcCallSettings.newBuilder().setMethodDescriptor(batchDeleteIntentsMethodDescriptor).setParamsExtractor(new RequestParamsExtractor<BatchDeleteIntentsRequest>() { // from class: com.google.cloud.dialogflow.v2.stub.GrpcIntentsStub.7
            @Override // com.google.api.gax.rpc.RequestParamsExtractor
    ...
    @Override // com.google.cloud.dialogflow.p049v2.stub.IntentsStub
    ...
    @Override // com.google.cloud.dialogflow.p049v2.stub.IntentsStub, java.lang.AutoCloseable

...
public class IntentsStubSettings extends StubSettings<IntentsStubSettings> {
    ...
    private static final PagedListDescriptor<ListIntentsRequest, ListIntentsResponse, Intent> LIST_INTENTS_PAGE_STR_DESC = new PagedListDescriptor<ListIntentsRequest, ListIntentsResponse, Intent>() { // from class: com.google.cloud.dialogflow.v2.stub.IntentsStubSettings.1

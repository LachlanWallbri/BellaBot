...
public class GrpcSessionEntityTypesStub extends SessionEntityTypesStub {
    ...
    private static final MethodDescriptor<GetSessionEntityTypeRequest, SessionEntityType> getSessionEntityTypeMethodDescriptor = MethodDescriptor.newBuilder().setType(MethodDescriptor.MethodType.UNARY).setFullMethodName("google.cloud.dialogflow.v2.SessionEntityTypes/GetSessionEntityType").setRequestMarshaller(ProtoUtils.marshaller(GetSessionEntityTypeRequest.getDefaultInstance())).setResponseMarshaller(ProtoUtils.marshaller(SessionEntityType.getDefaultInstance())).build();
    private static final MethodDescriptor<CreateSessionEntityTypeRequest, SessionEntityType> createSessionEntityTypeMethodDescriptor = MethodDescriptor.newBuilder().setType(MethodDescriptor.MethodType.UNARY).setFullMethodName("google.cloud.dialogflow.v2.SessionEntityTypes/CreateSessionEntityType").setRequestMarshaller(ProtoUtils.marshaller(CreateSessionEntityTypeRequest.getDefaultInstance())).setResponseMarshaller(ProtoUtils.marshaller(SessionEntityType.getDefaultInstance())).build();
    private static final MethodDescriptor<UpdateSessionEntityTypeRequest, SessionEntityType> updateSessionEntityTypeMethodDescriptor = MethodDescriptor.newBuilder().setType(MethodDescriptor.MethodType.UNARY).setFullMethodName("google.cloud.dialogflow.v2.SessionEntityTypes/UpdateSessionEntityType").setRequestMarshaller(ProtoUtils.marshaller(UpdateSessionEntityTypeRequest.getDefaultInstance())).setResponseMarshaller(ProtoUtils.marshaller(SessionEntityType.getDefaultInstance())).build();
    private static final MethodDescriptor<DeleteSessionEntityTypeRequest, Empty> deleteSessionEntityTypeMethodDescriptor = MethodDescriptor.newBuilder().setType(MethodDescriptor.MethodType.UNARY).setFullMethodName("google.cloud.dialogflow.v2.SessionEntityTypes/DeleteSessionEntityType").setRequestMarshaller(ProtoUtils.marshaller(DeleteSessionEntityTypeRequest.getDefaultInstance())).setResponseMarshaller(ProtoUtils.marshaller(Empty.getDefaultInstance())).build();
    ...
    /* JADX WARN: Type inference failed for: r1v1, types: [com.google.cloud.dialogflow.v2.stub.SessionEntityTypesStubSettings] */
    ...
    protected GrpcSessionEntityTypesStub(SessionEntityTypesStubSettings sessionEntityTypesStubSettings, ClientContext clientContext, GrpcStubCallableFactory grpcStubCallableFactory) throws IOException {
        ...
        GrpcCallSettings build = GrpcCallSettings.newBuilder().setMethodDescriptor(listSessionEntityTypesMethodDescriptor).setParamsExtractor(new RequestParamsExtractor<ListSessionEntityTypesRequest>() { // from class: com.google.cloud.dialogflow.v2.stub.GrpcSessionEntityTypesStub.1
        ...
        GrpcCallSettings build2 = GrpcCallSettings.newBuilder().setMethodDescriptor(getSessionEntityTypeMethodDescriptor).setParamsExtractor(new RequestParamsExtractor<GetSessionEntityTypeRequest>() { // from class: com.google.cloud.dialogflow.v2.stub.GrpcSessionEntityTypesStub.2
            @Override // com.google.api.gax.rpc.RequestParamsExtractor
        ...
        GrpcCallSettings build3 = GrpcCallSettings.newBuilder().setMethodDescriptor(createSessionEntityTypeMethodDescriptor).setParamsExtractor(new RequestParamsExtractor<CreateSessionEntityTypeRequest>() { // from class: com.google.cloud.dialogflow.v2.stub.GrpcSessionEntityTypesStub.3
            @Override // com.google.api.gax.rpc.RequestParamsExtractor
        ...
        GrpcCallSettings build4 = GrpcCallSettings.newBuilder().setMethodDescriptor(updateSessionEntityTypeMethodDescriptor).setParamsExtractor(new RequestParamsExtractor<UpdateSessionEntityTypeRequest>() { // from class: com.google.cloud.dialogflow.v2.stub.GrpcSessionEntityTypesStub.4
            @Override // com.google.api.gax.rpc.RequestParamsExtractor
        ...
        GrpcCallSettings build5 = GrpcCallSettings.newBuilder().setMethodDescriptor(deleteSessionEntityTypeMethodDescriptor).setParamsExtractor(new RequestParamsExtractor<DeleteSessionEntityTypeRequest>() { // from class: com.google.cloud.dialogflow.v2.stub.GrpcSessionEntityTypesStub.5
            @Override // com.google.api.gax.rpc.RequestParamsExtractor
    ...
    @Override // com.google.cloud.dialogflow.p049v2.stub.SessionEntityTypesStub
    ...
    @Override // com.google.cloud.dialogflow.p049v2.stub.SessionEntityTypesStub, java.lang.AutoCloseable

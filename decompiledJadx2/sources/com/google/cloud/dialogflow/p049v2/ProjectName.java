...
public class ProjectName implements ResourceName {
    ...
    /* renamed from: of */
    public static ProjectName m587of(String str) {
    ...
    public static ProjectName parse(String str) {
        ...
        return m587of(PATH_TEMPLATE.validatedMatch(str, "ProjectName.parse: formattedString not in valid format").get("project"));
    }

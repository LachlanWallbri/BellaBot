...
import com.google.cloud.dialogflow.p049v2.EntityTypeBatch;
...
public final class BatchUpdateEntityTypesRequest extends GeneratedMessageV3 implements BatchUpdateEntityTypesRequestOrBuilder {
    ...
    private static final Parser<BatchUpdateEntityTypesRequest> PARSER = new AbstractParser<BatchUpdateEntityTypesRequest>() { // from class: com.google.cloud.dialogflow.v2.BatchUpdateEntityTypesRequest.1
    ...
    public static final Descriptors.Descriptor getDescriptor() {
        return EntityTypeProto.f1421x2f4b836d;
    }

    @Override // com.google.protobuf.GeneratedMessageV3
    protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
        return EntityTypeProto.f1422xfdaaeceb.ensureFieldAccessorsInitialized(BatchUpdateEntityTypesRequest.class, Builder.class);
    }
    ...
    @Override // com.google.cloud.dialogflow.p049v2.BatchUpdateEntityTypesRequestOrBuilder
    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements BatchUpdateEntityTypesRequestOrBuilder {
        ...
        public Builder mergeFrom(BatchUpdateEntityTypesRequest batchUpdateEntityTypesRequest) {
            ...
            int i = C21732.f1396xac993a94[batchUpdateEntityTypesRequest.getEntityTypeBatchCase().ordinal()];
            if (i == 1) {
                this.entityTypeBatchCase_ = 2;
     ...
     */
    /* renamed from: com.google.cloud.dialogflow.v2.BatchUpdateEntityTypesRequest$2 */
    /* loaded from: classes2.dex */
    public static /* synthetic */ class C21732 {

        /* renamed from: $SwitchMap$com$google$cloud$dialogflow$v2$BatchUpdateEntityTypesRequest$EntityTypeBatchCase */
        static final /* synthetic */ int[] f1396xac993a94 = new int[EntityTypeBatchCase.values().length];

        static {
            try {
                f1396xac993a94[EntityTypeBatchCase.ENTITY_TYPE_BATCH_URI.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f1396xac993a94[EntityTypeBatchCase.ENTITY_TYPE_BATCH_INLINE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f1396xac993a94[EntityTypeBatchCase.ENTITYTYPEBATCH_NOT_SET.ordinal()] = 3;

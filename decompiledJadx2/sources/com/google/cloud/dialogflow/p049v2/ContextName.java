...
public class ContextName implements ResourceName {
    ...
    /* renamed from: of */
    public static ContextName m583of(String str, String str2, String str3) {
    ...
    public static ContextName parse(String str) {
        ...
        return m583of(validatedMatch.get("project"), validatedMatch.get("session"), validatedMatch.get("context"));
    }

...
public final class ExportAgentResponse extends GeneratedMessageV3 implements ExportAgentResponseOrBuilder {
    ...
    private static final Parser<ExportAgentResponse> PARSER = new AbstractParser<ExportAgentResponse>() { // from class: com.google.cloud.dialogflow.v2.ExportAgentResponse.1
    ...
    public static final Descriptors.Descriptor getDescriptor() {
        return AgentProto.f1366xeab911b7;
    }

    @Override // com.google.protobuf.GeneratedMessageV3
    protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
        return AgentProto.f1367xcd729135.ensureFieldAccessorsInitialized(ExportAgentResponse.class, Builder.class);
    }
    ...
    @Override // com.google.cloud.dialogflow.p049v2.ExportAgentResponseOrBuilder
    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements ExportAgentResponseOrBuilder {
        ...
        public Builder mergeFrom(ExportAgentResponse exportAgentResponse) {
            ...
            int i = C22052.f1442xf75903d2[exportAgentResponse.getAgentCase().ordinal()];
            if (i == 1) {
                this.agentCase_ = 1;
     ...
     */
    /* renamed from: com.google.cloud.dialogflow.v2.ExportAgentResponse$2 */
    /* loaded from: classes2.dex */
    public static /* synthetic */ class C22052 {

        /* renamed from: $SwitchMap$com$google$cloud$dialogflow$v2$ExportAgentResponse$AgentCase */
        static final /* synthetic */ int[] f1442xf75903d2 = new int[AgentCase.values().length];

        static {
            try {
                f1442xf75903d2[AgentCase.AGENT_URI.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f1442xf75903d2[AgentCase.AGENT_CONTENT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f1442xf75903d2[AgentCase.AGENT_NOT_SET.ordinal()] = 3;

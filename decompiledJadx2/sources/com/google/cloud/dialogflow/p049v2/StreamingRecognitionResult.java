...
import com.google.cloud.dialogflow.p049v2.SpeechWordInfo;
...
public final class StreamingRecognitionResult extends GeneratedMessageV3 implements StreamingRecognitionResultOrBuilder {
    ...
    private static final Parser<StreamingRecognitionResult> PARSER = new AbstractParser<StreamingRecognitionResult>() { // from class: com.google.cloud.dialogflow.v2.StreamingRecognitionResult.1
    ...
    public static final Descriptors.Descriptor getDescriptor() {
        return SessionProto.f1565x2a95f801;
    }

    @Override // com.google.protobuf.GeneratedMessageV3
    protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
        return SessionProto.f1566xc8d18d7f.ensureFieldAccessorsInitialized(StreamingRecognitionResult.class, Builder.class);
    }
    ...
    public enum MessageType implements ProtocolMessageEnum {
        ...
        private static final Internal.EnumLiteMap<MessageType> internalValueMap = new Internal.EnumLiteMap<MessageType>() { // from class: com.google.cloud.dialogflow.v2.StreamingRecognitionResult.MessageType.1
    ...
    @Override // com.google.cloud.dialogflow.p049v2.StreamingRecognitionResultOrBuilder
    ...
    public int hashCode() {
        ...
        int hashCode = ((((((((((((((((779 + getDescriptor().hashCode()) * 37) + 1) * 53) + this.messageType_) * 37) + 2) * 53) + getTranscript().hashCode()) * 37) + 3) * 53) + Internal.hashBoolean(getIsFinal())) * 37) + 4) * 53) + Float.floatToIntBits(getConfidence());

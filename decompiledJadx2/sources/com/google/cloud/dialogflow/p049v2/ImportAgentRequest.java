...
public final class ImportAgentRequest extends GeneratedMessageV3 implements ImportAgentRequestOrBuilder {
    ...
    private static final Parser<ImportAgentRequest> PARSER = new AbstractParser<ImportAgentRequest>() { // from class: com.google.cloud.dialogflow.v2.ImportAgentRequest.1
    ...
    public static final Descriptors.Descriptor getDescriptor() {
        return AgentProto.f1372xf04eff44;
    }

    @Override // com.google.protobuf.GeneratedMessageV3
    protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
        return AgentProto.f1373x727ca1c2.ensureFieldAccessorsInitialized(ImportAgentRequest.class, Builder.class);
    }
    ...
    @Override // com.google.cloud.dialogflow.p049v2.ImportAgentRequestOrBuilder
    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements ImportAgentRequestOrBuilder {
        ...
        public Builder mergeFrom(ImportAgentRequest importAgentRequest) {
            ...
            int i = C22132.f1443x29ecec51[importAgentRequest.getAgentCase().ordinal()];
            if (i == 1) {
                this.agentCase_ = 2;
     ...
     */
    /* renamed from: com.google.cloud.dialogflow.v2.ImportAgentRequest$2 */
    /* loaded from: classes2.dex */
    public static /* synthetic */ class C22132 {

        /* renamed from: $SwitchMap$com$google$cloud$dialogflow$v2$ImportAgentRequest$AgentCase */
        static final /* synthetic */ int[] f1443x29ecec51 = new int[AgentCase.values().length];

        static {
            try {
                f1443x29ecec51[AgentCase.AGENT_URI.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f1443x29ecec51[AgentCase.AGENT_CONTENT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f1443x29ecec51[AgentCase.AGENT_NOT_SET.ordinal()] = 3;

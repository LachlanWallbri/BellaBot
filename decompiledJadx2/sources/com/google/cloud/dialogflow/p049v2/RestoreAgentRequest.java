...
public final class RestoreAgentRequest extends GeneratedMessageV3 implements RestoreAgentRequestOrBuilder {
    ...
    private static final Parser<RestoreAgentRequest> PARSER = new AbstractParser<RestoreAgentRequest>() { // from class: com.google.cloud.dialogflow.v2.RestoreAgentRequest.1
    ...
    public static final Descriptors.Descriptor getDescriptor() {
        return AgentProto.f1374x303cd391;
    }

    @Override // com.google.protobuf.GeneratedMessageV3
    protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
        return AgentProto.f1375xb9ebd90f.ensureFieldAccessorsInitialized(RestoreAgentRequest.class, Builder.class);
    }
    ...
    @Override // com.google.cloud.dialogflow.p049v2.RestoreAgentRequestOrBuilder
    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements RestoreAgentRequestOrBuilder {
        ...
        public Builder mergeFrom(RestoreAgentRequest restoreAgentRequest) {
            ...
            int i = C22802.f1531xbfc89eb8[restoreAgentRequest.getAgentCase().ordinal()];
            if (i == 1) {
                this.agentCase_ = 2;
     ...
     */
    /* renamed from: com.google.cloud.dialogflow.v2.RestoreAgentRequest$2 */
    /* loaded from: classes2.dex */
    public static /* synthetic */ class C22802 {

        /* renamed from: $SwitchMap$com$google$cloud$dialogflow$v2$RestoreAgentRequest$AgentCase */
        static final /* synthetic */ int[] f1531xbfc89eb8 = new int[AgentCase.values().length];

        static {
            try {
                f1531xbfc89eb8[AgentCase.AGENT_URI.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f1531xbfc89eb8[AgentCase.AGENT_CONTENT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f1531xbfc89eb8[AgentCase.AGENT_NOT_SET.ordinal()] = 3;

...
public class GrpcEntityTypesStub extends EntityTypesStub {
    ...
    private static final MethodDescriptor<BatchDeleteEntityTypesRequest, Operation> batchDeleteEntityTypesMethodDescriptor = MethodDescriptor.newBuilder().setType(MethodDescriptor.MethodType.UNARY).setFullMethodName("google.cloud.dialogflow.v2beta1.EntityTypes/BatchDeleteEntityTypes").setRequestMarshaller(ProtoUtils.marshaller(BatchDeleteEntityTypesRequest.getDefaultInstance())).setResponseMarshaller(ProtoUtils.marshaller(Operation.getDefaultInstance())).build();
    private static final MethodDescriptor<BatchCreateEntitiesRequest, Operation> batchCreateEntitiesMethodDescriptor = MethodDescriptor.newBuilder().setType(MethodDescriptor.MethodType.UNARY).setFullMethodName("google.cloud.dialogflow.v2beta1.EntityTypes/BatchCreateEntities").setRequestMarshaller(ProtoUtils.marshaller(BatchCreateEntitiesRequest.getDefaultInstance())).setResponseMarshaller(ProtoUtils.marshaller(Operation.getDefaultInstance())).build();
    private static final MethodDescriptor<BatchUpdateEntitiesRequest, Operation> batchUpdateEntitiesMethodDescriptor = MethodDescriptor.newBuilder().setType(MethodDescriptor.MethodType.UNARY).setFullMethodName("google.cloud.dialogflow.v2beta1.EntityTypes/BatchUpdateEntities").setRequestMarshaller(ProtoUtils.marshaller(BatchUpdateEntitiesRequest.getDefaultInstance())).setResponseMarshaller(ProtoUtils.marshaller(Operation.getDefaultInstance())).build();
    private static final MethodDescriptor<BatchDeleteEntitiesRequest, Operation> batchDeleteEntitiesMethodDescriptor = MethodDescriptor.newBuilder().setType(MethodDescriptor.MethodType.UNARY).setFullMethodName("google.cloud.dialogflow.v2beta1.EntityTypes/BatchDeleteEntities").setRequestMarshaller(ProtoUtils.marshaller(BatchDeleteEntitiesRequest.getDefaultInstance())).setResponseMarshaller(ProtoUtils.marshaller(Operation.getDefaultInstance())).build();
    ...
    protected GrpcEntityTypesStub(EntityTypesStubSettings entityTypesStubSettings, ClientContext clientContext, GrpcStubCallableFactory grpcStubCallableFactory) throws IOException {
        ...
        GrpcCallSettings build = GrpcCallSettings.newBuilder().setMethodDescriptor(listEntityTypesMethodDescriptor).setParamsExtractor(new RequestParamsExtractor<ListEntityTypesRequest>() { // from class: com.google.cloud.dialogflow.v2beta1.stub.GrpcEntityTypesStub.1
        ...
        GrpcCallSettings build2 = GrpcCallSettings.newBuilder().setMethodDescriptor(getEntityTypeMethodDescriptor).setParamsExtractor(new RequestParamsExtractor<GetEntityTypeRequest>() { // from class: com.google.cloud.dialogflow.v2beta1.stub.GrpcEntityTypesStub.2
            @Override // com.google.api.gax.rpc.RequestParamsExtractor
        ...
        GrpcCallSettings build3 = GrpcCallSettings.newBuilder().setMethodDescriptor(createEntityTypeMethodDescriptor).setParamsExtractor(new RequestParamsExtractor<CreateEntityTypeRequest>() { // from class: com.google.cloud.dialogflow.v2beta1.stub.GrpcEntityTypesStub.3
            @Override // com.google.api.gax.rpc.RequestParamsExtractor
        ...
        GrpcCallSettings build4 = GrpcCallSettings.newBuilder().setMethodDescriptor(updateEntityTypeMethodDescriptor).setParamsExtractor(new RequestParamsExtractor<UpdateEntityTypeRequest>() { // from class: com.google.cloud.dialogflow.v2beta1.stub.GrpcEntityTypesStub.4
            @Override // com.google.api.gax.rpc.RequestParamsExtractor
        ...
        GrpcCallSettings build5 = GrpcCallSettings.newBuilder().setMethodDescriptor(deleteEntityTypeMethodDescriptor).setParamsExtractor(new RequestParamsExtractor<DeleteEntityTypeRequest>() { // from class: com.google.cloud.dialogflow.v2beta1.stub.GrpcEntityTypesStub.5
            @Override // com.google.api.gax.rpc.RequestParamsExtractor
        ...
        GrpcCallSettings build6 = GrpcCallSettings.newBuilder().setMethodDescriptor(batchUpdateEntityTypesMethodDescriptor).setParamsExtractor(new RequestParamsExtractor<BatchUpdateEntityTypesRequest>() { // from class: com.google.cloud.dialogflow.v2beta1.stub.GrpcEntityTypesStub.6
            @Override // com.google.api.gax.rpc.RequestParamsExtractor
        ...
        GrpcCallSettings build7 = GrpcCallSettings.newBuilder().setMethodDescriptor(batchDeleteEntityTypesMethodDescriptor).setParamsExtractor(new RequestParamsExtractor<BatchDeleteEntityTypesRequest>() { // from class: com.google.cloud.dialogflow.v2beta1.stub.GrpcEntityTypesStub.7
            @Override // com.google.api.gax.rpc.RequestParamsExtractor
        ...
        GrpcCallSettings build8 = GrpcCallSettings.newBuilder().setMethodDescriptor(batchCreateEntitiesMethodDescriptor).setParamsExtractor(new RequestParamsExtractor<BatchCreateEntitiesRequest>() { // from class: com.google.cloud.dialogflow.v2beta1.stub.GrpcEntityTypesStub.8
            @Override // com.google.api.gax.rpc.RequestParamsExtractor
        ...
        GrpcCallSettings build9 = GrpcCallSettings.newBuilder().setMethodDescriptor(batchUpdateEntitiesMethodDescriptor).setParamsExtractor(new RequestParamsExtractor<BatchUpdateEntitiesRequest>() { // from class: com.google.cloud.dialogflow.v2beta1.stub.GrpcEntityTypesStub.9
            @Override // com.google.api.gax.rpc.RequestParamsExtractor
        ...
        GrpcCallSettings build10 = GrpcCallSettings.newBuilder().setMethodDescriptor(batchDeleteEntitiesMethodDescriptor).setParamsExtractor(new RequestParamsExtractor<BatchDeleteEntitiesRequest>() { // from class: com.google.cloud.dialogflow.v2beta1.stub.GrpcEntityTypesStub.10
            @Override // com.google.api.gax.rpc.RequestParamsExtractor

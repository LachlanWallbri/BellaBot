...
public class GrpcContextsStub extends ContextsStub {
    ...
    private static final MethodDescriptor<ListContextsRequest, ListContextsResponse> listContextsMethodDescriptor = MethodDescriptor.newBuilder().setType(MethodDescriptor.MethodType.UNARY).setFullMethodName("google.cloud.dialogflow.v2beta1.Contexts/ListContexts").setRequestMarshaller(ProtoUtils.marshaller(ListContextsRequest.getDefaultInstance())).setResponseMarshaller(ProtoUtils.marshaller(ListContextsResponse.getDefaultInstance())).build();
    private static final MethodDescriptor<GetContextRequest, Context> getContextMethodDescriptor = MethodDescriptor.newBuilder().setType(MethodDescriptor.MethodType.UNARY).setFullMethodName("google.cloud.dialogflow.v2beta1.Contexts/GetContext").setRequestMarshaller(ProtoUtils.marshaller(GetContextRequest.getDefaultInstance())).setResponseMarshaller(ProtoUtils.marshaller(Context.getDefaultInstance())).build();
    private static final MethodDescriptor<CreateContextRequest, Context> createContextMethodDescriptor = MethodDescriptor.newBuilder().setType(MethodDescriptor.MethodType.UNARY).setFullMethodName("google.cloud.dialogflow.v2beta1.Contexts/CreateContext").setRequestMarshaller(ProtoUtils.marshaller(CreateContextRequest.getDefaultInstance())).setResponseMarshaller(ProtoUtils.marshaller(Context.getDefaultInstance())).build();
    private static final MethodDescriptor<UpdateContextRequest, Context> updateContextMethodDescriptor = MethodDescriptor.newBuilder().setType(MethodDescriptor.MethodType.UNARY).setFullMethodName("google.cloud.dialogflow.v2beta1.Contexts/UpdateContext").setRequestMarshaller(ProtoUtils.marshaller(UpdateContextRequest.getDefaultInstance())).setResponseMarshaller(ProtoUtils.marshaller(Context.getDefaultInstance())).build();
    private static final MethodDescriptor<DeleteContextRequest, Empty> deleteContextMethodDescriptor = MethodDescriptor.newBuilder().setType(MethodDescriptor.MethodType.UNARY).setFullMethodName("google.cloud.dialogflow.v2beta1.Contexts/DeleteContext").setRequestMarshaller(ProtoUtils.marshaller(DeleteContextRequest.getDefaultInstance())).setResponseMarshaller(ProtoUtils.marshaller(Empty.getDefaultInstance())).build();
    private static final MethodDescriptor<DeleteAllContextsRequest, Empty> deleteAllContextsMethodDescriptor = MethodDescriptor.newBuilder().setType(MethodDescriptor.MethodType.UNARY).setFullMethodName("google.cloud.dialogflow.v2beta1.Contexts/DeleteAllContexts").setRequestMarshaller(ProtoUtils.marshaller(DeleteAllContextsRequest.getDefaultInstance())).setResponseMarshaller(ProtoUtils.marshaller(Empty.getDefaultInstance())).build();
    ...
    /* JADX WARN: Type inference failed for: r1v1, types: [com.google.cloud.dialogflow.v2beta1.stub.ContextsStubSettings] */
    ...
    protected GrpcContextsStub(ContextsStubSettings contextsStubSettings, ClientContext clientContext, GrpcStubCallableFactory grpcStubCallableFactory) throws IOException {
        ...
        GrpcCallSettings build = GrpcCallSettings.newBuilder().setMethodDescriptor(listContextsMethodDescriptor).setParamsExtractor(new RequestParamsExtractor<ListContextsRequest>() { // from class: com.google.cloud.dialogflow.v2beta1.stub.GrpcContextsStub.1
        ...
        GrpcCallSettings build2 = GrpcCallSettings.newBuilder().setMethodDescriptor(getContextMethodDescriptor).setParamsExtractor(new RequestParamsExtractor<GetContextRequest>() { // from class: com.google.cloud.dialogflow.v2beta1.stub.GrpcContextsStub.2
            @Override // com.google.api.gax.rpc.RequestParamsExtractor
        ...
        GrpcCallSettings build3 = GrpcCallSettings.newBuilder().setMethodDescriptor(createContextMethodDescriptor).setParamsExtractor(new RequestParamsExtractor<CreateContextRequest>() { // from class: com.google.cloud.dialogflow.v2beta1.stub.GrpcContextsStub.3
            @Override // com.google.api.gax.rpc.RequestParamsExtractor
        ...
        GrpcCallSettings build4 = GrpcCallSettings.newBuilder().setMethodDescriptor(updateContextMethodDescriptor).setParamsExtractor(new RequestParamsExtractor<UpdateContextRequest>() { // from class: com.google.cloud.dialogflow.v2beta1.stub.GrpcContextsStub.4
            @Override // com.google.api.gax.rpc.RequestParamsExtractor
        ...
        GrpcCallSettings build5 = GrpcCallSettings.newBuilder().setMethodDescriptor(deleteContextMethodDescriptor).setParamsExtractor(new RequestParamsExtractor<DeleteContextRequest>() { // from class: com.google.cloud.dialogflow.v2beta1.stub.GrpcContextsStub.5
            @Override // com.google.api.gax.rpc.RequestParamsExtractor
        ...
        GrpcCallSettings build6 = GrpcCallSettings.newBuilder().setMethodDescriptor(deleteAllContextsMethodDescriptor).setParamsExtractor(new RequestParamsExtractor<DeleteAllContextsRequest>() { // from class: com.google.cloud.dialogflow.v2beta1.stub.GrpcContextsStub.6
            @Override // com.google.api.gax.rpc.RequestParamsExtractor
    ...
    @Override // com.google.cloud.dialogflow.v2beta1.stub.ContextsStub
    ...
    @Override // com.google.cloud.dialogflow.v2beta1.stub.ContextsStub, java.lang.AutoCloseable

...
public final class QueryInput extends GeneratedMessageV3 implements QueryInputOrBuilder {
    ...
    public static final Descriptors.Descriptor getDescriptor() {
        return SessionProto.f1846x57840f0a;
    }

    @Override // com.google.protobuf.GeneratedMessageV3
    protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
        return SessionProto.f1847x84208b88.ensureFieldAccessorsInitialized(QueryInput.class, Builder.class);
    }
    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements QueryInputOrBuilder {
        ...
        public Builder mergeFrom(QueryInput queryInput) {
            ...
            int i = C25262.f1819xb473a2ce[queryInput.getInputCase().ordinal()];
            if (i == 1) {
     ...
     */
    /* renamed from: com.google.cloud.dialogflow.v2beta1.QueryInput$2 */
    /* loaded from: classes3.dex */
    public static /* synthetic */ class C25262 {

        /* renamed from: $SwitchMap$com$google$cloud$dialogflow$v2beta1$QueryInput$InputCase */
        static final /* synthetic */ int[] f1819xb473a2ce = new int[InputCase.values().length];

        static {
            try {
                f1819xb473a2ce[InputCase.AUDIO_CONFIG.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f1819xb473a2ce[InputCase.TEXT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f1819xb473a2ce[InputCase.EVENT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f1819xb473a2ce[InputCase.INPUT_NOT_SET.ordinal()] = 4;

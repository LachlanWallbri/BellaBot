...
public final class QueryResult extends GeneratedMessageV3 implements QueryResultOrBuilder {
            ...
            try {
                try {
                    ...
                    switch (readTag) {
                        ...
                        case 146:
                            KnowledgeAnswers.Builder builder6 = this.knowledgeAnswers_ != null ? this.knowledgeAnswers_.toBuilder() : null;
                            this.knowledgeAnswers_ = (KnowledgeAnswers) codedInputStream.readMessage(KnowledgeAnswers.parser(), extensionRegistryLite);
                            if (builder6 != null) {
                                builder6.mergeFrom(this.knowledgeAnswers_);
                                this.knowledgeAnswers_ = builder6.buildPartial();
                            }
                        default:
    ...
    public static final Descriptors.Descriptor getDescriptor() {
        return SessionProto.f1852x36effd8b;
    }

    @Override // com.google.protobuf.GeneratedMessageV3
    protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
        return SessionProto.f1853x1e3a6909.ensureFieldAccessorsInitialized(QueryResult.class, Builder.class);
    }
    ...
    public KnowledgeAnswers getKnowledgeAnswers() {
        KnowledgeAnswers knowledgeAnswers = this.knowledgeAnswers_;
        return knowledgeAnswers == null ? KnowledgeAnswers.getDefaultInstance() : knowledgeAnswers;
    }
    ...
    public int getSerializedSize() {
        ...
        if (this.knowledgeAnswers_ != null) {
            i2 += CodedOutputStream.computeMessageSize(18, getKnowledgeAnswers());
        }
    ...
    public boolean equals(Object obj) {
        ...
        if ((!hasSentimentAnalysisResult() || getSentimentAnalysisResult().equals(queryResult.getSentimentAnalysisResult())) && hasKnowledgeAnswers() == queryResult.hasKnowledgeAnswers()) {
            return (!hasKnowledgeAnswers() || getKnowledgeAnswers().equals(queryResult.getKnowledgeAnswers())) && this.unknownFields.equals(queryResult.unknownFields);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        if (hasKnowledgeAnswers()) {
            floatToIntBits = (((floatToIntBits * 37) + 18) * 53) + getKnowledgeAnswers().hashCode();
        }
    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements QueryResultOrBuilder {
        ...
        public QueryResult buildPartial() {
            ...
            SingleFieldBuilderV3<KnowledgeAnswers, KnowledgeAnswers.Builder, KnowledgeAnswersOrBuilder> singleFieldBuilderV36 = this.knowledgeAnswersBuilder_;
            if (singleFieldBuilderV36 == null) {
                queryResult.knowledgeAnswers_ = this.knowledgeAnswers_;
            } else {
                queryResult.knowledgeAnswers_ = singleFieldBuilderV36.build();
            }
            onBuilt();
            return queryResult;
        }
        ...
        */
        ...
        @Override // com.google.cloud.dialogflow.v2beta1.QueryResultOrBuilder
        public KnowledgeAnswers getKnowledgeAnswers() {
            SingleFieldBuilderV3<KnowledgeAnswers, KnowledgeAnswers.Builder, KnowledgeAnswersOrBuilder> singleFieldBuilderV3 = this.knowledgeAnswersBuilder_;
            if (singleFieldBuilderV3 == null) {
                KnowledgeAnswers knowledgeAnswers = this.knowledgeAnswers_;
                return knowledgeAnswers == null ? KnowledgeAnswers.getDefaultInstance() : knowledgeAnswers;
            }
        ...
        public Builder setKnowledgeAnswers(KnowledgeAnswers knowledgeAnswers) {
            SingleFieldBuilderV3<KnowledgeAnswers, KnowledgeAnswers.Builder, KnowledgeAnswersOrBuilder> singleFieldBuilderV3 = this.knowledgeAnswersBuilder_;
            if (singleFieldBuilderV3 != null) {
                singleFieldBuilderV3.setMessage(knowledgeAnswers);
            } else {
        ...
        public Builder setKnowledgeAnswers(KnowledgeAnswers.Builder builder) {
            SingleFieldBuilderV3<KnowledgeAnswers, KnowledgeAnswers.Builder, KnowledgeAnswersOrBuilder> singleFieldBuilderV3 = this.knowledgeAnswersBuilder_;
            if (singleFieldBuilderV3 == null) {
                this.knowledgeAnswers_ = builder.build();
                onChanged();
            } else {
                singleFieldBuilderV3.setMessage(builder.build());
            }
        ...
        public Builder mergeKnowledgeAnswers(KnowledgeAnswers knowledgeAnswers) {
            SingleFieldBuilderV3<KnowledgeAnswers, KnowledgeAnswers.Builder, KnowledgeAnswersOrBuilder> singleFieldBuilderV3 = this.knowledgeAnswersBuilder_;
            if (singleFieldBuilderV3 == null) {
                KnowledgeAnswers knowledgeAnswers2 = this.knowledgeAnswers_;
                if (knowledgeAnswers2 != null) {
                    this.knowledgeAnswers_ = KnowledgeAnswers.newBuilder(knowledgeAnswers2).mergeFrom(knowledgeAnswers).buildPartial();
                } else {
                    this.knowledgeAnswers_ = knowledgeAnswers;
                }
                onChanged();
            } else {
                singleFieldBuilderV3.mergeFrom(knowledgeAnswers);
            }
            return this;
        }

...
public final class BatchUpdateIntentsRequest extends GeneratedMessageV3 implements BatchUpdateIntentsRequestOrBuilder {
    ...
    private static final Parser<BatchUpdateIntentsRequest> PARSER = new AbstractParser<BatchUpdateIntentsRequest>() { // from class: com.google.cloud.dialogflow.v2beta1.BatchUpdateIntentsRequest.1
    ...
    public static final Descriptors.Descriptor getDescriptor() {
        return IntentProto.f1693x50eb1a95;
    }

    @Override // com.google.protobuf.GeneratedMessageV3
    protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
        return IntentProto.f1694x9874dc13.ensureFieldAccessorsInitialized(BatchUpdateIntentsRequest.class, Builder.class);
    }
    ...
    @Override // com.google.cloud.dialogflow.v2beta1.BatchUpdateIntentsRequestOrBuilder
    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements BatchUpdateIntentsRequestOrBuilder {
        ...
        public Builder mergeFrom(BatchUpdateIntentsRequest batchUpdateIntentsRequest) {
            ...
            int i = C23782.f1616x85a12aef[batchUpdateIntentsRequest.getIntentBatchCase().ordinal()];
            if (i == 1) {
                this.intentBatchCase_ = 2;
     ...
     */
    /* renamed from: com.google.cloud.dialogflow.v2beta1.BatchUpdateIntentsRequest$2 */
    /* loaded from: classes3.dex */
    public static /* synthetic */ class C23782 {

        /* renamed from: $SwitchMap$com$google$cloud$dialogflow$v2beta1$BatchUpdateIntentsRequest$IntentBatchCase */
        static final /* synthetic */ int[] f1616x85a12aef = new int[IntentBatchCase.values().length];

        static {
            try {
                f1616x85a12aef[IntentBatchCase.INTENT_BATCH_URI.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f1616x85a12aef[IntentBatchCase.INTENT_BATCH_INLINE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f1616x85a12aef[IntentBatchCase.INTENTBATCH_NOT_SET.ordinal()] = 3;

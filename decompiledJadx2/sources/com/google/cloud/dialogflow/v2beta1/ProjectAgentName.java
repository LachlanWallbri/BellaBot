...
public class ProjectAgentName implements ResourceName {
    ...
    /* renamed from: of */
    public static ProjectAgentName m598of(String str) {
    ...
    public static ProjectAgentName parse(String str) {
        ...
        return m598of(PATH_TEMPLATE.validatedMatch(str, "ProjectAgentName.parse: formattedString not in valid format").get("project"));
    }

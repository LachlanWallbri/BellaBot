...
public final class Context extends GeneratedMessageV3 implements ContextOrBuilder {
    ...
    private static final Parser<Context> PARSER = new AbstractParser<Context>() { // from class: com.google.cloud.dialogflow.v2beta1.Context.1
    ...
    public static final Descriptors.Descriptor getDescriptor() {
        return ContextProto.f1617x691591a1;
    }

    @Override // com.google.protobuf.GeneratedMessageV3
    protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
        return ContextProto.f1618xa96d871f.ensureFieldAccessorsInitialized(Context.class, Builder.class);
    }

    @Override // com.google.cloud.dialogflow.v2beta1.ContextOrBuilder

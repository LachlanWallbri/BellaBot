...
public final class KnowledgeBase extends GeneratedMessageV3 implements KnowledgeBaseOrBuilder {
    ...
    private static final Parser<KnowledgeBase> PARSER = new AbstractParser<KnowledgeBase>() { // from class: com.google.cloud.dialogflow.v2beta1.KnowledgeBase.1
    ...
    public static final Descriptors.Descriptor getDescriptor() {
        return KnowledgeBaseProto.f1811x57225961;
    }

    @Override // com.google.protobuf.GeneratedMessageV3
    protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
        return KnowledgeBaseProto.f1812x31168edf.ensureFieldAccessorsInitialized(KnowledgeBase.class, Builder.class);
    }

    @Override // com.google.cloud.dialogflow.v2beta1.KnowledgeBaseOrBuilder
    ...
    public boolean equals(Object obj) {
        ...
        return getName().equals(knowledgeBase.getName()) && getDisplayName().equals(knowledgeBase.getDisplayName()) && getLanguageCode().equals(knowledgeBase.getLanguageCode()) && this.unknownFields.equals(knowledgeBase.unknownFields);
    }
    ...
    public int hashCode() {
        ...
        int hashCode = ((((((((((((((779 + getDescriptor().hashCode()) * 37) + 1) * 53) + getName().hashCode()) * 37) + 2) * 53) + getDisplayName().hashCode()) * 37) + 4) * 53) + getLanguageCode().hashCode()) * 29) + this.unknownFields.hashCode();
    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements KnowledgeBaseOrBuilder {
        ...
        private void maybeForceBuilderInitialization() {
            boolean unused = KnowledgeBase.alwaysUseFieldBuilders;
        }
        ...
        public KnowledgeBase buildPartial() {
            ...
            knowledgeBase.displayName_ = this.displayName_;
            knowledgeBase.languageCode_ = this.languageCode_;
            onBuilt();
        ...
        public Builder mergeFrom(KnowledgeBase knowledgeBase) {
            ...
            if (!knowledgeBase.getDisplayName().isEmpty()) {
                this.displayName_ = knowledgeBase.displayName_;
                onChanged();
            }
            if (!knowledgeBase.getLanguageCode().isEmpty()) {
                this.languageCode_ = knowledgeBase.languageCode_;
                onChanged();
            }
        ...
        */
        public Builder mergeFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException {
            ...
            try {
                try {
                    KnowledgeBase knowledgeBase2 = (KnowledgeBase) KnowledgeBase.PARSER.parsePartialFrom(codedInputStream, extensionRegistryLite);
                    if (knowledgeBase2 != null) {
                        mergeFrom(knowledgeBase2);
                    }
                    return this;
                } catch (InvalidProtocolBufferException e) {
                    KnowledgeBase knowledgeBase3 = (KnowledgeBase) e.getUnfinishedMessage();
                    try {
        ...
        public Builder clearDisplayName() {
            this.displayName_ = KnowledgeBase.getDefaultInstance().getDisplayName();
            onChanged();
            return this;
        }
        ...
        public Builder clearLanguageCode() {
            this.languageCode_ = KnowledgeBase.getDefaultInstance().getLanguageCode();
            onChanged();
            return this;
        }

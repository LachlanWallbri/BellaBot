...
public final class WebhookResponse extends GeneratedMessageV3 implements WebhookResponseOrBuilder {
    ...
    private static final Parser<WebhookResponse> PARSER = new AbstractParser<WebhookResponse>() { // from class: com.google.cloud.dialogflow.v2beta1.WebhookResponse.1
    ...
    public static final Descriptors.Descriptor getDescriptor() {
        return WebhookProto.f1876x4ef639d8;
    }

    @Override // com.google.protobuf.GeneratedMessageV3
    protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
        return WebhookProto.f1877x72da0856.ensureFieldAccessorsInitialized(WebhookResponse.class, Builder.class);
    }

    @Override // com.google.cloud.dialogflow.v2beta1.WebhookResponseOrBuilder
    ...
    public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
        ...
        boolean z = this.endInteraction_;
        if (z) {
    ...
    public boolean equals(Object obj) {
        ...
        if ((!hasPayload() || getPayload().equals(webhookResponse.getPayload())) && getOutputContextsList().equals(webhookResponse.getOutputContextsList()) && hasFollowupEventInput() == webhookResponse.hasFollowupEventInput()) {
            return (!hasFollowupEventInput() || getFollowupEventInput().equals(webhookResponse.getFollowupEventInput())) && getEndInteraction() == webhookResponse.getEndInteraction() && getSessionEntityTypesList().equals(webhookResponse.getSessionEntityTypesList()) && this.unknownFields.equals(webhookResponse.unknownFields);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int hashBoolean = (((hashCode2 * 37) + 8) * 53) + Internal.hashBoolean(getEndInteraction());
        if (getSessionEntityTypesCount() > 0) {
            hashBoolean = (((hashBoolean * 37) + 10) * 53) + getSessionEntityTypesList().hashCode();
        }
    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements WebhookResponseOrBuilder {
        ...
        public WebhookResponse buildPartial() {
            ...
            webhookResponse.endInteraction_ = this.endInteraction_;
            RepeatedFieldBuilderV3<SessionEntityType, SessionEntityType.Builder, SessionEntityTypeOrBuilder> repeatedFieldBuilderV33 = this.sessionEntityTypesBuilder_;
            if (repeatedFieldBuilderV33 != null) {
        ...
        public Builder mergeFrom(WebhookResponse webhookResponse) {
            ...
            if (webhookResponse.getEndInteraction()) {
                setEndInteraction(webhookResponse.getEndInteraction());
            }

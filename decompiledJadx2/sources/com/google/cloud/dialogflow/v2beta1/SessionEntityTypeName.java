...
public class SessionEntityTypeName implements ResourceName {
    ...
    /* renamed from: of */
    public static SessionEntityTypeName m600of(String str, String str2, String str3) {
    ...
    public static SessionEntityTypeName parse(String str) {
        ...
        return m600of(validatedMatch.get("project"), validatedMatch.get("session"), validatedMatch.get("entity_type"));
    }

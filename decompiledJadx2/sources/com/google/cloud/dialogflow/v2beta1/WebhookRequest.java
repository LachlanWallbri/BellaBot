...
import com.google.cloud.dialogflow.v2beta1.OriginalDetectIntentRequest;
...
public final class WebhookRequest extends GeneratedMessageV3 implements WebhookRequestOrBuilder {
    ...
    private static final Parser<WebhookRequest> PARSER = new AbstractParser<WebhookRequest>() { // from class: com.google.cloud.dialogflow.v2beta1.WebhookRequest.1
    ...
    public static final Descriptors.Descriptor getDescriptor() {
        return WebhookProto.f1874x2b678e14;
    }

    @Override // com.google.protobuf.GeneratedMessageV3
    protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
        return WebhookProto.f1875x82c16092.ensureFieldAccessorsInitialized(WebhookRequest.class, Builder.class);
    }

    @Override // com.google.cloud.dialogflow.v2beta1.WebhookRequestOrBuilder
    ...
    public boolean equals(Object obj) {
        ...
        if ((!hasQueryResult() || getQueryResult().equals(webhookRequest.getQueryResult())) && getAlternativeQueryResultsList().equals(webhookRequest.getAlternativeQueryResultsList()) && hasOriginalDetectIntentRequest() == webhookRequest.hasOriginalDetectIntentRequest()) {
    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements WebhookRequestOrBuilder {
        ...
        public WebhookRequest buildPartial() {
            ...
            RepeatedFieldBuilderV3<QueryResult, QueryResult.Builder, QueryResultOrBuilder> repeatedFieldBuilderV3 = this.alternativeQueryResultsBuilder_;
            if (repeatedFieldBuilderV3 != null) {
                webhookRequest.alternativeQueryResults_ = repeatedFieldBuilderV3.build();
            } else {
                if ((this.bitField0_ & 1) != 0) {
                    this.alternativeQueryResults_ = Collections.unmodifiableList(this.alternativeQueryResults_);
                    this.bitField0_ &= -2;
                }
                webhookRequest.alternativeQueryResults_ = this.alternativeQueryResults_;
            }
        ...
        public Builder mergeFrom(WebhookRequest webhookRequest) {
            ...
            if (this.alternativeQueryResultsBuilder_ == null) {
                if (!webhookRequest.alternativeQueryResults_.isEmpty()) {
                    if (this.alternativeQueryResults_.isEmpty()) {
                        this.alternativeQueryResults_ = webhookRequest.alternativeQueryResults_;
                        this.bitField0_ &= -2;
                    } else {
                        ensureAlternativeQueryResultsIsMutable();
                        this.alternativeQueryResults_.addAll(webhookRequest.alternativeQueryResults_);
                    }
                    onChanged();
                }
            } else if (!webhookRequest.alternativeQueryResults_.isEmpty()) {
                if (!this.alternativeQueryResultsBuilder_.isEmpty()) {
                    this.alternativeQueryResultsBuilder_.addAllMessages(webhookRequest.alternativeQueryResults_);
                } else {
                    this.alternativeQueryResultsBuilder_.dispose();
                    this.alternativeQueryResultsBuilder_ = null;
                    this.alternativeQueryResults_ = webhookRequest.alternativeQueryResults_;
                    this.bitField0_ &= -2;
                    this.alternativeQueryResultsBuilder_ = WebhookRequest.alwaysUseFieldBuilders ? getAlternativeQueryResultsFieldBuilder() : null;
                }
            }

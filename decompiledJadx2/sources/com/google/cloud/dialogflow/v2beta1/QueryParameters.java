...
import com.google.cloud.dialogflow.v2beta1.SubAgent;
...
public final class QueryParameters extends GeneratedMessageV3 implements QueryParametersOrBuilder {
    ...
    private List<SubAgent> subAgents_;
    ...
    private QueryParameters() {
        ...
        this.subAgents_ = Collections.emptyList();
    }
    ...
    private QueryParameters(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
        ...
        while (!z) {
            try {
                try {
                    ...
                    switch (readTag) {
                        ...
                        case 98:
                            ...
                            this.knowledgeBaseNames_.add(readStringRequireUtf8);
                        case 106:
                            int i4 = (c == true ? 1 : 0) & 8;
                            c = c;
                            if (i4 == 0) {
                                this.subAgents_ = new ArrayList();
                                c = (c == true ? 1 : 0) | '\b';
                            }
                            this.subAgents_.add(codedInputStream.readMessage(SubAgent.parser(), extensionRegistryLite));
                        case 114:
                            ...
                            MapEntry mapEntry = (MapEntry) codedInputStream.readMessage(WebhookHeadersDefaultEntryHolder.defaultEntry.getParserForType(), extensionRegistryLite);
                            this.webhookHeaders_.getMutableMap().put(mapEntry.getKey(), mapEntry.getValue());
                        default:
                ...
                if (((c == true ? 1 : 0) & 8) != 0) {
                    this.subAgents_ = Collections.unmodifiableList(this.subAgents_);
                }
    ...
    public static final Descriptors.Descriptor getDescriptor() {
        return SessionProto.f1850x6aaee49e;
    }
    ...
    protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
        return SessionProto.f1851x75368d1c.ensureFieldAccessorsInitialized(QueryParameters.class, Builder.class);
    }
    ...
    @Override // com.google.cloud.dialogflow.v2beta1.QueryParametersOrBuilder
    public String getKnowledgeBaseNames(int i) {
        return (String) this.knowledgeBaseNames_.get(i);
    }

    @Override // com.google.cloud.dialogflow.v2beta1.QueryParametersOrBuilder
    public ByteString getKnowledgeBaseNamesBytes(int i) {
        return this.knowledgeBaseNames_.getByteString(i);
    }
    ...
    public int getSubAgentsCount() {
        return this.subAgents_.size();
    }

    @Override // com.google.cloud.dialogflow.v2beta1.QueryParametersOrBuilder
    public SubAgent getSubAgents(int i) {
        return this.subAgents_.get(i);
    }

    @Override // com.google.cloud.dialogflow.v2beta1.QueryParametersOrBuilder
    public SubAgentOrBuilder getSubAgentsOrBuilder(int i) {
        return this.subAgents_.get(i);
    }
    ...
    public static final class WebhookHeadersDefaultEntryHolder {
        static final MapEntry<String, String> defaultEntry = MapEntry.newDefaultInstance(SessionProto.f1848xc3b2685a, WireFormat.FieldType.STRING, "", WireFormat.FieldType.STRING, "");
    ...
    public MapField<String, String> internalGetWebhookHeaders() {
        MapField<String, String> mapField = this.webhookHeaders_;
        return mapField == null ? MapField.emptyMapField(WebhookHeadersDefaultEntryHolder.defaultEntry) : mapField;
    }
    ...
    public String getWebhookHeadersOrDefault(String str, String str2) {
        ...
        Map<String, String> map = internalGetWebhookHeaders().getMap();
    ...
    public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
        ...
        for (int i3 = 0; i3 < this.knowledgeBaseNames_.size(); i3++) {
            GeneratedMessageV3.writeString(codedOutputStream, 12, this.knowledgeBaseNames_.getRaw(i3));
        }
        for (int i4 = 0; i4 < this.subAgents_.size(); i4++) {
            codedOutputStream.writeMessage(13, this.subAgents_.get(i4));
        }
        GeneratedMessageV3.serializeStringMapTo(codedOutputStream, internalGetWebhookHeaders(), WebhookHeadersDefaultEntryHolder.defaultEntry, 14);
    ...
    public int getSerializedSize() {
        ...
        int i5 = 0;
        for (int i6 = 0; i6 < this.knowledgeBaseNames_.size(); i6++) {
            i5 += computeStringSizeNoTag(this.knowledgeBaseNames_.getRaw(i6));
        }
        int size = i2 + i5 + (getKnowledgeBaseNamesList().size() * 1);
        for (int i7 = 0; i7 < this.subAgents_.size(); i7++) {
            size += CodedOutputStream.computeMessageSize(13, this.subAgents_.get(i7));
        }
        for (Map.Entry<String, String> entry : internalGetWebhookHeaders().getMap().entrySet()) {
            size += CodedOutputStream.computeMessageSize(14, WebhookHeadersDefaultEntryHolder.defaultEntry.newBuilderForType().setKey(entry.getKey()).setValue(entry.getValue()).build());
        }
    ...
    public boolean equals(Object obj) {
        ...
        if ((!hasPayload() || getPayload().equals(queryParameters.getPayload())) && getKnowledgeBaseNamesList().equals(queryParameters.getKnowledgeBaseNamesList()) && hasSentimentAnalysisRequestConfig() == queryParameters.hasSentimentAnalysisRequestConfig()) {
            return (!hasSentimentAnalysisRequestConfig() || getSentimentAnalysisRequestConfig().equals(queryParameters.getSentimentAnalysisRequestConfig())) && getSubAgentsList().equals(queryParameters.getSubAgentsList()) && internalGetWebhookHeaders().equals(queryParameters.internalGetWebhookHeaders()) && this.unknownFields.equals(queryParameters.unknownFields);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        if (getKnowledgeBaseNamesCount() > 0) {
            hashBoolean = (((hashBoolean * 37) + 12) * 53) + getKnowledgeBaseNamesList().hashCode();
        }
        ...
        if (getSubAgentsCount() > 0) {
            hashBoolean = (((hashBoolean * 37) + 13) * 53) + getSubAgentsList().hashCode();
        }
        if (!internalGetWebhookHeaders().getMap().isEmpty()) {
            hashBoolean = (((hashBoolean * 37) + 14) * 53) + internalGetWebhookHeaders().hashCode();
        }
    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements QueryParametersOrBuilder {
        ...
        private List<SessionEntityType> sessionEntityTypes_;
        private RepeatedFieldBuilderV3<SubAgent, SubAgent.Builder, SubAgentOrBuilder> subAgentsBuilder_;
        private List<SubAgent> subAgents_;
        ...
        public Builder clear() {
            ...
            RepeatedFieldBuilderV3<SubAgent, SubAgent.Builder, SubAgentOrBuilder> repeatedFieldBuilderV33 = this.subAgentsBuilder_;
        ...
        public QueryParameters buildPartial() {
            ...
            RepeatedFieldBuilderV3<SubAgent, SubAgent.Builder, SubAgentOrBuilder> repeatedFieldBuilderV33 = this.subAgentsBuilder_;
            if (repeatedFieldBuilderV33 != null) {
                queryParameters.subAgents_ = repeatedFieldBuilderV33.build();
            } else {
                if ((this.bitField0_ & 8) != 0) {
                    this.subAgents_ = Collections.unmodifiableList(this.subAgents_);
                    this.bitField0_ &= -9;
                }
                queryParameters.subAgents_ = this.subAgents_;
            }
        ...
        public Builder mergeFrom(QueryParameters queryParameters) {
            ...
            if (this.subAgentsBuilder_ == null) {
                if (!queryParameters.subAgents_.isEmpty()) {
                    if (this.subAgents_.isEmpty()) {
                        this.subAgents_ = queryParameters.subAgents_;
                        this.bitField0_ &= -9;
                    } else {
                        ensureSubAgentsIsMutable();
                        this.subAgents_.addAll(queryParameters.subAgents_);
                    }
                    onChanged();
                }
            } else if (!queryParameters.subAgents_.isEmpty()) {
                if (!this.subAgentsBuilder_.isEmpty()) {
                    this.subAgentsBuilder_.addAllMessages(queryParameters.subAgents_);
                } else {
                    this.subAgentsBuilder_.dispose();
                    this.subAgentsBuilder_ = null;
                    this.subAgents_ = queryParameters.subAgents_;
                    this.bitField0_ &= -9;
                    this.subAgentsBuilder_ = QueryParameters.alwaysUseFieldBuilders ? getSubAgentsFieldBuilder() : null;
                }
            }
        ...
        */
        ...
        public Builder setKnowledgeBaseNames(int i, String str) {
            if (str == null) {
                throw new NullPointerException();
            }
            ensureKnowledgeBaseNamesIsMutable();
            this.knowledgeBaseNames_.set(i, str);
            onChanged();
            return this;
        }
        ...
        public Builder addKnowledgeBaseNames(String str) {
            ...
            ensureKnowledgeBaseNamesIsMutable();
            this.knowledgeBaseNames_.add(str);
            onChanged();
            return this;
        }
        ...
        private void ensureSubAgentsIsMutable() {
            if ((this.bitField0_ & 8) == 0) {
                this.subAgents_ = new ArrayList(this.subAgents_);
                this.bitField0_ |= 8;
            }
        }
        ...
        @Override // com.google.cloud.dialogflow.v2beta1.QueryParametersOrBuilder
        public List<SubAgent> getSubAgentsList() {
            RepeatedFieldBuilderV3<SubAgent, SubAgent.Builder, SubAgentOrBuilder> repeatedFieldBuilderV3 = this.subAgentsBuilder_;
            if (repeatedFieldBuilderV3 == null) {
                return Collections.unmodifiableList(this.subAgents_);
            }
            return repeatedFieldBuilderV3.getMessageList();
        }
        ...
        public Builder setSubAgents(int i, SubAgent subAgent) {
            RepeatedFieldBuilderV3<SubAgent, SubAgent.Builder, SubAgentOrBuilder> repeatedFieldBuilderV3 = this.subAgentsBuilder_;
            if (repeatedFieldBuilderV3 != null) {
                repeatedFieldBuilderV3.setMessage(i, subAgent);
            } else {
                if (subAgent == null) {
                    throw new NullPointerException();
                }
                ensureSubAgentsIsMutable();
                this.subAgents_.set(i, subAgent);
                onChanged();
            }
            return this;
        }

        public Builder setSubAgents(int i, SubAgent.Builder builder) {
            RepeatedFieldBuilderV3<SubAgent, SubAgent.Builder, SubAgentOrBuilder> repeatedFieldBuilderV3 = this.subAgentsBuilder_;
            if (repeatedFieldBuilderV3 == null) {
                ensureSubAgentsIsMutable();
                this.subAgents_.set(i, builder.build());
                onChanged();
            } else {
                repeatedFieldBuilderV3.setMessage(i, builder.build());
            }
        ...
        public Builder addSubAgents(SubAgent subAgent) {
            RepeatedFieldBuilderV3<SubAgent, SubAgent.Builder, SubAgentOrBuilder> repeatedFieldBuilderV3 = this.subAgentsBuilder_;
            if (repeatedFieldBuilderV3 != null) {
                repeatedFieldBuilderV3.addMessage(subAgent);
            } else {
                if (subAgent == null) {
                    throw new NullPointerException();
                }
                ensureSubAgentsIsMutable();
                this.subAgents_.add(subAgent);
                onChanged();
            }
            return this;
        }

        public Builder addSubAgents(int i, SubAgent subAgent) {
            RepeatedFieldBuilderV3<SubAgent, SubAgent.Builder, SubAgentOrBuilder> repeatedFieldBuilderV3 = this.subAgentsBuilder_;
            if (repeatedFieldBuilderV3 != null) {
                repeatedFieldBuilderV3.addMessage(i, subAgent);
            } else {
                if (subAgent == null) {
                    throw new NullPointerException();
                }
                ensureSubAgentsIsMutable();
                this.subAgents_.add(i, subAgent);
                onChanged();
            }
            return this;
        }

        public Builder addSubAgents(SubAgent.Builder builder) {
            RepeatedFieldBuilderV3<SubAgent, SubAgent.Builder, SubAgentOrBuilder> repeatedFieldBuilderV3 = this.subAgentsBuilder_;
            if (repeatedFieldBuilderV3 == null) {
                ensureSubAgentsIsMutable();
                this.subAgents_.add(builder.build());
                onChanged();
            } else {
                repeatedFieldBuilderV3.addMessage(builder.build());
            }
        ...
        public Builder addSubAgents(int i, SubAgent.Builder builder) {
            RepeatedFieldBuilderV3<SubAgent, SubAgent.Builder, SubAgentOrBuilder> repeatedFieldBuilderV3 = this.subAgentsBuilder_;
            if (repeatedFieldBuilderV3 == null) {
                ensureSubAgentsIsMutable();
                this.subAgents_.add(i, builder.build());
                onChanged();
            } else {
                repeatedFieldBuilderV3.addMessage(i, builder.build());
            }
        ...
        public Builder addAllSubAgents(Iterable<? extends SubAgent> iterable) {
            RepeatedFieldBuilderV3<SubAgent, SubAgent.Builder, SubAgentOrBuilder> repeatedFieldBuilderV3 = this.subAgentsBuilder_;
            if (repeatedFieldBuilderV3 == null) {
                ensureSubAgentsIsMutable();
                AbstractMessageLite.Builder.addAll((Iterable) iterable, (List) this.subAgents_);
                onChanged();
            } else {
                repeatedFieldBuilderV3.addAllMessages(iterable);
            }
        ...
        public Builder removeSubAgents(int i) {
            RepeatedFieldBuilderV3<SubAgent, SubAgent.Builder, SubAgentOrBuilder> repeatedFieldBuilderV3 = this.subAgentsBuilder_;
            if (repeatedFieldBuilderV3 == null) {
                ensureSubAgentsIsMutable();
                this.subAgents_.remove(i);
                onChanged();
            } else {
                repeatedFieldBuilderV3.remove(i);
            }
        ...
        public SubAgent.Builder getSubAgentsBuilder(int i) {
            return getSubAgentsFieldBuilder().getBuilder(i);
        }
        ...
        public SubAgent.Builder addSubAgentsBuilder() {
            return getSubAgentsFieldBuilder().addBuilder(SubAgent.getDefaultInstance());
        }

        public SubAgent.Builder addSubAgentsBuilder(int i) {
            return getSubAgentsFieldBuilder().addBuilder(i, SubAgent.getDefaultInstance());
        }
        ...
        private RepeatedFieldBuilderV3<SubAgent, SubAgent.Builder, SubAgentOrBuilder> getSubAgentsFieldBuilder() {
            if (this.subAgentsBuilder_ == null) {
                this.subAgentsBuilder_ = new RepeatedFieldBuilderV3<>(this.subAgents_, (this.bitField0_ & 8) != 0, getParentForChildren(), isClean());
                this.subAgents_ = null;
            }
            return this.subAgentsBuilder_;
        }

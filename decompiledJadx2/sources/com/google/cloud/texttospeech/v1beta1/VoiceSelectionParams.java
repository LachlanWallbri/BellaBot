...
public final class VoiceSelectionParams extends GeneratedMessageV3 implements VoiceSelectionParamsOrBuilder {
    ...
    private static final Parser<VoiceSelectionParams> PARSER = new AbstractParser<VoiceSelectionParams>() { // from class: com.google.cloud.texttospeech.v1beta1.VoiceSelectionParams.1
    ...
    public static final Descriptors.Descriptor getDescriptor() {
        return TextToSpeechProto.f1909x256ca001;
    }

    @Override // com.google.protobuf.GeneratedMessageV3
    protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
        return TextToSpeechProto.f1910x7680357f.ensureFieldAccessorsInitialized(VoiceSelectionParams.class, Builder.class);
    }

    @Override // com.google.cloud.texttospeech.v1beta1.VoiceSelectionParamsOrBuilder

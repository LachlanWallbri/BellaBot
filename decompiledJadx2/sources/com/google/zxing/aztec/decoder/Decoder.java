...
public final class Decoder {
    ...
    private static final String[] LOWER_TABLE = {"CTRL_PS", " ", "a", "b", "c", LinkFormat.DOMAIN, C3898x.f4338g, C3898x.f4339h, C3898x.f4336e, "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u", "v", "w", "x", "y", CompressorStreamFactory.f8930Z, "CTRL_US", "CTRL_ML", "CTRL_DL", "CTRL_BS"};
    private static final String[] MIXED_TABLE = {"CTRL_PS", " ", "\u0001", "\u0002", "\u0003", "\u0004", "\u0005", "\u0006", "\u0007", "\b", "\t", "\n", "\u000b", "\f", "\r", "\u001b", "\u001c", "\u001d", "\u001e", "\u001f", "@", "\\", "^", "_", "`", "|", "~", "\u007f", "CTRL_LL", "CTRL_UL", "CTRL_PL", "CTRL_BS"};
    private static final String[] PUNCT_TABLE = {"", "\r", IOUtils.LINE_SEPARATOR_WINDOWS, ". ", ", ", ": ", "!", "\"", MqttTopic.MULTI_LEVEL_WILDCARD, "$", "%", "&", "'", "(", ")", "*", "+", ",", "-", ".", "/", ":", VoiceWakeuperAidl.PARAMS_SEPARATE, "<", "=", ">", "?", "[", "]", "{", "}", "CTRL_UL"};
    private static final String[] DIGIT_TABLE = {"CTRL_PS", " ", "0", "1", "2", "3", TmpConstant.MODEL_TYPE_ALI_LCA_CLOUD, "5", "6", "7", "8", "9", ",", ".", "CTRL_UL", "CTRL_US"};
    ...
    /* loaded from: classes.dex */
    public static /* synthetic */ class C35091 {
    ...
    private static String getCharacter(Table table, int i) {
        int i2 = C35091.$SwitchMap$com$google$zxing$aztec$decoder$Decoder$Table[table.ordinal()];
        if (i2 == 1) {

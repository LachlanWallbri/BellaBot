...
public final class Detector {
    ...
    private void extractParameters(ResultPoint[] resultPointArr) throws NotFoundException {
        ...
        if (this.compact) {
            ...
            this.nbDataBlocks = (correctedParameterData & MapFilePathConfig.MAX_DELETE_CODE_VALUE) + 1;
        }
    }
    ...
    public static final class Point {
        ...
        public String toString() {
            return "<" + this.f2100x + ' ' + this.f2101y + Typography.greater;
        }
    }
}

...
public class ClockHandView extends View {
    ...
    public ClockHandView(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1653R.styleable.ClockHandView, i, 0);
        this.circleRadius = obtainStyledAttributes.getDimensionPixelSize(C1653R.styleable.ClockHandView_materialCircleRadius, 0);
        this.selectorRadius = obtainStyledAttributes.getDimensionPixelSize(C1653R.styleable.ClockHandView_selectorSize, 0);
        this.selectorStrokeWidth = getResources().getDimensionPixelSize(C1653R.dimen.material_clock_hand_stroke_width);
        this.centerDotRadius = r5.getDimensionPixelSize(C1653R.dimen.material_clock_hand_center_dot_radius);
        int color = MaterialColors.getColor(this, C1653R.attr.colorPrimary);

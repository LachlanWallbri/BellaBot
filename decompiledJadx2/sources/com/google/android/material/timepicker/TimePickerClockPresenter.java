...
class TimePickerClockPresenter implements ClockHandView.OnRotateListener, TimePickerView.OnSelectionChange, TimePickerView.OnPeriodChangeListener, ClockHandView.OnActionUpListener, TimePickerPresenter {
    ...
    private static final String[] HOUR_CLOCK_VALUES = {"12", "1", "2", "3", TmpConstant.MODEL_TYPE_ALI_LCA_CLOUD, "5", "6", "7", "8", "9", "10", "11"};
    private static final String[] HOUR_CLOCK_24_VALUES = {"00", "2", TmpConstant.MODEL_TYPE_ALI_LCA_CLOUD, "6", "8", "10", "12", "14", "16", "18", "20", "22"};
    ...
    void setSelection(int i, boolean z) {
        ...
        this.timePickerView.setValues(z2 ? MINUTE_CLOCK_VALUES : getHourClockValues(), z2 ? C1653R.string.material_minute_suffix : C1653R.string.material_hour_suffix);
        ...
        timePickerView.setMinuteHourDelegate(new ClickActionDelegate(timePickerView.getContext(), C1653R.string.material_hour_selection));
        TimePickerView timePickerView2 = this.timePickerView;
        timePickerView2.setHourClickDelegate(new ClickActionDelegate(timePickerView2.getContext(), C1653R.string.material_minute_selection));
    }

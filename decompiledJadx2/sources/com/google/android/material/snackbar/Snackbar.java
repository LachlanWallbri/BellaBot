...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    private static final int[] SNACKBAR_BUTTON_STYLE_ATTR = {C1653R.attr.snackbarButtonStyle};
    private static final int[] SNACKBAR_CONTENT_STYLE_ATTRS = {C1653R.attr.snackbarButtonStyle, C1653R.attr.snackbarTextViewStyle};
    ...
    public static Snackbar make(View view, CharSequence charSequence, int i) {
        ...
        SnackbarContentLayout snackbarContentLayout = (SnackbarContentLayout) LayoutInflater.from(findSuitableParent.getContext()).inflate(hasSnackbarContentStyleAttrs(findSuitableParent.getContext()) ? C1653R.layout.mtrl_layout_snackbar_include : C1653R.layout.design_layout_snackbar_include, findSuitableParent, false);

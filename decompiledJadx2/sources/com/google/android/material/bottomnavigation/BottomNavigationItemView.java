...
public class BottomNavigationItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(context).inflate(C1653R.layout.design_bottom_navigation_item, (ViewGroup) this, true);
        setBackgroundResource(C1653R.drawable.design_bottom_navigation_item_background);
        this.defaultMargin = resources.getDimensionPixelSize(C1653R.dimen.design_bottom_navigation_margin);
        this.icon = (ImageView) findViewById(C1653R.id.icon);
        this.smallLabel = (TextView) findViewById(C1653R.id.smallLabel);
        this.largeLabel = (TextView) findViewById(C1653R.id.largeLabel);

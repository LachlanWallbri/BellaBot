...
public class DropdownMenuEndIconDelegate extends EndIconDelegate {
    ...
    public DropdownMenuEndIconDelegate(TextInputLayout textInputLayout) {
        ...
        this.endIconChangedListener = new TextInputLayout.OnEndIconChangedListener() { // from class: com.google.android.material.textfield.DropdownMenuEndIconDelegate.5
            ...
            class AnonymousClass1 implements Runnable {
                ...
                @Override // java.lang.Runnable
                public void run() {
                    this.val$editText.removeTextChangedListener(DropdownMenuEndIconDelegate.this.accessibilityDelegate);
                }
            }
        };
    ...
    public void initialize() {
        float dimensionPixelOffset = this.context.getResources().getDimensionPixelOffset(C1653R.dimen.mtrl_shape_corner_size_small_component);
        float dimensionPixelOffset2 = this.context.getResources().getDimensionPixelOffset(C1653R.dimen.mtrl_exposed_dropdown_menu_popup_elevation);
        int dimensionPixelOffset3 = this.context.getResources().getDimensionPixelOffset(C1653R.dimen.mtrl_exposed_dropdown_menu_popup_vertical_padding);
        ...
        this.textInputLayout.setEndIconDrawable(AppCompatResources.getDrawable(this.context, IS_LOLLIPOP ? C1653R.drawable.mtrl_dropdown_arrow : C1653R.drawable.mtrl_ic_arrow_drop_down));
        this.textInputLayout.setEndIconContentDescription(this.textInputLayout.getResources().getText(C1653R.string.exposed_dropdown_menu_content_description));
    ...
    public void addRippleEffect(AutoCompleteTextView autoCompleteTextView) {
        ...
        int color = MaterialColors.getColor(autoCompleteTextView, C1653R.attr.colorControlHighlight);
    ...
    private void addRippleEffectOnOutlinedLayout(AutoCompleteTextView autoCompleteTextView, int i, int[][] iArr, MaterialShapeDrawable materialShapeDrawable) {
        ...
        int color = MaterialColors.getColor(autoCompleteTextView, C1653R.attr.colorSurface);

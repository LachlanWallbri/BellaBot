...
public class ProgressIndicator extends ProgressBar {
    ...
    protected static final int DEF_STYLE_RES = C1653R.style.Widget_MaterialComponents_ProgressIndicator_Linear_Determinate;
    ...
    public ProgressIndicator(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1653R.attr.progressIndicatorStyle);
    }
    ...
    private void loadExtraAttributes(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        if (obtainStyledAttributes.hasValue(C1653R.styleable.ProgressIndicator_minHideDelay)) {
            this.minHideDelay = Math.min(obtainStyledAttributes.getInt(C1653R.styleable.ProgressIndicator_minHideDelay, -1), 1000);
        }
    ...
    public void setIndicatorWidth(int i) {
        if (this.spec.indicatorWidth != i) {
            this.spec.indicatorWidth = i;
            requestLayout();
        }
    }
    ...
    public void setIndicatorCornerRadius(int i) {
        if (this.spec.indicatorCornerRadius != i) {
            ...
            progressIndicatorSpec.indicatorCornerRadius = Math.min(i, progressIndicatorSpec.indicatorWidth / 2);

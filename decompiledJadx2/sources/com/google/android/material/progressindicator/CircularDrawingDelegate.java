...
public final class CircularDrawingDelegate implements DrawingDelegate {
    ...
    private static int getSize(ProgressIndicatorSpec progressIndicatorSpec) {
        return (progressIndicatorSpec.circularRadius * 2) + progressIndicatorSpec.indicatorWidth + (progressIndicatorSpec.circularInset * 2);
    }

    @Override // com.google.android.material.progressindicator.DrawingDelegate
    public void adjustCanvas(Canvas canvas, ProgressIndicatorSpec progressIndicatorSpec, float f) {
        int i = progressIndicatorSpec.circularRadius + (progressIndicatorSpec.indicatorWidth / 2) + progressIndicatorSpec.circularInset;
        float f2 = i;
        ...
        if (progressIndicatorSpec.growMode == 1) {
            f3 += ((1.0f - f) * progressIndicatorSpec.indicatorWidth) / 2.0f;

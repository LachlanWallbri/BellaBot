...
class FadeModeEvaluators {
    ...
    /* renamed from: IN */
    private static final FadeModeEvaluator f1306IN = new FadeModeEvaluator() { // from class: com.google.android.material.transition.FadeModeEvaluators.1
    ...
    public static FadeModeEvaluator get(int i, boolean z) {
        if (i == 0) {
            return z ? f1306IN : OUT;
        }
        if (i == 1) {
            return z ? OUT : f1306IN;
        }
        if (i == 2) {
            return CROSS;
        }

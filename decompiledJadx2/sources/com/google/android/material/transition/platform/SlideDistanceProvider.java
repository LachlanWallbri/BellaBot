...
public final class SlideDistanceProvider implements VisibilityAnimatorProvider {
    ...
    static class C19491 extends AnimatorListenerAdapter {
        final /* synthetic */ float val$originalTranslation;
        final /* synthetic */ View val$view;

        C19491(View view, float f) {
            this.val$view = view;
    ...
    /* loaded from: classes2.dex */
    static class C19502 extends AnimatorListenerAdapter {
        final /* synthetic */ float val$originalTranslation;
        final /* synthetic */ View val$view;

        C19502(View view, float f) {
            this.val$view = view;
            this.val$originalTranslation = f;
        }

    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements TimestampOrBuilder {
        ...
        */
        public Builder mergeFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException {
            ...
            try {
                try {
                    Timestamp timestamp2 = (Timestamp) Timestamp.PARSER.parsePartialFrom(codedInputStream, extensionRegistryLite);
                    if (timestamp2 != null) {
                        mergeFrom(timestamp2);
                    }
                    return this;
                } catch (InvalidProtocolBufferException e) {
                    Timestamp timestamp3 = (Timestamp) e.getUnfinishedMessage();
                    try {

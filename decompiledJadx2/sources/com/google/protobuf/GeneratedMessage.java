...
public abstract class GeneratedMessage extends AbstractMessage implements Serializable {
    ...
    public static abstract class ExtendableBuilder<MessageType extends ExtendableMessage, BuilderType extends ExtendableBuilder<MessageType, BuilderType>> extends Builder<BuilderType> implements ExtendableMessageOrBuilder<MessageType> {
        ...
        /* renamed from: clone */
        public BuilderType mo4275clone() {
            return (BuilderType) super.mo4275clone();
        }
    ...
    public static class GeneratedExtension<ContainingType extends Message, Type> extends Extension<ContainingType, Type> {
        ...
        protected Object singularFromReflectionType(Object obj) {
            int i = C33795.f2049xdde82548[getDescriptor().getJavaType().ordinal()];
        ...
        protected Object singularToReflectionType(Object obj) {
            return C33795.f2049xdde82548[getDescriptor().getJavaType().ordinal()] != 2 ? obj : GeneratedMessage.invokeOrDie(this.enumGetValueDescriptor, obj, new Object[0]);
        }
    ...
    public static /* synthetic */ class C33795 {
        ...
        static {
            ...
            try {
                f2049xdde82548[Descriptors.FieldDescriptor.JavaType.ENUM.ordinal()] = 2;
    ...
    public static final class FieldAccessorTable {
        ...
        public static class SingularFieldAccessor implements FieldAccessor {
            ...
            SingularFieldAccessor(Descriptors.FieldDescriptor fieldDescriptor, String str, Class<? extends GeneratedMessage> cls, Class<? extends Builder> cls2, String str2) {
                ...
                this.getMethod = GeneratedMessage.getMethodOrDie(cls, TmpConstant.PROPERTY_IDENTIFIER_GET + str, new Class[0]);
                this.getMethodBuilder = GeneratedMessage.getMethodOrDie(cls2, TmpConstant.PROPERTY_IDENTIFIER_GET + str, new Class[0]);
                this.type = this.getMethod.getReturnType();
                this.setMethod = GeneratedMessage.getMethodOrDie(cls2, TmpConstant.PROPERTY_IDENTIFIER_SET + str, this.type);
                ...
                if (this.isOneofField) {
                    method3 = GeneratedMessage.getMethodOrDie(cls, TmpConstant.PROPERTY_IDENTIFIER_GET + str2 + "Case", new Class[0]);
                } else {
                    method3 = null;
                }
                this.caseMethod = method3;
                if (this.isOneofField) {
                    method4 = GeneratedMessage.getMethodOrDie(cls2, TmpConstant.PROPERTY_IDENTIFIER_GET + str2 + "Case", new Class[0]);
                }
        ...
        public static class RepeatedFieldAccessor implements FieldAccessor {
            ...
            RepeatedFieldAccessor(Descriptors.FieldDescriptor fieldDescriptor, String str, Class<? extends GeneratedMessage> cls, Class<? extends Builder> cls2) {
                this.getMethod = GeneratedMessage.getMethodOrDie(cls, TmpConstant.PROPERTY_IDENTIFIER_GET + str + "List", new Class[0]);
                this.getMethodBuilder = GeneratedMessage.getMethodOrDie(cls2, TmpConstant.PROPERTY_IDENTIFIER_GET + str + "List", new Class[0]);
                StringBuilder sb = new StringBuilder();
                ...
                this.getRepeatedMethodBuilder = GeneratedMessage.getMethodOrDie(cls2, TmpConstant.PROPERTY_IDENTIFIER_GET + str, Integer.TYPE);
                this.type = this.getRepeatedMethod.getReturnType();
                this.setRepeatedMethod = GeneratedMessage.getMethodOrDie(cls2, TmpConstant.PROPERTY_IDENTIFIER_SET + str, Integer.TYPE, this.type);
                this.addRepeatedMethod = GeneratedMessage.getMethodOrDie(cls2, TmpConstant.GROUP_OP_ADD + str, this.type);
                this.getCountMethod = GeneratedMessage.getMethodOrDie(cls, TmpConstant.PROPERTY_IDENTIFIER_GET + str + "Count", new Class[0]);
                this.getCountMethodBuilder = GeneratedMessage.getMethodOrDie(cls2, TmpConstant.PROPERTY_IDENTIFIER_GET + str + "Count", new Class[0]);
        ...
        public static final class RepeatedEnumFieldAccessor extends RepeatedFieldAccessor {
            ...
            RepeatedEnumFieldAccessor(Descriptors.FieldDescriptor fieldDescriptor, String str, Class<? extends GeneratedMessage> cls, Class<? extends Builder> cls2) {
                ...
                this.supportUnknownEnumValue = supportsUnknownEnumValue;
                if (supportsUnknownEnumValue) {
                    this.getRepeatedValueMethod = GeneratedMessage.getMethodOrDie(cls, TmpConstant.PROPERTY_IDENTIFIER_GET + str + "Value", Integer.TYPE);
                    this.getRepeatedValueMethodBuilder = GeneratedMessage.getMethodOrDie(cls2, TmpConstant.PROPERTY_IDENTIFIER_GET + str + "Value", Integer.TYPE);
                    this.setRepeatedValueMethod = GeneratedMessage.getMethodOrDie(cls2, TmpConstant.PROPERTY_IDENTIFIER_SET + str + "Value", Integer.TYPE, Integer.TYPE);
                    this.addRepeatedValueMethod = GeneratedMessage.getMethodOrDie(cls2, TmpConstant.GROUP_OP_ADD + str + "Value", Integer.TYPE);
                }
            }

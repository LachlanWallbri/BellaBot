...
public final class QuotaFailure extends GeneratedMessageV3 implements QuotaFailureOrBuilder {
    ...
    public static final class Violation extends GeneratedMessageV3 implements ViolationOrBuilder {
        ...
        @Override // com.google.protobuf.GeneratedMessageV3
        protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
            return ErrorDetailsProto.f2065x11d2cec3.ensureFieldAccessorsInitialized(Violation.class, Builder.class);
        }
    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements QuotaFailureOrBuilder {
        ...
        */
        public Builder mergeFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException {
            ...
            try {
                try {
                    QuotaFailure quotaFailure2 = (QuotaFailure) QuotaFailure.PARSER.parsePartialFrom(codedInputStream, extensionRegistryLite);
                    if (quotaFailure2 != null) {
                        mergeFrom(quotaFailure2);
                    }
                    return this;
                } catch (InvalidProtocolBufferException e) {
                    QuotaFailure quotaFailure3 = (QuotaFailure) e.getUnfinishedMessage();
                    try {
                        throw e.unwrapIOException();
                    } catch (Throwable th) {
                        th = th;
                        quotaFailure = quotaFailure3;

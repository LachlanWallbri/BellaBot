...
class JsonUtils {
    private static final JsonReader.Options POINT_NAMES = JsonReader.Options.m82of("x", "y");
    ...
    /* loaded from: classes.dex */
    public static /* synthetic */ class C08001 {
        static final /* synthetic */ int[] $SwitchMap$com$airbnb$lottie$parser$moshi$JsonReader$Token = new int[JsonReader.Token.values().length];
    ...
    public static PointF jsonToPoint(JsonReader jsonReader, float f) throws IOException {
        int i = C08001.$SwitchMap$com$airbnb$lottie$parser$moshi$JsonReader$Token[jsonReader.peek().ordinal()];
        if (i == 1) {
    ...
    public static float valueFromObject(JsonReader jsonReader) throws IOException {
        ...
        int i = C08001.$SwitchMap$com$airbnb$lottie$parser$moshi$JsonReader$Token[peek.ordinal()];
        if (i == 1) {

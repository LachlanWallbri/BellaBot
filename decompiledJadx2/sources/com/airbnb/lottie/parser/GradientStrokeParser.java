...
public class GradientStrokeParser {
    private static JsonReader.Options NAMES = JsonReader.Options.m82of("nm", C3898x.f4336e, "o", "t", "s", C3898x.f4338g, "w", "lc", "lj", "ml", "hd", LinkFormat.DOMAIN);
    private static final JsonReader.Options GRADIENT_NAMES = JsonReader.Options.m82of("p", "k");
    private static final JsonReader.Options DASH_PATTERN_NAMES = JsonReader.Options.m82of("n", "v");
                ...
                case 11:
                    ...
                    while (jsonReader.hasNext()) {
                        ...
                        if (str2.equals("o")) {
                            ...
                            if (str2.equals(LinkFormat.DOMAIN) || str2.equals(C3898x.f4336e)) {

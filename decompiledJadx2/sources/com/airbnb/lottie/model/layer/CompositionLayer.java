...
public class CompositionLayer extends BaseLayer {
        ...
        while (true) {
            ...
            if (forModel != null) {
                ...
                if (baseLayer2 != null) {
                    ...
                    int i2 = C07961.$SwitchMap$com$airbnb$lottie$model$layer$Layer$MatteType[layer2.getMatteType().ordinal()];
                    if (i2 == 1 || i2 == 2) {
                        baseLayer2 = forModel;
                    }
                }
    ...
    void drawLayer(Canvas canvas, Matrix matrix, int i) {
        C0750L.beginSection("CompositionLayer#draw");
        ...
        canvas.restore();
        C0750L.endSection("CompositionLayer#draw");
    }

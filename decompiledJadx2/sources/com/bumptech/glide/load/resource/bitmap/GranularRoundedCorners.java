...
public final class GranularRoundedCorners extends BitmapTransformation {
    ...
    /* renamed from: ID */
    private static final String f1243ID = "com.bumptech.glide.load.resource.bitmap.GranularRoundedCorners";
    private static final byte[] ID_BYTES = f1243ID.getBytes(CHARSET);
    ...
    @Override // com.bumptech.glide.load.Key
    public int hashCode() {
        return Util.hashCode(this.bottomLeft, Util.hashCode(this.bottomRight, Util.hashCode(this.topRight, Util.hashCode(f1243ID.hashCode(), Util.hashCode(this.topLeft)))));
    }

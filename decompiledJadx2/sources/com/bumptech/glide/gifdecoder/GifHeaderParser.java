...
public class GifHeaderParser {
    ...
    private void readBitmap() {
        this.header.currentFrame.f1228ix = readShort();
        this.header.currentFrame.f1229iy = readShort();
        this.header.currentFrame.f1227iw = readShort();
        this.header.currentFrame.f1226ih = readShort();
        int read = read();

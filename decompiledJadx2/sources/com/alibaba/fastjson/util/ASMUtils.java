...
public class ASMUtils {
    ...
    public static String desc(Class<?> cls) {
        ...
        return "L" + type(cls) + VoiceWakeuperAidl.PARAMS_SEPARATE;
    }
    ...
    public static String[] lookupParameterNames(AccessibleObject accessibleObject) {
        ...
        InputStream resourceAsStream = classLoader.getResourceAsStream(declaringClass.getName().replace(FilenameUtils.EXTENSION_SEPARATOR, '/') + ".class");
        try {

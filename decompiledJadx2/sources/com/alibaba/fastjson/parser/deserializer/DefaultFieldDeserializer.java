...
public class DefaultFieldDeserializer extends FieldDeserializer {
    ...
    public void parseField(DefaultJSONParser defaultJSONParser, Object obj, Type type, Map<String, Object> map) {
        ...
        if ((objectDeserializer instanceof JavaBeanDeserializer) && this.fieldInfo.parserFeatures != 0) {
            deserialze = ((JavaBeanDeserializer) objectDeserializer).deserialze(defaultJSONParser, type3, this.fieldInfo.name, this.fieldInfo.parserFeatures);
        } else if (this.fieldInfo.format != null && (objectDeserializer instanceof ContextObjectDeserializer)) {
            deserialze = ((ContextObjectDeserializer) objectDeserializer).deserialze(defaultJSONParser, type3, this.fieldInfo.name, this.fieldInfo.format, this.fieldInfo.parserFeatures);
        } else {

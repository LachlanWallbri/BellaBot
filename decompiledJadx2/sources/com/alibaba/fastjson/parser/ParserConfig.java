...
public class ParserConfig {
    ...
    private ParserConfig(ASMDeserializerFactory aSMDeserializerFactory, ClassLoader classLoader, boolean z) {
        ...
        this.deserializers.put(JSONObject.class, com.alibaba.fastjson.parser.deserializer.MapDeserializer.instance);
        this.deserializers.put(JSONArray.class, CollectionCodec.instance);
        this.deserializers.put(Map.class, com.alibaba.fastjson.parser.deserializer.MapDeserializer.instance);
        this.deserializers.put(HashMap.class, com.alibaba.fastjson.parser.deserializer.MapDeserializer.instance);
        this.deserializers.put(LinkedHashMap.class, com.alibaba.fastjson.parser.deserializer.MapDeserializer.instance);
        this.deserializers.put(TreeMap.class, com.alibaba.fastjson.parser.deserializer.MapDeserializer.instance);
        this.deserializers.put(ConcurrentMap.class, com.alibaba.fastjson.parser.deserializer.MapDeserializer.instance);
        this.deserializers.put(ConcurrentHashMap.class, com.alibaba.fastjson.parser.deserializer.MapDeserializer.instance);
        ...
        this.deserializers.put(Object.class, com.alibaba.fastjson.parser.deserializer.JavaObjectDeserializer.instance);
        ...
        this.deserializers.put(Serializable.class, com.alibaba.fastjson.parser.deserializer.JavaObjectDeserializer.instance);
        this.deserializers.put(Cloneable.class, com.alibaba.fastjson.parser.deserializer.JavaObjectDeserializer.instance);
        this.deserializers.put(Comparable.class, com.alibaba.fastjson.parser.deserializer.JavaObjectDeserializer.instance);
        this.deserializers.put(Closeable.class, com.alibaba.fastjson.parser.deserializer.JavaObjectDeserializer.instance);
    ...
    public ObjectDeserializer getDeserializer(Class<?> cls, Type type) {
        ...
        String replace = cls.getName().replace(Typography.dollar, FilenameUtils.EXTENSION_SEPARATOR);
        int i = 0;
        ...
        if (cls.isEnum()) {
            ...
            objectDeserializer = new com.alibaba.fastjson.parser.deserializer.EnumDeserializer(cls);
        } else if (cls.isArray()) {
            ...
            objectDeserializer = com.alibaba.fastjson.parser.deserializer.MapDeserializer.instance;
        } else if (Throwable.class.isAssignableFrom(cls)) {
            objectDeserializer = new com.alibaba.fastjson.parser.deserializer.ThrowableDeserializer(this, cls);
    ...
    public ObjectDeserializer createJavaBeanDeserializer(Class<?> cls, Type type) {
        ...
        if (z) {
            ...
            if (z) {
                Class<?> builderClass = com.alibaba.fastjson.util.JavaBeanInfo.getBuilderClass(cls, jSONType);
        ...
        if (z) {
            ...
            com.alibaba.fastjson.util.JavaBeanInfo build = com.alibaba.fastjson.util.JavaBeanInfo.build(cls, type, this.propertyNamingStrategy);
            ...
            for (FieldInfo fieldInfo : build.fields) {
                if (!fieldInfo.getOnly) {
                    ...
                    if (Modifier.isPublic(cls2.getModifiers()) && ((!cls2.isMemberClass() || Modifier.isStatic(cls2.getModifiers())) && ((fieldInfo.getMember() == null || ASMUtils.checkName(fieldInfo.getMember().getName())) && (((annotation = fieldInfo.getAnnotation()) == null || (ASMUtils.checkName(annotation.name()) && annotation.format().length() == 0 && annotation.deserializeUsing() == Void.class && !annotation.unwrapped())) && ((fieldInfo.method == null || fieldInfo.method.getParameterTypes().length <= 1) && (!cls2.isEnum() || (getDeserializer(cls2) instanceof com.alibaba.fastjson.parser.deserializer.EnumDeserializer))))))) {
                    }
                }
                z = false;
                break;
        ...
        com.alibaba.fastjson.util.JavaBeanInfo build2 = com.alibaba.fastjson.util.JavaBeanInfo.build(cls, type, this.propertyNamingStrategy);
        try {
            return this.asmFactory.createJavaBeanDeserializer(this, build2);
        } catch (JSONException unused2) {
            return new com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer(this, build2);
    ...
    public FieldDeserializer createFieldDeserializer(ParserConfig parserConfig, com.alibaba.fastjson.util.JavaBeanInfo javaBeanInfo, FieldInfo fieldInfo) {
        ...
        return new com.alibaba.fastjson.parser.deserializer.DefaultFieldDeserializer(parserConfig, cls, fieldInfo);
    }
    ...
    public Class<?> checkAutoType(String str, Class<?> cls) {
        ...
        String replace = str.replace(Typography.dollar, FilenameUtils.EXTENSION_SEPARATOR);
        int i = 0;
            ...
            while (true) {
                ...
                if (i2 >= strArr.length) {
                    ...
                    while (true) {
                        ...
                        if (replace.startsWith(strArr2[i3]) && TypeUtils.getClassFromMapping(str) == null) {
                            throw new JSONException("autoType is not support. " + str);
                        }
                        i3++;
                    }
                } else {
                    if (replace.startsWith(strArr[i2]) && (cls2 = TypeUtils.loadClass(str, this.defaultClassLoader)) != null) {
                        return cls2;
                    }
                    i2++;
                }
                ...
                if (i4 >= strArr3.length) {
                    while (true) {
                        ...
                        if (replace.startsWith(strArr4[i])) {
                            if (cls2 == null) {
                                cls2 = TypeUtils.loadClass(str, this.defaultClassLoader);
                            }
        ...
        if (cls2 != null) {
            ...
            if (com.alibaba.fastjson.util.JavaBeanInfo.build(cls2, cls2, this.propertyNamingStrategy).creatorConstructor != null && this.autoTypeSupport) {
                throw new JSONException("autoType is not support. " + str);
            }
        }
        if (this.autoTypeSupport) {

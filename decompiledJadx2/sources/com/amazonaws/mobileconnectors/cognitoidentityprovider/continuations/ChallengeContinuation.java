        ...
        if (this.runInBackground) {
            new Thread(new Runnable() { // from class: com.amazonaws.mobileconnectors.cognitoidentityprovider.continuations.ChallengeContinuation.1
                ...
                public void run() {
                    ...
                    try {
                        runnable2 = ChallengeContinuation.this.user.respondToChallenge(ChallengeContinuation.this.clientMetaData, respondToAuthChallengeRequest, ChallengeContinuation.this.callback, true);
                    } catch (Exception e) {

...
import com.amazonaws.services.p048s3.AmazonS3EncryptionClient;
...
import com.amazonaws.services.p048s3.internal.crypto.MultipartUploadCryptoContext;
import com.amazonaws.services.p048s3.model.AbortMultipartUploadRequest;
import com.amazonaws.services.p048s3.model.AbstractPutObjectRequest;
...
import com.amazonaws.services.p048s3.model.CryptoStorageMode;
import com.amazonaws.services.p048s3.model.EncryptionMaterials;
import com.amazonaws.services.p048s3.model.EncryptionMaterialsFactory;
...
import com.amazonaws.services.p048s3.model.InstructionFileId;
import com.amazonaws.services.p048s3.model.MaterialsDescriptionProvider;
...
import com.amazonaws.services.p048s3.model.S3DataSource;
import com.amazonaws.services.p048s3.model.S3Object;
import com.amazonaws.services.p048s3.model.S3ObjectId;
...
public abstract class S3CryptoModuleBase<T extends MultipartUploadCryptoContext> extends S3CryptoModule<T> {
    ...
    /* renamed from: s3 */
    protected final S3Direct f1178s3;
    ...
    public S3CryptoModuleBase(AWSKMSClient aWSKMSClient, S3Direct s3Direct, AWSCredentialsProvider aWSCredentialsProvider, EncryptionMaterialsProvider encryptionMaterialsProvider, CryptoConfiguration cryptoConfiguration) {
        ...
        this.f1178s3 = s3Direct;
        this.cryptoConfig = cryptoConfiguration;
        this.cryptoScheme = S3CryptoScheme.from(cryptoConfiguration.getCryptoMode());
    ...
    private PutObjectResult putObjectUsingMetadata(PutObjectRequest putObjectRequest) {
        ...
        try {
            return this.f1178s3.putObject(putObjectRequest2);
        } finally {
    ...
    private PutObjectResult putObjectUsingInstructionFile(PutObjectRequest putObjectRequest) {
        File file = putObjectRequest.getFile();
        InputStream inputStream = putObjectRequest.getInputStream();
        PutObjectRequest withInputStream = putObjectRequest.mo4269clone().withFile((File) null).withInputStream((InputStream) null);
        withInputStream.setKey(withInputStream.getKey() + ".instruction");
        ContentCryptoMaterial createContentCryptoMaterial = createContentCryptoMaterial(putObjectRequest);
        PutObjectRequest putObjectRequest2 = (PutObjectRequest) wrapWithCipher(putObjectRequest, createContentCryptoMaterial);
        try {
            PutObjectResult putObject = this.f1178s3.putObject(putObjectRequest2);
            S3DataSource.Utils.cleanupDataSource(putObjectRequest, file, inputStream, putObjectRequest2.getInputStream(), this.log);
            this.f1178s3.putObject(updateInstructionPutRequest(withInputStream, createContentCryptoMaterial));
            return putObject;
        } catch (Throwable th) {
            S3DataSource.Utils.cleanupDataSource(putObjectRequest, file, inputStream, putObjectRequest2.getInputStream(), this.log);
            throw th;
    ...
    public final void abortMultipartUploadSecurely(AbortMultipartUploadRequest abortMultipartUploadRequest) {
        this.f1178s3.abortMultipartUpload(abortMultipartUploadRequest);
    ...
    public final CopyPartResult copyPartSecurely(CopyPartRequest copyPartRequest) {
        ...
        CopyPartResult copyPart = this.f1178s3.copyPart(copyPartRequest);
    ...
    public InitiateMultipartUploadResult initiateMultipartUploadSecurely(InitiateMultipartUploadRequest initiateMultipartUploadRequest) {
        ...
        InitiateMultipartUploadResult initiateMultipartUpload = this.f1178s3.initiateMultipartUpload(initiateMultipartUploadRequest);
    ...
    public UploadPartResult uploadPartSecurely(UploadPartRequest uploadPartRequest) {
        ...
        try {
            cipherLiteInputStream = newMultipartS3CipherInputStream(uploadPartRequest, cipherLiteForNextPart);
        } catch (Throwable th) {
            th = th;
            cipherLiteInputStream = null;
        }
        try {
            SdkFilterInputStream wrapForMultipart = wrapForMultipart(cipherLiteInputStream, partSize);
            ...
            UploadPartResult uploadPart = this.f1178s3.uploadPart(uploadPartRequest);
    ...
    public CompleteMultipartUploadResult completeMultipartUploadSecurely(CompleteMultipartUploadRequest completeMultipartUploadRequest) {
        ...
        CompleteMultipartUploadResult completeMultipartUpload = this.f1178s3.completeMultipartUpload(completeMultipartUploadRequest);
        if (t != null && this.cryptoConfig.getStorageMode() == CryptoStorageMode.InstructionFile) {
            this.f1178s3.putObject(createInstructionPutRequest(t.getBucketName(), t.getKey(), t.getContentCryptoMaterial()));
        }
    ...
    public final void putLocalObjectSecurely(UploadObjectRequest uploadObjectRequest, String str, OutputStream outputStream) throws IOException {
        UploadObjectRequest mo4269clone = uploadObjectRequest.mo4269clone();
        File file = mo4269clone.getFile();
        InputStream inputStream = mo4269clone.getInputStream();
        T t = this.multipartUploadContexts.get(str);
        UploadObjectRequest uploadObjectRequest2 = (UploadObjectRequest) wrapWithCipher(mo4269clone, t.getContentCryptoMaterial());
        try {
    ...
    public final S3ObjectWrapper fetchInstructionFile(S3ObjectId s3ObjectId, String str) {
        try {
            S3Object object = this.f1178s3.getObject(createInstructionGetRequest(s3ObjectId, str));
            if (object == null) {
                return null;
            }
    ...
    public final PutObjectResult putInstructionFileSecurely(PutInstructionFileRequest putInstructionFileRequest) {
        ...
        S3Object object = this.f1178s3.getObject(getObjectRequest);
        ...
        try {
            ...
            return this.f1178s3.putObject(updateInstructionPutRequest(putInstructionFileRequest.createPutObjectRequest(object), recreate));
        } catch (Error e) {
            IOUtils.closeQuietly(object, this.log);
            throw e;

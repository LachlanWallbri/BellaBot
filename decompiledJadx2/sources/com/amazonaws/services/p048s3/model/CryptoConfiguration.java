...
import com.amazonaws.services.p048s3.internal.crypto.CryptoRuntime;
...
public class CryptoConfiguration implements Cloneable, Serializable {
    ...
    private static final class ReadOnly extends CryptoConfiguration {
        @Override // com.amazonaws.services.p048s3.model.CryptoConfiguration
        public boolean isReadOnly() {
            return true;
        }
        ...
        @Override // com.amazonaws.services.p048s3.model.CryptoConfiguration
        /* renamed from: clone */
        public /* bridge */ /* synthetic */ Object mo4271clone() throws CloneNotSupportedException {
            return super.mo4271clone();
        }
    ...
    public CryptoConfiguration mo4271clone() {

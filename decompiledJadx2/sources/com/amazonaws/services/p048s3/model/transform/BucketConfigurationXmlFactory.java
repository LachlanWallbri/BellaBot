...
import com.amazonaws.services.p048s3.model.CloudFunctionConfiguration;
import com.amazonaws.services.p048s3.model.Filter;
import com.amazonaws.services.p048s3.model.FilterRule;
import com.amazonaws.services.p048s3.model.LambdaConfiguration;
import com.amazonaws.services.p048s3.model.NotificationConfiguration;
import com.amazonaws.services.p048s3.model.QueueConfiguration;
...
import com.amazonaws.services.p048s3.model.S3KeyFilter;
...
import com.amazonaws.services.p048s3.model.analytics.AnalyticsPredicateVisitor;
...
import com.amazonaws.services.p048s3.model.inventory.InventoryFilterPredicate;
...
import com.amazonaws.services.p048s3.model.lifecycle.LifecyclePredicateVisitor;
...
import com.amazonaws.services.p048s3.model.metrics.MetricsPredicateVisitor;
...
public class BucketConfigurationXmlFactory {
    ...
    private void addEventsAndFilterCriteria(XmlWriter xmlWriter, NotificationConfiguration notificationConfiguration) {
        ...
        while (it.hasNext()) {
            xmlWriter.start(MoveError.LEVEL_EVENT).value(it.next()).end();
        }
    ...
    public byte[] convertToXmlByteArray(BucketReplicationConfiguration bucketReplicationConfiguration) {
        ...
        for (Map.Entry<String, ReplicationRule> entry : rules.entrySet()) {
            ...
            xmlWriter.start(HttpHeaders.DESTINATION);
    ...
    public class LifecyclePredicateVisitorImpl implements LifecyclePredicateVisitor {
        ...
        @Override // com.amazonaws.services.p048s3.model.lifecycle.LifecyclePredicateVisitor
    ...
    public class AnalyticsPredicateVisitorImpl implements AnalyticsPredicateVisitor {
        ...
        @Override // com.amazonaws.services.p048s3.model.analytics.AnalyticsPredicateVisitor
    ...
    public class MetricsPredicateVisitorImpl implements MetricsPredicateVisitor {
        ...
        @Override // com.amazonaws.services.p048s3.model.metrics.MetricsPredicateVisitor

...
public class DeleteUserPoolClientRequestMarshaller implements Marshaller<Request<DeleteUserPoolClientRequest>, DeleteUserPoolClientRequest> {
    ...
    public Request<DeleteUserPoolClientRequest> marshall(DeleteUserPoolClientRequest deleteUserPoolClientRequest) {
        ...
        defaultRequest.addHeader("X-Amz-Target", "AWSCognitoIdentityProviderService.DeleteUserPoolClient");
        ...
        try {
            ...
            if (deleteUserPoolClientRequest.getUserPoolId() != null) {
                String userPoolId = deleteUserPoolClientRequest.getUserPoolId();
                jsonWriter.name("UserPoolId");
                jsonWriter.value(userPoolId);
            }
            if (deleteUserPoolClientRequest.getClientId() != null) {
                String clientId = deleteUserPoolClientRequest.getClientId();

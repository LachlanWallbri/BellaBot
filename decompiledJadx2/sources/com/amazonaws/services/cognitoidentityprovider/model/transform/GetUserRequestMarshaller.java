...
public class GetUserRequestMarshaller implements Marshaller<Request<GetUserRequest>, GetUserRequest> {
    ...
    public Request<GetUserRequest> marshall(GetUserRequest getUserRequest) {
        ...
        DefaultRequest defaultRequest = new DefaultRequest(getUserRequest, "AmazonCognitoIdentityProvider");
        defaultRequest.addHeader("X-Amz-Target", "AWSCognitoIdentityProviderService.GetUser");

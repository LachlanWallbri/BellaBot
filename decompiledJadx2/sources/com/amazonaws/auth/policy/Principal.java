...
public class Principal {
    ...
    public Principal(Services services) {
        ...
        this.f1137id = services.getServiceId();
        this.provider = "Service";
    }

    public Principal(String str, String str2) {
        this.provider = str;
        this.f1137id = "AWS".equals(str) ? str2.replaceAll("-", "") : str2;
    }
    ...
    public Principal(WebIdentityProviders webIdentityProviders) {
        ...
        this.f1137id = webIdentityProviders.getWebIdentityProvider();
    ...
    public int hashCode() {
        return ((this.provider.hashCode() + 31) * 31) + this.f1137id.hashCode();
    }

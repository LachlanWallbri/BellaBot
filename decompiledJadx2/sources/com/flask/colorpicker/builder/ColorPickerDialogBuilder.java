...
public class ColorPickerDialogBuilder {
    ...
    private ColorPickerDialogBuilder(Context context, int i) {
        ...
        this.defaultMargin = getDimensionAsPx(context, C1645R.dimen.default_slider_margin);
        int dimensionAsPx = getDimensionAsPx(context, C1645R.dimen.default_slider_margin_btw_title);
    ...
    public AlertDialog build() {
        ...
        if (this.isLightnessSliderEnabled) {
            LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(-1, getDimensionAsPx(context, C1645R.dimen.default_slider_height));
        ...
        if (this.isAlphaSliderEnabled) {
            LinearLayout.LayoutParams layoutParams2 = new LinearLayout.LayoutParams(-1, getDimensionAsPx(context, C1645R.dimen.default_slider_height));
        ...
        if (this.isColorEditEnabled) {
            ...
            EditText editText = (EditText) View.inflate(context, C1645R.layout.picker_edit, null);
        ...
        if (this.isPreviewEnabled) {
            LinearLayout linearLayout = (LinearLayout) View.inflate(context, C1645R.layout.color_preview, null);
            ...
            if (this.initialColor.length != 0) {
                ...
                while (true) {
                    ...
                    LinearLayout linearLayout2 = (LinearLayout) View.inflate(context, C1645R.layout.color_selector, null);
                    ((ImageView) linearLayout2.findViewById(C1645R.id.image_preview)).setImageDrawable(new ColorDrawable(this.initialColor[i].intValue()));
                    this.colorPreview.addView(linearLayout2);
                    i++;
                }
            } else {
                ((ImageView) View.inflate(context, C1645R.layout.color_selector, null)).setImageDrawable(new ColorDrawable(-1));
            }

...
public class Stream<T> implements Closeable {
    ...
    public static <T> Stream<T> empty() {
        return m531of(Collections.emptyList());
    }

    /* renamed from: of */
    public static <K, V> Stream<Map.Entry<K, V>> m533of(Map<K, V> map) {
        Objects.requireNonNull(map);
        return new Stream<>(map.entrySet());
    }

    /* renamed from: of */
    public static <T> Stream<T> m532of(Iterator<? extends T> it) {
        Objects.requireNonNull(it);
        return new Stream<>(it);
    }

    /* renamed from: of */
    public static <T> Stream<T> m531of(Iterable<? extends T> iterable) {
        Objects.requireNonNull(iterable);
        return new Stream<>(iterable);
    }

    /* renamed from: of */
    public static <T> Stream<T> m534of(T... tArr) {
    ...
    public Optional<T> reduce(BiFunction<T, T, T> biFunction) {
        ...
        return z ? Optional.m521of(t) : Optional.empty();
    }
    ...
    public Optional<IntPair<T>> findIndexed(int i, int i2, IndexedPredicate<? super T> indexedPredicate) {
        while (this.iterator.hasNext()) {
            ...
            if (indexedPredicate.test(i, next)) {
                return Optional.m521of(new IntPair(i, next));
            }
            i += i2;
        }
    ...
    public Optional<T> findFirst() {
        if (this.iterator.hasNext()) {
            return Optional.m521of(this.iterator.next());
        }
        return Optional.empty();
    }

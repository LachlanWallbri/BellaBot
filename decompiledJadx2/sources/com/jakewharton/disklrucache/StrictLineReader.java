...
class StrictLineReader implements Closeable {
    ...
    /* renamed from: CR */
    private static final byte f3514CR = 13;

    /* renamed from: LF */
    private static final byte f3515LF = 10;
    private byte[] buf;
    private final Charset charset;
    private int end;

    /* renamed from: in */
    private final InputStream f3516in;
    private int pos;
    ...
    public String readLine() throws IOException {
        ...
        synchronized (this.f3516in) {
            ...
            ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream((this.end - this.pos) + 80) { // from class: com.jakewharton.disklrucache.StrictLineReader.1
    ...
    private void fillBuf() throws IOException {
        InputStream inputStream = this.f3516in;
        byte[] bArr = this.buf;

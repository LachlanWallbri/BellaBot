...
public class AppUtil {
    ...
    public static void startDebugFunction(BaseActivity baseActivity) {
        try {
            CrossProcessTask.INSTANCE.jumpActivity(baseActivity, "com.pudutech.mirsdk", "com.pudutech.mirsdk.activity.MirSDKActivity");

...
public final class KeyboardUtils {
    ...
    public static void showSoftInput(View view, int i) {
        InputMethodManager inputMethodManager = (InputMethodManager) AppContext.context.getSystemService("input_method");
        ...
        view.requestFocus();
        inputMethodManager.showSoftInput(view, i, new ResultReceiver(new Handler()) { // from class: com.pudutech.freeinstall_ui.utils.KeyboardUtils.1
    ...
    public static void registerSoftInputChangedListener(final Window window, final OnSoftInputChangedListener onSoftInputChangedListener) {
        ...
        frameLayout.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: com.pudutech.freeinstall_ui.utils.KeyboardUtils.2
    ...
    public static void fixAndroidBug5497(final Window window) {
        ...
        frameLayout.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: com.pudutech.freeinstall_ui.utils.KeyboardUtils.3
            @Override // android.view.ViewTreeObserver.OnGlobalLayoutListener
            public void onGlobalLayout() {

...
public final class AddTableActivity extends BaseActivity<AddTableViewModel> {
    ...
    private final AddTableActivity$robotPoseListener$1 robotPoseListener = new RobotMoveManager.RobotPoseListener() { // from class: com.pudutech.freeinstall_ui.activity.AddTableActivity$robotPoseListener$1
        ...
        public void onPose(double x, double y, double yaw) {
            ...
            Vector3d vector3d;
            str = AddTableActivity.this.TAG;
            Pdlog.m3273d(str, "x--" + x + "  y--" + y + "  yaw--" + yaw);
            AddTableActivity.this.vector3d = new Vector3d(x, y, yaw);
            Utils.Companion companion = Utils.INSTANCE;
            robotLayer = AddTableActivity.this.robotLayer;
            vector3d = AddTableActivity.this.vector3d;
    ...
    public int layoutId() {
        return C5362R.layout.activity_add_table;
    }
    ...
    private final void initRecycleView() {
        ...
        setLineVisible();
        addTableAdapter.setOnItemClickListener(new Function2<TableListItem, Integer, Unit>() { // from class: com.pudutech.freeinstall_ui.activity.AddTableActivity$initRecycleView$$inlined$apply$lambda$1
            ...
            public final void invoke(TableListItem item, int i) {
                ...
                for (TableListItem tableListItem : list) {
                    ...
                    if (Intrinsics.areEqual(tableListItem, item)) {
                        ...
                        Drawable drawable = this.getDrawable(C5362R.drawable.icon_table_select);
                        ...
                        Drawable drawable2 = this.getDrawable(C5362R.drawable.icon_table_unselect);
        ...
        addTableAdapter.setOnRenameClickListener(new Function2<TableListItem, Integer, Unit>() { // from class: com.pudutech.freeinstall_ui.activity.AddTableActivity$initRecycleView$$inlined$apply$lambda$2
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(2);
            }
            ...
            public final void invoke(TableListItem item, int i) {
                Intrinsics.checkParameterIsNotNull(item, "item");
                AddTableActivity.this.showInputDialog(item, Integer.valueOf(i));
            }
        });
        addTableAdapter.setOnDeleteClickListener(new Function2<TableListItem, Integer, Unit>() { // from class: com.pudutech.freeinstall_ui.activity.AddTableActivity$initRecycleView$$inlined$apply$lambda$3
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(2);
        ...
        addTableAdapter.setOnDeleteSureClickListener(new Function2<TableListItem, Integer, Unit>() { // from class: com.pudutech.freeinstall_ui.activity.AddTableActivity$initRecycleView$$inlined$apply$lambda$4
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(2);
    ...
    public final void showInputDialog(final TableListItem item, final Integer pos) {
        ...
        inputFreeInstallDialog.setOnInputResult(new Function1<String, Unit>() { // from class: com.pudutech.freeinstall_ui.activity.AddTableActivity$showInputDialog$1
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            ...
            public final void invoke2(String it) {
                ...
                if (it.length() == 0) {
                    ...
                    String string3 = AddTableActivity.this.getString(C5362R.string.please_input_name);
                    Intrinsics.checkExpressionValueIsNotNull(string3, "getString(R.string.please_input_name)");
                    toastUtils.showShortToast(string3);
                    return;
                }
                Utils.Companion companion = Utils.INSTANCE;
                list = AddTableActivity.this.tableList;
                if (companion.checkPointNameRepeat(it, Constants.POINT_TYPE_TABLE, list)) {
                    ToastUtils toastUtils2 = ToastUtils.INSTANCE;
                    String string4 = AddTableActivity.this.getString(C5362R.string.name_repeat);
                ...
                if (pos == null) {
                    ...
                    list3 = AddTableActivity.this.tableList;
                    list3.add(new TableListItem(destination, false, false, 4, null));
                    Utils.Companion companion2 = Utils.INSTANCE;
                    pointsLayer2 = AddTableActivity.this.pointsLayer;
                    Drawable drawable = AddTableActivity.this.getDrawable(C5362R.drawable.icon_table_unselect);
                    companion2.addPoint(pointsLayer2, destination, drawable != null ? DrawableKt.toBitmap$default(drawable, 0, 0, null, 7, null) : null);
                } else {
                    Utils.Companion companion3 = Utils.INSTANCE;
                    pointsLayer = AddTableActivity.this.pointsLayer;
    ...
    private final void initListener() {
        ...
        final long j = 800;
        textView.setOnClickListener(new View.OnClickListener() { // from class: com.pudutech.freeinstall_ui.activity.AddTableActivity$initListener$$inlined$singleClick$1
        ...
        textView2.setOnClickListener(new View.OnClickListener() { // from class: com.pudutech.freeinstall_ui.activity.AddTableActivity$initListener$$inlined$singleClick$2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                long currentTimeMillis = System.currentTimeMillis();
        ...
        imageView.setOnClickListener(new View.OnClickListener() { // from class: com.pudutech.freeinstall_ui.activity.AddTableActivity$initListener$$inlined$singleClick$3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                List list;
                List list2;
        ...
        imageView2.setOnClickListener(new View.OnClickListener() { // from class: com.pudutech.freeinstall_ui.activity.AddTableActivity$initListener$$inlined$singleClick$4
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                long currentTimeMillis = System.currentTimeMillis();
        ...
        textView3.setOnClickListener(new View.OnClickListener() { // from class: com.pudutech.freeinstall_ui.activity.AddTableActivity$initListener$$inlined$singleClick$5
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                long currentTimeMillis = System.currentTimeMillis();
    ...
    public final void setFinish() {
        BuildersKt__Builders_commonKt.launch$default(GlobalScope.INSTANCE, null, null, new AddTableActivity$setFinish$1(this, null), 3, null);
    ...
    public void createObserver() {
        ((AddTableViewModel) getMViewModel()).getStaticMapLiveData().observe(this, new AddTableActivity$createObserver$1(this));
    ...
    public final void setRestoreData() {
        ...
        if (addTable == null || addTable.isEmpty()) {
            return;
        }
        this.tableList.addAll(addTable);
        ...
        Utils.Companion companion = Utils.INSTANCE;
        PointsLayer pointsLayer = this.pointsLayer;
        Drawable drawable = getDrawable(C5362R.drawable.icon_table_unselect);

...
@DebugMetadata(m3969c = "com.pudutech.freeinstall_ui.viewmodel.AddDoublePathViewModel$getTopoMap$1", m3970f = "AddDoublePathViewModel.kt", m3971i = {}, m3972l = {}, m3973m = "invokeSuspend", m3974n = {}, m3975s = {})
/* loaded from: classes2.dex */
final class AddDoublePathViewModel$getTopoMap$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;

    /* renamed from: p$ */
    private CoroutineScope f5256p$;
    final /* synthetic */ AddDoublePathViewModel this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AddDoublePathViewModel$getTopoMap$1(AddDoublePathViewModel addDoublePathViewModel, Continuation continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> completion) {
        ...
        AddDoublePathViewModel$getTopoMap$1 addDoublePathViewModel$getTopoMap$1 = new AddDoublePathViewModel$getTopoMap$1(this.this$0, completion);
        addDoublePathViewModel$getTopoMap$1.f5256p$ = (CoroutineScope) obj;
        return addDoublePathViewModel$getTopoMap$1;
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((AddDoublePathViewModel$getTopoMap$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (this.label == 0) {
            ...
            CoroutineScope coroutineScope = this.f5256p$;
            List<TopoTrack> topPath = LocateMappingManager.INSTANCE.getTopPath();
            Pdlog.m3273d(this.this$0.getTAG(), "getTopoMap " + topPath);

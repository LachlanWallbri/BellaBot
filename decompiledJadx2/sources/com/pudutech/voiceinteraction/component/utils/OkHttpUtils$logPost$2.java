...
@DebugMetadata(m3969c = "com.pudutech.voiceinteraction.component.utils.OkHttpUtils$logPost$2", m3970f = "OkHttpUtils.kt", m3971i = {0, 0}, m3972l = {355}, m3973m = "invokeSuspend", m3974n = {"$this$launch", "$this$runCatching"}, m3975s = {"L$0", "L$1"})
/* loaded from: classes7.dex */
final class OkHttpUtils$logPost$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    /* renamed from: p$ */
    private CoroutineScope f7586p$;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OkHttpUtils$logPost$2(OkHttpUtils.LogDataD logDataD, Ref.ObjectRef objectRef, Continuation continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> completion) {
        ...
        OkHttpUtils$logPost$2 okHttpUtils$logPost$2 = new OkHttpUtils$logPost$2(this.$log, this.$aiVoiceService, completion);
        okHttpUtils$logPost$2.f7586p$ = (CoroutineScope) obj;
        return okHttpUtils$logPost$2;
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((OkHttpUtils$logPost$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        try {
            if (i == 0) {
                ...
                CoroutineScope coroutineScope = this.f7586p$;
                ...
                OkHttpUtils.LogDataD logDataD = this.$log;
                this.L$0 = coroutineScope;
                this.L$1 = coroutineScope;
                this.label = 1;
                obj = aiVoiceService.logPost(logDataD, this);

...
public final class ShowRadar3DActivity extends AppCompatActivity {
    ...
    private final Handler.Callback callback = new Handler.Callback() { // from class: com.pudutech.lidar.preview3d.ShowRadar3DActivity$callback$1
    ...
    /* compiled from: ShowRadar3DActivity.kt */
    @Metadata(m3959bv = {1, 0, 3}, m3960d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u001c\u0010\u0003\u001a\u0004\u0018\u00010\u0004X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0005\u0010\u0006\"\u0004\b\u0007\u0010\b¨\u0006\t"}, m3961d2 = {"Lcom/pudutech/lidar/preview3d/ShowRadar3DActivity$Companion;", "", "()V", "lidarAdapter", "Lcom/pudutech/lidar/base/BaseLidarAdapter;", "getLidarAdapter", "()Lcom/pudutech/lidar/base/BaseLidarAdapter;", "setLidarAdapter", "(Lcom/pudutech/lidar/base/BaseLidarAdapter;)V", "LidarLib_mirRelease"}, m3962k = 1, m3963mv = {1, 1, 16})
    /* loaded from: classes5.dex */
    ...
    private final void initView() {
        ...
        ((Button) _$_findCachedViewById(C4705R.id.start_3d_btn)).setOnClickListener(new View.OnClickListener() { // from class: com.pudutech.lidar.preview3d.ShowRadar3DActivity$initView$2
        ...
        ((Button) _$_findCachedViewById(C4705R.id.stop_3d_btn)).setOnClickListener(new View.OnClickListener() { // from class: com.pudutech.lidar.preview3d.ShowRadar3DActivity$initView$3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                BaseLidarAdapter lidarAdapter2 = ShowRadar3DActivity.INSTANCE.getLidarAdapter();
                if (lidarAdapter2 != null) {
        ...
        ((Button) _$_findCachedViewById(C4705R.id.back_3d_btn)).setOnClickListener(new View.OnClickListener() { // from class: com.pudutech.lidar.preview3d.ShowRadar3DActivity$initView$4
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {

package com.pudutech.lidar.rplidar_a2m7;
...
import com.pudutech.lidar.rplidar_a2m7.RPLIDAR_A2M7_PROTOCOL;
...
public class RPLIDAR_A2M7 extends SerialLidar {
    private static final String TAG = "Lidar";
    Thread parseDataThread;
    public static final byte[] COMMAND_START_SCAN = {-91, -126, 5, 3, 0, 0, 0, 0, BinaryMemcacheOpcodes.SASL_AUTH};
    public static final byte[] COMMAND_START_MOTOR = {-91, -16, 2, -108, 2, -63};
    public static final byte[] COMMAND_STOP_MOTOR_SCAN = {-91, -16, 2, 0, 0, 87};
    ...
    private Runnable controlRunnable = new Runnable() { // from class: com.pudutech.lidar.rplidar_a2m7.RPLIDAR_A2M7.1
        @Override // java.lang.Runnable
        public void run() {
            RPLIDAR_A2M7.this.controlFSM();
        }
    };
    private boolean isReceiveResponse = false;
    boolean isRunning = false;
    Runnable runnable = new Runnable() { // from class: com.pudutech.lidar.rplidar_a2m7.RPLIDAR_A2M7.4
        @Override // java.lang.Runnable
        public void run() {
            while (RPLIDAR_A2M7.this.isRunning) {
                RPLIDAR_A2M7.this.parseData();
            }
        }
    };
    byte[] pre = null;
    byte[] now = new byte[132];
    RPLIDAR_A2M7_PROTOCOL RPLIDARA2M7PROTOCAL = new RPLIDAR_A2M7_PROTOCOL();
    ...
    public void controlFSM() {
        ...
        if (lidarInterface != null) {
            int i = C47215.f5468x4e578348[this.step.ordinal()];
            if (i == 1) {
    ...
    /* JADX WARN: Classes with same name are omitted:
      classes4.dex
     */
    /* renamed from: com.pudutech.lidar.rplidar_a2m7.RPLIDAR_A2M7$5 */
    /* loaded from: classes.dex */
    public static /* synthetic */ class C47215 {

        /* renamed from: $SwitchMap$com$pudutech$lidar$rplidar_a2m7$RPLIDAR_A2M7$ControlStep */
        static final /* synthetic */ int[] f5468x4e578348;
        ...
        static {
            ...
            try {
                f5468x4e578348[ControlStep.START_MOTOR.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f5468x4e578348[ControlStep.SCAN.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f5468x4e578348[ControlStep.STOP.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f5468x4e578348[ControlStep.STOP_DTR.ordinal()] = 5;
    ...
    public void startScan() {
        ...
        this.isRunning = true;
        this.controlHandler.post(new Runnable() { // from class: com.pudutech.lidar.rplidar_a2m7.RPLIDAR_A2M7.2
            @Override // java.lang.Runnable
            public void run() {
                if (RPLIDAR_A2M7.this.step == ControlStep.IDLE || RPLIDAR_A2M7.this.step == ControlStep.STOP || RPLIDAR_A2M7.this.step == ControlStep.STOP_DTR) {
                    RPLIDAR_A2M7.this.controlHandler.removeCallbacks(RPLIDAR_A2M7.this.controlRunnable);
                    RPLIDAR_A2M7.this.startScanTimestamp = SystemClock.elapsedRealtime();
                    RPLIDAR_A2M7.this.step = ControlStep.START_DTR;
                    RPLIDAR_A2M7.this.controlFSM();
                }
            }
        });
    ...
    public void stopScan() {
        ...
        this.controlHandler.post(new Runnable() { // from class: com.pudutech.lidar.rplidar_a2m7.RPLIDAR_A2M7.3
            @Override // java.lang.Runnable
            public void run() {
                if (RPLIDAR_A2M7.this.step == ControlStep.IDLE || !(RPLIDAR_A2M7.this.step == ControlStep.STOP || RPLIDAR_A2M7.this.step == ControlStep.STOP_DTR)) {
                    RPLIDAR_A2M7.this.controlHandler.removeCallbacks(RPLIDAR_A2M7.this.controlRunnable);
                    RPLIDAR_A2M7.this.step = ControlStep.STOP;
                    RPLIDAR_A2M7.this.controlFSM();
                }
            }
        });
    ...
    public boolean parseData() {
        ...
        if (bArr != null) {
            int i2 = -1;
            Iterator<RPLIDAR_A2M7_PROTOCOL.Node> it = this.RPLIDARA2M7PROTOCAL.test(bArr, this.now).iterator();
            while (it.hasNext()) {
                RPLIDAR_A2M7_PROTOCOL.Node next = it.next();

...
public class EaiX4 extends SerialLidar {
    ...
    private final Runnable controlRunnable = new Runnable() { // from class: com.pudutech.lidar.EaiX4.1
        @Override // java.lang.Runnable
        public void run() {
            EaiX4.this.controlFSM();
        }
    };
    private int len = 0;
    ...
    public void controlFSM() {
        ...
        if (lidarInterface != null) {
            int i = C47004.$SwitchMap$com$pudutech$lidar$EaiX4$ControlStep[this.step.ordinal()];
            if (i == 1) {
    ...
    public void startScan() {
        ...
        this.controlHandler.post(new Runnable() { // from class: com.pudutech.lidar.EaiX4.2
            @Override // java.lang.Runnable
            public void run() {
                if (EaiX4.this.step == ControlStep.IDLE || EaiX4.this.step == ControlStep.STOP || EaiX4.this.step == ControlStep.STOP_DTR) {
                    EaiX4.this.controlHandler.removeCallbacks(EaiX4.this.controlRunnable);
                    EaiX4.this.step = ControlStep.START_DTR;
                    EaiX4.this.controlFSM();
                }
            }
        });
    ...
    public void stopScan() {
        ...
        this.controlHandler.post(new Runnable() { // from class: com.pudutech.lidar.EaiX4.3
            @Override // java.lang.Runnable
            public void run() {
                if (EaiX4.this.step == ControlStep.IDLE || !(EaiX4.this.step == ControlStep.STOP || EaiX4.this.step == ControlStep.STOP_DTR)) {
                    EaiX4.this.controlHandler.removeCallbacks(EaiX4.this.controlRunnable);
                    EaiX4.this.step = ControlStep.STOP_DTR;
                    EaiX4.this.controlFSM();
                }
            }
        });
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: com.pudutech.lidar.EaiX4$4 */
    /* loaded from: classes5.dex */
    public static /* synthetic */ class C47004 {
        static final /* synthetic */ int[] $SwitchMap$com$pudutech$lidar$EaiX4$ControlStep;

        static {
            try {
                $SwitchMap$com$pudutech$lidar$EaiX4$State[State.SEARCH_START_LOW.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                $SwitchMap$com$pudutech$lidar$EaiX4$State[State.SEARCH_START_HIGH.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                $SwitchMap$com$pudutech$lidar$EaiX4$State[State.PACK_TYPE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                $SwitchMap$com$pudutech$lidar$EaiX4$State[State.FRAME_LENGTH.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                $SwitchMap$com$pudutech$lidar$EaiX4$State[State.START_ANGLE_LOW.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                $SwitchMap$com$pudutech$lidar$EaiX4$State[State.START_ANGLE_HIGH.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                $SwitchMap$com$pudutech$lidar$EaiX4$State[State.END_ANGLE_LOW.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                $SwitchMap$com$pudutech$lidar$EaiX4$State[State.END_ANGLE_HIGH.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                $SwitchMap$com$pudutech$lidar$EaiX4$State[State.CHECK_SUM_LOW.ordinal()] = 9;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                $SwitchMap$com$pudutech$lidar$EaiX4$State[State.CHECK_SUM_HIGH.ordinal()] = 10;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                $SwitchMap$com$pudutech$lidar$EaiX4$State[State.DISTANCE_LOW.ordinal()] = 11;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                $SwitchMap$com$pudutech$lidar$EaiX4$State[State.DISTANCE_HIGH.ordinal()] = 12;
            } catch (NoSuchFieldError unused12) {
            }
            $SwitchMap$com$pudutech$lidar$EaiX4$ControlStep = new int[ControlStep.values().length];
            try {
                $SwitchMap$com$pudutech$lidar$EaiX4$ControlStep[ControlStep.START_DTR.ordinal()] = 1;
            } catch (NoSuchFieldError unused13) {
            }
            try {
                $SwitchMap$com$pudutech$lidar$EaiX4$ControlStep[ControlStep.SCAN.ordinal()] = 2;
            } catch (NoSuchFieldError unused14) {
            }
            try {
                $SwitchMap$com$pudutech$lidar$EaiX4$ControlStep[ControlStep.STOP_DTR.ordinal()] = 3;
            } catch (NoSuchFieldError unused15) {
            }
            try {
                $SwitchMap$com$pudutech$lidar$EaiX4$ControlStep[ControlStep.STOP.ordinal()] = 4;

...
public final class Frame {
    ...
    public final void m4369setReserved1xj2QHRw(short s) {
        this.reserved1 = s;
    }
    ...
    public final void m4365setBlockNumber7apg3OU(byte b) {
        this.blockNumber = b;
    }
    ...
    public final void m4368setFlags7apg3OU(byte b) {
        this.flags = b;
    }
    ...
    public final void m4367setCountxj2QHRw(short s) {
        this.count = s;
    }

    public final int getTimestampUs() {
        return this.timestampUs;
    }

    /* renamed from: setTimestampUs-WZ4Q5Ns, reason: not valid java name */
    public final void m4371setTimestampUsWZ4Q5Ns(int i) {
        this.timestampUs = i;
    }
    ...
    public final void m4366setCheckSumxj2QHRw(short s) {
        this.checkSum = s;
    }
    ...
    public final void m4370setReserved2xj2QHRw(short s) {
        this.reserved2 = s;
    }
    ...
    public String toString() {
        return "blockNumber=" + UByte.m4563toStringimpl(this.blockNumber) + " flags=" + UByte.m4563toStringimpl(this.flags) + " count=" + UShort.m4796toStringimpl(this.count) + " timestamp_us=" + UInt.m4632toStringimpl(this.timestampUs) + " checkSum=" + UShort.m4796toStringimpl(this.checkSum);
    }
}

...
public class EAI_TG30 extends SerialLidar {
    public static final byte[] COMMAND_START_SCAN = {-91, -48, -91, 11, -91, 11, -91, 11, -91, 11, -91, 11, -91, 11, -91, 12, -91, 12, -91, 96};
    ...
    private Runnable controlRunnable = new Runnable() { // from class: com.pudutech.lidar.eai_tg30.EAI_TG30.1
        @Override // java.lang.Runnable
        public void run() {
            EAI_TG30.this.controlFSM();
        }
    };
    private int LSN = 0;
    ...
    public void controlFSM() {
        ...
        if (lidarInterface != null) {
            int i = C47094.$SwitchMap$com$pudutech$lidar$eai_tg30$EAI_TG30$ControlStep[this.step.ordinal()];
            if (i == 1) {
    ...
    public void startScan() {
        ...
        this.controlHandler.post(new Runnable() { // from class: com.pudutech.lidar.eai_tg30.EAI_TG30.2
            @Override // java.lang.Runnable
            public void run() {
                if (EAI_TG30.this.step == ControlStep.IDLE || EAI_TG30.this.step == ControlStep.STOP || EAI_TG30.this.step == ControlStep.STOP_DTR) {
                    EAI_TG30.this.controlHandler.removeCallbacks(EAI_TG30.this.controlRunnable);
                    EAI_TG30.this.startScanTimestamp = SystemClock.elapsedRealtime();
                    EAI_TG30.this.step = ControlStep.START_DTR;
                    EAI_TG30.this.controlFSM();
                }
            }
        });
    ...
    public void stopScan() {
        ...
        this.controlHandler.post(new Runnable() { // from class: com.pudutech.lidar.eai_tg30.EAI_TG30.3
            @Override // java.lang.Runnable
            public void run() {
                if (EAI_TG30.this.step == ControlStep.IDLE || !(EAI_TG30.this.step == ControlStep.STOP || EAI_TG30.this.step == ControlStep.STOP_DTR)) {
                    EAI_TG30.this.controlHandler.removeCallbacks(EAI_TG30.this.controlRunnable);
                    EAI_TG30.this.step = ControlStep.STOP_DTR;
                    EAI_TG30.this.controlFSM();
                }
            }
        });
    ...
    private void parseData(byte[] bArr) {
        ...
        if (this.startScanTimestamp == -1) {
            ...
            Pdlog.m3273d("Lidar", "receive data len " + bArr2.length + " state " + this.state + " " + HexData.hexToString(bArr));
        } else {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            byte b = bArr2[i2];
            i++;
            switch (C47094.$SwitchMap$com$pudutech$lidar$eai_tg30$EAI_TG30$State[this.state.ordinal()]) {
                case 1:
                    this.f5450PH = b;
                    this.state = b == -86 ? State.SearchStartHigh : State.SearchStartLow;
                    continue;
                case 2:
                    this.f5450PH = (short) (((b & 255) << 8) | (this.f5450PH & 255));
                ...
                case 4:
                    ...
                    if (this.LSN == 0) {
                        ...
                        Pdlog.m3277w("Lidar", " LSN=0 " + HexData.hexToString(bArr5));
                ...
                case 8:
                    ...
                    if (this.LSN <= 1) {
                        ...
                        this.angleResolution = ((360.0d + d) - d2) / (r13 - 1);
                    } else {
                        this.angleResolution = (d - d2) / (r13 - 1);
                    }
                    this.state = State.ChecksumLow;
                    Pdlog.m3276v("Lidar", "angle " + this.angleBase + "  resolution " + this.angleResolution + " END " + d + " LSN:" + this.LSN);
                    break;
                case 9:
                ...
                case 10:
                    ...
                    this.checkSum = (short) (this.f5450PH ^ this.FSA);
                ...
                case 12:
                    ...
                    double d4 = this.angleBase + (this.disCnt * this.angleResolution);
                    lidarNode.angle = (int) d4;
                    if (d4 >= 360.0d) {
                        d4 -= 360.0d;
                    }
    ...
    /* JADX WARN: Classes with same name are omitted:
      classes4.dex
     */
    /* renamed from: com.pudutech.lidar.eai_tg30.EAI_TG30$4 */
    /* loaded from: classes.dex */
    public static /* synthetic */ class C47094 {
        static final /* synthetic */ int[] $SwitchMap$com$pudutech$lidar$eai_tg30$EAI_TG30$ControlStep;
        static final /* synthetic */ int[] $SwitchMap$com$pudutech$lidar$eai_tg30$EAI_TG30$State;

        static {
            int[] iArr = new int[State.values().length];
            $SwitchMap$com$pudutech$lidar$eai_tg30$EAI_TG30$State = iArr;
            try {
                iArr[State.SearchStartLow.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                $SwitchMap$com$pudutech$lidar$eai_tg30$EAI_TG30$State[State.SearchStartHigh.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                $SwitchMap$com$pudutech$lidar$eai_tg30$EAI_TG30$State[State.PackType.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                $SwitchMap$com$pudutech$lidar$eai_tg30$EAI_TG30$State[State.FrameLength.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                $SwitchMap$com$pudutech$lidar$eai_tg30$EAI_TG30$State[State.StartAngleLow.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                $SwitchMap$com$pudutech$lidar$eai_tg30$EAI_TG30$State[State.StartAngleHigh.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                $SwitchMap$com$pudutech$lidar$eai_tg30$EAI_TG30$State[State.EndAngleLow.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                $SwitchMap$com$pudutech$lidar$eai_tg30$EAI_TG30$State[State.EndAngleHigh.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                $SwitchMap$com$pudutech$lidar$eai_tg30$EAI_TG30$State[State.ChecksumLow.ordinal()] = 9;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                $SwitchMap$com$pudutech$lidar$eai_tg30$EAI_TG30$State[State.ChecksumHigh.ordinal()] = 10;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                $SwitchMap$com$pudutech$lidar$eai_tg30$EAI_TG30$State[State.DistanceLow.ordinal()] = 11;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                $SwitchMap$com$pudutech$lidar$eai_tg30$EAI_TG30$State[State.DistanceHigh.ordinal()] = 12;
            } catch (NoSuchFieldError unused12) {
            }
            int[] iArr2 = new int[ControlStep.values().length];
            $SwitchMap$com$pudutech$lidar$eai_tg30$EAI_TG30$ControlStep = iArr2;
            try {
                iArr2[ControlStep.START_DTR.ordinal()] = 1;
            } catch (NoSuchFieldError unused13) {
            }
            try {
                $SwitchMap$com$pudutech$lidar$eai_tg30$EAI_TG30$ControlStep[ControlStep.SCAN.ordinal()] = 2;
            } catch (NoSuchFieldError unused14) {
            }
            try {
                $SwitchMap$com$pudutech$lidar$eai_tg30$EAI_TG30$ControlStep[ControlStep.STOP_DTR.ordinal()] = 3;
            } catch (NoSuchFieldError unused15) {
            }
            try {
                $SwitchMap$com$pudutech$lidar$eai_tg30$EAI_TG30$ControlStep[ControlStep.STOP.ordinal()] = 4;

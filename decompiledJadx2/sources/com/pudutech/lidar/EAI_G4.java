...
public class EAI_G4 extends SerialLidar {
    ...
    private Runnable controlRunnable = new Runnable() { // from class: com.pudutech.lidar.EAI_G4.1
        @Override // java.lang.Runnable
        public void run() {
            EAI_G4.this.controlFSM();
        }
    };
    private int len = 0;
    ...
    public void controlFSM() {
        ...
        if (lidarInterface != null) {
            int i = C46804.$SwitchMap$com$pudutech$lidar$EAI_G4$ControlStep[this.step.ordinal()];
            if (i == 1) {
    ...
    public void startScan() {
        ...
        this.controlHandler.post(new Runnable() { // from class: com.pudutech.lidar.EAI_G4.2
            @Override // java.lang.Runnable
            public void run() {
                if (EAI_G4.this.step == ControlStep.IDLE || EAI_G4.this.step == ControlStep.STOP || EAI_G4.this.step == ControlStep.STOP_DTR) {
                    EAI_G4.this.controlHandler.removeCallbacks(EAI_G4.this.controlRunnable);
                    EAI_G4.this.step = ControlStep.START_DTR;
                    EAI_G4.this.controlFSM();
                }
            }
        });
    ...
    public void stopScan() {
        ...
        this.controlHandler.post(new Runnable() { // from class: com.pudutech.lidar.EAI_G4.3
            @Override // java.lang.Runnable
            public void run() {
                if (EAI_G4.this.step == ControlStep.IDLE || !(EAI_G4.this.step == ControlStep.STOP || EAI_G4.this.step == ControlStep.STOP_DTR)) {
                    EAI_G4.this.controlHandler.removeCallbacks(EAI_G4.this.controlRunnable);
                    EAI_G4.this.step = ControlStep.STOP_DTR;
                    EAI_G4.this.controlFSM();
                }
            }
        });
    ...
    private void parseData(byte[] bArr) {
        ...
        for (int length = bArr2.length; i2 < length; length = i) {
            byte b = bArr2[i2];
            i3++;
            switch (C46804.$SwitchMap$com$pudutech$lidar$EAI_G4$State[this.state.ordinal()]) {
                case 1:
                ...
                case 2:
                    arrayList = arrayList2;
                    i = length;
                    this.f5443PH = (short) (((b & 255) << 8) | (this.f5443PH & 255));
                ...
                case 10:
                    ...
                    this.checkSum = (short) (this.f5443PH ^ this.FSA);
    ...
    /* JADX WARN: Classes with same name are omitted:
      classes4.dex
     */
    /* renamed from: com.pudutech.lidar.EAI_G4$4 */
    /* loaded from: classes.dex */
    public static /* synthetic */ class C46804 {
        static final /* synthetic */ int[] $SwitchMap$com$pudutech$lidar$EAI_G4$ControlStep;
        static final /* synthetic */ int[] $SwitchMap$com$pudutech$lidar$EAI_G4$State;

        static {
            int[] iArr = new int[State.values().length];
            $SwitchMap$com$pudutech$lidar$EAI_G4$State = iArr;
            try {
                iArr[State.SearchStartLow.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                $SwitchMap$com$pudutech$lidar$EAI_G4$State[State.SearchStartHigh.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                $SwitchMap$com$pudutech$lidar$EAI_G4$State[State.PackType.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                $SwitchMap$com$pudutech$lidar$EAI_G4$State[State.FrameLength.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                $SwitchMap$com$pudutech$lidar$EAI_G4$State[State.StartAngleLow.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                $SwitchMap$com$pudutech$lidar$EAI_G4$State[State.StartAngleHigh.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                $SwitchMap$com$pudutech$lidar$EAI_G4$State[State.EndAngleLow.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                $SwitchMap$com$pudutech$lidar$EAI_G4$State[State.EndAngleHigh.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                $SwitchMap$com$pudutech$lidar$EAI_G4$State[State.ChecksumLow.ordinal()] = 9;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                $SwitchMap$com$pudutech$lidar$EAI_G4$State[State.ChecksumHigh.ordinal()] = 10;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                $SwitchMap$com$pudutech$lidar$EAI_G4$State[State.DistanceLow.ordinal()] = 11;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                $SwitchMap$com$pudutech$lidar$EAI_G4$State[State.DistanceHigh.ordinal()] = 12;
            } catch (NoSuchFieldError unused12) {
            }
            int[] iArr2 = new int[ControlStep.values().length];
            $SwitchMap$com$pudutech$lidar$EAI_G4$ControlStep = iArr2;
            try {
                iArr2[ControlStep.START_DTR.ordinal()] = 1;
            } catch (NoSuchFieldError unused13) {
            }
            try {
                $SwitchMap$com$pudutech$lidar$EAI_G4$ControlStep[ControlStep.SCAN.ordinal()] = 2;
            } catch (NoSuchFieldError unused14) {
            }
            try {
                $SwitchMap$com$pudutech$lidar$EAI_G4$ControlStep[ControlStep.STOP_DTR.ordinal()] = 3;
            } catch (NoSuchFieldError unused15) {
            }
            try {
                $SwitchMap$com$pudutech$lidar$EAI_G4$ControlStep[ControlStep.STOP.ordinal()] = 4;

...
public class NavigationBarUtil {
    public static void hideNavigationBar(final Window window) {
        ...
        window.getDecorView().setOnSystemUiVisibilityChangeListener(new View.OnSystemUiVisibilityChangeListener() { // from class: com.pudutech.mpmodule.NavigationBarUtil.1

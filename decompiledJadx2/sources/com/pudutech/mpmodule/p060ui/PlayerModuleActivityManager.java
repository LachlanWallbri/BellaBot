...
public class PlayerModuleActivityManager {
    private int visibleActivityCount = 0;
    private static final String TAG = PlayerModuleActivityManager.class.getSimpleName();
    private static final PlayerModuleActivityManager INSTANCE = new PlayerModuleActivityManager();
    private static final Stack<Activity> activityStack = new Stack<>();

    private PlayerModuleActivityManager() {
    }

    public static PlayerModuleActivityManager getInstance() {
        return INSTANCE;
    }
    ...
    public void finishAllModulesActivities() {
        ImPModuleActivityManager.getInstance().finishAllActivity();
        finishAllActivity();
    }

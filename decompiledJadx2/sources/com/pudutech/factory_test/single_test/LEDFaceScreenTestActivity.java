...
/* compiled from: LEDFaceScreenTestActivity.kt */
@Metadata(m3959bv = {1, 0, 3}, m3960d1 = {"\u0000F\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\b\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0007\n\u0002\u0018\u0002\n\u0002\b\u0007\u0018\u00002\u00020\u0001:\u0001'B\u0005¢\u0006\u0002\u0010\u0002J\u0006\u0010\u001e\u001a\u00020\bJ\u0012\u0010\u001f\u001a\u00020\b2\b\u0010 \u001a\u0004\u0018\u00010!H\u0014J\b\u0010\"\u001a\u00020\bH\u0014J\u0006\u0010#\u001a\u00020\bJ\u0006\u0010$\u001a\u00020\bJ\u0006\u0010%\u001a\u00020\bJ\u0006\u0010&\u001a\u00020\bR\u000e\u0010\u0003\u001a\u00020\u0004X\u0082D¢\u0006\u0002\n\u0000R-\u0010\u0005\u001a\u001e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\b0\u00070\u0006j\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\b0\u0007`\t¢\u0006\b\n\u0000\u001a\u0004\b\n\u0010\u000bR\u001a\u0010\f\u001a\u00020\rX\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u000e\u0010\u000f\"\u0004\b\u0010\u0010\u0011R\u001a\u0010\u0012\u001a\u00020\u0013X\u0086.¢\u0006\u000e\n\u0000\u001a\u0004\b\u0014\u0010\u0015\"\u0004\b\u0016\u0010\u0017R\u001a\u0010\u0018\u001a\u00020\u0019X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u001a\u0010\u001b\"\u0004\b\u001c\u0010\u001d¨\u0006("}, m3961d2 = {"Lcom/pudutech/factory_test/single_test/LEDFaceScreenTestActivity;", "Landroidx/appcompat/app/AppCompatActivity;", "()V", "TAG", "", "allCases", "Ljava/util/ArrayList;", "Lkotlin/Function0;", "", "Lkotlin/collections/ArrayList;", "getAllCases", "()Ljava/util/ArrayList;", "caseNum", "", "getCaseNum", "()I", "setCaseNum", "(I)V", "mTestItem", "Lcom/pudutech/factory_test/test_pack/TestItem;", "getMTestItem", "()Lcom/pudutech/factory_test/test_pack/TestItem;", "setMTestItem", "(Lcom/pudutech/factory_test/test_pack/TestItem;)V", "step", "Lcom/pudutech/factory_test/single_test/LEDFaceScreenTestActivity$Step;", "getStep", "()Lcom/pudutech/factory_test/single_test/LEDFaceScreenTestActivity$Step;", "setStep", "(Lcom/pudutech/factory_test/single_test/LEDFaceScreenTestActivity$Step;)V", "FSM", "onCreate", "savedInstanceState", "Landroid/os/Bundle;", "onDestroy", "runStepFail", "runStepPlaying", "runStepSuccess", "setCases", "Step", "factorytest_3.11_2021-06-12_release"}, m3962k = 1, m3963mv = {1, 1, 16})
/* loaded from: classes.dex */
public final class LEDFaceScreenTestActivity extends AppCompatActivity {
    private HashMap _$_findViewCache;
    private int caseNum;
    public TestItem mTestItem;
    private final String TAG = "LEDFaceScreenTestActivity";
    private final ArrayList<Function0<Unit>> allCases = new ArrayList<>();
    private Step step = Step.IDLE;

    /* compiled from: LEDFaceScreenTestActivity.kt */
    @Metadata(m3959bv = {1, 0, 3}, m3960d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\u0006\b\u0086\u0001\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002j\u0002\b\u0003j\u0002\b\u0004j\u0002\b\u0005j\u0002\b\u0006¨\u0006\u0007"}, m3961d2 = {"Lcom/pudutech/factory_test/single_test/LEDFaceScreenTestActivity$Step;", "", "(Ljava/lang/String;I)V", "IDLE", "PLAYING", "FAIL", "SUCCESS", "factorytest_3.11_2021-06-12_release"}, m3962k = 1, m3963mv = {1, 1, 16})
    /* loaded from: classes.dex */
    public enum Step {
        IDLE,
        PLAYING,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent() != null) {
            ...
            while (true) {
                ...
                if (Intrinsics.areEqual(testItem2.getName(), TestConstantKt.LED_FACE_SCREEN) && testItem2.getStage() == fromValue) {
                    break;
                }
            }
            if (testItem == null) {
        ...
        ((AppCompatButton) _$_findCachedViewById(C4491R.id.btnQuit)).setOnClickListener(new View.OnClickListener() { // from class: com.pudutech.factory_test.single_test.LEDFaceScreenTestActivity$onCreate$2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                String str;
                str = LEDFaceScreenTestActivity.this.TAG;
                Pdlog.m3275i(str, "click quit");
                LEDFaceScreenTestActivity.this.finish();
            }
        });
        ((AppCompatButton) _$_findCachedViewById(C4491R.id.btnErrorQuit)).setOnClickListener(new View.OnClickListener() { // from class: com.pudutech.factory_test.single_test.LEDFaceScreenTestActivity$onCreate$3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                String str;
                str = LEDFaceScreenTestActivity.this.TAG;
                Pdlog.m3275i(str, "click error quit");
                LEDFaceScreenTestActivity.this.getMTestItem().setStatus(TestStatus.FAIL);
                LEDFaceScreenTestActivity.this.finish();
            }
        });
        ((AppCompatButton) _$_findCachedViewById(C4491R.id.btnReset)).setOnClickListener(new View.OnClickListener() { // from class: com.pudutech.factory_test.single_test.LEDFaceScreenTestActivity$onCreate$4
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                String str;
                str = LEDFaceScreenTestActivity.this.TAG;
                Pdlog.m3275i(str, "click reset");
                LEDFaceScreenTestActivity.this.getMTestItem().setStatus(TestStatus.TESTING);
                LEDFaceScreenTestActivity.this.setStep(LEDFaceScreenTestActivity.Step.IDLE);
                LEDFaceScreenTestActivity.this.FSM();
            }
        });
    ...
    public final void runStepSuccess() {
        ...
        ((Button) layoutBtnOptions$default.get(0)).setOnClickListener(new View.OnClickListener() { // from class: com.pudutech.factory_test.single_test.LEDFaceScreenTestActivity$runStepSuccess$1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                LEDFaceScreenTestActivity.this.finish();
            }
        });
        ((Button) layoutBtnOptions$default.get(1)).setOnClickListener(new View.OnClickListener() { // from class: com.pudutech.factory_test.single_test.LEDFaceScreenTestActivity$runStepSuccess$2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                Function0<Unit> action;
                TestItem nextUntested = AllTestItem.INSTANCE.getNextUntested(LEDFaceScreenTestActivity.this.getMTestItem());
    ...
    public final void runStepFail() {
        ...
        ((Button) layoutBtnOptions$default.get(0)).setOnClickListener(new View.OnClickListener() { // from class: com.pudutech.factory_test.single_test.LEDFaceScreenTestActivity$runStepFail$1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                LEDFaceScreenTestActivity.this.finish();
            }
        });
        ((Button) layoutBtnOptions$default.get(1)).setOnClickListener(new View.OnClickListener() { // from class: com.pudutech.factory_test.single_test.LEDFaceScreenTestActivity$runStepFail$2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ((AppCompatButton) LEDFaceScreenTestActivity.this._$_findCachedViewById(C4491R.id.btnReset)).callOnClick();
            }
        });
    }
    ...
    public final void setCases() {
        ...
        LinearLayoutCompat layoutOptions = (LinearLayoutCompat) _$_findCachedViewById(C4491R.id.layoutOptions);
        Intrinsics.checkExpressionValueIsNotNull(layoutOptions, "layoutOptions");
        for (Object obj : LayoutHelperKt.layoutBtnOptions$default(layoutOptions, this, CollectionsKt.arrayListOf("动画", "无显示"), 0.0f, 4, null)) {
            int i2 = i + 1;
            if (i < 0) {
                CollectionsKt.throwIndexOverflow();
            }
            ((Button) obj).setOnClickListener(new View.OnClickListener() { // from class: com.pudutech.factory_test.single_test.LEDFaceScreenTestActivity$setCases$$inlined$forEachIndexed$lambda$1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    String str;
                    str = this.TAG;
                    ...
                    if (intRef.element != i) {
                        this.setStep(LEDFaceScreenTestActivity.Step.FAIL);
        ...
        final Function0<Unit> function0 = new Function0<Unit>() { // from class: com.pudutech.factory_test.single_test.LEDFaceScreenTestActivity$setCases$updateGuide$1
            ...
            public final void invoke2() {
                int caseNum = LEDFaceScreenTestActivity.this.getCaseNum() - LEDFaceScreenTestActivity.this.getAllCases().size();
                AppCompatTextView tvGuide = (AppCompatTextView) LEDFaceScreenTestActivity.this._$_findCachedViewById(C4491R.id.tvGuide);
                Intrinsics.checkExpressionValueIsNotNull(tvGuide, "tvGuide");
                tvGuide.setText("连通性测试 ( " + caseNum + " | " + LEDFaceScreenTestActivity.this.getCaseNum() + " )：\n点阵屏显示的内容是？");
            }
        };
        this.allCases.add(new Function0<Unit>() { // from class: com.pudutech.factory_test.single_test.LEDFaceScreenTestActivity$setCases$2
            /* JADX INFO: Access modifiers changed from: package-private */
            ...
            public final void invoke2() {
                ...
                RobotInterface rbInterface = ServiceConnectionKt.getRbInterface();
                if (rbInterface != null) {
                    rbInterface.controlLEDFaceScreen(LEDFaceScreenMode.LookAround);
                }
            }
        });
        this.allCases.add(new Function0<Unit>() { // from class: com.pudutech.factory_test.single_test.LEDFaceScreenTestActivity$setCases$3
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            ...
            public final void invoke2() {
                ...
                RobotInterface rbInterface = ServiceConnectionKt.getRbInterface();
                if (rbInterface != null) {
                    rbInterface.controlLEDFaceScreen(LEDFaceScreenMode.CloseLED);
                }
            }
        });

...
public class NetStatusUtil {
    ...
    public static void dumpNetStatus(Context context) {
        try {
            Pdlog.m3275i(TAG, ((ConnectivityManager) context.getSystemService("connectivity")).getActiveNetworkInfo().toString());
        } catch (Exception e) {
            Pdlog.m3274e(TAG, "", e);
        }
    }
    ...
    public static void setMobileDataEnabled(Context context, boolean z) {
        ...
        try {
            ...
            Pdlog.m3274e("setMobileDataEnabled", "Errot setting" + ((InvocationTargetException) e).getTargetException() + telephonyManager);
        }
    }

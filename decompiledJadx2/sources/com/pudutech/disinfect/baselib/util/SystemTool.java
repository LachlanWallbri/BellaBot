...
public final class SystemTool {
    ...
    public final void setProperty(Context context, String key, String value) {
        ...
        try {
            Class<?> loadClass = context.getClassLoader().loadClass("android.os.SystemProperties");
            Method method = loadClass.getMethod(TmpConstant.PROPERTY_IDENTIFIER_SET, String.class, String.class);
            Intrinsics.checkExpressionValueIsNotNull(method, "systemProperties.getMeth…java, String::class.java)");
            method.invoke(loadClass, key, value);
        } catch (Exception e) {

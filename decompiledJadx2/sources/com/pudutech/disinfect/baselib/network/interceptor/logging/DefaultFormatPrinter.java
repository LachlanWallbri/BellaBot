...
import com.pudutech.disinfect.baselib.ext.util.CharacterHandler;
import com.pudutech.disinfect.baselib.util.LogUtils;
...
public final class DefaultFormatPrinter implements FormatPrinter {
    ...
    /* renamed from: N */
    private static final String f5047N = "\n";
    ...
    /* renamed from: T */
    private static final String f5048T = "\t";
    ...
    @Override // com.pudutech.disinfect.baselib.network.interceptor.logging.FormatPrinter
    ...
    public static final class Companion {
        ...
        private final boolean isEmpty(String line) {
            String str = line;
            if (!TextUtils.isEmpty(str) && !Intrinsics.areEqual("\n", line) && !Intrinsics.areEqual(DefaultFormatPrinter.f5048T, line)) {
    ...
    static {
        ...
        DOUBLE_SEPARATOR = Intrinsics.stringPlus(str, str);
        String str2 = LINE_SEPARATOR;
        OMITTED_RESPONSE = new String[]{str2, "Omitted response body"};
        OMITTED_REQUEST = new String[]{str2, "Omitted request body"};
        ARMS = new String[]{"-A-", "-R-", "-M-", "-S-"};
        last = new ThreadLocal<Integer>() { // from class: com.pudutech.disinfect.baselib.network.interceptor.logging.DefaultFormatPrinter$Companion$last$1

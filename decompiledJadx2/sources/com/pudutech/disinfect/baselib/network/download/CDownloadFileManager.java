...
/* JADX WARN: Classes with same name are omitted:
  classes3.dex
 */
/* compiled from: CDownloadFileManager.kt */
@Metadata(m3959bv = {1, 0, 3}, m3960d1 = {"\u0000.\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0002\b\u0002\u0018\u0000 \u000f2\u00020\u0001:\u0001\u000fB\u0007\b\u0002¢\u0006\u0002\u0010\u0002J.\u0010\u0005\u001a\u00020\u00062\b\u0010\u0007\u001a\u0004\u0018\u00010\b2\b\u0010\t\u001a\u0004\u0018\u00010\b2\u0006\u0010\n\u001a\u00020\b2\b\u0010\u000b\u001a\u0004\u0018\u00010\fH\u0016J\u0010\u0010\r\u001a\u00020\u000e2\u0006\u0010\u0007\u001a\u00020\bH\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0010"}, m3961d2 = {"Lcom/pudutech/disinfect/baselib/network/download/CDownloadFileManager;", "Lcom/pudutech/disinfect/baselib/network/download/IFileDownloadInterface;", "()V", "okHttpClient", "Lokhttp3/OkHttpClient;", "downloadFile", "", "fileUrl", "", "fileName", "directoryPath", "listener", "Lcom/pudutech/disinfect/baselib/network/download/OnDownloadFileListener;", "getContentLength", "", "Companion", "module_baselib_robot_release"}, m3962k = 1, m3963mv = {1, 1, 16})
/* loaded from: classes4.dex */
public final class CDownloadFileManager implements IFileDownloadInterface {

    /* renamed from: Companion, reason: from kotlin metadata */
    public static final Companion INSTANCE = new Companion(null);
    private static final Lazy INSTANCE$delegate = LazyKt.lazy(LazyThreadSafetyMode.SYNCHRONIZED, (Function0) new Function0<CDownloadFileManager>() { // from class: com.pudutech.disinfect.baselib.network.download.CDownloadFileManager$Companion$INSTANCE$2
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // kotlin.jvm.functions.Function0
        public final CDownloadFileManager invoke() {
            return new CDownloadFileManager(null);
        }
    });
    public static final String TAG = "CDownloadFileManager";
    private OkHttpClient okHttpClient;

    private CDownloadFileManager() {
    ...
    public /* synthetic */ CDownloadFileManager(DefaultConstructorMarker defaultConstructorMarker) {
        this();
    }
     ...
     */
    /* compiled from: CDownloadFileManager.kt */
    @Metadata(m3959bv = {1, 0, 3}, m3960d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\u000e\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u001b\u0010\u0003\u001a\u00020\u00048FX\u0086\u0084\u0002¢\u0006\f\n\u0004\b\u0007\u0010\b\u001a\u0004\b\u0005\u0010\u0006R\u000e\u0010\t\u001a\u00020\nX\u0086T¢\u0006\u0002\n\u0000¨\u0006\u000b"}, m3961d2 = {"Lcom/pudutech/disinfect/baselib/network/download/CDownloadFileManager$Companion;", "", "()V", "INSTANCE", "Lcom/pudutech/disinfect/baselib/network/download/CDownloadFileManager;", "getINSTANCE", "()Lcom/pudutech/disinfect/baselib/network/download/CDownloadFileManager;", "INSTANCE$delegate", "Lkotlin/Lazy;", "TAG", "", "module_baselib_robot_release"}, m3962k = 1, m3963mv = {1, 1, 16})
    /* loaded from: classes4.dex */
    public static final class Companion {
        public final CDownloadFileManager getINSTANCE() {
            Lazy lazy = CDownloadFileManager.INSTANCE$delegate;
            Companion companion = CDownloadFileManager.INSTANCE;
            return (CDownloadFileManager) lazy.getValue();
        }
    ...
    @Override // com.pudutech.disinfect.baselib.network.download.IFileDownloadInterface
    public void downloadFile(final String fileUrl, String fileName, final String directoryPath, final OnDownloadFileListener listener) {
        ...
        Observable.create(new ObservableOnSubscribe<String>() { // from class: com.pudutech.disinfect.baselib.network.download.CDownloadFileManager$downloadFile$1
            ...
            public final void subscribe(ObservableEmitter<String> emitter) {
                ...
                try {
                    ...
                    int i = 1;
                    Pdlog.m3273d("CDownloadFileManager", "directoryPath[" + directoryPath + ']');
                    ...
                    contentLength = CDownloadFileManager.this.getContentLength(fileUrl);
                    if (contentLength == 0) {
                        ...
                        okHttpClient = CDownloadFileManager.this.okHttpClient;
        ...
        }).subscribeOn(Schedulers.m3958io()).observeOn(AndroidSchedulers.mainThread()).subscribe(new Observer<String>() { // from class: com.pudutech.disinfect.baselib.network.download.CDownloadFileManager$downloadFile$2

package com.pudutech.disinfect.baselib.ext.navigation;
...
public final class DialogFragmentNavigator extends Navigator<Destination> {
    ...
    private LifecycleEventObserver mObserver = new LifecycleEventObserver() { // from class: com.pudutech.disinfect.baselib.ext.navigation.DialogFragmentNavigator.1
    ...
    public boolean popBackStack() {
        ...
        if (this.mFragmentManager.isStateSaved()) {
            Pdlog.m3275i(TAG, "Ignoring popBackStack() call: FragmentManager has already saved its state");
            return false;
        }
    ...
    public NavDestination navigate(Destination destination, Bundle bundle, NavOptions navOptions, Navigator.Extras extras) {
        if (this.mFragmentManager.isStateSaved()) {
            Pdlog.m3275i(TAG, "Ignoring navigate() call: FragmentManager has already saved its state");
            return null;
        }
    ...
    public static class Destination extends NavDestination implements FloatingWindow {
        ...
        public void onInflate(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, C4429R.styleable.DialogFragmentNavigator);
            String string = obtainAttributes.getString(C4429R.styleable.DialogFragmentNavigator_android_name);
            if (string != null) {
                setClassName(string);
            }

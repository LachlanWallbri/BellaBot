    ...
    */
    public NavDestination navigate(Destination destination, Bundle bundle, NavOptions navOptions, Navigator.Extras extras) {
        ...
        if (this.mFragmentManager.getFragments().size() > 0) {
            beginTransaction.hide(this.mFragmentManager.getFragments().get(this.mFragmentManager.getFragments().size() - 1));
    ...
    public static class Destination extends NavDestination {
        ...
        public void onInflate(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, C4429R.styleable.FragmentNavigator);
            String string = obtainAttributes.getString(C4429R.styleable.FragmentNavigator_android_name);
            if (string != null) {
                setClassName(string);
            }

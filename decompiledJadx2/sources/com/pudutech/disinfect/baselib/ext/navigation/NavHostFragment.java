...
import com.pudutech.disinfect.baselib.ext.navigation.FragmentNavigator;
...
public class NavHostFragment extends Fragment implements NavHost {
    ...
    private int getContainerId() {
        int id = getId();
        return (id == 0 || id == -1) ? C4429R.id.nav_host_fragment_container : id;
    }
    ...
    public void onInflate(Context context, AttributeSet attributeSet, Bundle bundle) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C4429R.styleable.NavHost);
        int resourceId = obtainStyledAttributes.getResourceId(C4429R.styleable.NavHost_navGraph, 0);
        if (resourceId != 0) {
            this.mGraphId = resourceId;
        }
        obtainStyledAttributes.recycle();
        TypedArray obtainStyledAttributes2 = context.obtainStyledAttributes(attributeSet, C4429R.styleable.NavHostFragment);
        if (obtainStyledAttributes2.getBoolean(C4429R.styleable.NavHostFragment_defaultNavHost, false)) {
            this.mDefaultNavHost = true;
        }

...
@DebugMetadata(m3969c = "com.pudutech.disinfect.baselib.base.viewmodel.BaseViewModel$requestSelfCheck$2", m3970f = "BaseViewModel.kt", m3971i = {0, 0, 1, 1, 1}, m3972l = {69, 72}, m3973m = "invokeSuspend", m3974n = {"$this$launch", "$this$runCatching", "$this$launch", "it", "$this$runCatching"}, m3975s = {"L$0", "L$1", "L$0", "L$2", "L$3"})
/* loaded from: classes2.dex */
public final class BaseViewModel$requestSelfCheck$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    /* renamed from: p$ */
    private CoroutineScope f5014p$;
    final /* synthetic */ BaseViewModel this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public BaseViewModel$requestSelfCheck$2(BaseViewModel baseViewModel, Function1 function1, Function1 function12, Function1 function13, Continuation continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> completion) {
        ...
        BaseViewModel$requestSelfCheck$2 baseViewModel$requestSelfCheck$2 = new BaseViewModel$requestSelfCheck$2(this.this$0, this.$block, this.$success, this.$error, completion);
        baseViewModel$requestSelfCheck$2.f5014p$ = (CoroutineScope) obj;
        return baseViewModel$requestSelfCheck$2;
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((BaseViewModel$requestSelfCheck$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
            ...
            if (i != 1) {
                if (i == 2) {
                    ...
                    if (m4513exceptionOrNullimpl != null) {
                        ...
                        objArr2[0] = message2;
                        Pdlog.m3274e("Freddy2", objArr2);
                        if (m4513exceptionOrNullimpl instanceof AppException) {
                            this.$error.invoke(m4513exceptionOrNullimpl);
                        } else {
                            this.$error.invoke(new AppException(-1, m4513exceptionOrNullimpl.getMessage(), null, 4, null));
                        }
                    }
                    return Unit.INSTANCE;
                }
        ...
        if (Result.m4517isSuccessimpl(m4510constructorimpl)) {
            ...
            try {
                ...
                c4433xefd839 = new C4433xefd839(null, baseResponse, this, r1);
                this.L$0 = r1;
            ...
            if (baseViewModel.executeResponseSelfCheck(baseResponse, c4433xefd839, this) == coroutine_suspended) {
                return coroutine_suspended;
            }
            obj2 = m4510constructorimpl;
            obj3 = Result.m4510constructorimpl(Unit.INSTANCE);

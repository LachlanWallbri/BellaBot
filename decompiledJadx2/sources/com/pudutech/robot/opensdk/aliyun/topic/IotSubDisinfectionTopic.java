...
public final class IotSubDisinfectionTopic extends BaseIotDirectTopic {
    ...
    public void onOtherMsg(String msgJson, String msgType) {
        ...
        if (Intrinsics.areEqual(msgType, Constant.INSTANCE.getMSG_TYPE_DIS_ACTION())) {
            Object fromJson = getGson().fromJson(msgJson, new TypeToken<BaseMsgBean<DisActionBody>>() { // from class: com.pudutech.robot.opensdk.aliyun.topic.IotSubDisinfectionTopic$onOtherMsg$baseMsgBean$type$1
            }.getType());
        ...
        } else if (Intrinsics.areEqual(msgType, Constant.INSTANCE.getMSG_TYPE_DIS_STATUS())) {
    ...
    public String getRole() {
        return Constant.INSTANCE.getROLE_DISINFECTION();
    }

    @Override // com.pudutech.robot.opensdk.interf.ISubTopic
    public String getTopic() {
        return Constant.INSTANCE.subDisinfectionTopicTemplate(getProductKey(), getDeviceName());
    }

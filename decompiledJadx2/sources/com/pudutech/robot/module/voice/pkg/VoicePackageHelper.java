...
import com.pudutech.robot.module.voice.pkg.protocol.Download;
import com.pudutech.robot.module.voice.pkg.protocol.Record;
import java.io.File;
...
@Metadata(m3959bv = {1, 0, 3}, m3960d1 = {"\u0000T\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\u000e\n\u0002\b\u0007\n\u0002\u0010\u0012\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0002\b\u0004\n\u0002\u0010\t\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0004\n\u0002\u0010!\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0004\u0018\u0000 .2\u00020\u0001:\u0001.B\u0005¢\u0006\u0002\u0010\u0002J\u0010\u0010\u0010\u001a\u00020\n2\u0006\u0010\u0011\u001a\u00020\u0012H\u0002J\u0010\u0010\u0013\u001a\u00020\n2\u0006\u0010\u0014\u001a\u00020\u0015H\u0002J\u0010\u0010\u0016\u001a\u00020\n2\u0006\u0010\u0017\u001a\u00020\nH\u0002J\u0016\u0010\u0018\u001a\u00020\u00192\u0006\u0010\u001a\u001a\u00020\n2\u0006\u0010\u001b\u001a\u00020\nJ\u0018\u0010\u001c\u001a\u00020\u00192\u0006\u0010\u001d\u001a\u00020\u001e2\u0006\u0010\u001f\u001a\u00020\nH\u0002J\u0006\u0010 \u001a\u00020!J\u0006\u0010\u0003\u001a\u00020\u0004J\u0010\u0010\"\u001a\u00020!2\u0006\u0010\u0014\u001a\u00020\u0015H\u0002J\u000e\u0010#\u001a\u00020!2\u0006\u0010$\u001a\u00020\nJ\f\u0010%\u001a\b\u0012\u0004\u0012\u00020\u00040&J\u0006\u0010'\u001a\u00020!J\u0016\u0010(\u001a\u00020\u00192\u0006\u0010)\u001a\u00020\n2\u0006\u0010*\u001a\u00020+J\u0014\u0010,\u001a\u00020!2\f\u0010-\u001a\b\u0012\u0004\u0012\u00020\u00040&R\u001b\u0010\u0003\u001a\u00020\u00048BX\u0082\u0084\u0002¢\u0006\f\n\u0004\b\u0007\u0010\b\u001a\u0004\b\u0005\u0010\u0006R*\u0010\u000b\u001a\u0004\u0018\u00010\n2\b\u0010\t\u001a\u0004\u0018\u00010\n8F@FX\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\f\u0010\r\"\u0004\b\u000e\u0010\u000f¨\u0006/"}, m3961d2 = {"Lcom/pudutech/robot/module/voice/pkg/VoicePackageHelper;", "", "()V", "defaultPackage", "Lcom/pudutech/robot/module/voice/pkg/VoicePackageInfo;", "getDefaultPackage", "()Lcom/pudutech/robot/module/voice/pkg/VoicePackageInfo;", "defaultPackage$delegate", "Lkotlin/Lazy;", ES6Iterator.VALUE_PROPERTY, "", "selectedIDRecord", "getSelectedIDRecord", "()Ljava/lang/String;", "setSelectedIDRecord", "(Ljava/lang/String;)V", "bytesToHexString", "bytes", "", "calMD5", "file", "Ljava/io/File;", "calMD5Mask", "string", "checkMD5Same", "", "zipName", "md5", "checkPackageExistAndDeleteIllegal", "id", "", "md5Mask", "cleanDownloads", "", "deleteFile", "deletePackFile", "name", "getDownloadList", "", "loadRecord", "moveDownloadsToPackage", "fileName", "cloudPack", "Lcom/pudutech/disinfect/baselib/network/response/VoicePackCloud;", "syncRecordToSDCard", "list", "Companion", "module_robot_voice_release"}, m3962k = 1, m3963mv = {1, 1, 16})
...
public final class VoicePackageHelper {
    ...
    private final Lazy defaultPackage = LazyKt.lazy(new Function0<VoicePackageInfo>() { // from class: com.pudutech.robot.module.voice.pkg.VoicePackageHelper$defaultPackage$2
        ...
        public final VoicePackageInfo invoke() {
            ...
            voicePackageInfo.setId$module_robot_voice_release(VoicePackageHelper.INSTANCE.getDefaultID());
            voicePackageInfo.setName$module_robot_voice_release("");
            boolean z = true;
            voicePackageInfo.setExist$module_robot_voice_release(true);
            String selectedIDRecord = VoicePackageHelper.this.getSelectedIDRecord();
            if (selectedIDRecord != null && selectedIDRecord.length() != 0) {
                z = false;
            }
            voicePackageInfo.setSelected$module_robot_voice_release(z);
    ...
    /* compiled from: VoicePackageHelper.kt */
    @Metadata(m3959bv = {1, 0, 3}, m3960d1 = {"\u00004\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\t\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0002\b\u000b\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000e\u0010\u0017\u001a\u00020\u00182\u0006\u0010\u0019\u001a\u00020\u001aR\u0014\u0010\u0003\u001a\u00020\u0004X\u0086D¢\u0006\b\n\u0000\u001a\u0004\b\u0005\u0010\u0006R\u0011\u0010\u0007\u001a\u00020\b¢\u0006\b\n\u0000\u001a\u0004\b\t\u0010\nR\u000e\u0010\u000b\u001a\u00020\bX\u0082D¢\u0006\u0002\n\u0000R\u0014\u0010\f\u001a\u00020\bX\u0086D¢\u0006\b\n\u0000\u001a\u0004\b\r\u0010\nR\u0014\u0010\u000e\u001a\u00020\bX\u0086D¢\u0006\b\n\u0000\u001a\u0004\b\u000f\u0010\nR\u0011\u0010\u0010\u001a\u00020\b¢\u0006\b\n\u0000\u001a\u0004\b\u0011\u0010\nR\u000e\u0010\u0012\u001a\u00020\bX\u0082D¢\u0006\u0002\n\u0000R\u0010\u0010\u0013\u001a\u0004\u0018\u00010\u0014X\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0015\u001a\u00020\u0016X\u0082.¢\u0006\u0002\n\u0000¨\u0006\u001b"}, m3961d2 = {"Lcom/pudutech/robot/module/voice/pkg/VoicePackageHelper$Companion;", "", "()V", "DefaultID", "", "getDefaultID", "()J", "DownloadPath", "", "getDownloadPath", "()Ljava/lang/String;", "FILE_NAME", "KEY_RECORD", "getKEY_RECORD", "KEY_SELECTED", "getKEY_SELECTED", "PackagesPath", "getPackagesPath", "TAG", VoicePackageHelper.KEY_RECORD, "Lcom/pudutech/robot/module/voice/pkg/protocol/Record;", "sharedPreferences", "Landroid/content/SharedPreferences;", "init", "", "context", "Landroid/content/Context;", "module_robot_voice_release"}, m3962k = 1, m3963mv = {1, 1, 16})
    /* loaded from: classes6.dex */
    ...
    */
        ...
        if (string != null) {
            try {
                ...
                if (record2 != null && (arrayList3 = record2.downloads) != null) {
                    arrayList3.removeIf(new Predicate<Download>() { // from class: com.pudutech.robot.module.voice.pkg.VoicePackageHelper$loadRecord$$inlined$let$lambda$1
                ...
                if (selectedIDRecord != null) {
                    ...
                    if (record3 == null || (arrayList2 = record3.downloads) == null) {
                        ...
                        for (Object obj : arrayList2) {
                            if (Intrinsics.areEqual(String.valueOf(((Download) obj).f7239id.longValue()), selectedIDRecord)) {
                                arrayList4.add(obj);
                            }
                        }
    ...
    public final List<VoicePackageInfo> getDownloadList() {
        ...
        if (record2 != null && (arrayList = record2.downloads) != null) {
            for (Download download : arrayList) {
                Pdlog.m3275i(TAG, "load record. download=" + download.name + ' ' + download.f7239id + ' ' + download.version_code);
                Long l = download.f7239id;
                Intrinsics.checkExpressionValueIsNotNull(l, "it.id");
                long longValue = l.longValue();
                String str = download.md5_mask;
                ...
                if (checkPackageExistAndDeleteIllegal(longValue, str)) {
                    ...
                    voicePackageInfo.setName$module_robot_voice_release(str2);
                    voicePackageInfo.setExist$module_robot_voice_release(true);
                    Long l2 = download.f7239id;
                    Intrinsics.checkExpressionValueIsNotNull(l2, "it.id");
                    voicePackageInfo.setId$module_robot_voice_release(l2.longValue());
                    Long l3 = download.version_code;
                    Intrinsics.checkExpressionValueIsNotNull(l3, "it.version_code");
                    voicePackageInfo.setVersion_code$module_robot_voice_release(l3.longValue());
                    if (Intrinsics.areEqual(String.valueOf(voicePackageInfo.getId()), selectedIDRecord)) {
                        voicePackageInfo.setSelected$module_robot_voice_release(true);
                    }
                    arrayList2.add(voicePackageInfo);
                } else {
                    Pdlog.m3275i(TAG, download.name + ' ' + download.f7239id + " not exist");
                }
            }
        }
        return arrayList2;
    ...
    public final VoicePackageInfo defaultPackage() {
        getDefaultPackage().setName$module_robot_voice_release("");
    ...
    public final void syncRecordToSDCard(List<VoicePackageInfo> list) {
        ...
        for (final VoicePackageInfo voicePackageInfo : list) {
            ...
            if (record3 != null && (arrayList = record3.downloads) != null) {
                arrayList.removeIf(new Predicate<Download>() { // from class: com.pudutech.robot.module.voice.pkg.VoicePackageHelper$syncRecordToSDCard$1$3
                    @Override // java.util.function.Predicate
                    public final boolean test(Download download) {
                        Long l2 = download.f7239id;
    ...
    public final boolean moveDownloadsToPackage(String fileName, VoicePackCloud cloudPack) {
        ...
        if (file2.exists()) {
            ...
            boolean z = false;
            for (Download download : arrayList) {
                if (Intrinsics.areEqual(download.f7239id, cloudPack.getId())) {
                    download.version_code = cloudPack.getVersion_code();
            ...
            if (!z) {
                ...
                download2.f7239id = cloudPack.getId();
                download2.name = cloudPack.getName();
                download2.version_code = cloudPack.getVersion_code();

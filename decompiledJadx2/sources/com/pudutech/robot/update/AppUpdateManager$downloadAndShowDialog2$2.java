...
@Metadata(m3959bv = {1, 0, 3}, m3960d1 = {"\u00001\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0005\n\u0002\u0010\u000b\n\u0002\b\u0004\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u0003\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u0010\u0010\r\u001a\u00020\u000e2\u0006\u0010\u000f\u001a\u00020\u0010H\u0016J\b\u0010\u0011\u001a\u00020\u000eH\u0016J\u0010\u0010\u0012\u001a\u00020\u000e2\u0006\u0010\u0013\u001a\u00020\u0014H\u0016J\b\u0010\u0015\u001a\u00020\u000eH\u0016R\u001a\u0010\u0002\u001a\u00020\u0003X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0004\u0010\u0005\"\u0004\b\u0006\u0010\u0007R\u001a\u0010\b\u001a\u00020\tX\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\b\u0010\n\"\u0004\b\u000b\u0010\f¨\u0006\u0016"}, m3961d2 = {"com/pudutech/robot/update/AppUpdateManager$downloadAndShowDialog2$2", "Lcom/pudutech/lib_update/listener/IShowProgress;", "downloadProgress", "", "getDownloadProgress", "()I", "setDownloadProgress", "(I)V", "isDownFinish", "", "()Z", "setDownFinish", "(Z)V", "onFail", "", C3898x.f4338g, "", "onFinish", "onProgress", "downloadInfo", "Lcom/pudutech/light_network/download/DownloadInfo;", "onStartProgress", "module_robot_update_release"}, m3962k = 1, m3963mv = {1, 1, 16})
/* loaded from: classes6.dex */
public final class AppUpdateManager$downloadAndShowDialog2$2 implements IShowProgress {
    final /* synthetic */ ShowTipsDialog $dialog;
    final /* synthetic */ Ref.ObjectRef $dont_turn_off_power;
    final /* synthetic */ Ref.ObjectRef $down_failed;
    final /* synthetic */ Ref.ObjectRef $install_failed;
    final /* synthetic */ Ref.ObjectRef $ok;
    ...
    public AppUpdateManager$downloadAndShowDialog2$2(ShowTipsDialog showTipsDialog, Ref.ObjectRef objectRef, Ref.ObjectRef objectRef2, Ref.ObjectRef objectRef3, Function0 function0, Ref.ObjectRef objectRef4) {
        this.$dialog = showTipsDialog;
        this.$install_failed = objectRef;
        this.$down_failed = objectRef2;
        this.$ok = objectRef3;
        this.$onDownFinish = function0;
        this.$dont_turn_off_power = objectRef4;
    }
    ...
    public void onFail(Throwable e) {
        ...
        BuildersKt__Builders_commonKt.launch$default(GlobalScope.INSTANCE, Dispatchers.getMain(), null, new AppUpdateManager$downloadAndShowDialog2$2$onFail$1(this, null), 2, null);
    }
    ...
    public void onFinish() {
        ...
        if (this.$dialog.isShowing()) {
            ...
            this.$dialog.setTips((String) this.$dont_turn_off_power.element);

...
/* compiled from: PeanutDebugActivity.kt */
@Metadata(m3959bv = {1, 0, 3}, m3960d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\b\u0010\u0003\u001a\u00020\u0004H\u0002J\u0012\u0010\u0005\u001a\u00020\u00042\b\u0010\u0006\u001a\u0004\u0018\u00010\u0007H\u0014¨\u0006\b"}, m3961d2 = {"Lcom/pudutech/robot/peripherals/activity/PeanutDebugActivity;", "Landroidx/appcompat/app/AppCompatActivity;", "()V", "initView", "", "onCreate", "savedInstanceState", "Landroid/os/Bundle;", "module_robot_peripherals_release"}, m3962k = 1, m3963mv = {1, 1, 16})
/* loaded from: classes6.dex */
public final class PeanutDebugActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(C5707R.layout.peripherals_activity_peanut_layout);
        initView();
    }
    ...
    private final void initView() {
        ...
        final IPeanutRobotPeripherals iPeanutRobotPeripherals = (IPeanutRobotPeripherals) obj;
        Context applicationContext = getApplicationContext();
        Intrinsics.checkExpressionValueIsNotNull(applicationContext, "this.applicationContext");
        iPeanutRobotPeripherals.init(applicationContext, false);
        ((Button) _$_findCachedViewById(C5707R.id.breathing_light_btn)).setOnClickListener(new View.OnClickListener() { // from class: com.pudutech.robot.peripherals.activity.PeanutDebugActivity$initView$1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                IPeanutRobotPeripherals.this.playBreathing(new LightBeltType[]{LightBeltType.BottomChassisLeft, LightBeltType.BottomChassisRear, LightBeltType.BottomChassisRight, LightBeltType.BottomChassis}, BreathingLightColor.Blue);
            }
        });
        ((Button) _$_findCachedViewById(C5707R.id.light_btn)).setOnClickListener(new View.OnClickListener() { // from class: com.pudutech.robot.peripherals.activity.PeanutDebugActivity$initView$2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                IPeanutRobotPeripherals.this.controlLightBelt(new LightBeltType[]{LightBeltType.BottomChassisLeft, LightBeltType.BottomChassisRear, LightBeltType.BottomChassisRight, LightBeltType.BottomChassis}, "Led2_1_1");
            }
        });
        ((Button) _$_findCachedViewById(C5707R.id.close_light_btn)).setOnClickListener(new View.OnClickListener() { // from class: com.pudutech.robot.peripherals.activity.PeanutDebugActivity$initView$3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                IPeanutRobotPeripherals.this.stopLightBelt(LightBeltType.BottomChassisLeft, LightBeltType.BottomChassisRear, LightBeltType.BottomChassisRight, LightBeltType.BottomChassis);
            }
        });
        TextView tv_title = (TextView) _$_findCachedViewById(C5707R.id.tv_title);
        Intrinsics.checkExpressionValueIsNotNull(tv_title, "tv_title");
        tv_title.setText("小花生调试界面");
        ((ImageView) _$_findCachedViewById(C5707R.id.iv_back)).setOnClickListener(new View.OnClickListener() { // from class: com.pudutech.robot.peripherals.activity.PeanutDebugActivity$initView$4
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                PeanutDebugActivity.this.finish();
            }
        });
    }
}

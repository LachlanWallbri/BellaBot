...
@Metadata(m3959bv = {1, 0, 3}, m3960d1 = {"\u0000B\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\b\u0016\u0018\u0000*\b\b\u0000\u0010\u0001*\u00020\u00022\u00020\u0003B\u0005¢\u0006\u0002\u0010\u0004J\u0017\u0010\u0012\u001a\u00020\u00132\b\u0010\u0014\u001a\u0004\u0018\u00018\u0000H\u0002¢\u0006\u0002\u0010\u0015J\u0015\u0010\u0016\u001a\u00020\u00132\u0006\u0010\u0014\u001a\u00028\u0000H\u0016¢\u0006\u0002\u0010\u0015J\u0015\u0010\u0017\u001a\u00020\u00132\u0006\u0010\u0014\u001a\u00028\u0000H\u0016¢\u0006\u0002\u0010\u0015J\u0010\u0010\u0018\u001a\u00020\u00132\u0006\u0010\u0019\u001a\u00020\u001aH\u0016J\u0017\u0010\u001b\u001a\u00020\u00132\b\u0010\u0014\u001a\u0004\u0018\u00018\u0000H\u0002¢\u0006\u0002\u0010\u0015J\u0014\u0010\u001c\u001a\u00020\u00132\f\u0010\u001d\u001a\b\u0012\u0004\u0012\u00020\u00130\u001eR\u0014\u0010\u0005\u001a\u00020\u0006X\u0094D¢\u0006\b\n\u0000\u001a\u0004\b\u0007\u0010\bR&\u0010\t\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00028\u00000\u000b0\nX\u0084\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\f\u0010\r\"\u0004\b\u000e\u0010\u000fR\u000e\u0010\u0010\u001a\u00020\u0011X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u001f"}, m3961d2 = {"Lcom/pudutech/peanut/presenter/mvp_base/BaseMultiViewPresenter;", ExifInterface.GPS_DIRECTION_TRUE, "Lcom/pudutech/peanut/presenter/mvp_base/BaseViewInterface;", "Lcom/pudutech/kotlinmvp/mvp_base/BasePresenterInterface;", "()V", "TAG", "", "getTAG", "()Ljava/lang/String;", "mViews", "Ljava/util/concurrent/CopyOnWriteArrayList;", "Ljava/lang/ref/WeakReference;", "getMViews", "()Ljava/util/concurrent/CopyOnWriteArrayList;", "setMViews", "(Ljava/util/concurrent/CopyOnWriteArrayList;)V", "uiHandler", "Landroid/os/Handler;", "attachLifecycle", "", "view", "(Lcom/pudutech/peanut/presenter/mvp_base/BaseViewInterface;)V", "attachView", "detachView", "onStop", "owner", "Landroidx/lifecycle/LifecycleOwner;", "removeLifecycle", "runOnUIThread", "method", "Lkotlin/Function0;", "presenter_release"}, m3962k = 1, m3963mv = {1, 1, 16})
...
public class BaseMultiViewPresenter<T extends BaseViewInterface> implements BasePresenterInterface {
    ...
    public final void runOnUIThread(final Function0<Unit> method) {
        ...
        if (currentThread != mainLooper.getThread()) {
            this.uiHandler.post(new Runnable() { // from class: com.pudutech.peanut.presenter.mvp_base.BaseMultiViewPresenter$sam$java_lang_Runnable$0
    ...
    protected final CopyOnWriteArrayList<WeakReference<T>> getMViews() {
        return this.mViews;
    }

    protected final void setMViews(CopyOnWriteArrayList<WeakReference<T>> copyOnWriteArrayList) {
    ...
    public void detachView(final T view) {
        ...
        this.mViews.removeIf(new Predicate<WeakReference<T>>() { // from class: com.pudutech.peanut.presenter.mvp_base.BaseMultiViewPresenter$detachView$2
    ...
    public void onStop(final LifecycleOwner owner) {
        ...
        this.mViews.removeIf(new Predicate<WeakReference<T>>() { // from class: com.pudutech.peanut.presenter.mvp_base.BaseMultiViewPresenter$onStop$2
            @Override // java.util.function.Predicate
            public final boolean test(WeakReference<T> weakReference2) {

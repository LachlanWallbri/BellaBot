...
public class Cloner {
    ...
    public Cloner() {
        ...
        this.deepCloner = new IDeepCloner() { // from class: com.pudutech.peanut.presenter.utils.cloner.cloning.Cloner.1
            @Override // com.pudutech.peanut.presenter.utils.cloner.cloning.IDeepCloner
    ...
    public void setDumpClonedClasses(boolean z) {
        if (z) {
            this.dumpCloned = new IDumpCloned() { // from class: com.pudutech.peanut.presenter.utils.cloner.cloning.Cloner.2
                @Override // com.pudutech.peanut.presenter.utils.cloner.cloning.IDumpCloned

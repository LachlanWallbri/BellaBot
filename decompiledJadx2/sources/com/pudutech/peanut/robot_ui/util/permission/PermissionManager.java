package com.pudutech.peanut.robot_ui.util.permission;
...
public final class PermissionManager {
    ...
    public static final void requestGroupPermission(AppCompatActivity appCompatActivity, String[] strArr, final PermissionResultListener permissionResultListener) {
        ...
        new RxPermissions(appCompatActivity).request(strArr).subscribe(new Consumer<Boolean>() { // from class: com.pudutech.peanut.robot_ui.util.permission.PermissionManager.1

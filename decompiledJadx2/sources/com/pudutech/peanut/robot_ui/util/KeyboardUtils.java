...
public final class KeyboardUtils {
    ...
    public static void showSoftInput(View view, int i) {
        ...
        view.requestFocus();
        inputMethodManager.showSoftInput(view, i, new ResultReceiver(new Handler()) { // from class: com.pudutech.peanut.robot_ui.util.KeyboardUtils.1
    ...
    public static void registerSoftInputChangedListener(final Window window, final OnSoftInputChangedListener onSoftInputChangedListener) {
        ...
        frameLayout.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: com.pudutech.peanut.robot_ui.util.KeyboardUtils.2
    ...
    public static void fixAndroidBug5497(final Window window) {
        ...
        frameLayout.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: com.pudutech.peanut.robot_ui.util.KeyboardUtils.3
            @Override // android.view.ViewTreeObserver.OnGlobalLayoutListener
            public void onGlobalLayout() {

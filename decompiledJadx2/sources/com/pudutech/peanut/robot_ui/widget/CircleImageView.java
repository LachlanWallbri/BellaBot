...
public class CircleImageView extends AppCompatImageView {
    ...
    public CircleImageView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mBorderColor = -16777216;
        this.mBorderWidth = 0;
        context.getTheme().obtainStyledAttributes(attributeSet, C5508R.styleable.CircleImageView, i, 0);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C5508R.styleable.CircleImageView, i, 0);
        this.mBorderWidth = obtainStyledAttributes.getDimensionPixelSize(C5508R.styleable.CircleImageView_border_width, 0);
        this.mBorderColor = obtainStyledAttributes.getColor(C5508R.styleable.CircleImageView_border_color, -16777216);

...
public class AnimatedRandomLayout extends FrameLayout {
    ...
    public AnimatedRandomLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        this.handler = new Handler() { // from class: com.pudutech.peanut.robot_ui.widget.random_layout.AnimatedRandomLayout.1
    ...
    public void loopChild() {
        ...
        resetPanelForChild();
        generateChild();
        getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: com.pudutech.peanut.robot_ui.widget.random_layout.AnimatedRandomLayout.2
            ...
            if (childAt.getVisibility() != 8 && !this.mFixedViews.contains(childAt)) {
                ...
                while (i11 > 0) {
                    ...
                    if (this.mAreaDensity[i15][i14] < i10) {
                        ...
                        i7 = i12;
                        int min = Math.min(((int) (i15 * f)) + getPaddingLeft() + childInBlockOffestX, paddingRight);
    ...
    public void startZoomAnimation() {
        for (final View view : this.justInitChilds) {
            ...
            if (((int) Math.sqrt(Math.pow(Math.abs(this.mCenter.x - childViewBound.getChildLeft()), 2.0d) + Math.pow(Math.abs(this.mCenter.y - childViewBound.getChildTop()), 2.0d))) <= right) {
                ...
                animatorUtil.getAnimate().setListener(new AnimatorListenerAdapter() { // from class: com.pudutech.peanut.robot_ui.widget.random_layout.AnimatedRandomLayout.3

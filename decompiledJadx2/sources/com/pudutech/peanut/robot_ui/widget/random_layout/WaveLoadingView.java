...
public class WaveLoadingView extends View {
    ...
    private void init(Context context, AttributeSet attributeSet, int i) {
        ...
        initAnimation();
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C5508R.styleable.WaveLoadingView, i, 0);
        this.mShapeType = obtainStyledAttributes.getInteger(C5508R.styleable.WaveLoadingView_wlv_shapeType, DEFAULT_WAVE_SHAPE);
        this.mWaveColor = obtainStyledAttributes.getColor(C5508R.styleable.WaveLoadingView_wlv_waveColor, DEFAULT_WAVE_COLOR);
        this.mWaveBgColor = obtainStyledAttributes.getColor(C5508R.styleable.WaveLoadingView_wlv_wave_background_Color, DEFAULT_WAVE_BACKGROUND_COLOR);
        this.mWaveBgPaint.setColor(this.mWaveBgColor);
        float f = obtainStyledAttributes.getFloat(C5508R.styleable.WaveLoadingView_wlv_waveAmplitude, 50.0f) / 1000.0f;
        if (f > 0.1f) {
            f = 0.1f;
        }
        this.mAmplitudeRatio = f;
        this.mProgressValue = obtainStyledAttributes.getInteger(C5508R.styleable.WaveLoadingView_wlv_progressValue, 50);
        setProgressValue(this.mProgressValue);
        this.mIsRoundRectangle = obtainStyledAttributes.getBoolean(C5508R.styleable.WaveLoadingView_wlv_round_rectangle, false);
        this.mRoundRectangleXY = obtainStyledAttributes.getInteger(C5508R.styleable.WaveLoadingView_wlv_round_rectangle_x_and_y, 30);
        this.mTriangleDirection = obtainStyledAttributes.getInteger(C5508R.styleable.WaveLoadingView_wlv_triangle_direction, DEFAULT_TRIANGLE_DIRECTION);
        this.mBorderPaint = new Paint();
        this.mBorderPaint.setAntiAlias(true);
        this.mBorderPaint.setStyle(Paint.Style.STROKE);
        this.mBorderPaint.setStrokeWidth(obtainStyledAttributes.getDimension(C5508R.styleable.WaveLoadingView_wlv_borderWidth, dp2px(0.0f)));
        this.mBorderPaint.setColor(obtainStyledAttributes.getColor(C5508R.styleable.WaveLoadingView_wlv_borderColor, DEFAULT_WAVE_COLOR));
        this.mTopTitlePaint = new Paint();
        this.mTopTitlePaint.setColor(obtainStyledAttributes.getColor(C5508R.styleable.WaveLoadingView_wlv_titleTopColor, DEFAULT_TITLE_COLOR));
        this.mTopTitlePaint.setStyle(Paint.Style.FILL);
        this.mTopTitlePaint.setAntiAlias(true);
        this.mTopTitlePaint.setTextSize(obtainStyledAttributes.getDimension(C5508R.styleable.WaveLoadingView_wlv_titleTopSize, sp2px(18.0f)));
        this.mTopTitleStrokePaint = new Paint();
        this.mTopTitleStrokePaint.setColor(obtainStyledAttributes.getColor(C5508R.styleable.WaveLoadingView_wlv_titleTopStrokeColor, 0));
        this.mTopTitleStrokePaint.setStrokeWidth(obtainStyledAttributes.getDimension(C5508R.styleable.WaveLoadingView_wlv_titleTopStrokeWidth, dp2px(0.0f)));
        ...
        this.mTopTitle = obtainStyledAttributes.getString(C5508R.styleable.WaveLoadingView_wlv_titleTop);
        this.mCenterTitlePaint = new Paint();
        this.mCenterTitlePaint.setColor(obtainStyledAttributes.getColor(C5508R.styleable.WaveLoadingView_wlv_titleCenterColor, DEFAULT_TITLE_COLOR));
        this.mCenterTitlePaint.setStyle(Paint.Style.FILL);
        this.mCenterTitlePaint.setAntiAlias(true);
        this.mCenterTitlePaint.setTextSize(obtainStyledAttributes.getDimension(C5508R.styleable.WaveLoadingView_wlv_titleCenterSize, sp2px(DEFAULT_TITLE_CENTER_SIZE)));
        this.mPercebtPaint = new Paint();
        this.mPercebtPaint.setColor(obtainStyledAttributes.getColor(C5508R.styleable.WaveLoadingView_wlv_titleCenterColor, DEFAULT_TITLE_COLOR));
        ...
        this.mCenterTitleStrokePaint.setColor(obtainStyledAttributes.getColor(C5508R.styleable.WaveLoadingView_wlv_titleCenterStrokeColor, 0));
        this.mCenterTitleStrokePaint.setStrokeWidth(obtainStyledAttributes.getDimension(C5508R.styleable.WaveLoadingView_wlv_titleCenterStrokeWidth, dp2px(0.0f)));
        ...
        this.mCenterTitle = obtainStyledAttributes.getString(C5508R.styleable.WaveLoadingView_wlv_titleCenter);
        this.mBottomTitlePaint = new Paint();
        this.mBottomTitlePaint.setColor(obtainStyledAttributes.getColor(C5508R.styleable.WaveLoadingView_wlv_titleBottomColor, DEFAULT_TITLE_COLOR));
        this.mBottomTitlePaint.setStyle(Paint.Style.FILL);
        this.mBottomTitlePaint.setAntiAlias(true);
        this.mBottomTitlePaint.setTextSize(obtainStyledAttributes.getDimension(C5508R.styleable.WaveLoadingView_wlv_titleBottomSize, sp2px(18.0f)));
        this.mBottomTitleStrokePaint = new Paint();
        this.mBottomTitleStrokePaint.setColor(obtainStyledAttributes.getColor(C5508R.styleable.WaveLoadingView_wlv_titleBottomStrokeColor, 0));
        this.mBottomTitleStrokePaint.setStrokeWidth(obtainStyledAttributes.getDimension(C5508R.styleable.WaveLoadingView_wlv_titleBottomStrokeWidth, dp2px(0.0f)));
        ...
        this.mBottomTitle = obtainStyledAttributes.getString(C5508R.styleable.WaveLoadingView_wlv_titleBottom);

...
public final class FaceSoundPlayManager {
    ...
    private final void createHandlerIfNeed() {
        if (playHandler == null) {
            ...
            playHandler = new Handler(looper) { // from class: com.pudutech.peanut.robot_ui.manager.FaceSoundPlayManager$createHandlerIfNeed$1
    ...
    private final MediaPlayer getMediaPlayer(final int resId, final int playId) {
        try {
            ...
            mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() { // from class: com.pudutech.peanut.robot_ui.manager.FaceSoundPlayManager$getMediaPlayer$1
            ...
            mediaPlayer.setOnPreparedListener(new MediaPlayer.OnPreparedListener() { // from class: com.pudutech.peanut.robot_ui.manager.FaceSoundPlayManager$getMediaPlayer$2

...
final class GreeterActivity$onTheWayLayout$2 extends Lambda implements Function0<OnTheWayLayout> {
    final /* synthetic */ GreeterActivity this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public GreeterActivity$onTheWayLayout$2(GreeterActivity greeterActivity) {
        super(0);
    ...
    public final OnTheWayLayout invoke() {
        ...
        onTheWayLayout.setOnClickListener(new OnLazyClickListener() { // from class: com.pudutech.peanut.robot_ui.ui.greeter.GreeterActivity$onTheWayLayout$2$$special$$inlined$apply$lambda$1
            @Override // com.pudutech.peanut.robot_ui.listener.OnLazyClickListener
            public void onSingleClick() {
                String str;
                GreeterVm greeterVm;
                str = GreeterActivity$onTheWayLayout$2.this.this$0.TAG;
                Pdlog.m3273d(str, " on_the_way_layout onSingleClick");
                greeterVm = GreeterActivity$onTheWayLayout$2.this.this$0.getGreeterVm();
                if (greeterVm != null) {
                    greeterVm.pause();
                }
            }

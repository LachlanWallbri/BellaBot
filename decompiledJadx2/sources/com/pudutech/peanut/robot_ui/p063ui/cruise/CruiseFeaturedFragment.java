...
public final class CruiseFeaturedFragment extends Fragment {
    ...
    public CruiseFeaturedFragment() {
        final Function0<Fragment> function0 = new Function0<Fragment>() { // from class: com.pudutech.peanut.robot_ui.ui.cruise.CruiseFeaturedFragment$$special$$inlined$viewModels$1
            {
                super(0);
            }
        ...
        this.mPromotionVm = FragmentViewModelLazyKt.createViewModelLazy(this, Reflection.getOrCreateKotlinClass(PromotionsViewModel.class), new Function0<ViewModelStore>() { // from class: com.pudutech.peanut.robot_ui.ui.cruise.CruiseFeaturedFragment$$special$$inlined$viewModels$2
            {
                super(0);
            }
    ...
    private final void initView() {
        ...
        smartRefreshLayout.setOnLoadMoreListener(new OnLoadMoreListener() { // from class: com.pudutech.peanut.robot_ui.ui.cruise.CruiseFeaturedFragment$initView$1
            ...
            public final void onLoadMore(RefreshLayout it) {
                ...
                CruiseFeaturedFragment cruiseFeaturedFragment = CruiseFeaturedFragment.this;
                i = cruiseFeaturedFragment.pageIndex;
                cruiseFeaturedFragment.pageIndex = i + 1;
                mPromotionVm = CruiseFeaturedFragment.this.getMPromotionVm();
                i2 = CruiseFeaturedFragment.this.pageIndex;
        ...
        smartRefreshLayout2.setOnRefreshListener(new OnRefreshListener() { // from class: com.pudutech.peanut.robot_ui.ui.cruise.CruiseFeaturedFragment$initView$2
            ...
            public final void onRefresh(RefreshLayout it) {
                ...
                int i;
                Intrinsics.checkParameterIsNotNull(it, "it");
                CruiseFeaturedFragment.this.pageIndex = 0;
                list = CruiseFeaturedFragment.this.mList;
                if (list != null) {
                    list.clear();
                }
                mPromotionVm = CruiseFeaturedFragment.this.getMPromotionVm();
                i = CruiseFeaturedFragment.this.pageIndex;
        ...
        ViewExtKt.onSingleClick(tvShop, new Function1<View, Unit>() { // from class: com.pudutech.peanut.robot_ui.ui.cruise.CruiseFeaturedFragment$initView$3
            ...
            public final void invoke2(View it) {
                Intrinsics.checkParameterIsNotNull(it, "it");
                Intent intent = new Intent(CruiseFeaturedFragment.this.getActivity(), (Class<?>) SolicitCustomerActivity.class);
                intent.putExtra("state", 1);
                CruiseFeaturedFragment.this.jumpAndFinish(intent);
            }
        });
        ...
        ViewExtKt.onSingleClick(tvCoupon, new Function1<View, Unit>() { // from class: com.pudutech.peanut.robot_ui.ui.cruise.CruiseFeaturedFragment$initView$4
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
            ...
            public final void invoke2(View it) {
                Intrinsics.checkParameterIsNotNull(it, "it");
                NavigationExtKt.nav(CruiseFeaturedFragment.this).navigate(C5508R.id.action_FeaturedPromotions_to_initNav);
            }
        });
        ...
        ViewExtKt.onSingleClick(tvPromotions, new Function1<View, Unit>() { // from class: com.pudutech.peanut.robot_ui.ui.cruise.CruiseFeaturedFragment$initView$5
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
        ...
        ViewExtKt.onSingleClick(tvGoShop, new Function1<View, Unit>() { // from class: com.pudutech.peanut.robot_ui.ui.cruise.CruiseFeaturedFragment$initView$6
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
        ...
        ViewExtKt.onSingleClick(llBack, new Function1<View, Unit>() { // from class: com.pudutech.peanut.robot_ui.ui.cruise.CruiseFeaturedFragment$initView$7
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
            ...
            public final void invoke2(View it) {
                Intrinsics.checkParameterIsNotNull(it, "it");
                NavigationExtKt.nav(CruiseFeaturedFragment.this).popBackStack();
            }
        });
    }
    ...
    private final void initVM() {
        ...
        getMPromotionVm().getMFeaturedDada().observe(getViewLifecycleOwner(), new Observer<List<? extends FeaturedBean>>() { // from class: com.pudutech.peanut.robot_ui.ui.cruise.CruiseFeaturedFragment$initVM$1
            ...
            public final void onChanged2(List<FeaturedBean> list) {
                int i;
                if (list == null) {
                    LinearLayout llTitle = (LinearLayout) CruiseFeaturedFragment.this._$_findCachedViewById(C5508R.id.llTitle);
                    Intrinsics.checkExpressionValueIsNotNull(llTitle, "llTitle");
                    llTitle.setVisibility(8);
                    SmartRefreshLayout smartRefreshLayout = (SmartRefreshLayout) CruiseFeaturedFragment.this._$_findCachedViewById(C5508R.id.refresh);
                    if (smartRefreshLayout != null) {
                        smartRefreshLayout.finishRefresh(true);
                    }
                    SmartRefreshLayout smartRefreshLayout2 = (SmartRefreshLayout) CruiseFeaturedFragment.this._$_findCachedViewById(C5508R.id.refresh);
                    if (smartRefreshLayout2 != null) {
                ...
                SmartRefreshLayout smartRefreshLayout3 = (SmartRefreshLayout) CruiseFeaturedFragment.this._$_findCachedViewById(C5508R.id.refresh);
                if (smartRefreshLayout3 != null) {
                    smartRefreshLayout3.finishRefresh();
                }
                SmartRefreshLayout smartRefreshLayout4 = (SmartRefreshLayout) CruiseFeaturedFragment.this._$_findCachedViewById(C5508R.id.refresh);
                if (smartRefreshLayout4 != null) {
                    smartRefreshLayout4.finishLoadMore();
                }
                i = CruiseFeaturedFragment.this.pageIndex;
                if (i == 0) {
                    ((SmartRefreshLayout) CruiseFeaturedFragment.this._$_findCachedViewById(C5508R.id.refresh)).finishRefresh();
                } else {
                    ((SmartRefreshLayout) CruiseFeaturedFragment.this._$_findCachedViewById(C5508R.id.refresh)).finishLoadMore();
                }
                CruiseFeaturedFragment.this.setData(list);
            }
        });
    }
    ...
    /* compiled from: CruiseFeaturedFragment.kt */
    @Metadata(m3959bv = {1, 0, 3}, m3960d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001:\u0001\u0007B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0006\u0010\u0005\u001a\u00020\u0006R\u000e\u0010\u0003\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000¨\u0006\b"}, m3961d2 = {"Lcom/pudutech/peanut/robot_ui/ui/cruise/CruiseFeaturedFragment$Companion;", "", "()V", "DATA_NOTIFY", "", "newInstance", "Lcom/pudutech/peanut/robot_ui/ui/cruise/CruiseFeaturedFragment;", "WithoutLeakHandler", "robot_ui_peanutRelease"}, m3962k = 1, m3963mv = {1, 1, 16})
    /* loaded from: classes5.dex */
    public static final class Companion {
        ...
        public final CruiseFeaturedFragment newInstance() {
            return new CruiseFeaturedFragment();
        }

        /* compiled from: CruiseFeaturedFragment.kt */
        @Metadata(m3959bv = {1, 0, 3}, m3960d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0002\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\u0010\u0010\u0007\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\nH\u0016R\u0014\u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00030\u0006X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u000b"}, m3961d2 = {"Lcom/pudutech/peanut/robot_ui/ui/cruise/CruiseFeaturedFragment$Companion$WithoutLeakHandler;", "Landroid/os/Handler;", "fragment", "Lcom/pudutech/peanut/robot_ui/ui/cruise/CruiseFeaturedFragment;", "(Lcom/pudutech/peanut/robot_ui/ui/cruise/CruiseFeaturedFragment;)V", "mActivity", "Ljava/lang/ref/WeakReference;", "handleMessage", "", NotificationCompat.CATEGORY_MESSAGE, "Landroid/os/Message;", "robot_ui_peanutRelease"}, m3962k = 1, m3963mv = {1, 1, 16})
        /* loaded from: classes5.dex */
        private static final class WithoutLeakHandler extends Handler {
            private WeakReference<CruiseFeaturedFragment> mActivity;

            public WithoutLeakHandler(CruiseFeaturedFragment fragment) {
            ...
            public void handleMessage(Message msg) {
                ...
                CruiseFeaturedFragment cruiseFeaturedFragment = this.mActivity.get();
                if (cruiseFeaturedFragment == null || msg.what != 4) {
                    return;
                }
                cruiseFeaturedFragment.setData(cruiseFeaturedFragment.mData);
            }
        }
    }
}

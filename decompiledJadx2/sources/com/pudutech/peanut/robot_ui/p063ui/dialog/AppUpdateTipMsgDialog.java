...
public class AppUpdateTipMsgDialog extends Dialog {
    ...
    private final void build() {
        View inflate = getLayoutInflater().inflate(C5508R.layout.fragment_version_setup_check_result_dialog, (ViewGroup) null);
    ...
    private final void initView() {
        TextView textView = (TextView) findViewById(C5508R.id.show_check_version);
        if (textView != null) {
            StringBuilder sb = new StringBuilder();
            sb.append(RobotContext.INSTANCE.getContext().getString(C5508R.string.pdStr7_32));
            sb.append("：");
        ...
        TextView textView2 = (TextView) findViewById(C5508R.id.edit_check_update_result_show);
        if (textView2 != null) {
        ...
        if (frameLayout != null) {
            frameLayout.setOnClickListener(new View.OnClickListener() { // from class: com.pudutech.peanut.robot_ui.ui.dialog.AppUpdateTipMsgDialog$initView$1
        ...
        Button button = (Button) findViewById(C5508R.id.update);
        if (button != null) {
            button.setOnClickListener(new View.OnClickListener() { // from class: com.pudutech.peanut.robot_ui.ui.dialog.AppUpdateTipMsgDialog$initView$2
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
    ...
    public final void canCancel(boolean c) {
        ...
        FrameLayout frameLayout2 = (FrameLayout) findViewById(C5508R.id.cancel);

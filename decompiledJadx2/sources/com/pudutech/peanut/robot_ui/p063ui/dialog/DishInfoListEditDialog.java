...
import com.pudutech.peanut.robot_ui.p063ui.adapter.DishInfoEditAdapter;
import com.pudutech.peanut.robot_ui.p063ui.adapter.StaggeredDividerItemDecoration;
...
@Metadata(m3959bv = {1, 0, 3}, m3960d1 = {"\u0000V\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u000b\u0018\u00002\u00020\u0001B\u000f\b\u0016\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004B\u0017\b\u0016\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0005\u001a\u00020\u0006¢\u0006\u0002\u0010\u0007J\b\u0010\u001e\u001a\u00020\u0017H\u0002J\u0010\u0010\u001f\u001a\u00020\u00172\u0006\u0010\u0002\u001a\u00020\u0003H\u0002J\b\u0010 \u001a\u00020\u0017H\u0002J\b\u0010!\u001a\u00020\u0017H\u0016J\b\u0010\"\u001a\u00020\u0017H\u0016J\u001e\u0010#\u001a\u00020\u00172\u0016\u0010$\u001a\u0012\u0012\u0004\u0012\u00020\u00160\fj\b\u0012\u0004\u0012\u00020\u0016`\u000eJ\b\u0010%\u001a\u00020\u0017H\u0016J\u000e\u0010&\u001a\u00020\u00172\u0006\u0010'\u001a\u00020\u0012R\u0016\u0010\b\u001a\n \n*\u0004\u0018\u00010\t0\tX\u0082\u0004¢\u0006\u0002\n\u0000R\u001e\u0010\u000b\u001a\u0012\u0012\u0004\u0012\u00020\r0\fj\b\u0012\u0004\u0012\u00020\r`\u000eX\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u000f\u001a\u00020\u0010X\u0082.¢\u0006\u0002\n\u0000R\u000e\u0010\u0011\u001a\u00020\u0012X\u0082\u000e¢\u0006\u0002\n\u0000R\u0010\u0010\u0013\u001a\u0004\u0018\u00010\u0003X\u0082\u000e¢\u0006\u0002\n\u0000R8\u0010\u0014\u001a \u0012\u0014\u0012\u0012\u0012\u0004\u0012\u00020\u00160\fj\b\u0012\u0004\u0012\u00020\u0016`\u000e\u0012\u0004\u0012\u00020\u0017\u0018\u00010\u0015X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0018\u0010\u0019\"\u0004\b\u001a\u0010\u001bR\u000e\u0010\u001c\u001a\u00020\u001dX\u0082.¢\u0006\u0002\n\u0000¨\u0006("}, m3961d2 = {"Lcom/pudutech/peanut/robot_ui/ui/dialog/DishInfoListEditDialog;", "Landroid/app/Dialog;", "context", "Landroid/content/Context;", "(Landroid/content/Context;)V", "themeResID", "", "(Landroid/content/Context;I)V", "TAG", "", "kotlin.jvm.PlatformType", "dataList", "Ljava/util/ArrayList;", "Lcom/pudutech/peanut/robot_ui/ui/adapter/DishInfoEditAdapter$DishInfoEdit;", "Lkotlin/collections/ArrayList;", "dishInfoEditAdapter", "Lcom/pudutech/peanut/robot_ui/ui/adapter/DishInfoEditAdapter;", "isBirthdayTheme", "", "mContext", "onDateEditFinishListener", "Lkotlin/Function1;", "Lcom/pudutech/peanut/presenter/information_system_task/InformationSystemContract$OrderInfo;", "", "getOnDateEditFinishListener", "()Lkotlin/jvm/functions/Function1;", "setOnDateEditFinishListener", "(Lkotlin/jvm/functions/Function1;)V", "view", "Landroid/view/View;", JsonPOJOBuilder.DEFAULT_BUILD_METHOD, "init", "initView", "onAttachedToWindow", "onDetachedFromWindow", "setDishInfo", "datas", "show", "switchBirthdayTheme", "boolean", "robot_ui_peanutRelease"}, m3962k = 1, m3963mv = {1, 1, 16})
...
public final class DishInfoListEditDialog extends Dialog {
    ...
    public final void switchBirthdayTheme(boolean r3) {
        if (this.isBirthdayTheme != r3) {
            ...
            if (this.isBirthdayTheme) {
                ((CardView) findViewById(C5508R.id.list_layout)).setCardBackgroundColor(getContext().getColor(C5508R.color.table_birthday_bg));
            } else {
                ((CardView) findViewById(C5508R.id.list_layout)).setCardBackgroundColor(getContext().getColor(C5508R.color.white));
            }
    ...
    private final void build() {
        View inflate = getLayoutInflater().inflate(C5508R.layout.dialog_dish_info_list_edit, (ViewGroup) null);
    ...
    private final void initView() {
        ((TextView) findViewById(C5508R.id.btn_return)).setOnClickListener(new OnLazyClickListener() { // from class: com.pudutech.peanut.robot_ui.ui.dialog.DishInfoListEditDialog$initView$1
        ...
        ((TextView) findViewById(C5508R.id.btn_sure)).setOnClickListener(new OnLazyClickListener() { // from class: com.pudutech.peanut.robot_ui.ui.dialog.DishInfoListEditDialog$initView$2
            @Override // com.pudutech.peanut.robot_ui.listener.OnLazyClickListener
            public void onSingleClick() {
                String str;
                str = DishInfoListEditDialog.this.TAG;
        ...
        RecyclerView dish_info_recycler_view = (RecyclerView) findViewById(C5508R.id.dish_info_recycler_view);
        ...
        RecyclerView dish_info_recycler_view2 = (RecyclerView) findViewById(C5508R.id.dish_info_recycler_view);
        ...
        ((RecyclerView) findViewById(C5508R.id.dish_info_recycler_view)).addItemDecoration(new StaggeredDividerItemDecoration(getContext(), 20.0f, 2));
        DishInfoEditAdapter dishInfoEditAdapter3 = this.dishInfoEditAdapter;
        if (dishInfoEditAdapter3 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("dishInfoEditAdapter");
        }
        dishInfoEditAdapter3.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() { // from class: com.pudutech.peanut.robot_ui.ui.dialog.DishInfoListEditDialog$initView$3
            @Override // com.chad.library.adapter.base.BaseQuickAdapter.OnItemClickListener
            public final void onItemClick(BaseQuickAdapter<Object, BaseViewHolder> adapter, View view, int i) {
                Intrinsics.checkExpressionValueIsNotNull(adapter, "adapter");
                Object obj = adapter.getData().get(i);
                if (obj == null) {
                    throw new TypeCastException("null cannot be cast to non-null type com.pudutech.peanut.robot_ui.ui.adapter.DishInfoEditAdapter.DishInfoEdit");
                }
                ((DishInfoEditAdapter.DishInfoEdit) obj).setClose(!r1.isClose());
                DishInfoListEditDialog.access$getDishInfoEditAdapter$p(DishInfoListEditDialog.this).notifyItemChanged(i);
            }
        });
    }

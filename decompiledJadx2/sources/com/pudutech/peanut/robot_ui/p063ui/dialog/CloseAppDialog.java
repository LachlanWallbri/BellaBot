...
public class CloseAppDialog extends Dialog {
    ...
    private final void build() {
        View inflate = getLayoutInflater().inflate(C5508R.layout.fragment_close_app_dialog, (ViewGroup) null);
    ...
    private final void initView() {
        ImageView imageView = (ImageView) findViewById(C5508R.id.ivClose);
        if (imageView != null) {
            imageView.setOnClickListener(new View.OnClickListener() { // from class: com.pudutech.peanut.robot_ui.ui.dialog.CloseAppDialog$initView$1
        ...
        LinearLayout linearLayout = (LinearLayout) findViewById(C5508R.id.llClose);
        if (linearLayout != null) {
            linearLayout.setOnClickListener(new View.OnClickListener() { // from class: com.pudutech.peanut.robot_ui.ui.dialog.CloseAppDialog$initView$2
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
        ...
        LinearLayout linearLayout2 = (LinearLayout) findViewById(C5508R.id.llRestart);
        if (linearLayout2 != null) {
            linearLayout2.setOnClickListener(new View.OnClickListener() { // from class: com.pudutech.peanut.robot_ui.ui.dialog.CloseAppDialog$initView$3
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    Function1<Boolean, Unit> onShutDownClick = CloseAppDialog.this.getOnShutDownClick();
                    if (onShutDownClick != null) {

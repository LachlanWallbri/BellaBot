...
@DebugMetadata(m3969c = "com.pudutech.peanut.robot_ui.ui.view.videoface.FaceVideoView$onTouchEvent$1", m3970f = "FaceVideoView.kt", m3971i = {0, 0}, m3972l = {512}, m3973m = "invokeSuspend", m3974n = {"$this$launch", "idx"}, m3975s = {"L$0", "I$0"})
...
public final class FaceVideoView$onTouchEvent$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> completion) {
        ...
        faceVideoView$onTouchEvent$1.f7052p$ = (CoroutineScope) obj;
    ...
    */
    public final Object invokeSuspend(Object obj) {
        ...
        if (i2 == 1) {
            ...
            if (i >= 5) {
                BuildersKt__Builders_commonKt.launch$default(GlobalScope.INSTANCE, Dispatchers.getMain(), null, new C56001(null), 2, null);
                faceVideoView$onTouchEvent$1.this$0.locationLostStopTouchJob = (Job) null;
                return Unit.INSTANCE;
            }
            if (CoroutineScopeKt.isActive(coroutineScope)) {
    ...
    /* compiled from: FaceVideoView.kt */
    @Metadata(m3959bv = {1, 0, 3}, m3960d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@¢\u0006\u0004\b\u0003\u0010\u0004"}, m3961d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;", "invoke", "(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;"}, m3962k = 3, m3963mv = {1, 1, 16})
    @DebugMetadata(m3969c = "com.pudutech.peanut.robot_ui.ui.view.videoface.FaceVideoView$onTouchEvent$1$1", m3970f = "FaceVideoView.kt", m3971i = {}, m3972l = {}, m3973m = "invokeSuspend", m3974n = {}, m3975s = {})
    /* renamed from: com.pudutech.peanut.robot_ui.ui.view.videoface.FaceVideoView$onTouchEvent$1$1 */
    /* loaded from: classes5.dex */
    public static final class C56001 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        int label;

        /* renamed from: p$ */
        private CoroutineScope f7053p$;

        C56001(Continuation continuation) {
            super(2, continuation);
        }
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> completion) {
            Intrinsics.checkParameterIsNotNull(completion, "completion");
            C56001 c56001 = new C56001(completion);
            c56001.f7053p$ = (CoroutineScope) obj;
            return c56001;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            return ((C56001) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            ResultKt.throwOnFailure(obj);
            CoroutineScope coroutineScope = this.f7053p$;

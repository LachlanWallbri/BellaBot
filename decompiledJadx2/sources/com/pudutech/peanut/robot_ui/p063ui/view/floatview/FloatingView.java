...
public class FloatingView implements IFloatingView {
    ...
    @Override // com.pudutech.peanut.robot_ui.p063ui.view.floatview.IFloatingView
    public FloatingView remove() {
        new Handler(Looper.getMainLooper()).post(new Runnable() { // from class: com.pudutech.peanut.robot_ui.ui.view.floatview.FloatingView.1

...
public class FloatView extends LinearLayout {
    ...
    /* renamed from: wm */
    private WindowManager f7045wm;
    private WindowManager.LayoutParams wmParams;

    /* renamed from: x */
    private float f7046x;

    /* renamed from: y */
    private float f7047y;
    ...
    private void init(View view, int i, int i2) {
        this.f7045wm = (WindowManager) getContext().getSystemService("window");
    ...
    public void updateFloatViewPosition(int i, int i2) {
        ...
        layoutParams.x = i;
        layoutParams.y = i2;
        this.f7045wm.updateViewLayout(this, layoutParams);
    }
    ...
    public boolean addToWindow() {
        if (this.f7045wm != null) {
            if (Build.VERSION.SDK_INT >= 19) {
                if (isAttachedToWindow()) {
                    return false;
                }
                this.f7045wm.addView(this, this.wmParams);
                return true;
            }
            try {
                if (getParent() == null) {
    ...
    public boolean removeFromWindow() {
        if (this.f7045wm != null) {
            if (Build.VERSION.SDK_INT >= 19) {
                ...
                this.f7045wm.removeViewImmediate(this);
                return true;
            }
            try {
                if (getParent() != null) {
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 1) {
            this.f7047y = ((int) motionEvent.getRawY()) - (getMeasuredHeight() / 2);
            this.f7046x = ((int) motionEvent.getRawX()) - (getMeasuredWidth() / 2);
            if (Math.abs(this.f7047y - this.mTouchStartY) > 10.0f || Math.abs(this.f7046x - this.mTouchStartX) > 10.0f) {
                this.f7045wm.updateViewLayout(this, this.wmParams);
            } else {

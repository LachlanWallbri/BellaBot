...
public final class WelComeActivateFragment extends Fragment implements TouchListenerManager.OnTouchListener, SolicitInfoManager.OnFaceChangeListener {
    ...
    public WelComeActivateFragment() {
        final Function0<Fragment> function0 = new Function0<Fragment>() { // from class: com.pudutech.peanut.robot_ui.ui.fragment.WelComeActivateFragment$$special$$inlined$viewModels$1
            {
                super(0);
            }
        ...
        this.weComeVm = FragmentViewModelLazyKt.createViewModelLazy(this, Reflection.getOrCreateKotlinClass(WelComeActivateViewModel.class), new Function0<ViewModelStore>() { // from class: com.pudutech.peanut.robot_ui.ui.fragment.WelComeActivateFragment$$special$$inlined$viewModels$2
            {
                super(0);
            }
        ...
        this.count = 1;
        this.finishId = -1;
        this.onFaceAnimationViewClick = new SingleClickListener(new Function0<Unit>() { // from class: com.pudutech.peanut.robot_ui.ui.fragment.WelComeActivateFragment$onFaceAnimationViewClick$1
            ...
            public final void invoke2() {
                ...
                WelComeActivateFragment.this.playAnimationMode(3);
                WelComeActivateFragment.INSTANCE.setRecording(false);
                RobotConfig.INSTANCE.setFaceDetectorSwitch(true);
            }
        });
    }
    ...
    public void onAttach(Context context) {
        ...
        SolicitInfoManager.INSTANCE.addFaceChangeListener(this);
    }
    ...
    public void onDetach() {
        ...
        SolicitInfoManager.INSTANCE.removeFaceChangeListener(this);
        isRecording = false;
    }
    ...
    private final void initView() {
        ...
        ((RecyclerView) _$_findCachedViewById(C5508R.id.recyclerView)).addOnScrollListener(new RecyclerView.OnScrollListener() { // from class: com.pudutech.peanut.robot_ui.ui.fragment.WelComeActivateFragment$initView$2
            ...
            public void onScrollStateChanged(RecyclerView recyclerView2, int newState) {
                ...
                z = WelComeActivateFragment.this.mShouldScroll;
                if (z && newState == 0) {
                    WelComeActivateFragment.this.mShouldScroll = false;
                    WelComeActivateFragment welComeActivateFragment = WelComeActivateFragment.this;
                    i = welComeActivateFragment.mToPosition;
                    welComeActivateFragment.smoothMoveToPosition(i);
                }
            }
        });
        ...
        ViewExtKt.onSingleClick(tvCoupon, new Function1<View, Unit>() { // from class: com.pudutech.peanut.robot_ui.ui.fragment.WelComeActivateFragment$initView$3
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
            ...
            public final void invoke2(View it) {
                ...
                WelComeActivateFragment.this.jump(2);
            }
        });
        ...
        ViewExtKt.onSingleClick(tvFeatured, new Function1<View, Unit>() { // from class: com.pudutech.peanut.robot_ui.ui.fragment.WelComeActivateFragment$initView$4
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
            ...
            public final void invoke2(View it) {
                Intrinsics.checkParameterIsNotNull(it, "it");
                WelComeActivateFragment.this.jump(1);
            }
        });
        ...
        ViewExtKt.onSingleClick(tvGoShops, new Function1<View, Unit>() { // from class: com.pudutech.peanut.robot_ui.ui.fragment.WelComeActivateFragment$initView$5
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
            ...
            public final void invoke2(View it) {
                Intrinsics.checkParameterIsNotNull(it, "it");
                WelComeActivateFragment.this.jump(3);
            }
        });
        ...
        ViewExtKt.onSingleClick(llBack, new Function1<View, Unit>() { // from class: com.pudutech.peanut.robot_ui.ui.fragment.WelComeActivateFragment$initView$6
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
            ...
            public final void invoke2(View it) {
                Intrinsics.checkParameterIsNotNull(it, "it");
                WelComeActivateFragment.this.handler.sendEmptyMessage(9);
            }
        });
    }
    ...
    private final void initVM() {
        ...
        getWeComeVm().getMsgModel().observe(getViewLifecycleOwner(), new Observer<WeComeBean>() { // from class: com.pudutech.peanut.robot_ui.ui.fragment.WelComeActivateFragment$initVM$1
            ...
            public final void onChanged(WeComeBean msg) {
                ...
                Pdlog.m3273d(WelComeActivateFragment.this.TAG, "msgModel: " + msg.toString() + ' ');
                if (msg.getType() == 1) {
                    if ((msg.getContent().length() > 0) && (marqueeTextView = WelComeActivateFragment.this.tvInputText) != null) {
                        marqueeTextView.setText(msg.getContent());
                    }
                    if (Intrinsics.areEqual((Object) msg.isFinish(), (Object) true)) {
                        i = WelComeActivateFragment.this.finishId;
                        if (i != msg.getId()) {
                            str = WelComeActivateFragment.this.content;
                            if (Intrinsics.areEqual(str, msg.getContent())) {
                                return;
                            }
                            WelComeActivateFragment.this.handler.sendEmptyMessage(7);
                            WelComeActivateFragment.this.finishId = msg.getId();
                            WelComeActivateFragment.this.content = msg.getContent();
                        }
                    }
                    WelComeActivateFragment.this.count = msg.getId();
                    z = WelComeActivateFragment.this.isStarSpeak;
                    if (z) {
                        return;
                    }
                    WelComeActivateFragment.this.handler.sendEmptyMessage(8);
                    WelComeActivateFragment.this.isStarSpeak = true;
                    WelComeActivateFragment.this.playAnimationMode(4);
                    WelComeActivateFragment.this.playAnimationMode(5);
                    return;
                }
                if (msg.getType() == 2) {
                    WelComeActivateFragment.this.isStarSpeak = false;
                    FrameLayout frameLayout = WelComeActivateFragment.this.animationView;
                    if (frameLayout != null && frameLayout.getVisibility() == 0) {
                        WelComeActivateFragment.this.handler.sendEmptyMessage(7);
                    }
                    WelComeActivateFragment.this.playAnimationMode(2);
                    WelComeActivateFragment welComeActivateFragment = WelComeActivateFragment.this;
                    Intrinsics.checkExpressionValueIsNotNull(msg, "msg");
                    welComeActivateFragment.updateMsg(msg);
                    ReportCustomerTask.INSTANCE.trackingBusinessInteractiveEvent();
                }
            }
        });
        getWeComeVm().getMVoiceChangeState().observe(getViewLifecycleOwner(), new Observer<Integer>() { // from class: com.pudutech.peanut.robot_ui.ui.fragment.WelComeActivateFragment$initVM$2
            @Override // androidx.lifecycle.Observer
            public final void onChanged(Integer num) {
                Pdlog.m3273d(WelComeActivateFragment.this.TAG, "mVoiceChangeState: " + num + ' ');
                if (num != null && num.intValue() == 1) {
                    RobotConfig.INSTANCE.setFaceDetectorSwitch(true);
                    WelComeActivateFragment.this.handler.removeMessages(9);
                    WelComeActivateFragment.this.handler.sendEmptyMessageDelayed(9, 15000L);
                    WelComeActivateFragment.INSTANCE.setWakeup(false);
                    WelComeActivateFragment.INSTANCE.setRecording(false);
                    Pdlog.m3273d(WelComeActivateFragment.this.TAG, "startWakeUp: " + num + ' ');
                    WelComeActivateFragment.this.playAnimationMode(3);
                    FrameLayout frameLayout = WelComeActivateFragment.this.animationView;
                    if (frameLayout == null || frameLayout.getVisibility() != 0) {
                        MarqueeTextView marqueeTextView = WelComeActivateFragment.this.tvInputText;
                ...
                if (num != null && num.intValue() == 2) {
                    ...
                    Pdlog.m3273d(WelComeActivateFragment.this.TAG, "startWakeUp: " + num + ' ');
                    WelComeActivateFragment.this.playAnimationMode(3);
                    FrameLayout frameLayout2 = WelComeActivateFragment.this.animationView;
                    if (frameLayout2 == null || frameLayout2.getVisibility() != 0) {
                        MarqueeTextView marqueeTextView2 = WelComeActivateFragment.this.tvInputText;
                ...
                if (num != null && num.intValue() == 3) {
                    Pdlog.m3273d(WelComeActivateFragment.this.TAG, "stopAiRecording: " + num + ' ');
                ...
                if (num != null && num.intValue() == 6) {
                    ...
                    if (WelComeActivateFragment.INSTANCE.isRecording()) {
                        return;
                    }
                    WelComeActivateFragment.this.handler.sendEmptyMessage(6);
                    return;
                }
                if (num != null && num.intValue() == 5) {
                    RobotConfig.INSTANCE.setFaceDetectorSwitch(true);
                    WelComeActivateFragment.this.playAnimationMode(3);
                    FrameLayout frameLayout3 = WelComeActivateFragment.this.animationView;
        ...
        getWeComeVm().getMInstructionState().observe(getViewLifecycleOwner(), new Observer<Integer>() { // from class: com.pudutech.peanut.robot_ui.ui.fragment.WelComeActivateFragment$initVM$3
            @Override // androidx.lifecycle.Observer
            public final void onChanged(Integer num) {
                Pdlog.m3273d(WelComeActivateFragment.this.TAG, "mInstructionState: " + num + ' ');
                if (num != null && num.intValue() == 1) {
                    AiVoiceManager.INSTANCE.forceStop();
                    WelComeActivateFragment.this.jump(1);
    ...
    /* compiled from: WelComeActivateFragment.kt */
    @Metadata(m3959bv = {1, 0, 3}, m3960d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\t\n\u0002\u0010\u000b\n\u0002\b\u0007\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001:\u0001\u0017B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0006\u0010\u0015\u001a\u00020\u0016R\u000e\u0010\u0003\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\t\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\n\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\u000b\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\f\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u001a\u0010\r\u001a\u00020\u000eX\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\r\u0010\u000f\"\u0004\b\u0010\u0010\u0011R\u001a\u0010\u0012\u001a\u00020\u000eX\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0013\u0010\u000f\"\u0004\b\u0014\u0010\u0011¨\u0006\u0018"}, m3961d2 = {"Lcom/pudutech/peanut/robot_ui/ui/fragment/WelComeActivateFragment$Companion;", "", "()V", "ALGORITHM_WAKE_UP", "", "AVOID_WAKE_UP", "BEGIN_VOICE", "CLOSE_ACTIVATE", "CLOSE_WAKE", "OPEN_FACE", "VOICE_WAKE_UP", "WAKE_UP", "WS_WE_COME_MSG", "isRecording", "", "()Z", "setRecording", "(Z)V", "wakeup", "getWakeup", "setWakeup", "newInstance", "Lcom/pudutech/peanut/robot_ui/ui/fragment/WelComeActivateFragment;", "WithoutLeakHandler", "robot_ui_peanutRelease"}, m3962k = 1, m3963mv = {1, 1, 16})
    /* loaded from: classes5.dex */
    public static final class Companion {
        ...
        public final WelComeActivateFragment newInstance() {
            return new WelComeActivateFragment();
        }

        public final boolean getWakeup() {
            return WelComeActivateFragment.wakeup;
        }

        public final void setWakeup(boolean z) {
            WelComeActivateFragment.wakeup = z;
        }

        public final boolean isRecording() {
            return WelComeActivateFragment.isRecording;
        }

        public final void setRecording(boolean z) {
            WelComeActivateFragment.isRecording = z;
        }

        /* compiled from: WelComeActivateFragment.kt */
        @Metadata(m3959bv = {1, 0, 3}, m3960d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0002\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\u0010\u0010\u0007\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\nH\u0016R\u0014\u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00030\u0006X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u000b"}, m3961d2 = {"Lcom/pudutech/peanut/robot_ui/ui/fragment/WelComeActivateFragment$Companion$WithoutLeakHandler;", "Landroid/os/Handler;", "fragment", "Lcom/pudutech/peanut/robot_ui/ui/fragment/WelComeActivateFragment;", "(Lcom/pudutech/peanut/robot_ui/ui/fragment/WelComeActivateFragment;)V", "mActivity", "Ljava/lang/ref/WeakReference;", "handleMessage", "", NotificationCompat.CATEGORY_MESSAGE, "Landroid/os/Message;", "robot_ui_peanutRelease"}, m3962k = 1, m3963mv = {1, 1, 16})
        /* loaded from: classes5.dex */
        private static final class WithoutLeakHandler extends Handler {
            private WeakReference<WelComeActivateFragment> mActivity;

            public WithoutLeakHandler(WelComeActivateFragment fragment) {
            ...
            public void handleMessage(Message msg) {
                ...
                WelComeActivateFragment welComeActivateFragment = this.mActivity.get();
                if (welComeActivateFragment != null) {
                    switch (msg.what) {
                        case 3:
                            Pdlog.m3273d(welComeActivateFragment.TAG, "receiveMsg: " + msg.obj.toString() + ' ');
                            try {
                                welComeActivateFragment.count++;
                                Object obj = msg.obj;
                                if (obj == null) {
                                ...
                                if (bundle != null) {
                                    int i = welComeActivateFragment.count;
                                    ...
                                    welComeActivateFragment.updateMsg(new WeComeBean(i, i2, string, "", null, 16, null));
                                    return;
                                }
                                return;
                            } catch (Exception e) {
                        ...
                        case 4:
                            welComeActivateFragment.content = "";
                            welComeActivateFragment.handler.removeMessages(9);
                            WelComeActivateFragment.INSTANCE.setRecording(true);
                            welComeActivateFragment.playAnimationMode(3);
                            AiVoiceManager.INSTANCE.startAiRecording();
                            Pdlog.m3273d(welComeActivateFragment.TAG, "startWakeUp: 4 ");
                            AiVoiceManager.INSTANCE.startWakeUp(0, 0);
                            return;
                        case 5:
                            welComeActivateFragment.handler.removeMessages(9);
                            FrameLayout frameLayout = welComeActivateFragment.animationView;
                            if (frameLayout != null) {
                                welComeActivateFragment.getWeComeVm().showView(frameLayout, welComeActivateFragment.tvInputText);
                                return;
                            }
                            return;
                        case 6:
                            ...
                            WelComeActivateFragment.INSTANCE.setRecording(true);
                            welComeActivateFragment.playAnimationMode(3);
                            Pdlog.m3273d(welComeActivateFragment.TAG, "AVOID_WAKE_UP : 6 ");
                            return;
                        case 7:
                            welComeActivateFragment.isStarSpeak = false;
                            int i3 = welComeActivateFragment.count;
                            MarqueeTextView marqueeTextView = welComeActivateFragment.tvInputText;
                            welComeActivateFragment.updateMsg(new WeComeBean(i3, 1, String.valueOf(marqueeTextView != null ? marqueeTextView.getText() : null), "", null, 16, null));
                            welComeActivateFragment.playAnimationMode(1);
                            if (welComeActivateFragment.animationView != null) {
                                welComeActivateFragment.getWeComeVm().closeView();
                                return;
                            }
                            return;
                        case 8:
                            if (WelComeActivateFragment.INSTANCE.getWakeup()) {
                                return;
                            }
                            welComeActivateFragment.handler.sendEmptyMessage(5);
                            WelComeActivateFragment.INSTANCE.setWakeup(true);
                            return;
                        case 9:
                            AiVoiceManager.INSTANCE.stopPlayVoice();
                            NavigationExtKt.nav(welComeActivateFragment).popBackStack();
                            return;
                        case 10:
                            RobotConfig.INSTANCE.setFaceDetectorSwitch(false);
                            if (WelComeActivateFragment.INSTANCE.isRecording()) {
                                return;
                            }
                            VoicePlayTasks.INSTANCE.stop();
                            welComeActivateFragment.handler.sendEmptyMessage(4);
                            return;
                        case 11:
                        default:
                            return;
                        case 12:
                            SolicitInfoManager.INSTANCE.openFace();
                            return;
                    }
                }
            }

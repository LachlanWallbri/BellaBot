...
public final class LotteryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(C5508R.layout.fragment_interact, container, false);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        Switch interaction_switch = (Switch) _$_findCachedViewById(C5508R.id.interaction_switch);
        ...
        ((Switch) _$_findCachedViewById(C5508R.id.interaction_switch)).setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.pudutech.peanut.robot_ui.module.setting.ui.LotteryFragment$onViewCreated$1
        ...
        this.viewSet.add((EditText) _$_findCachedViewById(C5508R.id.prize_level_0_input));
        this.viewSet.add((EditText) _$_findCachedViewById(C5508R.id.prize_level_1_input));
        this.viewSet.add((EditText) _$_findCachedViewById(C5508R.id.prize_level_2_input));
        this.viewSet.add((EditText) _$_findCachedViewById(C5508R.id.prize_level_3_input));
        EditText editText = (EditText) _$_findCachedViewById(C5508R.id.prize_level_0_input);
        EditText prize_level_0_input = (EditText) _$_findCachedViewById(C5508R.id.prize_level_0_input);
        ...
        EditText editText2 = (EditText) _$_findCachedViewById(C5508R.id.prize_level_1_input);
        EditText prize_level_1_input = (EditText) _$_findCachedViewById(C5508R.id.prize_level_1_input);
        ...
        EditText editText3 = (EditText) _$_findCachedViewById(C5508R.id.prize_level_2_input);
        EditText prize_level_2_input = (EditText) _$_findCachedViewById(C5508R.id.prize_level_2_input);
        ...
        EditText editText4 = (EditText) _$_findCachedViewById(C5508R.id.prize_level_3_input);
        EditText prize_level_3_input = (EditText) _$_findCachedViewById(C5508R.id.prize_level_3_input);
        ...
        new Thread(new Runnable() { // from class: com.pudutech.peanut.robot_ui.module.setting.ui.LotteryFragment$onViewCreated$2
            ...
            public final void run() {
                ...
                if (activity != null) {
                    activity.runOnUiThread(new Runnable() { // from class: com.pudutech.peanut.robot_ui.module.setting.ui.LotteryFragment$onViewCreated$2.1
                        @Override // java.lang.Runnable
                        public final void run() {
                            EditText editText5 = (EditText) LotteryFragment.this._$_findCachedViewById(C5508R.id.prize_level_0_input);
                            if (editText5 != null) {
                                editText5.setText(String.valueOf(LotteryFragment.probablity_0), (TextView.BufferType) null);
                            }
                            EditText editText6 = (EditText) LotteryFragment.this._$_findCachedViewById(C5508R.id.prize_level_1_input);
                            if (editText6 != null) {
                                editText6.setText(String.valueOf(LotteryFragment.probablity_1), (TextView.BufferType) null);
                            }
                            EditText editText7 = (EditText) LotteryFragment.this._$_findCachedViewById(C5508R.id.prize_level_2_input);
                            if (editText7 != null) {
                                editText7.setText(String.valueOf(LotteryFragment.probablity_2), (TextView.BufferType) null);
                            }
                            EditText editText8 = (EditText) LotteryFragment.this._$_findCachedViewById(C5508R.id.prize_level_3_input);
                            if (editText8 != null) {
    ...
    */
    private final void updateProbabilities() {
        ...
        if (prize_level_0_input.getText() != null) {
            EditText prize_level_0_input2 = (EditText) _$_findCachedViewById(C5508R.id.prize_level_0_input);
            ...
            if (StringsKt.toFloatOrNull(prize_level_0_input2.getText().toString()) != null) {
                EditText prize_level_0_input3 = (EditText) _$_findCachedViewById(C5508R.id.prize_level_0_input);
                ...
                probablity_0 = f;
                prize_level_1_input = (EditText) _$_findCachedViewById(C5508R.id.prize_level_1_input);
                Intrinsics.checkExpressionValueIsNotNull(prize_level_1_input, "prize_level_1_input");
                if (prize_level_1_input.getText() != null) {
                    EditText prize_level_1_input2 = (EditText) _$_findCachedViewById(C5508R.id.prize_level_1_input);
                    ...
                    if (StringsKt.toFloatOrNull(prize_level_1_input2.getText().toString()) != null) {
                        EditText prize_level_1_input3 = (EditText) _$_findCachedViewById(C5508R.id.prize_level_1_input);
                        ...
                        probablity_1 = f2;
                        prize_level_2_input = (EditText) _$_findCachedViewById(C5508R.id.prize_level_2_input);
                        Intrinsics.checkExpressionValueIsNotNull(prize_level_2_input, "prize_level_2_input");
                        if (prize_level_2_input.getText() != null) {
                            EditText prize_level_2_input2 = (EditText) _$_findCachedViewById(C5508R.id.prize_level_2_input);
                            ...
                            if (StringsKt.toFloatOrNull(prize_level_2_input2.getText().toString()) != null) {
                                EditText prize_level_2_input3 = (EditText) _$_findCachedViewById(C5508R.id.prize_level_2_input);
                                ...
                                probablity_2 = f3;
                                prize_level_3_input = (EditText) _$_findCachedViewById(C5508R.id.prize_level_3_input);
                                Intrinsics.checkExpressionValueIsNotNull(prize_level_3_input, "prize_level_3_input");
                                if (prize_level_3_input.getText() != null) {
                                    EditText prize_level_3_input2 = (EditText) _$_findCachedViewById(C5508R.id.prize_level_3_input);
                                    ...
                                    if (StringsKt.toFloatOrNull(prize_level_3_input2.getText().toString()) != null) {
                                        EditText prize_level_3_input3 = (EditText) _$_findCachedViewById(C5508R.id.prize_level_3_input);
    ...
    public void onDestroyView() {
        super.onDestroyView();
        new Thread(new Runnable() { // from class: com.pudutech.peanut.robot_ui.module.setting.ui.LotteryFragment$onDestroyView$1
            @Override // java.lang.Runnable
            public final void run() {
    ...
    /* compiled from: LotteryFragment.kt */
    @Metadata(m3959bv = {1, 0, 3}, m3960d1 = {"\u0000,\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\r\n\u0000\n\u0002\u0010\b\n\u0002\b\u0005\b\u0082\u0004\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\u0012\u0010\u0005\u001a\u00020\u00062\b\u0010\u0007\u001a\u0004\u0018\u00010\bH\u0016J*\u0010\t\u001a\u00020\u00062\b\u0010\u0007\u001a\u0004\u0018\u00010\n2\u0006\u0010\u000b\u001a\u00020\f2\u0006\u0010\r\u001a\u00020\f2\u0006\u0010\u000e\u001a\u00020\fH\u0016J*\u0010\u000f\u001a\u00020\u00062\b\u0010\u0007\u001a\u0004\u0018\u00010\n2\u0006\u0010\u000b\u001a\u00020\f2\u0006\u0010\u0010\u001a\u00020\f2\u0006\u0010\r\u001a\u00020\fH\u0016R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0011"}, m3961d2 = {"Lcom/pudutech/peanut/robot_ui/module/setting/ui/LotteryFragment$TextMonitor;", "Landroid/text/TextWatcher;", "view", "Landroid/widget/EditText;", "(Lcom/pudutech/peanut/robot_ui/module/setting/ui/LotteryFragment;Landroid/widget/EditText;)V", "afterTextChanged", "", "s", "Landroid/text/Editable;", "beforeTextChanged", "", "start", "", "count", "after", "onTextChanged", "before", "robot_ui_peanutRelease"}, m3962k = 1, m3963mv = {1, 1, 16})
    /* loaded from: classes5.dex */
        ...
        public void afterTextChanged(Editable s) {
            ...
            if (s != null) {
                ...
                if (!(StringsKt.toFloatOrNull(s.toString()) != null && !StringsKt.startsWith$default((CharSequence) editable, (CharSequence) ".", false, 2, (Object) null) && !StringsKt.startsWith$default((CharSequence) editable, (CharSequence) "00", false, 2, (Object) null) && s.length() <= 10 && Float.parseFloat(s.toString()) <= ((float) 1) && Float.parseFloat(s.toString()) >= ((float) 0))) {
                    Toast.makeText(RobotContext.INSTANCE.getContext(), this.this$0.getString(C5508R.string.pdStr7_111), 0).show();
                ...
                if (f + parseFloat > 1.0f) {
                    Toast.makeText(RobotContext.INSTANCE.getContext(), this.this$0.getString(C5508R.string.pdStr7_112), 0).show();

...
public final class GreeterSettingActivity extends BatteryBaseActivity {
    ...
    public final void initView() {
        ...
        tvBack.setText(getString(C5508R.string.greeter_setting));
        replaceFragment(new GreeterSettingFragment());
        ...
        ViewExtKt.onSingleClick(llBack, new Function1<View, Unit>() { // from class: com.pudutech.peanut.robot_ui.module.setting.ui.GreeterSettingActivity$initView$1
            ...
            public final void invoke2(View it) {
                ...
                GreeterSettingActivity.this.jumpAndFinish(null);
            }
        });
        bindPresenter();
    }

...
public final class ShowDownloadingDialog extends Dialog {
    ...
    private final void build() {
        View inflate = getLayoutInflater().inflate(C5508R.layout.fragment_version_setup_downloading_dialog, (ViewGroup) null);
        ...
        if (window != null) {
            ...
            this.downloading_num_show = inflate != null ? (TextView) inflate.findViewById(C5508R.id.downloading_num_show) : null;
            this.cancel = inflate != null ? inflate.findViewById(C5508R.id.cancel) : null;
        }
        View view = this.cancel;
        if (view != null) {
            view.setOnClickListener(new OnLazyVoiceClickListener() { // from class: com.pudutech.peanut.robot_ui.module.setting.ui.dialog.ShowDownloadingDialog$build$2

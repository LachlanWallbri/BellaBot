...
final class UpdateManager$checkSoftWareVersionSilent$2<T> implements Consumer<Throwable> {
    final /* synthetic */ IShowProgress $showDownFileProgress;

    UpdateManager$checkSoftWareVersionSilent$2(IShowProgress iShowProgress) {
    ...
    public final void accept(Throwable throwable) {
        ...
        if (iShowProgress != null) {
            ...
            iShowProgress.onFail(throwable);
        }
        Pdlog.m3274e("UpdateManager", "uri e:" + throwable);
    }
}

...
public abstract class NetWorkChangeEvent extends BroadcastReceiver {
    ...
    public boolean isNetworkChange(Context context, NetworkInfo networkInfo) {
        ...
        if (networkInfo.getType() == 1) {
            ...
            if (connectionInfo != null && (wifiInfo = this.lastWifiInfo) != null && wifiInfo.getBSSID() != null && this.lastWifiInfo.getBSSID().equals(connectionInfo.getBSSID()) && this.lastWifiInfo.getNetworkId() == connectionInfo.getNetworkId() && !this.lastConnected) {

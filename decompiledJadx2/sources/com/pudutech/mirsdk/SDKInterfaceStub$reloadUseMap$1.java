...
final class SDKInterfaceStub$reloadUseMap$1 extends Lambda implements Function2<ISDKListener, String, Unit> {
    final /* synthetic */ String $pdmap;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    SDKInterfaceStub$reloadUseMap$1(String str) {
        super(2);
        this.$pdmap = str;
    }
    ...
    public final void invoke2(ISDKListener it, String str) {
        ...
        it.onSwitchPdmapResult(SwitchMapResult.GoalNameNull, this.$pdmap);
    }
}

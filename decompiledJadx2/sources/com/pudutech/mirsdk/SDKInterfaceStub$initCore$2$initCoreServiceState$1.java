...
final class SDKInterfaceStub$initCore$2$initCoreServiceState$1 extends Lambda implements Function2<LoadCoreListener, String, Unit> {
    public static final SDKInterfaceStub$initCore$2$initCoreServiceState$1 INSTANCE = new SDKInterfaceStub$initCore$2$initCoreServiceState$1();

    SDKInterfaceStub$initCore$2$initCoreServiceState$1() {
        super(2);
    }
    ...
    public final void invoke2(LoadCoreListener it, String name) {
        ...
        it.coreInitStepResult(CoreStepType.InitAlgoModules, CoreInitState.Success);
    }
}

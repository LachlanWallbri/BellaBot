...
public interface LocateCameraCalibListener extends IInterface {
     ...
     */
    /* loaded from: classes5.dex */
    public static abstract class Stub extends Binder implements LocateCameraCalibListener {
        private static final String DESCRIPTOR = "com.pudutech.mirsdk.aidl.LocateCameraCalibListener";
        ...
        public static LocateCameraCalibListener asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            if (queryLocalInterface != null && (queryLocalInterface instanceof LocateCameraCalibListener)) {
                return (LocateCameraCalibListener) queryLocalInterface;
            }
         ...
         */
        /* loaded from: classes5.dex */
        private static class Proxy implements LocateCameraCalibListener {

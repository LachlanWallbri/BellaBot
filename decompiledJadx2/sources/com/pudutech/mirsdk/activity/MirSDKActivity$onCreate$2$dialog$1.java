...
final class MirSDKActivity$onCreate$2$dialog$1 implements DialogInterface.OnClickListener {
    final /* synthetic */ List $cruiseIDs;
    final /* synthetic */ MirSDKActivity$onCreate$2 this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    public MirSDKActivity$onCreate$2$dialog$1(MirSDKActivity$onCreate$2 mirSDKActivity$onCreate$2, List list) {
        this.this$0 = mirSDKActivity$onCreate$2;
        this.$cruiseIDs = list;
    }
    ...
    public final void onClick(DialogInterface dialogInterface, int i) {
        ...
        if (sDKInterface2 != null) {
            sDKInterface2.calibrationMarkerCamera(i, new BinderC48641());
        }
    }

    /* compiled from: MirSDKActivity.kt */
    @Metadata(m3959bv = {1, 0, 3}, m3960d1 = {"\u0000\u001f\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J \u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u00072\u0006\u0010\b\u001a\u00020\u0007H\u0016¨\u0006\t"}, m3961d2 = {"com/pudutech/mirsdk/activity/MirSDKActivity$onCreate$2$dialog$1$1", "Lcom/pudutech/mirsdk/aidl/LocateCameraCalibListener$Stub;", "calibResult", "", "p0", "", "rpy", "Lcom/pudutech/mirsdk/hardware/serialize/Vector3d;", "xyz", "MirFunction_packRelease"}, m3962k = 1, m3963mv = {1, 1, 16})
    /* renamed from: com.pudutech.mirsdk.activity.MirSDKActivity$onCreate$2$dialog$1$1 */
    /* loaded from: classes5.dex */
    public static final class BinderC48641 extends LocateCameraCalibListener.Stub {
        BinderC48641() {
        }
        ...
        public void calibResult(final boolean p0, final Vector3d rpy, final Vector3d xyz) {
            ...
            MirSDKActivity$onCreate$2$dialog$1.this.this$0.this$0.runOnUiThread(new Runnable() { // from class: com.pudutech.mirsdk.activity.MirSDKActivity$onCreate$2$dialog$1$1$calibResult$1
                @Override // java.lang.Runnable
                public final void run() {
                    TextView tx_calib_state = (TextView) MirSDKActivity$onCreate$2$dialog$1.this.this$0.this$0._$_findCachedViewById(C4946R.id.tx_calib_state);
                    Intrinsics.checkExpressionValueIsNotNull(tx_calib_state, "tx_calib_state");
                    tx_calib_state.setText(p0 ? "Success" : "Fail");
                    TextView tx_calib_rpy = (TextView) MirSDKActivity$onCreate$2$dialog$1.this.this$0.this$0._$_findCachedViewById(C4946R.id.tx_calib_rpy);
                    Intrinsics.checkExpressionValueIsNotNull(tx_calib_rpy, "tx_calib_rpy");
                    tx_calib_rpy.setText('(' + rpy.getX() + ", " + rpy.getY() + ", " + rpy.getZ() + ')');
                    TextView tx_calib_xyz = (TextView) MirSDKActivity$onCreate$2$dialog$1.this.this$0.this$0._$_findCachedViewById(C4946R.id.tx_calib_xyz);

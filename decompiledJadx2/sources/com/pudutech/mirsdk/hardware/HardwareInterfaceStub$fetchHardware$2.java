...
final class HardwareInterfaceStub$fetchHardware$2 extends Lambda implements Function2<IHardware, String, Unit> {
    public static final HardwareInterfaceStub$fetchHardware$2 INSTANCE = new HardwareInterfaceStub$fetchHardware$2();

    HardwareInterfaceStub$fetchHardware$2() {
        super(2);
    }

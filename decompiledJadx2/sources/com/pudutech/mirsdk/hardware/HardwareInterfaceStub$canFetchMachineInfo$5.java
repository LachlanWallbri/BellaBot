...
final class HardwareInterfaceStub$canFetchMachineInfo$5 extends Lambda implements Function2<IHardware, String, Unit> {
    public static final HardwareInterfaceStub$canFetchMachineInfo$5 INSTANCE = new HardwareInterfaceStub$canFetchMachineInfo$5();

    HardwareInterfaceStub$canFetchMachineInfo$5() {
        super(2);
    }

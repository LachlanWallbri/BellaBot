...
final class HardwareInterfaceStub$startSelfCheck$2 extends Lambda implements Function2<IHardware, String, Unit> {
    public static final HardwareInterfaceStub$startSelfCheck$2 INSTANCE = new HardwareInterfaceStub$startSelfCheck$2();

    HardwareInterfaceStub$startSelfCheck$2() {
        super(2);
    }

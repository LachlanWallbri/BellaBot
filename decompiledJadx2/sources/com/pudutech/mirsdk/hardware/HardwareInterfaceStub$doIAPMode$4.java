...
final class HardwareInterfaceStub$doIAPMode$4 extends Lambda implements Function2<IHardware, String, Unit> {
    final /* synthetic */ HardwareInterfaceStub.Result $mcuUpdateInIAPModeResult;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    HardwareInterfaceStub$doIAPMode$4(HardwareInterfaceStub.Result result) {
        super(2);
        this.$mcuUpdateInIAPModeResult = result;
    }
    ...
    public final void invoke2(IHardware l, String str) {
        ...
        l.onOpenStep(HardwareOpenStep.MCUUpdateInIAPMode, StepState.Fail, this.$mcuUpdateInIAPModeResult.getDescription());
    }
}

...
final class HardwareInterfaceStub$fetchHardware$3 extends Lambda implements Function2<IHardware, String, Unit> {
    public static final HardwareInterfaceStub$fetchHardware$3 INSTANCE = new HardwareInterfaceStub$fetchHardware$3();

    HardwareInterfaceStub$fetchHardware$3() {
        super(2);
    }

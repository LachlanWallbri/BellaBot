...
final class HardwareInterfaceStub$bootUpCAN$4 extends Lambda implements Function2<IHardware, String, Unit> {
    final /* synthetic */ CANBus.Result $canBootUpResult;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    HardwareInterfaceStub$bootUpCAN$4(CANBus.Result result) {
        super(2);
        this.$canBootUpResult = result;
    }
    ...
    public final void invoke2(IHardware l, String str) {
        ...
        l.onOpenStep(HardwareOpenStep.CanConnect, StepState.Fail, this.$canBootUpResult.getDescription());
    }
}

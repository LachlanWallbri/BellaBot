...
final class HardwareInterfaceStub$notFetchMachineInfo$8 extends Lambda implements Function2<IHardware, String, Unit> {
    public static final HardwareInterfaceStub$notFetchMachineInfo$8 INSTANCE = new HardwareInterfaceStub$notFetchMachineInfo$8();

    HardwareInterfaceStub$notFetchMachineInfo$8() {
        super(2);
    }

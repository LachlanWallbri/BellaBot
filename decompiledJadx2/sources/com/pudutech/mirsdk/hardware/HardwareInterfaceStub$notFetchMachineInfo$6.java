...
final class HardwareInterfaceStub$notFetchMachineInfo$6 extends Lambda implements Function2<IHardware, String, Unit> {
    public static final HardwareInterfaceStub$notFetchMachineInfo$6 INSTANCE = new HardwareInterfaceStub$notFetchMachineInfo$6();

    HardwareInterfaceStub$notFetchMachineInfo$6() {
        super(2);
    }

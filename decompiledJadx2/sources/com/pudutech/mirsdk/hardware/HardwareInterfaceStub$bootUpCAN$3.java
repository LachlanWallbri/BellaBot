...
final class HardwareInterfaceStub$bootUpCAN$3 extends Lambda implements Function2<IHardware, String, Unit> {
    public static final HardwareInterfaceStub$bootUpCAN$3 INSTANCE = new HardwareInterfaceStub$bootUpCAN$3();

    HardwareInterfaceStub$bootUpCAN$3() {
        super(2);
    }

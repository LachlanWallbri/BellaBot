...
final class HardwareInterfaceStub$openESPTimeout$6 extends Lambda implements Function2<IHardware, String, Unit> {
    public static final HardwareInterfaceStub$openESPTimeout$6 INSTANCE = new HardwareInterfaceStub$openESPTimeout$6();

    HardwareInterfaceStub$openESPTimeout$6() {
        super(2);
    }

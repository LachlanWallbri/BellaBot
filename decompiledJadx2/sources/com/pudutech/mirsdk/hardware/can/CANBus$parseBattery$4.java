...
final class CANBus$parseBattery$4 extends Lambda implements Function2<Integer, UByteArray, Unit> {
    final /* synthetic */ CANBus this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    CANBus$parseBattery$4(CANBus cANBus) {
        super(2);
        this.this$0 = cANBus;
    }
    ...
    public final void invoke(int i, byte[] bytes) {
        ...
        if ((UByteArray.m4577getimpl(bytes, 1) & 255) == 1) {
            this.this$0.lastChargeState = ChargeState.Charging;
        } else {
            this.this$0.lastChargeState = ChargeState.Idle;
        }
        this.this$0.getHardwareListener().notify(new Function2<IHardware, String, Unit>() { // from class: com.pudutech.mirsdk.hardware.can.CANBus$parseBattery$4.1
            {
                super(2);
            }
            ...
            public final void invoke2(IHardware l, String str) {
                ...
                i2 = CANBus$parseBattery$4.this.this$0.lastPowerPecent;
                chargeState = CANBus$parseBattery$4.this.this$0.lastChargeState;

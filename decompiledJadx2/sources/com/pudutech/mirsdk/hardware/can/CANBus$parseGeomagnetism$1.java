...
final class CANBus$parseGeomagnetism$1 extends Lambda implements Function2<Integer, UByteArray, Unit> {
    final /* synthetic */ CANBus this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    CANBus$parseGeomagnetism$1(CANBus cANBus) {
        super(2);
        this.this$0 = cANBus;
    }
    ...
    public final void invoke(int i, byte[] bytes) {
        ...
        this.this$0.getHardwareListener().notify(new Function2<IHardware, String, Unit>() { // from class: com.pudutech.mirsdk.hardware.can.CANBus$parseGeomagnetism$1.1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(2);
            }
            ...
            public final void invoke2(IHardware it, String name) {
                ...
                it.geomagneticAntiDrop("left", Math.abs(Ref.IntRef.this.element), Math.abs(intRef2.element), Math.abs(intRef3.element));
            }
        });
        if (intRef.element == 0 && intRef2.element == 0 && intRef3.element == 0) {
            return;
        }
        this.this$0.setLeftMagicSensor$mirhardware_packRelease(true);
    }
}

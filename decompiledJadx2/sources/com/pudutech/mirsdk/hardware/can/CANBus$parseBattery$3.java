...
final class CANBus$parseBattery$3 extends Lambda implements Function2<Integer, UByteArray, Unit> {
    final /* synthetic */ CANBus this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    CANBus$parseBattery$3(CANBus cANBus) {
        super(2);
        this.this$0 = cANBus;
    }
    ...
    public final void invoke(int i, byte[] bytes) {
        ...
        CANBus.access$setBatteryFloorLevelLimit$p(this.this$0, UByteArray.m4577getimpl(bytes, 2) & 255);
        this.this$0.getHardwareListener().notify(new Function2<IHardware, String, Unit>() { // from class: com.pudutech.mirsdk.hardware.can.CANBus$parseBattery$3.1
            {
                super(2);
            }
            ...
            public final void invoke2(IHardware l, String str) {
                ...
                l.onBatteryFloorLevelLimit(CANBus.access$getBatteryFloorLevelLimit$p(CANBus$parseBattery$3.this.this$0));
            }
        });
    }
}

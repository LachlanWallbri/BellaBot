...
final class CANBus$getBatterySn$2 extends Lambda implements Function2<Integer, UByteArray, Unit> {
    ...
    CANBus$getBatterySn$2(CANBus cANBus, Ref.IntRef intRef, List list, Ref.ObjectRef objectRef) {
        super(2);
        this.this$0 = cANBus;
        this.$len = intRef;
    ...
    public final void invoke(int i, byte[] bytes) {
        ...
        if (m4577getimpl == 0 && UByteArray.m4577getimpl(bytes, 2) == UByte.m4528constructorimpl((byte) 128) && UByteArray.m4577getimpl(bytes, 3) == UByte.m4528constructorimpl((byte) 80)) {
        ...
        if (this.$snByteList.size() > this.$len.element) {
            ...
            this.$batterySn.element = new String(CollectionsKt.toByteArray(subList), Charsets.UTF_8);
            str = this.this$0.TAG;
            Pdlog.m3273d(str, "getBatterySn:" + CommonKt.toHexString(CollectionsKt.toByteArray(subList)));
        }
    }
}

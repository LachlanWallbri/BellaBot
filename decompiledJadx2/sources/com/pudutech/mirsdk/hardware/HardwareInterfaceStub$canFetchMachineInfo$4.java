...
final class HardwareInterfaceStub$canFetchMachineInfo$4 extends Lambda implements Function2<IHardware, String, Unit> {
    final /* synthetic */ String $description;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    HardwareInterfaceStub$canFetchMachineInfo$4(String str) {
        super(2);
    ...
    public final void invoke2(IHardware l, String str) {
        ...
        l.onOpenStep(HardwareOpenStep.FetchMachineInfo, StepState.Fail, this.$description);
    }
}

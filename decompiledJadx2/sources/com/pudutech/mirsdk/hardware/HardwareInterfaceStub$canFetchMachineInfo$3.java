...
final class HardwareInterfaceStub$canFetchMachineInfo$3 extends Lambda implements Function2<IHardware, String, Unit> {
    final /* synthetic */ HardwareInterfaceStub.Result $fetchResult;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    HardwareInterfaceStub$canFetchMachineInfo$3(HardwareInterfaceStub.Result result) {
        super(2);
    ...
    public final void invoke2(IHardware l, String str) {
        ...
        l.onOpenStep(HardwareOpenStep.FetchMachineInfo, StepState.Fail, this.$fetchResult.getDescription());
    }
}

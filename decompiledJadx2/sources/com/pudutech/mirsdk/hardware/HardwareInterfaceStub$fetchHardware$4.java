...
final class HardwareInterfaceStub$fetchHardware$4 extends Lambda implements Function2<IHardware, String, Unit> {
    final /* synthetic */ CANBus.Result $result;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    HardwareInterfaceStub$fetchHardware$4(CANBus.Result result) {
        super(2);
        this.$result = result;
    }
    ...
    public final void invoke2(IHardware l, String str) {
        ...
        l.onOpenStep(HardwareOpenStep.GetHardwareVersion, StepState.Fail, this.$result.getDescription());
    }
}

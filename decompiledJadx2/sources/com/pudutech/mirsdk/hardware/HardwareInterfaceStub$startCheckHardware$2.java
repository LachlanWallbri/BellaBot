...
final class HardwareInterfaceStub$startCheckHardware$2 extends Lambda implements Function2<IHardware, String, Unit> {
    final /* synthetic */ CANBus.Result $openHeadUsbResult;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    HardwareInterfaceStub$startCheckHardware$2(CANBus.Result result) {
        super(2);
        this.$openHeadUsbResult = result;
    }
    ...
    public final void invoke2(IHardware l, String str) {
        ...
        l.onOpenStep(HardwareOpenStep.CanConnect, StepState.Fail, this.$openHeadUsbResult.getDescription());
    }
}

...
final class HardwareInterfaceStub$notFetchMachineInfo$7 extends Lambda implements Function2<IHardware, String, Unit> {
    public static final HardwareInterfaceStub$notFetchMachineInfo$7 INSTANCE = new HardwareInterfaceStub$notFetchMachineInfo$7();

    HardwareInterfaceStub$notFetchMachineInfo$7() {
        super(2);
    }

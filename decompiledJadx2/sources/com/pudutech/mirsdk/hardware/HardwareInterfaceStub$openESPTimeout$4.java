...
final class HardwareInterfaceStub$openESPTimeout$4 extends Lambda implements Function2<IHardware, String, Unit> {
    public static final HardwareInterfaceStub$openESPTimeout$4 INSTANCE = new HardwareInterfaceStub$openESPTimeout$4();

    HardwareInterfaceStub$openESPTimeout$4() {
        super(2);
    }

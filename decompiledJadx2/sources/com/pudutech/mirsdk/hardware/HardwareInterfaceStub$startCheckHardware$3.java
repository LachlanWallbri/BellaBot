...
final class HardwareInterfaceStub$startCheckHardware$3 extends Lambda implements Function2<IHardware, String, Unit> {
    public static final HardwareInterfaceStub$startCheckHardware$3 INSTANCE = new HardwareInterfaceStub$startCheckHardware$3();

    HardwareInterfaceStub$startCheckHardware$3() {
        super(2);
    }

...
final class HardwareInterfaceStub$openESPTimeout$2 extends Lambda implements Function2<IHardware, String, Unit> {
    public static final HardwareInterfaceStub$openESPTimeout$2 INSTANCE = new HardwareInterfaceStub$openESPTimeout$2();

    HardwareInterfaceStub$openESPTimeout$2() {
        super(2);
    }

...
final class HardwareInterfaceStub$canFetchMachineInfo$2 extends Lambda implements Function2<IHardware, String, Unit> {
    public static final HardwareInterfaceStub$canFetchMachineInfo$2 INSTANCE = new HardwareInterfaceStub$canFetchMachineInfo$2();

    HardwareInterfaceStub$canFetchMachineInfo$2() {
        super(2);
    }

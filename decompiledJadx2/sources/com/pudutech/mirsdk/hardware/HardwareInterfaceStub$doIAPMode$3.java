...
final class HardwareInterfaceStub$doIAPMode$3 extends Lambda implements Function2<IHardware, String, Unit> {
    public static final HardwareInterfaceStub$doIAPMode$3 INSTANCE = new HardwareInterfaceStub$doIAPMode$3();

    HardwareInterfaceStub$doIAPMode$3() {
        super(2);
    }
    ...
    public final void invoke2(IHardware l, String str) {
        ...
        l.onOpenStep(HardwareOpenStep.MCUUpdateInIAPMode, StepState.Success, "");
    }
}

...
final class HardwareInterfaceStub$bootUpCAN$2 extends Lambda implements Function2<IHardware, String, Unit> {
    public static final HardwareInterfaceStub$bootUpCAN$2 INSTANCE = new HardwareInterfaceStub$bootUpCAN$2();

    HardwareInterfaceStub$bootUpCAN$2() {
        super(2);
    }

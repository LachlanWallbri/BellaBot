...
final class HardwareInterfaceStub$notFetchMachineInfo$2 extends Lambda implements Function2<IHardware, String, Unit> {
    public static final HardwareInterfaceStub$notFetchMachineInfo$2 INSTANCE = new HardwareInterfaceStub$notFetchMachineInfo$2();

    HardwareInterfaceStub$notFetchMachineInfo$2() {
        super(2);
    }

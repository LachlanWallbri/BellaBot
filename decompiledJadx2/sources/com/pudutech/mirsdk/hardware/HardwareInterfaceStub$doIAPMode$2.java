...
final class HardwareInterfaceStub$doIAPMode$2 extends Lambda implements Function2<IHardware, String, Unit> {
    public static final HardwareInterfaceStub$doIAPMode$2 INSTANCE = new HardwareInterfaceStub$doIAPMode$2();

    HardwareInterfaceStub$doIAPMode$2() {
        super(2);
    }
    ...
    public final void invoke2(IHardware l, String str) {
        ...
        l.onOpenStep(HardwareOpenStep.MCUUpdateInIAPMode, StepState.Running, "");
    }
}

...
@Metadata(m3959bv = {1, 0, 3}, m3960d1 = {"\u0000P\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010\u0006\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0007\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u000f\u0018\u00002\u00020\u0001:\u0004*+,-B\u0005¢\u0006\u0002\u0010\u0002J\u0006\u0010\u001d\u001a\u00020\u0017J\u001e\u0010\u001e\u001a\u00020\u001f2\u0006\u0010 \u001a\u00020\u00072\u0006\u0010!\u001a\u00020\u00072\u0006\u0010\"\u001a\u00020\u0007J&\u0010#\u001a\u00020\u001f2\u0006\u0010$\u001a\u00020\u00072\u0006\u0010%\u001a\u00020\u00072\u0006\u0010&\u001a\u00020\u00072\u0006\u0010\"\u001a\u00020\u0007J\u001e\u0010'\u001a\u00020\u001c2\u0006\u0010(\u001a\u00020\u00072\u0006\u0010)\u001a\u00020\u00072\u0006\u0010\"\u001a\u00020\u0007R\u0016\u0010\u0003\u001a\n \u0005*\u0004\u0018\u00010\u00040\u0004X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0007X\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\u0007X\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\t\u001a\u00020\nX\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u000b\u001a\u00020\u0007X\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\f\u001a\u00020\rX\u0082\u000e¢\u0006\u0002\n\u0000R$\u0010\u000f\u001a\u00020\r2\u0006\u0010\u000e\u001a\u00020\r@FX\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0010\u0010\u0011\"\u0004\b\u0012\u0010\u0013R\u000e\u0010\u0014\u001a\u00020\u0015X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0016\u001a\u00020\u0017X\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0018\u001a\u00020\u0019X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u001a\u001a\u00020\u0007X\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u001b\u001a\u00020\u001cX\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006."}, m3961d2 = {"Lcom/pudutech/mirsdk/mircore/localization/OdometryCenter;", "", "()V", "TAG", "", "kotlin.jvm.PlatformType", "encoder_left_value", "", "encoder_right_value", "fusionEncoderAndGyro", "Lcom/pudutech/mirsdk/mircore/localization/OdometryCenter$FusionEncoderAndGyro;", "gyroscope_angvel", "localCase", "Lcom/pudutech/mirsdk/mircore/PuduLocateInterface$LocateCase;", ES6Iterator.VALUE_PROPERTY, "locateCase", "getLocateCase", "()Lcom/pudutech/mirsdk/mircore/PuduLocateInterface$LocateCase;", "setLocateCase", "(Lcom/pudutech/mirsdk/mircore/PuduLocateInterface$LocateCase;)V", AUserTrack.UTKEY_MODULE, "Lcom/pudutech/mirsdk/mircore/localization/OdometryCenter$MoveModel;", "odom_data", "Lcom/pudutech/mirsdk/hardware/serialize/Vector3d;", "odom_pose", "Lcom/pudutech/mirsdk/mircore/localization/OdometryCenter$Vector2d;", "odom_theta", "speeds", "Lcom/pudutech/mirsdk/hardware/serialize/Vector2d;", "getOdom", "updateEncoder", "", "left", "right", "interval", "updateIMU", "x", "y", CompressorStreamFactory.f8930Z, "updateSpeed", "line_speed", "angle_speed", "FusionEncoderAndGyro", "MoveModel", "Transform2d", "Vector2d", "MirLocalization_packRelease"}, m3962k = 1, m3963mv = {1, 1, 16})
...
public final class OdometryCenter {
    ...
    private PuduLocateInterface.LocateCase localCase = PuduLocateInterface.LocateCase.Marker;
    private PuduLocateInterface.LocateCase locateCase = PuduLocateInterface.LocateCase.Marker;
    ...
    public final PuduLocateInterface.LocateCase getLocateCase() {
        return this.locateCase;
    }

    public final void setLocateCase(PuduLocateInterface.LocateCase value) {
        Intrinsics.checkParameterIsNotNull(value, "value");
        this.localCase = value;
    }
    ...
    public final com.pudutech.mirsdk.hardware.serialize.Vector2d updateSpeed(double line_speed, double angle_speed, double interval) {
        ...
        int i = WhenMappings.$EnumSwitchMapping$0[this.localCase.ordinal()];
        if (i == 1) {
            MarkerLocateNative.INSTANCE.setOdomData(this.encoder_left_value, this.encoder_right_value, this.odom_pose.getX(), this.odom_pose.getY(), this.odom_theta, line_speed, angle_speed);
        } else if (i == 2 || i == 3) {
            LaserLocateNative.INSTANCE.setOdomData(this.encoder_left_value, this.encoder_right_value, this.odom_pose.getX(), this.odom_pose.getY(), this.odom_theta, line_speed, angle_speed);
        }
        return this.speeds;
    }
     ...
     */
    /* compiled from: OdometryCenter.kt */
    @Metadata(m3959bv = {1, 0, 3}, m3960d1 = {"\u00000\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0013\n\u0000\n\u0002\u0010\u0006\n\u0002\b\u0007\n\u0002\u0010\u000b\n\u0002\b\u0003\b\u0000\u0018\u0000 \u00152\u00020\u0001:\u0001\u0015B\u0005¢\u0006\u0002\u0010\u0002J\u0016\u0010\u000f\u001a\u00020\t2\u0006\u0010\u0010\u001a\u00020\t2\u0006\u0010\u0011\u001a\u00020\u000bJ\u0010\u0010\u0012\u001a\u00020\u00132\u0006\u0010\u0014\u001a\u00020\u0013H\u0002R\u0016\u0010\u0003\u001a\n \u0005*\u0004\u0018\u00010\u00040\u0004X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0007X\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\tX\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\n\u001a\u00020\u000bX\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\f\u001a\u00020\u000bX\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\r\u001a\u00020\u0007X\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u000e\u001a\u00020\u0007X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0016"}, m3961d2 = {"Lcom/pudutech/mirsdk/mircore/localization/OdometryCenter$FusionEncoderAndGyro;", "", "()V", "TAG", "", "kotlin.jvm.PlatformType", "cnt", "", "errorBuffer", "", "errorSum", "", "gyroCompensation", "index", "zeroCnt", "currentEncoder", "encoderPath", "gyroAxisZ", "delayCheckStop", "", "isStopThisTime", "Companion", "MirLocalization_packRelease"}, m3962k = 1, m3963mv = {1, 1, 16})
    /* loaded from: classes6.dex */
    public static final class FusionEncoderAndGyro {
        ...
        public final double[] currentEncoder(double[] encoderPath, double gyroAxisZ) {
            ...
            Pdlog.m3273d(this.TAG, "currentEncoder line: {" + d + "}, angle: {" + d2 + "}, origin gyro z: {" + gyroAxisZ + "}, gyro compensation: {" + this.gyroCompensation + '}');
     ...
     */
    /* compiled from: OdometryCenter.kt */
    @Metadata(m3959bv = {1, 0, 3}, m3960d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u0006\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0004\b\u0000\u0018\u0000 \u00132\u00020\u0001:\u0001\u0013B\u0005¢\u0006\u0002\u0010\u0002J\u0016\u0010\u000f\u001a\u00020\u00102\u0006\u0010\u0011\u001a\u00020\u00042\u0006\u0010\u0012\u001a\u00020\u0004R\u0011\u0010\u0003\u001a\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006R\u000e\u0010\u0007\u001a\u00020\bX\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\t\u001a\u00020\bX\u0082\u0004¢\u0006\u0002\n\u0000R\u0011\u0010\n\u001a\u00020\b8F¢\u0006\u0006\u001a\u0004\b\u000b\u0010\fR\u000e\u0010\r\u001a\u00020\u000eX\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0014"}, m3961d2 = {"Lcom/pudutech/mirsdk/mircore/localization/OdometryCenter$MoveModel;", "", "()V", "dirInRad", "", "getDirInRad", "()D", "originCenter", "Lcom/pudutech/mirsdk/mircore/localization/OdometryCenter$Vector2d;", "originDir", RequestParameters.POSITION, "getPosition", "()Lcom/pudutech/mirsdk/mircore/localization/OdometryCenter$Vector2d;", "transform", "Lcom/pudutech/mirsdk/mircore/localization/OdometryCenter$Transform2d;", "update", "", "odomPathLine", "odomPathAngle", "Companion", "MirLocalization_packRelease"}, m3962k = 1, m3963mv = {1, 1, 16})
    /* loaded from: classes6.dex */
     ...
     */
    /* compiled from: OdometryCenter.kt */
    @Metadata(m3959bv = {1, 0, 3}, m3960d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u0006\n\u0002\b\u000f\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\b\u0000\u0018\u00002\u00020\u0001B\u0007\b\u0016¢\u0006\u0002\u0010\u0002B\u0017\b\u0016\u0012\u0006\u0010\u0003\u001a\u00020\u0004\u0012\u0006\u0010\u0005\u001a\u00020\u0004¢\u0006\u0002\u0010\u0006J\u000e\u0010\r\u001a\u00020\u00002\u0006\u0010\u000e\u001a\u00020\u0000J\u000e\u0010\u000f\u001a\u00020\u00042\u0006\u0010\u000e\u001a\u00020\u0000J\u0011\u0010\u0010\u001a\u00020\u00002\u0006\u0010\u0011\u001a\u00020\u0000H\u0086\u0002J\u0006\u0010\u0012\u001a\u00020\u0004J\u0006\u0010\u0013\u001a\u00020\u0014J\u0006\u0010\u0015\u001a\u00020\u0014J\b\u0010\u0016\u001a\u00020\u0017H\u0016R\u001a\u0010\u0003\u001a\u00020\u0004X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0007\u0010\b\"\u0004\b\t\u0010\nR\u001a\u0010\u0005\u001a\u00020\u0004X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u000b\u0010\b\"\u0004\b\f\u0010\n¨\u0006\u0018"}, m3961d2 = {"Lcom/pudutech/mirsdk/mircore/localization/OdometryCenter$Vector2d;", "", "()V", "x", "", "y", "(DD)V", "getX", "()D", "setX", "(D)V", "getY", "setY", TmpConstant.GROUP_OP_ADD, "v", "angleToVector", "minus", "subtrahend", "norm", "normalize", "", "setUnit", "toString", "", "MirLocalization_packRelease"}, m3962k = 1, m3963mv = {1, 1, 16})
    /* loaded from: classes6.dex */
     ...
     */
    /* compiled from: OdometryCenter.kt */
    @Metadata(m3959bv = {1, 0, 3}, m3960d1 = {"\u0000.\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u0011\n\u0002\u0010\u0013\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u0006\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0006\b\u0000\u0018\u0000 \u00132\u00020\u0001:\u0001\u0013B\u0005¢\u0006\u0002\u0010\u0002J\u000e\u0010\u0007\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\nJ\u0006\u0010\u000b\u001a\u00020\bJ\u0011\u0010\f\u001a\u00020\u00002\u0006\u0010\r\u001a\u00020\u0000H\u0086\u0002J\u0011\u0010\f\u001a\u00020\u000e2\u0006\u0010\u000f\u001a\u00020\u000eH\u0086\u0002J\u000e\u0010\u0010\u001a\u00020\b2\u0006\u0010\u000f\u001a\u00020\u000eJ\u0016\u0010\u0010\u001a\u00020\b2\u0006\u0010\u0011\u001a\u00020\n2\u0006\u0010\u0012\u001a\u00020\nR\u0016\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004X\u0082\u0004¢\u0006\u0004\n\u0002\u0010\u0006¨\u0006\u0014"}, m3961d2 = {"Lcom/pudutech/mirsdk/mircore/localization/OdometryCenter$Transform2d;", "", "()V", "matrix", "", "", "[[D", "rotate", "", "theta", "", "setIdentity", "times", "trans", "Lcom/pudutech/mirsdk/mircore/localization/OdometryCenter$Vector2d;", "v", "translate", "x", "y", "Companion", "MirLocalization_packRelease"}, m3962k = 1, m3963mv = {1, 1, 16})
    /* loaded from: classes6.dex */

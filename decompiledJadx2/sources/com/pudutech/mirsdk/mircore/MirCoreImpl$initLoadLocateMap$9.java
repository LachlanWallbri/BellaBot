...
final class MirCoreImpl$initLoadLocateMap$9 extends Lambda implements Function1<Vector3d, Unit> {
    public static final MirCoreImpl$initLoadLocateMap$9 INSTANCE = new MirCoreImpl$initLoadLocateMap$9();

    MirCoreImpl$initLoadLocateMap$9() {
        super(1);
    }

...
final class MirCoreImpl$initializerOnLoadTopoMap$3 extends Lambda implements Function2<String, IMarkerCameraData, Unit> {
    public static final MirCoreImpl$initializerOnLoadTopoMap$3 INSTANCE = new MirCoreImpl$initializerOnLoadTopoMap$3();

    MirCoreImpl$initializerOnLoadTopoMap$3() {
        super(2);
    }

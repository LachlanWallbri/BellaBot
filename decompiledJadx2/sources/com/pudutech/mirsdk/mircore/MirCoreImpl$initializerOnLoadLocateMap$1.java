...
final class MirCoreImpl$initializerOnLoadLocateMap$1 extends Lambda implements Function2<String, ILidarData, Unit> {
    public static final MirCoreImpl$initializerOnLoadLocateMap$1 INSTANCE = new MirCoreImpl$initializerOnLoadLocateMap$1();

    MirCoreImpl$initializerOnLoadLocateMap$1() {
        super(2);
    }

...
@DebugMetadata(m3969c = "com.pudutech.mirsdk.mircore.MirCoreImpl$loadScheMapAndConfig$scheduleInitJob$1", m3970f = "MirCoreImpl.kt", m3971i = {}, m3972l = {}, m3973m = "invokeSuspend", m3974n = {}, m3975s = {})
/* loaded from: classes4.dex */
final class MirCoreImpl$loadScheMapAndConfig$scheduleInitJob$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    /* renamed from: p$ */
    private CoroutineScope f6173p$;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    MirCoreImpl$loadScheMapAndConfig$scheduleInitJob$1(Ref.ObjectRef objectRef, InitServiceListener initServiceListener, int i, List list, Ref.ObjectRef objectRef2, Ref.ObjectRef objectRef3, List list2, Continuation continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> completion) {
        ...
        MirCoreImpl$loadScheMapAndConfig$scheduleInitJob$1 mirCoreImpl$loadScheMapAndConfig$scheduleInitJob$1 = new MirCoreImpl$loadScheMapAndConfig$scheduleInitJob$1(this.$topoMapBytes, this.$initListener, this.$defFloorIndex, this.$floors_map, this.$scheduleJsonBytes, this.$scheduleYamlBytes, this.$initModuleList, completion);
        mirCoreImpl$loadScheMapAndConfig$scheduleInitJob$1.f6173p$ = (CoroutineScope) obj;
        return mirCoreImpl$loadScheMapAndConfig$scheduleInitJob$1;
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((MirCoreImpl$loadScheMapAndConfig$scheduleInitJob$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        CoroutineScope coroutineScope = this.f6173p$;

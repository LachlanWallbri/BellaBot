...
final class MirCoreImpl$reloadMap$9 extends Lambda implements Function2<String, IRightRgbdData, Unit> {
    public static final MirCoreImpl$reloadMap$9 INSTANCE = new MirCoreImpl$reloadMap$9();

    MirCoreImpl$reloadMap$9() {
        super(2);
    }

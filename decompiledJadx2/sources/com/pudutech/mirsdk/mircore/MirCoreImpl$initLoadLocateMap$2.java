...
final class MirCoreImpl$initLoadLocateMap$2 extends Lambda implements Function1<Vector2d, Unit> {
    public static final MirCoreImpl$initLoadLocateMap$2 INSTANCE = new MirCoreImpl$initLoadLocateMap$2();

    MirCoreImpl$initLoadLocateMap$2() {
        super(1);
    }

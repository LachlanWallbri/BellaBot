...
@Metadata(m3959bv = {1, 0, 3}, m3960d1 = {"\u0000L\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\t\bÆ\u0002\u0018\u00002\u00020\u0001:\u0004\u001c\u001d\u001e\u001fB\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0016\u0010\u0014\u001a\u00020\u00152\u0006\u0010\u0016\u001a\u00020\u00172\u0006\u0010\u0018\u001a\u00020\fJ\u000e\u0010\u0019\u001a\u00020\u00152\u0006\u0010\u001a\u001a\u00020\u0006J\u000e\u0010\u001b\u001a\u00020\u00152\u0006\u0010\u001a\u001a\u00020\u0006R\u0010\u0010\u0003\u001a\u0004\u0018\u00010\u0004X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0006X\u0082D¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\bX\u0082.¢\u0006\u0002\n\u0000R\u000e\u0010\t\u001a\u00020\nX\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u000b\u001a\u00020\fX\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\r\u001a\u00020\u0006X\u0082D¢\u0006\u0002\n\u0000R\u0014\u0010\u000e\u001a\b\u0012\u0004\u0012\u00020\u00100\u000fX\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0011\u001a\u00020\u0012X\u0082.¢\u0006\u0002\n\u0000R\u000e\u0010\u0013\u001a\u00020\u0006X\u0082.¢\u0006\u0002\n\u0000¨\u0006 "}, m3961d2 = {"Lcom/pudutech/mirsdk/cloud/ReportClient;", "", "()V", JsonFactory.FORMAT_NAME_JSON, "Lokhttp3/MediaType;", "TAG", "", "client", "Lokhttp3/OkHttpClient;", "gson", "Lcom/google/gson/Gson;", "has_history", "", "historyFilePath", "intentsDequeue", "Ljava/util/concurrent/LinkedBlockingDeque;", "Lcom/pudutech/mirsdk/cloud/ReportClient$ReportContent;", "reportThread", "Lcom/pudutech/mirsdk/cloud/ReportClient$ReportIntentThread;", "reportUrl", "init", "", "context", "Landroid/content/Context;", "debug", ReportClient.TAG, NotificationCompat.CATEGORY_MESSAGE, "reportOrThrown", "HistoryBody", "HistoryContent", "ReportContent", "ReportIntentThread", "MirFunction_packRelease"}, m3962k = 1, m3963mv = {1, 1, 16})
...
public final class ReportClient {
    ...
    public final void init(Context context, boolean debug) {
        ...
        if (client == null && reportThread == null) {
            reportUrl = debug ? BuildConfig.DebugReportURL : BuildConfig.ReportURL;
            ...
            reportIntentThread.setName("SDKCloudReport");
    ...
    public final void report(String msg) {
        ...
        LinkedBlockingDeque<ReportContent> linkedBlockingDeque = intentsDequeue;
        String str = reportUrl;
        if (str == null) {
            Intrinsics.throwUninitializedPropertyAccessException("reportUrl");
        }
        linkedBlockingDeque.putFirst(new ReportContent(msg, str, true));
    }

    public final void reportOrThrown(String msg) {
        Intrinsics.checkParameterIsNotNull(msg, "msg");
        if (client == null) {
            return;
        }
        ...
        linkedBlockingDeque.putFirst(new ReportContent(msg, str, false));
    }
     ...
     */
    /* compiled from: ReportClient.kt */
    @Metadata(m3959bv = {1, 0, 3}, m3960d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\f\b\u0002\u0018\u00002\u00020\u0001B#\u0012\b\b\u0002\u0010\u0002\u001a\u00020\u0003\u0012\b\b\u0002\u0010\u0004\u001a\u00020\u0003\u0012\b\b\u0002\u0010\u0005\u001a\u00020\u0006¢\u0006\u0002\u0010\u0007R\u001a\u0010\u0002\u001a\u00020\u0003X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\b\u0010\t\"\u0004\b\n\u0010\u000bR\u001a\u0010\u0005\u001a\u00020\u0006X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\f\u0010\r\"\u0004\b\u000e\u0010\u000fR\u001a\u0010\u0004\u001a\u00020\u0003X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0010\u0010\t\"\u0004\b\u0011\u0010\u000b¨\u0006\u0012"}, m3961d2 = {"Lcom/pudutech/mirsdk/cloud/ReportClient$ReportContent;", "", "data", "", "url", "save_to_history", "", "(Ljava/lang/String;Ljava/lang/String;Z)V", "getData", "()Ljava/lang/String;", "setData", "(Ljava/lang/String;)V", "getSave_to_history", "()Z", "setSave_to_history", "(Z)V", "getUrl", "setUrl", "MirFunction_packRelease"}, m3962k = 1, m3963mv = {1, 1, 16})
    /* loaded from: classes5.dex */
     ...
     */
    /* compiled from: ReportClient.kt */
    @Metadata(m3959bv = {1, 0, 3}, m3960d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000e\n\u0002\b\r\b\u0002\u0018\u00002\u00020\u0001B#\u0012\b\b\u0002\u0010\u0002\u001a\u00020\u0003\u0012\b\b\u0002\u0010\u0004\u001a\u00020\u0005\u0012\b\b\u0002\u0010\u0006\u001a\u00020\u0005¢\u0006\u0002\u0010\u0007R\u001a\u0010\u0006\u001a\u00020\u0005X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\b\u0010\t\"\u0004\b\n\u0010\u000bR\u001a\u0010\u0002\u001a\u00020\u0003X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\f\u0010\r\"\u0004\b\u000e\u0010\u000fR\u001a\u0010\u0004\u001a\u00020\u0005X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0010\u0010\t\"\u0004\b\u0011\u0010\u000b¨\u0006\u0012"}, m3961d2 = {"Lcom/pudutech/mirsdk/cloud/ReportClient$HistoryContent;", "", "time", "", "url", "", "data", "(ILjava/lang/String;Ljava/lang/String;)V", "getData", "()Ljava/lang/String;", "setData", "(Ljava/lang/String;)V", "getTime", "()I", "setTime", "(I)V", "getUrl", "setUrl", "MirFunction_packRelease"}, m3962k = 1, m3963mv = {1, 1, 16})
    /* loaded from: classes5.dex */
     ...
     */
    /* compiled from: ReportClient.kt */
    @Metadata(m3959bv = {1, 0, 3}, m3960d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\n\b\u0002\u0018\u00002\u00020\u0001B-\u0012\b\b\u0002\u0010\u0002\u001a\u00020\u0003\u0012\u001c\b\u0002\u0010\u0004\u001a\u0016\u0012\u0004\u0012\u00020\u0006\u0018\u00010\u0005j\n\u0012\u0004\u0012\u00020\u0006\u0018\u0001`\u0007¢\u0006\u0002\u0010\bR.\u0010\u0004\u001a\u0016\u0012\u0004\u0012\u00020\u0006\u0018\u00010\u0005j\n\u0012\u0004\u0012\u00020\u0006\u0018\u0001`\u0007X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\t\u0010\n\"\u0004\b\u000b\u0010\fR\u001a\u0010\u0002\u001a\u00020\u0003X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\r\u0010\u000e\"\u0004\b\u000f\u0010\u0010¨\u0006\u0011"}, m3961d2 = {"Lcom/pudutech/mirsdk/cloud/ReportClient$HistoryBody;", "", "size", "", "history", "Ljava/util/ArrayList;", "Lcom/pudutech/mirsdk/cloud/ReportClient$HistoryContent;", "Lkotlin/collections/ArrayList;", "(ILjava/util/ArrayList;)V", "getHistory", "()Ljava/util/ArrayList;", "setHistory", "(Ljava/util/ArrayList;)V", "getSize", "()I", "setSize", "(I)V", "MirFunction_packRelease"}, m3962k = 1, m3963mv = {1, 1, 16})
    /* loaded from: classes5.dex */
     ...
     */
    /* compiled from: ReportClient.kt */
    @Metadata(m3959bv = {1, 0, 3}, m3960d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0006\b\u0002\u0018\u00002\u00020\u0001:\u0001\u0011B\u0005¢\u0006\u0002\u0010\u0002J\n\u0010\u0003\u001a\u0004\u0018\u00010\u0004H\u0002J\u0010\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\u0004H\u0002J\b\u0010\b\u001a\u00020\tH\u0002J\u0010\u0010\n\u001a\u00020\u00062\u0006\u0010\u000b\u001a\u00020\fH\u0002J\b\u0010\r\u001a\u00020\tH\u0016J\b\u0010\u000e\u001a\u00020\tH\u0002J\u0010\u0010\u000f\u001a\u00020\t2\u0006\u0010\u000b\u001a\u00020\fH\u0002J\u0010\u0010\u0010\u001a\u00020\t2\u0006\u0010\u000b\u001a\u00020\fH\u0002¨\u0006\u0012"}, m3961d2 = {"Lcom/pudutech/mirsdk/cloud/ReportClient$ReportIntentThread;", "Ljava/lang/Thread;", "()V", "createFile", "Ljava/io/File;", "deleteDir", "", "file", "reportHistory", "", "reportToCloud", AIUIConstant.KEY_CONTENT, "Lcom/pudutech/mirsdk/cloud/ReportClient$ReportContent;", "run", "saveEmptyFile", "saveOneContentToFile", "saveToHistory", "ReportResultObj", "MirFunction_packRelease"}, m3962k = 1, m3963mv = {1, 1, 16})
    /* loaded from: classes5.dex */
    public static final class ReportIntentThread extends Thread {
         ...
         */
        /* compiled from: ReportClient.kt */
        @Metadata(m3959bv = {1, 0, 3}, m3960d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u000e\b\u0086\u0004\u0018\u00002\u00020\u0001B\u001f\u0012\b\b\u0002\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005\u0012\u0006\u0010\u0006\u001a\u00020\u0007¢\u0006\u0002\u0010\bR\u001a\u0010\u0002\u001a\u00020\u0003X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\t\u0010\n\"\u0004\b\u000b\u0010\fR\u001a\u0010\u0006\u001a\u00020\u0007X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\r\u0010\u000e\"\u0004\b\u000f\u0010\u0010R\u001a\u0010\u0004\u001a\u00020\u0005X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0011\u0010\u0012\"\u0004\b\u0013\u0010\u0014¨\u0006\u0015"}, m3961d2 = {"Lcom/pudutech/mirsdk/cloud/ReportClient$ReportIntentThread$ReportResultObj;", "", "code", "", NotificationCompat.CATEGORY_MESSAGE, "", "data", "Lcom/google/gson/Gson;", "(Lcom/pudutech/mirsdk/cloud/ReportClient$ReportIntentThread;ILjava/lang/String;Lcom/google/gson/Gson;)V", "getCode", "()I", "setCode", "(I)V", "getData", "()Lcom/google/gson/Gson;", "setData", "(Lcom/google/gson/Gson;)V", "getMsg", "()Ljava/lang/String;", "setMsg", "(Ljava/lang/String;)V", "MirFunction_packRelease"}, m3962k = 1, m3963mv = {1, 1, 16})
        /* loaded from: classes5.dex */
        ...
        */
        ...
        private final void saveOneContentToFile(ReportContent content) {
            ...
            if (createFile == null) {
                Pdlog.m3275i(ReportClient.access$getTAG$p(ReportClient.INSTANCE), "create history file failed");
                return;
            }
            HistoryBody historyBody = new HistoryBody(i, null, 3, 0 == true ? 1 : 0);
        ...
        private final void saveEmptyFile() {
            ...
            try {
                try {
                    fileOutputStream = new FileOutputStream(createFile);
                    try {
                        json = ReportClient.access$getGson$p(ReportClient.INSTANCE).toJson(historyBody);
                        Intrinsics.checkExpressionValueIsNotNull(json, "gson.toJson(body)");
        ...
        private final File createFile() {
            ...
            try {
                ...
                Pdlog.m3277w(ReportClient.access$getTAG$p(ReportClient.INSTANCE), "can not create history file");
                return null;
            }
        }
    }

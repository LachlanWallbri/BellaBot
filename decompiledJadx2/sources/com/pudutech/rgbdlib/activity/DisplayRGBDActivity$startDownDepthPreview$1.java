...
@Metadata(m3959bv = {1, 0, 3}, m3960d1 = {"\u0000\u001f\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0003*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J(\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u00072\u0006\u0010\b\u001a\u00020\u00072\u0006\u0010\t\u001a\u00020\u0007H\u0016¨\u0006\n"}, m3961d2 = {"com/pudutech/rgbdlib/activity/DisplayRGBDActivity$startDownDepthPreview$1", "Lcom/pudutech/rgbdlib/RGBDDataCatcher;", "onFrameDescriptor", "", "p0", "Landroid/os/ParcelFileDescriptor;", "p1", "", "p2", "p3", "RGBDLib_release"}, m3962k = 1, m3963mv = {1, 1, 16})
/* loaded from: classes2.dex */
public final class DisplayRGBDActivity$startDownDepthPreview$1 implements RGBDDataCatcher {
    final /* synthetic */ DisplayRGBDActivity this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    public DisplayRGBDActivity$startDownDepthPreview$1(DisplayRGBDActivity displayRGBDActivity) {
    ...
    public void onFrameDescriptor(ParcelFileDescriptor p0, int p1, int p2, int p3) {
        ...
        if (read > 64) {
            ...
            str = this.this$0.TAG;
            Pdlog.m3273d(str, "rgbd width: " + rGBDData.getWidth() + ",height: " + rGBDData.getHeight());
            ...
            this.this$0.runOnUiThread(new Runnable() { // from class: com.pudutech.rgbdlib.activity.DisplayRGBDActivity$startDownDepthPreview$1$onFrameDescriptor$1
                /* JADX WARN: Multi-variable type inference failed */
                @Override // java.lang.Runnable
                public final void run() {
                    DisplayRGBDActivity displayRGBDActivity = DisplayRGBDActivity$startDownDepthPreview$1.this.this$0;

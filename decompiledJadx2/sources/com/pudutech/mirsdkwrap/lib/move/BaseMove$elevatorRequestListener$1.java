...
public final class BaseMove$elevatorRequestListener$1 extends ElevatorRequestListener.Stub {
    ...
    public void informElevatorUtilizeState(ElevatorUtilizeState p0, String p1) {
        ...
        if (ElevatorUtilizeState.CallingElevator == p0 || ElevatorUtilizeState.EnteringElevator == p0) {
            this.this$0.runOnUi(new BaseMove$elevatorRequestListener$1$informElevatorUtilizeState$1(this, p0, null));
        }
        ...
        if (parserElevatorJson != null) {
            ...
            this.this$0.runOnUi(new BaseMove$elevatorRequestListener$1$informElevatorUtilizeState$2(this, p0, parserElevatorJson, null));
        } else {

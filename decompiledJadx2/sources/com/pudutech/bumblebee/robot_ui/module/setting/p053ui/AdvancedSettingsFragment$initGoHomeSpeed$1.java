...
public final class AdvancedSettingsFragment$initGoHomeSpeed$1 extends Lambda implements Function1<IndicatorSeekBar, Unit> {
    final /* synthetic */ int $levelSize;
    final /* synthetic */ AdvancedSettingsFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AdvancedSettingsFragment$initGoHomeSpeed$1(AdvancedSettingsFragment advancedSettingsFragment, int i) {
        super(1);
    ...
    public final void invoke2(IndicatorSeekBar indicatorSeekBar) {
        ...
        if (indicatorSeekBar != null) {
            ...
            sb.append("gohomeSpeed onStopTrackingTouch:  ");
            ...
            BuildersKt__Builders_commonKt.launch$default(GlobalScope.INSTANCE, Dispatchers.getDefault(), null, new C4215x8a4e0b41(round, null, this), 2, null);
            arrayList2 = this.this$0.speedList;
            if (arrayList2.size() - 4 <= round) {
                AdvancedSettingsFragment advancedSettingsFragment = this.this$0;
                i = advancedSettingsFragment.TYPE_GOHOME;

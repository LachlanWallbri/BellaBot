...
public final class SpeedFragment$goHomeSpeed$1 extends Lambda implements Function1<IndicatorSeekBar, Unit> {
    ...
    public SpeedFragment$goHomeSpeed$1(SpeedFragment speedFragment, int i, List list) {
        super(1);
    ...
    public final void invoke2(IndicatorSeekBar indicatorSeekBar) {
        ...
        if (indicatorSeekBar != null) {
            ...
            str = this.this$0.TAG;
            Pdlog.m3275i(str, "goHomeSpeed onStopTrackingTouch:  " + indicatorSeekBar.getProgressFloat() + ' ' + rint + ' ' + ((String) this.$speedData.get(rint)));
            BuildersKt__Builders_commonKt.launch$default(GlobalScope.INSTANCE, Dispatchers.getIO(), null, new SpeedFragment$goHomeSpeed$1$$special$$inlined$let$lambda$1(rint, null, this), 2, null);
            isTooFast = this.this$0.isTooFast(rint, this.$speedData);
            if (isTooFast) {
                SpeedFragment speedFragment = this.this$0;
                i = speedFragment.TYPE_GOHOME;

...
@DebugMetadata(m3969c = "com.pudutech.bumblebee.robot_ui.module.robot_user_interaction_animation.ui.LaserRunningLocationLostActivity$dispatchTouchEvent$1", m3970f = "LaserRunningLocationLostActivity.kt", m3971i = {0, 0}, m3972l = {182}, m3973m = "invokeSuspend", m3974n = {"$this$launch", "idx"}, m3975s = {"L$0", "I$0"})
...
public final class LaserRunningLocationLostActivity$dispatchTouchEvent$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> completion) {
        ...
        laserRunningLocationLostActivity$dispatchTouchEvent$1.f4862p$ = (CoroutineScope) obj;
    ...
    */
    public final Object invokeSuspend(Object obj) {
        ...
        if (i2 == 1) {
            ...
            i++;
            if (i >= 5) {
                BuildersKt__Builders_commonKt.launch$default(GlobalScope.INSTANCE, Dispatchers.getMain(), null, new C42091(null), 2, null);
                return Unit.INSTANCE;
            }
            if (CoroutineScopeKt.isActive(coroutineScope)) {
    ...
    /* compiled from: LaserRunningLocationLostActivity.kt */
    @Metadata(m3959bv = {1, 0, 3}, m3960d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@¢\u0006\u0004\b\u0003\u0010\u0004"}, m3961d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;", "invoke", "(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;"}, m3962k = 3, m3963mv = {1, 1, 16})
    @DebugMetadata(m3969c = "com.pudutech.bumblebee.robot_ui.module.robot_user_interaction_animation.ui.LaserRunningLocationLostActivity$dispatchTouchEvent$1$1", m3970f = "LaserRunningLocationLostActivity.kt", m3971i = {}, m3972l = {}, m3973m = "invokeSuspend", m3974n = {}, m3975s = {})
    /* renamed from: com.pudutech.bumblebee.robot_ui.module.robot_user_interaction_animation.ui.LaserRunningLocationLostActivity$dispatchTouchEvent$1$1 */
    /* loaded from: classes3.dex */
    public static final class C42091 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        int label;

        /* renamed from: p$ */
        private CoroutineScope f4863p$;

        C42091(Continuation continuation) {
            super(2, continuation);
        }
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> completion) {
            Intrinsics.checkParameterIsNotNull(completion, "completion");
            C42091 c42091 = new C42091(completion);
            c42091.f4863p$ = (CoroutineScope) obj;
            return c42091;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            return ((C42091) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            ResultKt.throwOnFailure(obj);
            CoroutineScope coroutineScope = this.f4863p$;
            LaserRunningLocationLostActivity$dispatchTouchEvent$1.this.this$0.jumpToHomePage();
            return Unit.INSTANCE;
        }
    }
}

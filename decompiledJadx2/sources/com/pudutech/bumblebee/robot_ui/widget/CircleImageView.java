...
public class CircleImageView extends AppCompatImageView {
    ...
    private static final ImageView.ScaleType SCALE_TYPE2 = ImageView.ScaleType.CENTER_CROP;
    ...
    public CircleImageView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mBorderColor = -16777216;
        this.mBorderWidth = 0;
        context.getTheme().obtainStyledAttributes(attributeSet, C4188R.styleable.CircleImageView, i, 0);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C4188R.styleable.CircleImageView, i, 0);
        this.mBorderWidth = obtainStyledAttributes.getDimensionPixelSize(C4188R.styleable.CircleImageView_border_width, 0);
        this.mBorderColor = obtainStyledAttributes.getColor(C4188R.styleable.CircleImageView_border_color, -16777216);

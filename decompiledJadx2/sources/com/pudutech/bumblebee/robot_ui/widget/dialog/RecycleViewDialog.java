package com.pudutech.bumblebee.robot_ui.widget.dialog;
...
public final class RecycleViewDialog extends BumbleBaseDialog {
    ...
    public final void setConfirmEnable(boolean z) {
        ...
        Button button = this.confirmBtn;
        if (button != null) {
            button.setEnabled(this.confirmEnable);
        }
    }
    ...
    public void initView(View view) {
        ...
        if (imageView != null) {
            ...
            final int i = 0;
            imageView.setOnClickListener(new OnLazyVoiceClickListener(emptyMap, i) { // from class: com.pudutech.bumblebee.robot_ui.widget.dialog.RecycleViewDialog$initView$$inlined$singleClick$1
        ...
        if (button != null) {
            ...
            final int i2 = 0;
            button.setOnClickListener(new OnLazyVoiceClickListener(emptyMap2, i2) { // from class: com.pudutech.bumblebee.robot_ui.widget.dialog.RecycleViewDialog$initView$$inlined$singleClick$2
                @Override // com.pudutech.bumblebee.robot_ui.ui_utils.OnLazyVoiceClickListener
                public void onSingleClick(View v) {
                    Intrinsics.checkParameterIsNotNull(v, "v");
                    super.onSingleClick(v);

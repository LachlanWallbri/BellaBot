...
public final class TurnBackTrack implements ISportTrack {
    ...
    public static /* synthetic */ void onCreateTask$default(TurnBackTrack turnBackTrack, String str, String str2, int i, Object obj) {
        if ((i & 2) != 0) {
            str2 = "";
        }
        turnBackTrack.onCreateTask(str, str2);
    }
    ...
    public final void onCreateTask(String pageKey2, String sessionId2) {
        ...
        if (sessionId2.length() == 0) {
            sessionId = TrackScene.INSTANCE.createOrGetSession(TrackType.TURN_BACK, true);
        } else {
            sessionId = sessionId2;
        }
        task = Turn_backKt.newTurnBackTask(TrackingReportManager.INSTANCE, new BaseTurnBackConfig.BellaBaseTurnBackConfig(AppCommonUtil.isOpenMusicSwitch(), Constans.INSTANCE.isReturnFace(), Float.parseFloat(RobotSpeedUtil.INSTANCE.getGoHomeSpeedLevel(RobotContext.INSTANCE.getContext())), pageKey2), sessionId);
        pageKey = pageKey2;
        VoiceInteractionTrack.INSTANCE.onCreateTask(pageKey2, sessionId);
        TurnBackTask turnBackTask = task;
        if (turnBackTask != null) {
            turnBackTask.onStart();
        }
    }
    ...
    public final void onArrive(String destination) {
        ...
        TurnBackTask turnBackTask = task;
        if (turnBackTask != null) {
            turnBackTask.onArrive(destination);
        }
    }

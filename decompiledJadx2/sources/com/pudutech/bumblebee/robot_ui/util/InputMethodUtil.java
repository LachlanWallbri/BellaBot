...
public class InputMethodUtil {
    ...
    public static void changeInputMethodIfNeed(final Context context, final String str) {
        final Context applicationContext = context.getApplicationContext();
        ThreadPoolManager.getInstance().execSimpleTask(new Runnable() { // from class: com.pudutech.bumblebee.robot_ui.util.InputMethodUtil.1
            ...
            public void run() {
                ...
                Pdlog.m3273d(InputMethodUtil.TAG, String.format("current default: %s", Settings.Secure.getString(context.getContentResolver(), "default_input_method")));
            }
        });
    }
}

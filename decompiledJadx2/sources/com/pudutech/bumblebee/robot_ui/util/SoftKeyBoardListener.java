...
public class SoftKeyBoardListener {
    ...
    public SoftKeyBoardListener(Activity activity) {
        ...
        this.rootView.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: com.pudutech.bumblebee.robot_ui.util.SoftKeyBoardListener.1

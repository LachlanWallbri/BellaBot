...
@Metadata(m3959bv = {1, 0, 3}, m3960d1 = {"\u0000d\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0003\n\u0002\b\u0003\n\u0002\u0010\t\n\u0002\b\r\bÆ\u0002\u0018\u00002\u00020\u0001:\u0002./B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0010\u0010\u000f\u001a\u00020\n2\u0006\u0010\u0010\u001a\u00020\u000eH\u0002J\b\u0010\u0011\u001a\u00020\u0012H\u0002J3\u0010\u0013\u001a\u00020\u00122\u0006\u0010\u0014\u001a\u00020\u00152#\u0010\u0016\u001a\u001f\u0012\u0015\u0012\u0013\u0018\u00010\u0004¢\u0006\f\b\u0018\u0012\b\b\u0019\u0012\u0004\b\b(\u001a\u0012\u0004\u0012\u00020\u00120\u0017J\u000e\u0010\u001b\u001a\u00020\u001c2\u0006\u0010\u001a\u001a\u00020\u0004J\u0010\u0010\u001d\u001a\u00020\u00122\u0006\u0010\u001e\u001a\u00020\u001fH\u0016J\b\u0010 \u001a\u00020\u0012H\u0016J\u0018\u0010!\u001a\u00020\u00122\u0006\u0010\"\u001a\u00020#2\u0006\u0010$\u001a\u00020#H\u0016J\b\u0010%\u001a\u00020\u0012H\u0016J\u000e\u0010&\u001a\u00020\u00122\u0006\u0010'\u001a\u00020\u0004J\u0010\u0010(\u001a\u00020\u00122\u0006\u0010)\u001a\u00020\u001cH\u0002J\u0006\u0010*\u001a\u00020\u0012J\b\u0010+\u001a\u00020\u0012H\u0002J\u0016\u0010,\u001a\u00020\n2\u0006\u0010\u0014\u001a\u00020\u00152\u0006\u0010\u001a\u001a\u00020\u0004J\b\u0010-\u001a\u00020\u0012H\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0006X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\bX\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\t\u001a\u00020\nX\u0082\u000e¢\u0006\u0002\n\u0000R\u0010\u0010\u000b\u001a\u0004\u0018\u00010\fX\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\r\u001a\u00020\u000eX\u0082\u000e¢\u0006\u0002\n\u0000¨\u00060"}, m3961d2 = {"Lcom/pudutech/bumblebee/robot_ui/manager/SystemUpdateManager;", "Lcom/pudutech/lib_update/listener/IShowProgress;", "()V", "TAG", "", "gson", "Lcom/google/gson/Gson;", "handler", "Landroid/os/Handler;", "isRequestFromServer", "", "netWorkChangeReceiver", "Lcom/pudutech/bumblebee/robot_ui/manager/SystemUpdateManager$NetWorkChangeReceiver;", "retryCount", "", "checkAppSysVersion", "systemVersionCode", "checkFromServer", "", "checkLocalSystemFile", "context", "Landroid/content/Context;", "sysUpdateFilePathCallback", "Lkotlin/Function1;", "Lkotlin/ParameterName;", "name", "path", "getUpdateCount", "Lcom/pudutech/bumblebee/robot_ui/manager/SystemUpdateManager$SystemUpdateCount;", "onFail", C3898x.f4338g, "", "onFinish", "onProgress", "crtSize", "", "totalSize", "onStartProgress", "requestNewUpdateFileIfNeed", "filePath", "saveUpdateCount", "countObj", "startCheckFromServer", "startNetReceiver", "startSystemUpdate", "stopNetReceiverIfNeed", "NetWorkChangeReceiver", "SystemUpdateCount", "robot_ui_robotRelease"}, m3962k = 1, m3963mv = {1, 1, 16})
...
public final class SystemUpdateManager implements IShowProgress {
    ...
    public final void startCheckFromServer() {
        ...
        if (RobotInfo.INSTANCE.isBellabot()) {
    ...
    public final void checkFromServer() {
        ...
        String str = mac;
        String appMetaData = AppUtil.INSTANCE.getAppMetaData(BaseApp.INSTANCE.getINSTANCE(), "Install_Channel");
        if (appMetaData == null) {
            appMetaData = "general";
        }
        String str2 = appMetaData;
        ...
        if (systemUpdateInfo == null) {
            ...
            PuduSystemVersionManager.INSTANCE.checkSystemUpdate(str, property, property2, systemUpdateInfo.getName(), systemUpdateInfo.getVersionName(), systemUpdateInfo.getVerCode(), "6.12.0.10", property3, str2, this);
        }
    }
    ...
    public final void checkLocalSystemFile(Context context, final Function1<? super String, Unit> sysUpdateFilePathCallback) {
        ...
        try {
            ...
            if (str == null || StringsKt.isBlank(str)) {
                ...
                PuduSystemVersionManager.INSTANCE.checkLocalSystemFile(Integer.parseInt(property), new Function1<String, Unit>() { // from class: com.pudutech.bumblebee.robot_ui.manager.SystemUpdateManager$checkLocalSystemFile$p$1
                    ...
                    public final void invoke2(String it) {
                        ...
                        Pdlog.m3273d("SystemUpdateManager", "checkLocalAndUpdate = " + it);
    ...
    public void onFail(Throwable e) {
        ...
        if (i < 3) {
            retryCount = i + 1;
            handler.postDelayed(new Runnable() { // from class: com.pudutech.bumblebee.robot_ui.manager.SystemUpdateManager$onFail$1
    ...
    /* compiled from: SystemUpdateManager.kt */
    @Metadata(m3959bv = {1, 0, 3}, m3960d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\b\u0000\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\b\u0010\u0003\u001a\u00020\u0004H\u0016¨\u0006\u0005"}, m3961d2 = {"Lcom/pudutech/bumblebee/robot_ui/manager/SystemUpdateManager$NetWorkChangeReceiver;", "Lcom/pudutech/bumblebee/robot_ui/util/NetWorkChangeEvent;", "()V", "onNetworkChange", "", "robot_ui_robotRelease"}, m3962k = 1, m3963mv = {1, 1, 16})
    /* loaded from: classes3.dex */
    ...
    /* compiled from: SystemUpdateManager.kt */
    @Metadata(m3959bv = {1, 0, 3}, m3960d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\b\n\u0002\b\r\n\u0002\u0010\u000b\n\u0002\b\u0004\b\u0086\b\u0018\u00002\u00020\u0001B\u0015\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0002\u0010\u0006J\t\u0010\u000f\u001a\u00020\u0003HÆ\u0003J\t\u0010\u0010\u001a\u00020\u0005HÆ\u0003J\u001d\u0010\u0011\u001a\u00020\u00002\b\b\u0002\u0010\u0002\u001a\u00020\u00032\b\b\u0002\u0010\u0004\u001a\u00020\u0005HÆ\u0001J\u0013\u0010\u0012\u001a\u00020\u00132\b\u0010\u0014\u001a\u0004\u0018\u00010\u0001HÖ\u0003J\t\u0010\u0015\u001a\u00020\u0005HÖ\u0001J\t\u0010\u0016\u001a\u00020\u0003HÖ\u0001R\u001a\u0010\u0004\u001a\u00020\u0005X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0007\u0010\b\"\u0004\b\t\u0010\nR\u001a\u0010\u0002\u001a\u00020\u0003X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u000b\u0010\f\"\u0004\b\r\u0010\u000e¨\u0006\u0017"}, m3961d2 = {"Lcom/pudutech/bumblebee/robot_ui/manager/SystemUpdateManager$SystemUpdateCount;", "", "path", "", "count", "", "(Ljava/lang/String;I)V", "getCount", "()I", "setCount", "(I)V", "getPath", "()Ljava/lang/String;", "setPath", "(Ljava/lang/String;)V", "component1", "component2", "copy", "equals", "", "other", "hashCode", "toString", "robot_ui_robotRelease"}, m3962k = 1, m3963mv = {1, 1, 16})
    /* loaded from: classes3.dex */

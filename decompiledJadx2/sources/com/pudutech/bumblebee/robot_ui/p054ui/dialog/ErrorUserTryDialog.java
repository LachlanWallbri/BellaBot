...
public class ErrorUserTryDialog extends Dialog {
    ...
    private final void build() {
        View inflate = getLayoutInflater().inflate(C4188R.layout.dialog_error_user_try, (ViewGroup) null);
    ...
    private final void initView() {
        Button button = (Button) findViewById(C4188R.id.btn_try);
        if (button != null) {
            button.setOnClickListener(new SingleVoiceClickListener(null, 0, new Function1<View, Unit>() { // from class: com.pudutech.bumblebee.robot_ui.ui.dialog.ErrorUserTryDialog$initView$1
        ...
        Button button2 = (Button) findViewById(C4188R.id.btnCancel);
        if (button2 != null) {
            button2.setOnClickListener(new SingleVoiceClickListener(null, 0, new Function1<View, Unit>() { // from class: com.pudutech.bumblebee.robot_ui.ui.dialog.ErrorUserTryDialog$initView$2
                /* JADX INFO: Access modifiers changed from: package-private */
                {
                    super(1);
                }
    ...
    public final void setContent(String m) {
        ...
        TextView msg_tv = (TextView) findViewById(C4188R.id.msg_tv);

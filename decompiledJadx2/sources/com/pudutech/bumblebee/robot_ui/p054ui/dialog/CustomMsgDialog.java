...
public class CustomMsgDialog extends Dialog {
    ...
    private final void build() {
        View inflate = getLayoutInflater().inflate(C4188R.layout.dialog_costom_msg, (ViewGroup) null);
    ...
    private final void initView() {
        ...
        if (frameLayout != null) {
            frameLayout.setOnClickListener(new OnLazyVoiceClickListener() { // from class: com.pudutech.bumblebee.robot_ui.ui.dialog.CustomMsgDialog$initView$1
        ...
        if (button2 != null) {
            button2.setOnClickListener(new OnLazyVoiceClickListener() { // from class: com.pudutech.bumblebee.robot_ui.ui.dialog.CustomMsgDialog$initView$2
                /* JADX INFO: Access modifiers changed from: package-private */
                {
                    super(null, 0, 3, 0 == true ? 1 : 0);
                }

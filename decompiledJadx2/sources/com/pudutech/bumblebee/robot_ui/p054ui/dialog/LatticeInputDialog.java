...
public final class LatticeInputDialog extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(C4188R.layout.dialog_latice_input, container, false);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        window.getDecorView().setOnSystemUiVisibilityChangeListener(new View.OnSystemUiVisibilityChangeListener() { // from class: com.pudutech.bumblebee.robot_ui.ui.dialog.LatticeInputDialog$onViewCreated$1
    ...
    private final void initView() {
        ...
        setCancelable(false);
        ((EditText) _$_findCachedViewById(C4188R.id.content_input)).setText(this.content);
        ((EditText) _$_findCachedViewById(C4188R.id.content_input)).setSelection(this.content.length());
        EditText content_input = (EditText) _$_findCachedViewById(C4188R.id.content_input);
        Intrinsics.checkExpressionValueIsNotNull(content_input, "content_input");
        ViewExtKt.disableCopyAndPaste(content_input);
        ((TextView) _$_findCachedViewById(C4188R.id.input_done)).setOnClickListener(new OnLazyVoiceClickListener() { // from class: com.pudutech.bumblebee.robot_ui.ui.dialog.LatticeInputDialog$initView$1
            ...
            public void onSingleClick() {
                ...
                EditText content_input2 = (EditText) LatticeInputDialog.this._$_findCachedViewById(C4188R.id.content_input);
        ...
        ((TextView) _$_findCachedViewById(C4188R.id.input_preview)).setOnClickListener(new OnLazyVoiceClickListener() { // from class: com.pudutech.bumblebee.robot_ui.ui.dialog.LatticeInputDialog$initView$2
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(null, 0, 3, null);
            }
            ...
            public void onSingleClick() {
                ...
                EditText content_input2 = (EditText) LatticeInputDialog.this._$_findCachedViewById(C4188R.id.content_input);
                Intrinsics.checkExpressionValueIsNotNull(content_input2, "content_input");
                peripheralsSceneUtil.showLedString(content_input2.getText().toString());
            }
        });
        ((TextView) _$_findCachedViewById(C4188R.id.cancel)).setOnClickListener(new OnLazyVoiceClickListener() { // from class: com.pudutech.bumblebee.robot_ui.ui.dialog.LatticeInputDialog$initView$3
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(null, 0, 3, null);
            }
        ...
        Intrinsics.checkExpressionValueIsNotNull(dialog, "dialog!!");
        KeyboardUtils.registerSoftInputChangedListener(dialog.getWindow(), new KeyboardUtils.OnSoftInputChangedListener() { // from class: com.pudutech.bumblebee.robot_ui.ui.dialog.LatticeInputDialog$initView$4
            @Override // com.pudutech.bumblebee.robot_ui.util.KeyboardUtils.OnSoftInputChangedListener
        ...
        KeyboardUtils.showSoftInput((EditText) _$_findCachedViewById(C4188R.id.content_input));
    }

    @Override // androidx.fragment.app.DialogFragment
    public void dismiss() {
        KeyboardUtils.hideSoftInput((EditText) _$_findCachedViewById(C4188R.id.content_input));
        super.dismiss();
    }

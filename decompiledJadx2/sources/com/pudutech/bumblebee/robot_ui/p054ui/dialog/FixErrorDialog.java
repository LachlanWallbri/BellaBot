...
public class FixErrorDialog extends Dialog {
    ...
    private void build() {
        View inflate = getLayoutInflater().inflate(C4188R.layout.dialog_fix_error, (ViewGroup) null);
        ...
        this.bigIv = (ImageView) inflate.findViewById(C4188R.id.big_repair_iv);
        this.smallIv = (ImageView) inflate.findViewById(C4188R.id.small_repair_iv);
        this.cancelIv = (TextView) inflate.findViewById(C4188R.id.cancel_tv);

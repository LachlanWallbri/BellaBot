...
@Metadata(m3959bv = {1, 0, 3}, m3960d1 = {"\u00001\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0004\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\u0003*\u0001\r\u0018\u00002\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00030\u0001B\r\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0002\u0010\u0006J\u0018\u0010\u000f\u001a\u00020\u00102\u0006\u0010\u0011\u001a\u00020\u00032\u0006\u0010\u0012\u001a\u00020\u0002H\u0014R\u000e\u0010\u0007\u001a\u00020\bX\u0082D¢\u0006\u0002\n\u0000R\u001a\u0010\u0004\u001a\u00020\u0005X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\t\u0010\n\"\u0004\b\u000b\u0010\u0006R\u0010\u0010\f\u001a\u00020\rX\u0082\u0004¢\u0006\u0004\n\u0002\u0010\u000e¨\u0006\u0013"}, m3961d2 = {"Lcom/pudutech/bumblebee/robot_ui/ui/adapter/SelectRecycleTaskAdapter;", "Lcom/chad/library/adapter/base/BaseQuickAdapter;", "Lcom/pudutech/bumblebee/presenter/delivery_task/TrayModel;", "Lcom/chad/library/adapter/base/BaseViewHolder;", "context", "Landroid/content/Context;", "(Landroid/content/Context;)V", "TAG", "", "getContext", "()Landroid/content/Context;", "setContext", "onCloseClickListener", "com/pudutech/bumblebee/robot_ui/ui/adapter/SelectRecycleTaskAdapter$onCloseClickListener$1", "Lcom/pudutech/bumblebee/robot_ui/ui/adapter/SelectRecycleTaskAdapter$onCloseClickListener$1;", "convert", "", "helper", "item", "robot_ui_robotRelease"}, m3962k = 1, m3963mv = {1, 1, 16})
...
public final class SelectRecycleTaskAdapter extends BaseQuickAdapter<TrayModel, BaseViewHolder> {
    ...
    /* JADX WARN: Type inference failed for: r2v2, types: [com.pudutech.bumblebee.robot_ui.ui.adapter.SelectRecycleTaskAdapter$onCloseClickListener$1] */
    public SelectRecycleTaskAdapter(Context context) {
        super(C4188R.layout.item_home_recycle_task);
        Intrinsics.checkParameterIsNotNull(context, "context");
        this.context = context;
        this.TAG = "SelectRecycleTaskAdapter";
        this.onCloseClickListener = new OnLazyVoiceClickListener() { // from class: com.pudutech.bumblebee.robot_ui.ui.adapter.SelectRecycleTaskAdapter$onCloseClickListener$1
            ...
            public void onSingleClick(View v) {
                ...
                Object tag = v.getTag();
                if (tag == null) {
                    throw new TypeCastException("null cannot be cast to non-null type com.pudutech.bumblebee.presenter.delivery_task.TrayModel");
                }
    ...
    public void convert(BaseViewHolder helper, TrayModel item) {
        ...
        ImageView closeIv = (ImageView) helper.getView(C4188R.id.close_iv);

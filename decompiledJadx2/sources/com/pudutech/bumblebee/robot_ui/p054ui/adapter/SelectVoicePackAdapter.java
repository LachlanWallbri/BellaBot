...
@Metadata(m3959bv = {1, 0, 3}, m3960d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\u0002\n\u0002\b\u0003\u0018\u00002\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00030\u0001B\r\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0002\u0010\u0006J\u0018\u0010\u0010\u001a\u00020\u00112\u0006\u0010\u0012\u001a\u00020\u00032\u0006\u0010\u0013\u001a\u00020\u0002H\u0014R\u001a\u0010\u0004\u001a\u00020\u0005X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0007\u0010\b\"\u0004\b\t\u0010\u0006R\u001c\u0010\n\u001a\u0004\u0018\u00010\u000bX\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\f\u0010\r\"\u0004\b\u000e\u0010\u000f¨\u0006\u0014"}, m3961d2 = {"Lcom/pudutech/bumblebee/robot_ui/ui/adapter/SelectVoicePackAdapter;", "Lcom/chad/library/adapter/base/BaseQuickAdapter;", "Lcom/pudutech/bumblebee/presenter/robot_voices_task/VoicePackageInfo;", "Lcom/chad/library/adapter/base/BaseViewHolder;", "context", "Landroid/content/Context;", "(Landroid/content/Context;)V", "getContext", "()Landroid/content/Context;", "setContext", "onBtnClickListener", "Landroid/view/View$OnClickListener;", "getOnBtnClickListener", "()Landroid/view/View$OnClickListener;", "setOnBtnClickListener", "(Landroid/view/View$OnClickListener;)V", "convert", "", "helper", "item", "robot_ui_robotRelease"}, m3962k = 1, m3963mv = {1, 1, 16})
...
public final class SelectVoicePackAdapter extends BaseQuickAdapter<VoicePackageInfo, BaseViewHolder> {
    ...
    public SelectVoicePackAdapter(Context context) {
        super(C4188R.layout.item_select_voice_pack);
    ...
    public void convert(BaseViewHolder helper, VoicePackageInfo item) {
        ...
        RelativeLayout btnLayout = (RelativeLayout) helper.getView(C4188R.id.btn_layout);
        TextView btnTv = (TextView) helper.getView(C4188R.id.btn_tv);
        ...
        if (!item.getIsExist()) {
            ...
            textView.setTextColor(this.context.getColor(C4188R.color.font_disable_color));
            Intrinsics.checkExpressionValueIsNotNull(btnTv, "btnTv");
            btnTv.setText(this.context.getString(C4188R.string.pdStr7_77));
            btnTv.setBackground(this.context.getDrawable(C4188R.drawable.shape_voice_download_btn_bg));
        } else {
            textView.setTextColor(this.context.getColor(C4188R.color.font_color_1));
            if (item.getNewVersionAvailable()) {
                btnLayout.setVisibility(0);
                Intrinsics.checkExpressionValueIsNotNull(btnTv, "btnTv");
                btnTv.setText(this.context.getString(C4188R.string.pdStr7_87));
                btnTv.setBackground(this.context.getDrawable(C4188R.drawable.shape_voice_update_btn_bg));
            } else {

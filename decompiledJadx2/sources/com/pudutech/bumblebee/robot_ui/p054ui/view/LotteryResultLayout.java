...
@Metadata(m3959bv = {1, 0, 3}, m3960d1 = {"\u0000H\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0007\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0005\n\u0002\u0010\u000b\n\u0002\b\u0006\u0018\u0000 &2\u00020\u0001:\u0002&'B\u0011\b\u0016\u0012\b\u0010\u0002\u001a\u0004\u0018\u00010\u0003¢\u0006\u0002\u0010\u0004B\u001b\b\u0016\u0012\b\u0010\u0002\u001a\u0004\u0018\u00010\u0003\u0012\b\u0010\u0005\u001a\u0004\u0018\u00010\u0006¢\u0006\u0002\u0010\u0007B#\b\u0016\u0012\b\u0010\u0002\u001a\u0004\u0018\u00010\u0003\u0012\b\u0010\u0005\u001a\u0004\u0018\u00010\u0006\u0012\u0006\u0010\b\u001a\u00020\t¢\u0006\u0002\u0010\nJ\b\u0010\u001b\u001a\u00020\u001cH\u0002J\b\u0010\u001d\u001a\u00020\u001cH\u0002J\u000e\u0010\u001e\u001a\u00020\u001c2\u0006\u0010\u001f\u001a\u00020\fJ\u0016\u0010 \u001a\u00020\u001c2\u0006\u0010!\u001a\u00020\"2\u0006\u0010#\u001a\u00020\tJ\b\u0010$\u001a\u00020\u001cH\u0002J\b\u0010%\u001a\u00020\u001cH\u0002R\u0016\u0010\u000b\u001a\n \r*\u0004\u0018\u00010\f0\fX\u0082\u0004¢\u0006\u0002\n\u0000R\u001c\u0010\u000e\u001a\u0004\u0018\u00010\fX\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u000f\u0010\u0010\"\u0004\b\u0011\u0010\u0012R\u001c\u0010\u0013\u001a\u0004\u0018\u00010\u0014X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0015\u0010\u0016\"\u0004\b\u0017\u0010\u0018R\u000e\u0010\u0019\u001a\u00020\u001aX\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006("}, m3961d2 = {"Lcom/pudutech/bumblebee/robot_ui/ui/view/LotteryResultLayout;", "Landroid/widget/RelativeLayout;", "context", "Landroid/content/Context;", "(Landroid/content/Context;)V", "attributeSet", "Landroid/util/AttributeSet;", "(Landroid/content/Context;Landroid/util/AttributeSet;)V", "defStyleAttr", "", "(Landroid/content/Context;Landroid/util/AttributeSet;I)V", "TAG", "", "kotlin.jvm.PlatformType", "destinationId", "getDestinationId", "()Ljava/lang/String;", "setDestinationId", "(Ljava/lang/String;)V", "hideListener", "Lcom/pudutech/bumblebee/robot_ui/ui/view/LotteryResultLayout$OnLayoutHideListener;", "getHideListener", "()Lcom/pudutech/bumblebee/robot_ui/ui/view/LotteryResultLayout$OnLayoutHideListener;", "setHideListener", "(Lcom/pudutech/bumblebee/robot_ui/ui/view/LotteryResultLayout$OnLayoutHideListener;)V", "uiHandler", "Landroid/os/Handler;", "hideView", "", "initView", "setDestination", "destination", "showLotteryResult", "winPrize", "", "prizeLevel", "stopNoPrizeAnim", "stopPrizeAnim", "Companion", "OnLayoutHideListener", "robot_ui_robotRelease"}, m3962k = 1, m3963mv = {1, 1, 16})
...
public final class LotteryResultLayout extends RelativeLayout {
    ...
    /* compiled from: LotteryResultLayout.kt */
    @Metadata(m3959bv = {1, 0, 3}, m3960d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\bf\u0018\u00002\u00020\u0001J\b\u0010\u0002\u001a\u00020\u0003H&¨\u0006\u0004"}, m3961d2 = {"Lcom/pudutech/bumblebee/robot_ui/ui/view/LotteryResultLayout$OnLayoutHideListener;", "", "onLayoutHide", "", "robot_ui_robotRelease"}, m3962k = 1, m3963mv = {1, 1, 16})
    /* loaded from: classes4.dex */
    ...
    private final void initView() {
        ...
        if (context != null) {
            ...
            if (layoutInflater != null) {
                layoutInflater.inflate(C4188R.layout.layout_lottery_result_container, this);
            }
        }
        ((Button) _$_findCachedViewById(C4188R.id.btn_shoot_prize)).setOnClickListener(new OnLazyClickListener() { // from class: com.pudutech.bumblebee.robot_ui.ui.view.LotteryResultLayout$initView$1
    ...
    public final void showLotteryResult(boolean winPrize, int prizeLevel) {
        ...
        if (winPrize) {
            ...
            UiUtils.adjustTvTextSize((TextView) _$_findCachedViewById(C4188R.id.prize_description_prize), getWidth() - 150, format2);
            Context context = getContext();
            Context context2 = getContext();
            Intrinsics.checkExpressionValueIsNotNull(context2, "context");
            int dp2px = SizeUtils.dp2px(context, context2.getResources().getDimension(C4188R.dimen.lottery_result_btn_width));
            Button button = (Button) _$_findCachedViewById(C4188R.id.btn_shoot_prize);
            Button btn_shoot_prize = (Button) _$_findCachedViewById(C4188R.id.btn_shoot_prize);
            ...
            PlaySound.playGameWinVoice();
            return;
        }
        View layout_prize2 = _$_findCachedViewById(C4188R.id.layout_prize);
        Intrinsics.checkExpressionValueIsNotNull(layout_prize2, "layout_prize");
        layout_prize2.setVisibility(8);
        View layout_no_prize2 = _$_findCachedViewById(C4188R.id.layout_no_prize);
        Intrinsics.checkExpressionValueIsNotNull(layout_no_prize2, "layout_no_prize");
        layout_no_prize2.setVisibility(0);
        TextView lottery_desk_number_no_prize = (TextView) _$_findCachedViewById(C4188R.id.lottery_desk_number_no_prize);
        Intrinsics.checkExpressionValueIsNotNull(lottery_desk_number_no_prize, "lottery_desk_number_no_prize");
        StringCompanionObject stringCompanionObject3 = StringCompanionObject.INSTANCE;
        String string4 = getContext().getString(C4188R.string.pdStr7_106);
        ...
        ((LottieAnimationView) _$_findCachedViewById(C4188R.id.no_prize_animation)).playAnimation();
        this.uiHandler.postDelayed(new Runnable() { // from class: com.pudutech.bumblebee.robot_ui.ui.view.LotteryResultLayout$showLotteryResult$1
    ...
    private final void stopNoPrizeAnim() {
        LottieAnimationView no_prize_animation = (LottieAnimationView) _$_findCachedViewById(C4188R.id.no_prize_animation);
        Intrinsics.checkExpressionValueIsNotNull(no_prize_animation, "no_prize_animation");
        if (no_prize_animation.isAnimating()) {
            ((LottieAnimationView) _$_findCachedViewById(C4188R.id.no_prize_animation)).cancelAnimation();
        }
    }

    private final void stopPrizeAnim() {
        LottieAnimationView prize_animation = (LottieAnimationView) _$_findCachedViewById(C4188R.id.prize_animation);
        Intrinsics.checkExpressionValueIsNotNull(prize_animation, "prize_animation");
        if (prize_animation.isAnimating()) {
            ((LottieAnimationView) _$_findCachedViewById(C4188R.id.prize_animation)).cancelAnimation();
        }
    }

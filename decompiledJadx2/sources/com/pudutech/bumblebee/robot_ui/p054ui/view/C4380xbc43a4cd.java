...
/* renamed from: com.pudutech.bumblebee.robot_ui.ui.view.LongDoublePressConstraintLayout$$special$$inlined$CoroutineExceptionHandler$3 */
/* loaded from: classes4.dex */
public final class C4380xbc43a4cd extends AbstractCoroutineContextElement implements CoroutineExceptionHandler {
    final /* synthetic */ LongDoublePressConstraintLayout this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C4380xbc43a4cd(CoroutineContext.Key key, LongDoublePressConstraintLayout longDoublePressConstraintLayout) {
        super(key);

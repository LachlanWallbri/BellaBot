...
@Metadata(m3959bv = {1, 0, 3}, m3960d1 = {"\u0000\u001f\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u0010\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H\u0016J\u0010\u0010\u0006\u001a\u00020\u00032\u0006\u0010\u0007\u001a\u00020\bH\u0016¨\u0006\t"}, m3961d2 = {"com/pudutech/bumblebee/robot_ui/ui/TransferDishesActivity$singleBatteryListener$1", "Lcom/pudutech/bumblebee/robot_ui/ui/helper/SingleBatteryListener;", "showChargerEvent", "", "model", "Lcom/pudutech/bumblebee/presenter/battery_task/BatteryContract2$ChargerModel;", "showPowerChange", "i", "", "robot_ui_robotRelease"}, m3962k = 1, m3963mv = {1, 1, 16})
/* loaded from: classes3.dex */
public final class TransferDishesActivity$singleBatteryListener$1 extends SingleBatteryListener {
    final /* synthetic */ TransferDishesActivity this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    public TransferDishesActivity$singleBatteryListener$1(TransferDishesActivity transferDishesActivity) {
    ...
    public void showChargerEvent(BatteryContract2.ChargerModel model) {
        ...
        TransferDishesPresenter transferDishesPresenter2;
        Intrinsics.checkParameterIsNotNull(model, "model");
        str = this.this$0.TAG;
        Pdlog.m3273d(str, "showChargerEvent " + model);
        if (model.isCharging()) {
            transferDishesPresenter = this.this$0.getTransferDishesPresenter();
            transferDishesPresenter.actionPauseNoTimer();
            transferDishesPresenter2 = this.this$0.getTransferDishesPresenter();

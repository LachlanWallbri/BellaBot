...
import com.pudutech.bumblebee.presenter.lease_task.LeasePresenter;
...
import com.pudutech.bumblebee.robot_ui.p054ui.dialog.LeaseExpireDialog;
...
@Metadata(m3959bv = {1, 0, 3}, m3960d1 = {"\u0000Z\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\b\n\u0002\u0010\t\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\u0010\u0010\u001e\u001a\u00020\u00192\b\u0010\u001f\u001a\u0004\u0018\u00010\u0007J\u0010\u0010 \u001a\u00020\u00042\u0006\u0010!\u001a\u00020\"H\u0002J\u0010\u0010#\u001a\u00020\u00192\u0006\u0010$\u001a\u00020%H\u0016J\u000e\u0010&\u001a\u00020\u00192\u0006\u0010\u001f\u001a\u00020\u0007J\u000e\u0010'\u001a\u00020\u00192\u0006\u0010(\u001a\u00020)J\u0006\u0010*\u001a\u00020\u0019R\u0016\u0010\u0003\u001a\n \u0005*\u0004\u0018\u00010\u00040\u0004X\u0082\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\u0006\u001a\u0004\u0018\u00010\u0007X\u0082\u000e¢\u0006\u0002\n\u0000R\u001a\u0010\b\u001a\u00020\tX\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\b\u0010\n\"\u0004\b\u000b\u0010\fR\u0010\u0010\r\u001a\u0004\u0018\u00010\u000eX\u0082\u000e¢\u0006\u0002\n\u0000R\u001b\u0010\u000f\u001a\u00020\u00108BX\u0082\u0084\u0002¢\u0006\f\n\u0004\b\u0013\u0010\u0014\u001a\u0004\b\u0011\u0010\u0012R\u0010\u0010\u0015\u001a\u0004\u0018\u00010\u0016X\u0082\u000e¢\u0006\u0002\n\u0000R\"\u0010\u0017\u001a\n\u0012\u0004\u0012\u00020\u0019\u0018\u00010\u0018X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u001a\u0010\u001b\"\u0004\b\u001c\u0010\u001d¨\u0006+"}, m3961d2 = {"Lcom/pudutech/bumblebee/robot_ui/ui/helper/LeaseHelper;", "Lcom/pudutech/bumblebee/presenter/lease_task/LeaseContract$ViewInterface;", "()V", "TAG", "", "kotlin.jvm.PlatformType", "bindAc", "Landroidx/appcompat/app/AppCompatActivity;", "isLeaseExpire", "", "()Z", "setLeaseExpire", "(Z)V", "leaseExpireDialog", "Lcom/pudutech/bumblebee/robot_ui/ui/dialog/LeaseExpireDialog;", "leasePresenter", "Lcom/pudutech/bumblebee/presenter/lease_task/LeasePresenter;", "getLeasePresenter", "()Lcom/pudutech/bumblebee/presenter/lease_task/LeasePresenter;", "leasePresenter$delegate", "Lkotlin/Lazy;", "leftTimeTips", "Lcom/pudutech/bumblebee/robot_ui/module/setting/ui/dialog/ShowTipMsgDialog;", "onLeaseExpireForceCloseCallback", "Lkotlin/Function0;", "", "getOnLeaseExpireForceCloseCallback", "()Lkotlin/jvm/functions/Function0;", "setOnLeaseExpireForceCloseCallback", "(Lkotlin/jvm/functions/Function0;)V", "bind", "activity", "getLeftData", "mss", "", "onLeaseStatusChange", "leaseStatus", "Lcom/pudutech/bumblebee/presenter/lease_task/LeaseContract$LeaseStatus;", "showExpireDialog", "startCheck", "application", "Landroid/app/Application;", "unbind", "robot_ui_robotRelease"}, m3962k = 1, m3963mv = {1, 1, 16})
...
public final class LeaseHelper implements LeaseContract.ViewInterface {
    ...
    private final Lazy leasePresenter = LazyKt.lazy(new Function0<LeasePresenter>() { // from class: com.pudutech.bumblebee.robot_ui.ui.helper.LeaseHelper$leasePresenter$2
        ...
        public final LeasePresenter invoke() {
            ...
            throw new TypeCastException("null cannot be cast to non-null type com.pudutech.bumblebee.presenter.lease_task.LeasePresenter");
        }
    });
    ...
    @Override // com.pudutech.bumblebee.presenter.lease_task.LeaseContract.ViewInterface
    public void onLeaseStatusChange(final LeaseContract.LeaseStatus leaseStatus) {
        ...
        if (leaseStatus.getNeedTipsLeftTime()) {
            ...
            if (appCompatActivity2 != null) {
                ...
                String string = RobotContext.INSTANCE.getContext().getString(C4188R.string.pdStr15_2);
                ...
                showTipMsgDialog5.setOnDismissListener(new DialogInterface.OnDismissListener() { // from class: com.pudutech.bumblebee.robot_ui.ui.helper.LeaseHelper$onLeaseStatusChange$$inlined$let$lambda$1
    ...
    public final void showExpireDialog(AppCompatActivity activity) {
        ...
        String string = RobotContext.INSTANCE.getContext().getString(C4188R.string.pdStr15_3);
        ...
        leaseExpireDialog3.setOnDismissListener(new DialogInterface.OnDismissListener() { // from class: com.pudutech.bumblebee.robot_ui.ui.helper.LeaseHelper$showExpireDialog$1
            @Override // android.content.DialogInterface.OnDismissListener
            public final void onDismiss(DialogInterface dialogInterface) {
        ...
        leaseExpireDialog4.setOnForceClose(new Function0<Unit>() { // from class: com.pudutech.bumblebee.robot_ui.ui.helper.LeaseHelper$showExpireDialog$2
    ...
    private final String getLeftData(long mss) {
        ...
        long j5 = (mss % j3) / 60;
        if (j2 > 0) {
            return String.valueOf(j2) + RobotContext.INSTANCE.getContext().getString(C4188R.string.pdStr15_4);
        }
        if (j4 > 0) {
            return String.valueOf(j4) + RobotContext.INSTANCE.getContext().getString(C4188R.string.pdStr15_5);
        }
        if (j5 > 0) {
            return String.valueOf(j5) + RobotContext.INSTANCE.getContext().getString(C4188R.string.pdStr15_6);
        }
        return "1" + RobotContext.INSTANCE.getContext().getString(C4188R.string.pdStr15_6);
    }
    ...
    public final void startCheck(Application application) {
        ...
        getLeasePresenter().checkLease(application, UrlManager.INSTANCE.isTest());
    }

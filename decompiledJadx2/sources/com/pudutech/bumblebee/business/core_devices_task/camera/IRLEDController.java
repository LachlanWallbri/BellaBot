...
@Metadata(m3959bv = {1, 0, 3}, m3960d1 = {"\u0000H\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\u000b\n\u0002\b\u0005\n\u0002\u0010\t\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\u0003\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u00012\u00020\u0003B\u0005¢\u0006\u0002\u0010\u0004J\b\u0010 \u001a\u00020!H\u0002J\u0010\u0010\"\u001a\u00020!2\u0006\u0010#\u001a\u00020\u0017H\u0016R\u000e\u0010\u0005\u001a\u00020\u0006X\u0082D¢\u0006\u0002\n\u0000R(\u0010\t\u001a\u0004\u0018\u00010\b2\b\u0010\u0007\u001a\u0004\u0018\u00010\b@@X\u0080\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\n\u0010\u000b\"\u0004\b\f\u0010\rR\u000e\u0010\u000e\u001a\u00020\u000fX\u0082\u0004¢\u0006\u0002\n\u0000R\u001b\u0010\u0010\u001a\u00020\u00118BX\u0082\u0084\u0002¢\u0006\f\n\u0004\b\u0014\u0010\u0015\u001a\u0004\b\u0012\u0010\u0013R\u0016\u0010\u0016\u001a\u0004\u0018\u00010\u00178VX\u0096\u0004¢\u0006\u0006\u001a\u0004\b\u0016\u0010\u0018R\u0012\u0010\u0019\u001a\u0004\u0018\u00010\u0017X\u0082\u000e¢\u0006\u0004\n\u0002\u0010\u001aR\u000e\u0010\u001b\u001a\u00020\u0017X\u0082\u000e¢\u0006\u0002\n\u0000R\u0014\u0010\u001c\u001a\u00020\u001d8VX\u0096\u0004¢\u0006\u0006\u001a\u0004\b\u001e\u0010\u001f¨\u0006$"}, m3961d2 = {"Lcom/pudutech/bumblebee/business/core_devices_task/camera/IRLEDController;", "Lcom/pudutech/bumblebee/business/base/BaseMultiListenerImpl;", "Lcom/pudutech/bumblebee/business/base/SwitchListener;", "Lcom/pudutech/bumblebee/business/base/SwitchInterface;", "()V", "TAG", "", ES6Iterator.VALUE_PROPERTY, "Lcom/pudutech/mirsdk/aidl/DeviceInterface;", "controller", "getController$module_bumblebee_business_robotRelease", "()Lcom/pudutech/mirsdk/aidl/DeviceInterface;", "setController$module_bumblebee_business_robotRelease", "(Lcom/pudutech/mirsdk/aidl/DeviceInterface;)V", "delayRunnable", "Ljava/lang/Runnable;", "deviceListener", "Lcom/pudutech/bumblebee/business/core_devices_task/IDeviceListenerDispatcher;", "getDeviceListener", "()Lcom/pudutech/bumblebee/business/core_devices_task/IDeviceListenerDispatcher;", "deviceListener$delegate", "Lkotlin/Lazy;", "isOn", "", "()Ljava/lang/Boolean;", "isRunning", "Ljava/lang/Boolean;", "isSwitchOn", "retryTime_ms", "", "getRetryTime_ms", "()J", "fsm", "", "turnOn", "onOrOff", "module_bumblebee_business_robotRelease"}, m3962k = 1, m3963mv = {1, 1, 16})
/* loaded from: classes4.dex */
public final class IRLEDController extends BaseMultiListenerImpl<SwitchListener> implements SwitchInterface {
    private DeviceInterface controller;
    private Boolean isRunning;
    private boolean isSwitchOn;
    private final String TAG = "IRLEDController";

    /* renamed from: deviceListener$delegate, reason: from kotlin metadata */
    private final Lazy deviceListener = LazyKt.lazy(new IRLEDController$deviceListener$2(this));
    private final Runnable delayRunnable = new Runnable() { // from class: com.pudutech.bumblebee.business.core_devices_task.camera.IRLEDController$delayRunnable$1
        @Override // java.lang.Runnable
        public final void run() {
            IRLEDController.this.fsm();
        }
    };
    ...
    public final void fsm() {
        Pdlog.m3275i(this.TAG, "fsm isSwitchOn=" + this.isSwitchOn + " isRuning=" + this.isRunning);
        TimerThread.INSTANCE.post(new Function0<Unit>() { // from class: com.pudutech.bumblebee.business.core_devices_task.camera.IRLEDController$fsm$1
            ...
            public final void invoke2() {
                ...
                runnable = IRLEDController.this.delayRunnable;
                timerThread.remove(runnable);
                z = IRLEDController.this.isSwitchOn;
                Boolean valueOf = Boolean.valueOf(z);
                bool = IRLEDController.this.isRunning;
                if (!Intrinsics.areEqual(valueOf, bool)) {
                    str = IRLEDController.this.TAG;
                    Pdlog.m3275i(str, "try again");
                    DeviceInterface controller = IRLEDController.this.getController();
                    if (controller != null) {
                        z2 = IRLEDController.this.isSwitchOn;
                        controller.controlIRLED(z2);
                    }
                    TimerThread timerThread2 = TimerThread.INSTANCE;
                    runnable2 = IRLEDController.this.delayRunnable;
                    timerThread2.post(runnable2, IRLEDController.this.getRetryTime_ms());
                }
            }
        });
    }
    ...
    public void turnOn(boolean onOrOff) {
        if (onOrOff) {
            ...
            if (deviceControlHelper != null) {
                deviceControlHelper.openDevice(DevicesControlHelper.DeviceName.IRLED);
                return;
            }
            return;
        }
        ...
        if (deviceControlHelper2 != null) {
            deviceControlHelper2.closeDevice(CollectionsKt.arrayListOf(DevicesControlHelper.DeviceName.IRLED));
        }
    }
}

...
public final class ReportTaskStatusMsgHandler extends AbstractMsgHandler {
    ...
    public void action(MessageProtobuf.Msg msg) {
        ...
        if (msg.getResp()) {
            ...
            cEvent.setTopic(Events.EVENT_REPORT_TASK_STATUS);
            cEvent.setObj(msg);

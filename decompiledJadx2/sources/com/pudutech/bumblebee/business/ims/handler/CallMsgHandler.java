...
/* compiled from: CallMsgHandler.kt */
@Metadata(m3959bv = {1, 0, 3}, m3960d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\u0010\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006H\u0016¨\u0006\u0007"}, m3961d2 = {"Lcom/pudutech/bumblebee/business/ims/handler/CallMsgHandler;", "Lcom/pudutech/bumblebee/business/ims/handler/AbstractMsgHandler;", "()V", "action", "", NotificationCompat.CATEGORY_MESSAGE, "Lcom/pudutech/bumblebee/business/protobuf/MessageProtobuf$Msg;", "module_bumblebee_business_robotRelease"}, m3962k = 1, m3963mv = {1, 1, 16})
/* loaded from: classes4.dex */
public final class CallMsgHandler extends AbstractMsgHandler {
    ...
    public void action(MessageProtobuf.Msg msg) {
        ...
        Pdlog.m3273d("CallMsgHandler", "msg.resp = " + msg.getResp());
        if (msg.getResp()) {
            return;
        }
        CEvent cEvent = new CEvent();
        cEvent.setTopic(Events.EVENT_CALL);
        cEvent.setObj(msg);

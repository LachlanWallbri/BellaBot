...
final class DisinfectionActivity$initSpray$11 implements View.OnClickListener {
    final /* synthetic */ DisinfectionActivity this$0;

    DisinfectionActivity$initSpray$11(DisinfectionActivity disinfectionActivity) {
    ...
    public final void onClick(View view) {
        String str;
        try {
            DisinfectionModuleManager.INSTANCE.configMagnetic-7apg3OU((byte) 1);
            DisinfectionActivity.access$setMagnity$p(this.this$0, "上通磁浮子");
        } catch (Exception e) {
            str = this.this$0.TAG;

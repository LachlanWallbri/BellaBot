...
final /* synthetic */ class RobotService$iBinder$1$hardware$1 extends FunctionReference implements Function1<IBinder, HardwareInterface> {
    public static final RobotService$iBinder$1$hardware$1 INSTANCE = new RobotService$iBinder$1$hardware$1();

    RobotService$iBinder$1$hardware$1() {
        super(1);
    }

...
public final /* data */ class AliyunIotSecretResp {
    ...
    public static /* synthetic */ AliyunIotSecretResp copy$default(AliyunIotSecretResp aliyunIotSecretResp, String str, String str2, int i, Object obj) {
        if ((i & 1) != 0) {
            str = aliyunIotSecretResp.deviceSecret;
        }
        if ((i & 2) != 0) {
            str2 = aliyunIotSecretResp.productKey;
        }
        return aliyunIotSecretResp.copy(str, str2);
    }
    ...
    public final AliyunIotSecretResp copy(String deviceSecret, String productKey) {
        Intrinsics.checkParameterIsNotNull(deviceSecret, "deviceSecret");
        Intrinsics.checkParameterIsNotNull(productKey, "productKey");
        return new AliyunIotSecretResp(deviceSecret, productKey);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.deviceSecret, aliyunIotSecretResp.deviceSecret) && Intrinsics.areEqual(this.productKey, aliyunIotSecretResp.productKey);
    }
    ...
    public String toString() {
        return "AliyunIotSecretResp(deviceSecret=" + this.deviceSecret + ", productKey=" + this.productKey + ")";
    }

    public AliyunIotSecretResp(String deviceSecret, String productKey) {
        Intrinsics.checkParameterIsNotNull(deviceSecret, "deviceSecret");
        Intrinsics.checkParameterIsNotNull(productKey, "productKey");

...
public final class DestinationPresenter extends BaseOneViewPresenter<DestinationContract.ViewInterface> implements DestinationContract.PresenterInterface {
    ...
    @Override // com.pudutech.bumblebee.presenter.delivery_task.DestinationContract.PresenterInterface
    public void loadMap() {
        runOnBusinessThread(new Function0<Unit>() { // from class: com.pudutech.bumblebee.presenter.delivery_task.DestinationPresenter$loadMap$1
            ...
            public final void invoke2() {
                ...
                DestinationPresenter.this.runOnUIThread(new Function0<Unit>() { // from class: com.pudutech.bumblebee.presenter.delivery_task.DestinationPresenter$loadMap$1.2
                ...
                DestinationPresenter.this.runOnUIThread(new Function0<Unit>() { // from class: com.pudutech.bumblebee.presenter.delivery_task.DestinationPresenter$loadMap$1.3
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(0);
                    }
                ...
                DestinationPresenter.this.runOnUIThread(new Function0<Unit>() { // from class: com.pudutech.bumblebee.presenter.delivery_task.DestinationPresenter$loadMap$1.4
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(0);
                    }
                ...
                DestinationPresenter.this.runOnUIThread(new Function0<Unit>() { // from class: com.pudutech.bumblebee.presenter.delivery_task.DestinationPresenter$loadMap$1.5
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(0);
                    }
                ...
                DestinationPresenter.this.runOnUIThread(new Function0<Unit>() { // from class: com.pudutech.bumblebee.presenter.delivery_task.DestinationPresenter$loadMap$1.6
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(0);
                    }
                ...
                DestinationPresenter.this.runOnUIThread(new Function0<Unit>() { // from class: com.pudutech.bumblebee.presenter.delivery_task.DestinationPresenter$loadMap$1.7
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(0);
                    }
                ...
                DestinationPresenter.this.runOnUIThread(new Function0<Unit>() { // from class: com.pudutech.bumblebee.presenter.delivery_task.DestinationPresenter$loadMap$1.8
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(0);
                    }
                ...
                DestinationPresenter.this.runOnUIThread(new Function0<Unit>() { // from class: com.pudutech.bumblebee.presenter.delivery_task.DestinationPresenter$loadMap$1.9
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(0);
                    }

...
public final class FramedStream {
    ...
    public boolean isLocallyInitiated() {
        return this.connection.client == ((this.f7605id & 1) == 1);
    }
    ...
    public void reply(List<Header> list, boolean z) throws IOException {
        ...
        this.connection.writeSynReply(this.f7605id, z2, list);
        if (z2) {
    ...
    public void close(ErrorCode errorCode) throws IOException {
        if (closeInternal(errorCode)) {
            this.connection.writeSynReset(this.f7605id, errorCode);
        }
    }

    public void closeLater(ErrorCode errorCode) {
        if (closeInternal(errorCode)) {
            this.connection.writeSynResetLater(this.f7605id, errorCode);
        }
    }
    ...
    private boolean closeInternal(ErrorCode errorCode) {
        synchronized (this) {
            ...
            notifyAll();
            this.connection.removeStream(this.f7605id);
            return true;
        }
    }
        ...
        public long read(Buffer buffer, long j) throws IOException {
            ...
            synchronized (FramedStream.this) {
                ...
                if (FramedStream.this.unacknowledgedBytesRead >= FramedStream.this.connection.okHttpSettings.getInitialWindowSize(65536) / 2) {
                    FramedStream.this.connection.writeWindowUpdateLater(FramedStream.this.f7605id, FramedStream.this.unacknowledgedBytesRead);
    ...
    public final class FramedDataSink implements Sink {
        ...
        private void emitDataFrame(boolean z) throws IOException {
            ...
            FramedStream.this.writeTimeout.enter();
            try {
                FramedStream.this.connection.writeData(FramedStream.this.f7605id, z && min == this.sendBuffer.size(), this.sendBuffer, min);
            } finally {
            }
        }
            ...
            synchronized (FramedStream.this) {
                ...
                if (!FramedStream.this.sink.finished) {
                    if (this.sendBuffer.size() > 0) {
                        ...
                        FramedStream.this.connection.writeData(FramedStream.this.f7605id, true, null, 0L);
                    }
                }
                synchronized (FramedStream.this) {
                    this.closed = true;

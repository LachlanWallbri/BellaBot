...
public class StdArraySerializers {
    ...
    public static class BooleanArraySerializer extends ArraySerializerBase<boolean[]> {
        ...
        public JsonNode getSchema(SerializerProvider serializerProvider, Type type) {
            ObjectNode createSchemaNode = createSchemaNode(TmpConstant.TYPE_VALUE_ARRAY, true);
    ...
    public static class ShortArraySerializer extends TypedPrimitiveArraySerializer<short[]> {
        ...
        @Override // com.fasterxml.jackson.databind.ser.std.StdSerializer, com.fasterxml.jackson.databind.jsonschema.SchemaAware
        public JsonNode getSchema(SerializerProvider serializerProvider, Type type) {
            return createSchemaNode(TmpConstant.TYPE_VALUE_ARRAY, true).set("items", createSchemaNode("integer"));
        }
    ...
    public static class LongArraySerializer extends TypedPrimitiveArraySerializer<long[]> {
        ...
        @Override // com.fasterxml.jackson.databind.ser.std.StdSerializer, com.fasterxml.jackson.databind.jsonschema.SchemaAware
        public JsonNode getSchema(SerializerProvider serializerProvider, Type type) {
            return createSchemaNode(TmpConstant.TYPE_VALUE_ARRAY, true).set("items", createSchemaNode("number", true));
        }
    ...
    public static class FloatArraySerializer extends TypedPrimitiveArraySerializer<float[]> {
        ...
        @Override // com.fasterxml.jackson.databind.ser.std.StdSerializer, com.fasterxml.jackson.databind.jsonschema.SchemaAware
        public JsonNode getSchema(SerializerProvider serializerProvider, Type type) {
            return createSchemaNode(TmpConstant.TYPE_VALUE_ARRAY, true).set("items", createSchemaNode("number"));
        }

    ...
    public JsonSerializer<?> createContextual(SerializerProvider serializerProvider, BeanProperty beanProperty) throws JsonMappingException {
        ...
        if (beanProperty != null) {
            ...
            if (member != null && (findContentSerializer = annotationIntrospector.findContentSerializer(member)) != null) {
                ...
                return (findContextualConvertingSerializer != this._elementSerializer && beanProperty == this._property && this._valueTypeSerializer == typeSerializer && this._unwrapSingle == feature) ? this : withResolved(beanProperty, typeSerializer, findContextualConvertingSerializer, feature);
            }
        }
        jsonSerializer = null;

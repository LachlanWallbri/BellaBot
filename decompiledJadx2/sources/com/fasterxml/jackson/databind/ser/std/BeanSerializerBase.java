...
public abstract class BeanSerializerBase extends StdSerializer<Object> implements ContextualSerializer, ResolvableSerializer, JsonFormatVisitable, SchemaAware {
        ...
        if (findFormatOverrides == null || !findFormatOverrides.hasShape()) {
            ...
            if (shape != JsonFormat.Shape.ANY && shape != this._serializationShape) {
                if (this._beanType.isEnumType()) {
                    int i3 = C16271.$SwitchMap$com$fasterxml$jackson$annotation$JsonFormat$Shape[shape.ordinal()];
                    if (i3 == 1 || i3 == 2 || i3 == 3) {
        ...
        if (member != null) {
            ...
            if (findObjectIdInfo != null) {
                ...
                if (generatorType == ObjectIdGenerators.PropertyGenerator.class) {
                    ...
                    objectIdWriter = ObjectIdWriter.construct(type, (PropertyName) null, propertyBasedObjectIdGenerator, findObjectReferenceInfo2.getAlwaysAsId());
    ...
    public JsonNode getSchema(SerializerProvider serializerProvider, Type type) throws JsonMappingException {
        ...
        if (jsonSerializableSchema != null && (m570id = jsonSerializableSchema.m570id()) != null && m570id.length() > 0) {
            createSchemaNode.put("id", m570id);
        }
        ...
        while (true) {
            ...
            if (i < beanPropertyWriterArr.length) {
                ...
                createSchemaNode.set(TmpConstant.DEVICE_MODEL_PROPERTIES, objectNode);

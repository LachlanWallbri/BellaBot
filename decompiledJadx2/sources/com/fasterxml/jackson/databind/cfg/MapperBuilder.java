...
public abstract class MapperBuilder<M extends ObjectMapper, B extends MapperBuilder<M, B>> {
    ...
    public B activateDefaultTyping(PolymorphicTypeValidator polymorphicTypeValidator, ObjectMapper.DefaultTyping defaultTyping, JsonTypeInfo.EnumC1586As enumC1586As) {
        this._mapper.activateDefaultTyping(polymorphicTypeValidator, defaultTyping, enumC1586As);
        return _this();
    }

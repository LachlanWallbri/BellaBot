...
public class TypeFactory implements Serializable {
    ...
    public TypeFactory withModifier(TypeModifier typeModifier) {
        ...
        LRUMap<Object, JavaType> lRUMap2 = null;
        ...
        return new TypeFactory(lRUMap2, this._parser, typeModifierArr, this._classLoader);
    }
    ...
    protected Class<?> _findPrimitive(String str) {
        ...
        if (DataType.LONG.equals(str)) {
            return Long.TYPE;
        }
        if ("float".equals(str)) {
            return Float.TYPE;
        }
        if (TmpConstant.TYPE_VALUE_DOUBLE.equals(str)) {
            return Double.TYPE;
        }
    ...
    */
    public JavaType _fromClass(ClassStack classStack, Class<?> cls, TypeBindings typeBindings) {
        ...
        if (cls.isArray()) {
            ...
            if (javaType == null && (javaType = _fromWellKnownClass(child, cls, typeBindings, javaType2, javaTypeArr)) == null && (javaType = _fromWellKnownInterface(child, cls, typeBindings, javaType2, javaTypeArr)) == null) {
                _newSimpleType = _newSimpleType(cls, typeBindings, javaType2, javaTypeArr);
            }

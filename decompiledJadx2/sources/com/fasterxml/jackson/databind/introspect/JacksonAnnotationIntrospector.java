...
public class JacksonAnnotationIntrospector extends AnnotationIntrospector implements Serializable {
    ...
    private JsonInclude.Value _refinePropertyInclusion(Annotated annotated, JsonInclude.Value value) {
        ...
        if (jsonSerialize != null) {
            int i = C15981.f1271xfdbfedae[jsonSerialize.include().ordinal()];
            if (i == 1) {
    ...
    public static /* synthetic */ class C15981 {
        ...
        static final /* synthetic */ int[] f1271xfdbfedae = new int[JsonSerialize.Inclusion.values().length];

        static {
            try {
                f1271xfdbfedae[JsonSerialize.Inclusion.ALWAYS.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f1271xfdbfedae[JsonSerialize.Inclusion.NON_NULL.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f1271xfdbfedae[JsonSerialize.Inclusion.NON_DEFAULT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f1271xfdbfedae[JsonSerialize.Inclusion.NON_EMPTY.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f1271xfdbfedae[JsonSerialize.Inclusion.DEFAULT_INCLUSION.ordinal()] = 5;
    ...
    public JavaType refineSerializationType(MapperConfig<?> mapperConfig, Annotated annotated, JavaType javaType) throws JsonMappingException {
        ...
        JsonSerialize jsonSerialize = (JsonSerialize) _findAnnotation(annotated, JsonSerialize.class);
        Class<?> _classIfExplicit = jsonSerialize == null ? null : _classIfExplicit(jsonSerialize.m568as());
    ...
    public JavaType refineDeserializationType(MapperConfig<?> mapperConfig, Annotated annotated, JavaType javaType) throws JsonMappingException {
        TypeFactory typeFactory = mapperConfig.getTypeFactory();
        JsonDeserialize jsonDeserialize = (JsonDeserialize) _findAnnotation(annotated, JsonDeserialize.class);
        Class<?> _classIfExplicit = jsonDeserialize == null ? null : _classIfExplicit(jsonDeserialize.m567as());
    ...
    protected TypeResolverBuilder<?> _findTypeResolver(MapperConfig<?> mapperConfig, Annotated annotated, JavaType javaType) {
        ...
        if (jsonTypeResolver != null) {
            ...
            if (jsonTypeInfo.use() == JsonTypeInfo.EnumC1587Id.NONE) {
        ...
        JsonTypeInfo.EnumC1586As include = jsonTypeInfo.include();
        if (include == JsonTypeInfo.EnumC1586As.EXTERNAL_PROPERTY && (annotated instanceof AnnotatedClass)) {
            include = JsonTypeInfo.EnumC1586As.PROPERTY;
        }

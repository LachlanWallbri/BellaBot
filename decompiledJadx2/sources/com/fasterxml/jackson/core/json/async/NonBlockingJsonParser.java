...
public class NonBlockingJsonParser extends NonBlockingJsonParserBase implements ByteArrayFeeder {
    ...
    */
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:50:0x00fb -> B:40:0x00a4). Please report as a decompilation issue!!! */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    ...
    protected final JsonToken _finishFieldWithEscape() throws IOException {
        ...
        if (_decodeSplitEscaped > 127) {
            ...
            if (_decodeSplitEscaped < 2048) {
                ...
                int i7 = (i3 << 8) | (_decodeSplitEscaped >> 12) | 224;
                i4++;
                if (i4 >= 4) {
                    ...
                    if (iArr[i5] == 0) {
                        ...
                        if (i4 >= i3) {
                            ...
                            if (i6 == 1) {
                                ...
                                int i9 = i8 + 1;
                                int i10 = i9 + 1;
                                int _decodeUTF8_4 = _decodeUTF8_4(i5, bArr3[i4], bArr3[i8], bArr3[i9]);

...
public class ValueAnimator extends Animator {
    ...
    @Override // com.nineoldandroids.animation.Animator
    /* renamed from: clone */
    public ValueAnimator mo4284clone() {
        ValueAnimator valueAnimator = (ValueAnimator) super.mo4284clone();
        ArrayList<AnimatorUpdateListener> arrayList = this.mUpdateListeners;
        if (arrayList != null) {
        ...
        if (propertyValuesHolderArr != null) {
            ...
            for (int i2 = 0; i2 < length; i2++) {
                PropertyValuesHolder mo4288clone = propertyValuesHolderArr[i2].mo4288clone();
                valueAnimator.mValues[i2] = mo4288clone;
                valueAnimator.mValuesMap.put(mo4288clone.getPropertyName(), mo4288clone);
            }
        }
        return valueAnimator;
    }

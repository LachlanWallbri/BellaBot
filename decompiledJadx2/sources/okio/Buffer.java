...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    public final Buffer copyTo(OutputStream outputStream, long j, long j2) throws IOException {
        ...
        C9045Util.checkOffsetAndCount(this.size, j, j2);
        if (j2 == 0) {
            return this;
        }
    ...
    public final Buffer writeTo(OutputStream outputStream, long j) throws IOException {
        ...
        C9045Util.checkOffsetAndCount(this.size, 0L, j);
        Segment segment = this.head;
        while (j > 0) {
    ...
    public final byte getByte(long j) {
        C9045Util.checkOffsetAndCount(this.size, j, 1L);
        long j2 = this.size;
        if (j2 - j > j) {
            Segment segment = this.head;
            while (true) {
    ...
    public short readShortLe() {
        return C9045Util.reverseBytesShort(readShort());
    }

    @Override // okio.BufferedSource
    public int readIntLe() {
        return C9045Util.reverseBytesInt(readInt());
    }

    @Override // okio.BufferedSource
    public long readLongLe() {
        return C9045Util.reverseBytesLong(readLong());
    }

    /* JADX WARN: Removed duplicated region for block: B:35:0x0098  */
    /* JADX WARN: Removed duplicated region for block: B:37:0x00a6  */
    /* JADX WARN: Removed duplicated region for block: B:46:0x00aa A[EDGE_INSN: B:46:0x00aa->B:40:0x00aa BREAK  A[LOOP:0: B:4:0x000f->B:45:?], SYNTHETIC] */
    ...
    public long readDecimalLong() {
        ...
        do {
            ...
            while (i2 < i3) {
                ...
                if (b >= 48 && b <= 57) {
                    int i4 = 48 - b;
                    if (j < BufferKt.OVERFLOW_ZONE || (j == BufferKt.OVERFLOW_ZONE && i4 < j2)) {
    ...
    */
    ...
    public String readUtf8() {
        try {
            return readString(this.size, C9045Util.UTF_8);
    ...
    public String readUtf8(long j) throws EOFException {
        return readString(j, C9045Util.UTF_8);
    }
            ...
            if (charAt < 128) {
                ...
                if (charAt < 2048) {
                    ...
                    if (charAt > 56319 || charAt3 < 56320 || charAt3 > 57343) {
                        ...
                        writeByte((i7 >> 18) | DimensionsKt.HDPI);
    ...
    public Buffer writeUtf8CodePoint(int i) {
        if (i < 128) {
            ...
            writeByte((i >> 18) | DimensionsKt.HDPI);
    ...
    public Buffer writeString(String str, int i, int i2, Charset charset) {
        ...
        if (i2 <= str.length()) {
            ...
            if (charset.equals(C9045Util.UTF_8)) {
    ...
    public Buffer write(byte[] bArr, int i, int i2) {
        ...
        long j = i2;
        C9045Util.checkOffsetAndCount(bArr.length, i, j);
        int i3 = i2 + i;
        while (i < i3) {
            Segment writableSegment = writableSegment(1);
    ...
    public Buffer writeShortLe(int i) {
        return writeShort((int) C9045Util.reverseBytesShort((short) i));
    }
    ...
    public Buffer writeIntLe(int i) {
        return writeInt(C9045Util.reverseBytesInt(i));
    }
    ...
    public Buffer writeLongLe(long j) {
        return writeLong(C9045Util.reverseBytesLong(j));
    }
    ...
    private ByteString digest(String str) {
        try {
            ...
            return ByteString.m3992of(messageDigest.digest());
    ...
    private ByteString hmac(String str, ByteString byteString) {
        try {
            ...
            return ByteString.m3992of(mac.doFinal());
    ...
    @Metadata(m3959bv = {1, 0, 2}, m3960d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u0012\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0005"}, m3961d2 = {"Lokio/Buffer$Companion;", "", "()V", "DIGITS", "", "jvm"}, m3962k = 1, m3963mv = {1, 1, 11})
    /* loaded from: classes2.dex */

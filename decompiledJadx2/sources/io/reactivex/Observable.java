...
public abstract class Observable<T> implements ObservableSource<T> {
    ...
    @CheckReturnValue
    /* renamed from: as */
    public final <R> R m3952as(ObservableConverter<T, ? extends R> observableConverter) {
    ...
    @CheckReturnValue
    /* renamed from: to */
    public final <R> R m3953to(Function<? super Observable<T>, R> function) {
        try {
    ...
    public final Flowable<T> toFlowable(BackpressureStrategy backpressureStrategy) {
        ...
        int i = C75771.$SwitchMap$io$reactivex$BackpressureStrategy[backpressureStrategy.ordinal()];
        if (i == 1) {

...
public abstract class ParallelFlowable<T> {
    ...
    public static <T> ParallelFlowable<T> from(Publisher<? extends T> publisher, int i, int i2) {
        ObjectHelper.requireNonNull(publisher, MapElement.Source.SOURCE);
    ...
    @CheckReturnValue
    /* renamed from: as */
    public final <R> R m3956as(ParallelFlowableConverter<T, R> parallelFlowableConverter) {
    ...
    @CheckReturnValue
    /* renamed from: to */
    public final <U> U m3957to(Function<? super ParallelFlowable<T>, U> function) {
        try {

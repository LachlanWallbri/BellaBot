...
public final class ParallelDoOnNextTry<T> extends ParallelFlowable<T> {
        ...
        public boolean tryOnNext(T t) {
            ...
            do {
                try {
                    ...
                    try {
                        j++;
                        i = C75841.$SwitchMap$io$reactivex$parallel$ParallelFailureHandling[((ParallelFailureHandling) ObjectHelper.requireNonNull(this.errorHandler.apply(Long.valueOf(j), th), "The errorHandler returned a null item")).ordinal()];
                    } catch (Throwable th2) {
    ...
    /* loaded from: classes2.dex */
    public static /* synthetic */ class C75841 {

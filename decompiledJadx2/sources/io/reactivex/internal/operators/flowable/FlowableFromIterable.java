...
public final class FlowableFromIterable<T> extends Flowable<T> {
    ...
    static abstract class BaseRangeSubscription<T> extends BasicQueueSubscription<T> {
        ...
        public final T poll() {
            Iterator<? extends T> it = this.f8666it;
            if (it == null) {
                return null;
            }
            if (!this.once) {
            ...
            return (T) ObjectHelper.requireNonNull(this.f8666it.next(), "Iterator.next() returned a null value");
        }

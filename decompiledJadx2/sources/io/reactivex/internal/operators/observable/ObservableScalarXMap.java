...
public final class ObservableScalarXMap {
    ...
    public static <T, R> boolean tryScalarXMapSubscribe(ObservableSource<T> observableSource, Observer<? super R> observer, Function<? super T, ? extends ObservableSource<? extends R>> function) {
        ...
        try {
            C$r8$backportedMethods$utility$Boolean$1$hashCode c$r8$backportedMethods$utility$Boolean$1$hashCode = (Object) ((Callable) observableSource).call();
            if (c$r8$backportedMethods$utility$Boolean$1$hashCode == null) {
                EmptyDisposable.complete(observer);
                return true;
            }
            try {
                ObservableSource observableSource2 = (ObservableSource) ObjectHelper.requireNonNull(function.apply(c$r8$backportedMethods$utility$Boolean$1$hashCode), "The mapper returned a null ObservableSource");

    ...
    static final class EqualCoordinator<T> extends AtomicInteger implements Disposable {
        ...
        void drain() {
            ...
            while (!this.cancelled) {
                ...
                if (this.f8704v1 == null) {
                    this.f8704v1 = spscLinkedArrayQueue.poll();
                }
                boolean z3 = this.f8704v1 == null;
                if (this.f8705v2 == null) {
                    this.f8705v2 = spscLinkedArrayQueue2.poll();
                }
                boolean z4 = this.f8705v2 == null;
                if (z && z2 && z3 && z4) {
                ...
                if (!z3 && !z4) {
                    try {
                        if (!this.comparer.test(this.f8704v1, this.f8705v2)) {
                            cancel(spscLinkedArrayQueue, spscLinkedArrayQueue2);
                            this.downstream.onSuccess(false);
                            return;
                        } else {

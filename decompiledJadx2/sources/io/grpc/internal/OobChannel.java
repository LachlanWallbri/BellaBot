...
public final class OobChannel extends ManagedChannel implements InternalInstrumented<InternalChannelz.ChannelStats> {
    ...
    public void setSubchannel(final InternalSubchannel internalSubchannel) {
        ...
        this.subchannelPicker = new LoadBalancer.SubchannelPicker() { // from class: io.grpc.internal.OobChannel.1OobSubchannelPicker
            ...
            public String toString() {
                return MoreObjects.toStringHelper((Class<?>) C1OobSubchannelPicker.class).add(SpeechUtility.TAG_RESOURCE_RESULT, this.result).toString();
            }
        };
    ...
    public void handleSubchannelStateChange(final ConnectivityStateInfo connectivityStateInfo) {
        ...
        int i = C61624.$SwitchMap$io$grpc$ConnectivityState[connectivityStateInfo.getState().ordinal()];
        if (i == 1 || i == 2) {
            this.delayedTransport.reprocess(this.subchannelPicker);
        } else {
            if (i != 3) {

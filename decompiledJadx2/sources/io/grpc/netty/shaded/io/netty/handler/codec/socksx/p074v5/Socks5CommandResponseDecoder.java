...
public class Socks5CommandResponseDecoder extends ReplayingDecoder<State> {
    ...
    /* JADX WARN: Classes with same name are omitted:
      classes6.dex
     */
    /* renamed from: io.grpc.netty.shaded.io.netty.handler.codec.socksx.v5.Socks5CommandResponseDecoder$1 */
    /* loaded from: classes7.dex */
    static /* synthetic */ class C65911 {

        /* renamed from: $SwitchMap$io$netty$handler$codec$socksx$v5$Socks5CommandResponseDecoder$State */
        static final /* synthetic */ int[] f8402x620fff3d = new int[State.values().length];

        static {
            try {
                f8402x620fff3d[State.INIT.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f8402x620fff3d[State.SUCCESS.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f8402x620fff3d[State.FAILURE.ordinal()] = 3;
    ...
    protected void decode(ChannelHandlerContext channelHandlerContext, ByteBuf byteBuf, List<Object> list) throws Exception {
        try {
            int i = C65911.f8402x620fff3d[state().ordinal()];
            if (i == 1) {

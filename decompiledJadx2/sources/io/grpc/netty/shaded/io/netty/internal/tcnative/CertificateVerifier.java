...
public abstract class CertificateVerifier {
    ...
    static {
        ...
        hashSet.add(Integer.valueOf(X509_V_OK));
        hashSet.add(Integer.valueOf(X509_V_ERR_UNSPECIFIED));
        hashSet.add(Integer.valueOf(X509_V_ERR_UNABLE_TO_GET_ISSUER_CERT));
        hashSet.add(Integer.valueOf(X509_V_ERR_UNABLE_TO_GET_CRL));
        hashSet.add(Integer.valueOf(X509_V_ERR_UNABLE_TO_DECRYPT_CERT_SIGNATURE));
        hashSet.add(Integer.valueOf(X509_V_ERR_UNABLE_TO_DECRYPT_CRL_SIGNATURE));
        hashSet.add(Integer.valueOf(X509_V_ERR_UNABLE_TO_DECODE_ISSUER_PUBLIC_KEY));
        hashSet.add(Integer.valueOf(X509_V_ERR_CERT_SIGNATURE_FAILURE));
        hashSet.add(Integer.valueOf(X509_V_ERR_CRL_SIGNATURE_FAILURE));
        hashSet.add(Integer.valueOf(X509_V_ERR_CERT_NOT_YET_VALID));
        hashSet.add(Integer.valueOf(X509_V_ERR_CERT_HAS_EXPIRED));
        hashSet.add(Integer.valueOf(X509_V_ERR_CRL_NOT_YET_VALID));
        hashSet.add(Integer.valueOf(X509_V_ERR_CRL_HAS_EXPIRED));
        hashSet.add(Integer.valueOf(X509_V_ERR_ERROR_IN_CERT_NOT_BEFORE_FIELD));
        hashSet.add(Integer.valueOf(X509_V_ERR_ERROR_IN_CERT_NOT_AFTER_FIELD));
        hashSet.add(Integer.valueOf(X509_V_ERR_ERROR_IN_CRL_LAST_UPDATE_FIELD));
        hashSet.add(Integer.valueOf(X509_V_ERR_ERROR_IN_CRL_NEXT_UPDATE_FIELD));
        hashSet.add(Integer.valueOf(X509_V_ERR_OUT_OF_MEM));
        hashSet.add(Integer.valueOf(X509_V_ERR_DEPTH_ZERO_SELF_SIGNED_CERT));
        hashSet.add(Integer.valueOf(X509_V_ERR_SELF_SIGNED_CERT_IN_CHAIN));
        hashSet.add(Integer.valueOf(X509_V_ERR_UNABLE_TO_GET_ISSUER_CERT_LOCALLY));
        hashSet.add(Integer.valueOf(X509_V_ERR_UNABLE_TO_VERIFY_LEAF_SIGNATURE));
        hashSet.add(Integer.valueOf(X509_V_ERR_CERT_CHAIN_TOO_LONG));
        hashSet.add(Integer.valueOf(X509_V_ERR_CERT_REVOKED));
        hashSet.add(Integer.valueOf(X509_V_ERR_INVALID_CA));
        hashSet.add(Integer.valueOf(X509_V_ERR_PATH_LENGTH_EXCEEDED));
        hashSet.add(Integer.valueOf(X509_V_ERR_INVALID_PURPOSE));
        hashSet.add(Integer.valueOf(X509_V_ERR_CERT_UNTRUSTED));
        hashSet.add(Integer.valueOf(X509_V_ERR_CERT_REJECTED));
        hashSet.add(Integer.valueOf(X509_V_ERR_SUBJECT_ISSUER_MISMATCH));
        hashSet.add(Integer.valueOf(X509_V_ERR_AKID_SKID_MISMATCH));
        hashSet.add(Integer.valueOf(X509_V_ERR_AKID_ISSUER_SERIAL_MISMATCH));
        hashSet.add(Integer.valueOf(X509_V_ERR_KEYUSAGE_NO_CERTSIGN));
        hashSet.add(Integer.valueOf(X509_V_ERR_UNABLE_TO_GET_CRL_ISSUER));
        hashSet.add(Integer.valueOf(X509_V_ERR_UNHANDLED_CRITICAL_EXTENSION));
        hashSet.add(Integer.valueOf(X509_V_ERR_KEYUSAGE_NO_CRL_SIGN));
        hashSet.add(Integer.valueOf(X509_V_ERR_UNHANDLED_CRITICAL_CRL_EXTENSION));
        hashSet.add(Integer.valueOf(X509_V_ERR_INVALID_NON_CA));
        hashSet.add(Integer.valueOf(X509_V_ERR_PROXY_PATH_LENGTH_EXCEEDED));
        hashSet.add(Integer.valueOf(X509_V_ERR_KEYUSAGE_NO_DIGITAL_SIGNATURE));
        hashSet.add(Integer.valueOf(X509_V_ERR_PROXY_CERTIFICATES_NOT_ALLOWED));
        hashSet.add(Integer.valueOf(X509_V_ERR_INVALID_EXTENSION));
        hashSet.add(Integer.valueOf(X509_V_ERR_INVALID_POLICY_EXTENSION));
        hashSet.add(Integer.valueOf(X509_V_ERR_NO_EXPLICIT_POLICY));
        hashSet.add(Integer.valueOf(X509_V_ERR_DIFFERENT_CRL_SCOPE));
        hashSet.add(Integer.valueOf(X509_V_ERR_UNSUPPORTED_EXTENSION_FEATURE));
        hashSet.add(Integer.valueOf(X509_V_ERR_UNNESTED_RESOURCE));
        hashSet.add(Integer.valueOf(X509_V_ERR_PERMITTED_VIOLATION));
        hashSet.add(Integer.valueOf(X509_V_ERR_EXCLUDED_VIOLATION));
        hashSet.add(Integer.valueOf(X509_V_ERR_SUBTREE_MINMAX));
        hashSet.add(Integer.valueOf(X509_V_ERR_APPLICATION_VERIFICATION));
        hashSet.add(Integer.valueOf(X509_V_ERR_UNSUPPORTED_CONSTRAINT_TYPE));
        hashSet.add(Integer.valueOf(X509_V_ERR_UNSUPPORTED_CONSTRAINT_SYNTAX));
        hashSet.add(Integer.valueOf(X509_V_ERR_UNSUPPORTED_NAME_SYNTAX));
        hashSet.add(Integer.valueOf(X509_V_ERR_CRL_PATH_VALIDATION_ERROR));
        hashSet.add(Integer.valueOf(X509_V_ERR_PATH_LOOP));
        hashSet.add(Integer.valueOf(X509_V_ERR_SUITE_B_INVALID_VERSION));
        hashSet.add(Integer.valueOf(X509_V_ERR_SUITE_B_INVALID_ALGORITHM));
        hashSet.add(Integer.valueOf(X509_V_ERR_SUITE_B_INVALID_CURVE));
        hashSet.add(Integer.valueOf(X509_V_ERR_SUITE_B_INVALID_SIGNATURE_ALGORITHM));
        hashSet.add(Integer.valueOf(X509_V_ERR_SUITE_B_LOS_NOT_ALLOWED));
        hashSet.add(Integer.valueOf(X509_V_ERR_SUITE_B_CANNOT_SIGN_P_384_WITH_P_256));
        hashSet.add(Integer.valueOf(X509_V_ERR_HOSTNAME_MISMATCH));
        hashSet.add(Integer.valueOf(X509_V_ERR_EMAIL_MISMATCH));
        hashSet.add(Integer.valueOf(X509_V_ERR_IP_ADDRESS_MISMATCH));
        hashSet.add(Integer.valueOf(X509_V_ERR_DANE_NO_MATCH));

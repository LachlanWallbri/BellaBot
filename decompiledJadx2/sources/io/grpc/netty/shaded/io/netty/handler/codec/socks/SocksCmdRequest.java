...
public final class SocksCmdRequest extends SocksRequest {
    ...
    public SocksCmdRequest(SocksCmdType socksCmdType, SocksAddressType socksAddressType, String str, int i) {
        ...
        int i2 = C65791.$SwitchMap$io$netty$handler$codec$socks$SocksAddressType[socksAddressType.ordinal()];
        if (i2 != 1) {
            if (i2 == 2) {
    ...
    /* JADX WARN: Classes with same name are omitted:
      classes6.dex
     */
    /* renamed from: io.grpc.netty.shaded.io.netty.handler.codec.socks.SocksCmdRequest$1 */
    /* loaded from: classes7.dex */
    static /* synthetic */ class C65791 {
    ...
    public void encodeAsByteBuf(ByteBuf byteBuf) {
        ...
        int i = C65791.$SwitchMap$io$netty$handler$codec$socks$SocksAddressType[this.addressType.ordinal()];
        if (i == 1) {

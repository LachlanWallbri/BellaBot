...
public abstract class HttpHeaders implements Iterable<Map.Entry<String, String>> {
    ...
    public static final class Names {
        ...
        /* renamed from: TE */
        public static final String f8369TE = "TE";
    ...
    private static boolean containsCommaSeparatedTrimmed(CharSequence charSequence, CharSequence charSequence2, boolean z) {
        if (z) {
            ...
            if (indexOf == -1) {
                ...
                int i = indexOf;
                int i2 = 0;
                while (!AsciiString.contentEqualsIgnoreCase(AsciiString.trim(charSequence.subSequence(i2, i)), charSequence2)) {
                    i2 = i + 1;
                    i = AsciiString.indexOf(charSequence, ',', i2);
                    if (i == -1) {
                        if (i2 < charSequence.length() && AsciiString.contentEqualsIgnoreCase(AsciiString.trim(charSequence.subSequence(i2, charSequence.length())), charSequence2)) {
                            return true;
                        }
                    }
                }
            ...
            if (indexOf2 == -1) {
                ...
                int i3 = indexOf2;
                int i4 = 0;
                while (!AsciiString.contentEquals(AsciiString.trim(charSequence.subSequence(i4, i3)), charSequence2)) {
                    i4 = i3 + 1;
                    i3 = AsciiString.indexOf(charSequence, ',', i4);
                    if (i3 == -1) {
                        if (i4 < charSequence.length() && AsciiString.contentEquals(AsciiString.trim(charSequence.subSequence(i4, charSequence.length())), charSequence2)) {
                            return true;
                        }
                    }
                }

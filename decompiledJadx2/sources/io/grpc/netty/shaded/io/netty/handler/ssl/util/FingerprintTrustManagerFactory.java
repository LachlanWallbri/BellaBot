...
public final class FingerprintTrustManagerFactory extends SimpleTrustManagerFactory {
    ...
    /* renamed from: tm */
    private final TrustManager f8424tm;
    ...
    public FingerprintTrustManagerFactory(byte[]... bArr) {
        this.f8424tm = new X509TrustManager() { // from class: io.grpc.netty.shaded.io.netty.handler.ssl.util.FingerprintTrustManagerFactory.2
    ...
    protected TrustManager[] engineGetTrustManagers() {
        return new TrustManager[]{this.f8424tm};
    }
}

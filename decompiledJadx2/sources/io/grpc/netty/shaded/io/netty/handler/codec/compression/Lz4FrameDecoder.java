...
public class Lz4FrameDecoder extends ByteToMessageDecoder {
    ...
    /* JADX WARN: Classes with same name are omitted:
      classes6.dex
     */
    /* renamed from: io.grpc.netty.shaded.io.netty.handler.codec.compression.Lz4FrameDecoder$1 */
    /* loaded from: classes7.dex */
    static /* synthetic */ class C64611 {

        /* renamed from: $SwitchMap$io$netty$handler$codec$compression$Lz4FrameDecoder$State */
        static final /* synthetic */ int[] f8362xd73b9784 = new int[State.values().length];

        static {
            try {
                f8362xd73b9784[State.INIT_BLOCK.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f8362xd73b9784[State.DECOMPRESS_DATA.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f8362xd73b9784[State.FINISHED.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f8362xd73b9784[State.CORRUPTED.ordinal()] = 4;
    ...
    protected void decode(ChannelHandlerContext channelHandlerContext, ByteBuf byteBuf, List<Object> list) throws Exception {
        ...
        try {
            int i = C64611.f8362xd73b9784[this.currentState.ordinal()];

...
public class SocksCmdRequestDecoder extends ReplayingDecoder<State> {
    ...
    /* JADX WARN: Classes with same name are omitted:
      classes6.dex
     */
    /* renamed from: io.grpc.netty.shaded.io.netty.handler.codec.socks.SocksCmdRequestDecoder$1 */
    /* loaded from: classes7.dex */
    static /* synthetic */ class C65801 {
        ...
        static final /* synthetic */ int[] f8390x4cc3c4aa = new int[State.values().length];

        static {
            try {
                f8390x4cc3c4aa[State.CHECK_PROTOCOL_VERSION.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f8390x4cc3c4aa[State.READ_CMD_HEADER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f8390x4cc3c4aa[State.READ_CMD_ADDRESS.ordinal()] = 3;
    ...
    */
    protected void decode(ChannelHandlerContext channelHandlerContext, ByteBuf byteBuf, List<Object> list) throws Exception {
        int i;
        int i2 = C65801.f8390x4cc3c4aa[state().ordinal()];
        if (i2 != 1) {
            if (i2 != 2) {
                if (i2 != 3) {
                    throw new Error();
                }
                i = C65801.$SwitchMap$io$netty$handler$codec$socks$SocksAddressType[this.addressType.ordinal()];
                if (i != 1) {

...
public class Socks5PasswordAuthRequestDecoder extends ReplayingDecoder<State> {
    ...
    /* JADX WARN: Classes with same name are omitted:
      classes6.dex
     */
    /* renamed from: io.grpc.netty.shaded.io.netty.handler.codec.socksx.v5.Socks5PasswordAuthRequestDecoder$1 */
    /* loaded from: classes7.dex */
    static /* synthetic */ class C65941 {

        /* renamed from: $SwitchMap$io$netty$handler$codec$socksx$v5$Socks5PasswordAuthRequestDecoder$State */
        static final /* synthetic */ int[] f8405xa51101bd = new int[State.values().length];

        static {
            try {
                f8405xa51101bd[State.INIT.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f8405xa51101bd[State.SUCCESS.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f8405xa51101bd[State.FAILURE.ordinal()] = 3;
    ...
    protected void decode(ChannelHandlerContext channelHandlerContext, ByteBuf byteBuf, List<Object> list) throws Exception {
        try {
            int i = C65941.f8405xa51101bd[state().ordinal()];
            if (i == 1) {

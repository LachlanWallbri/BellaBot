...
public class ObjectDecoderInputStream extends InputStream implements ObjectInput {
    ...
    /* renamed from: in */
    private final DataInputStream f8384in;
    ...
    public ObjectDecoderInputStream(InputStream inputStream, ClassLoader classLoader, int i) {
        ...
        if (inputStream instanceof DataInputStream) {
            this.f8384in = (DataInputStream) inputStream;
        } else {
            this.f8384in = new DataInputStream(inputStream);
        }
    ...
    public Object readObject() throws ClassNotFoundException, IOException {
        ...
        return new CompactObjectInputStream(this.f8384in, this.classResolver).readObject();
    }

    @Override // java.io.InputStream, java.io.ObjectInput
    public int available() throws IOException {
        return this.f8384in.available();
    }
    ...
    public boolean markSupported() {
        return this.f8384in.markSupported();
    }

    @Override // java.io.InputStream, java.io.ObjectInput
    public int read() throws IOException {
        return this.f8384in.read();
    }

    @Override // java.io.InputStream, java.io.ObjectInput
    public final int read(byte[] bArr, int i, int i2) throws IOException {
        return this.f8384in.read(bArr, i, i2);
    }

    @Override // java.io.InputStream, java.io.ObjectInput
    public final int read(byte[] bArr) throws IOException {
        return this.f8384in.read(bArr);
    }

    @Override // java.io.DataInput
    public final boolean readBoolean() throws IOException {
        return this.f8384in.readBoolean();
    }

    @Override // java.io.DataInput
    public final byte readByte() throws IOException {
        return this.f8384in.readByte();
    }

    @Override // java.io.DataInput
    public final char readChar() throws IOException {
        return this.f8384in.readChar();
    }

    @Override // java.io.DataInput
    public final double readDouble() throws IOException {
        return this.f8384in.readDouble();
    }

    @Override // java.io.DataInput
    public final float readFloat() throws IOException {
        return this.f8384in.readFloat();
    }

    @Override // java.io.DataInput
    public final void readFully(byte[] bArr, int i, int i2) throws IOException {
        this.f8384in.readFully(bArr, i, i2);
    }

    @Override // java.io.DataInput
    public final void readFully(byte[] bArr) throws IOException {
        this.f8384in.readFully(bArr);
    }

    @Override // java.io.DataInput
    public final int readInt() throws IOException {
        return this.f8384in.readInt();
    }

    @Override // java.io.DataInput
    @Deprecated
    public final String readLine() throws IOException {
        return this.f8384in.readLine();
    }

    @Override // java.io.DataInput
    public final long readLong() throws IOException {
        return this.f8384in.readLong();
    }

    @Override // java.io.DataInput
    public final short readShort() throws IOException {
        return this.f8384in.readShort();
    }

    @Override // java.io.DataInput
    public final int readUnsignedByte() throws IOException {
        return this.f8384in.readUnsignedByte();
    }

    @Override // java.io.DataInput
    public final int readUnsignedShort() throws IOException {
        return this.f8384in.readUnsignedShort();
    }

    @Override // java.io.DataInput
    public final String readUTF() throws IOException {
        return this.f8384in.readUTF();
    }
    ...
    public long skip(long j) throws IOException {
        return this.f8384in.skip(j);
    }

    @Override // java.io.DataInput
    public final int skipBytes(int i) throws IOException {
        return this.f8384in.skipBytes(i);
    }
}

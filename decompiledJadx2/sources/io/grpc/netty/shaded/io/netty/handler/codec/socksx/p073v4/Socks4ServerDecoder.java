...
public class Socks4ServerDecoder extends ReplayingDecoder<State> {
    ...
    /* JADX WARN: Classes with same name are omitted:
      classes6.dex
     */
    /* renamed from: io.grpc.netty.shaded.io.netty.handler.codec.socksx.v4.Socks4ServerDecoder$1 */
    /* loaded from: classes7.dex */
    static /* synthetic */ class C65871 {

        /* renamed from: $SwitchMap$io$netty$handler$codec$socksx$v4$Socks4ServerDecoder$State */
        static final /* synthetic */ int[] f8400xc9960af6 = new int[State.values().length];

        static {
            try {
                f8400xc9960af6[State.START.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f8400xc9960af6[State.READ_USERID.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f8400xc9960af6[State.READ_DOMAIN.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f8400xc9960af6[State.SUCCESS.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f8400xc9960af6[State.FAILURE.ordinal()] = 5;
    ...
    */
    protected void decode(ChannelHandlerContext channelHandlerContext, ByteBuf byteBuf, List<Object> list) throws Exception {
        ...
        try {
            int i = C65871.f8400xc9960af6[state().ordinal()];
            if (i == 1) {

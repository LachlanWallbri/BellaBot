...
public final class WeightedFairQueueByteDistributor implements StreamByteDistributor {
    ...
    public WeightedFairQueueByteDistributor(Http2Connection http2Connection, int i) {
        ...
        http2Connection.addListener(new Http2ConnectionAdapter() { // from class: io.grpc.netty.shaded.io.netty.handler.codec.http2.WeightedFairQueueByteDistributor.1
            ...
            public void onStreamAdded(Http2Stream http2Stream) {
                State state2 = (State) WeightedFairQueueByteDistributor.this.stateOnlyMap.remove(http2Stream.mo3916id());
                if (state2 != null) {
                ...
                int i2 = C65762.$SwitchMap$io$netty$handler$codec$http2$Http2Stream$State[http2Stream.state().ordinal()];
                if (i2 == 1 || i2 == 2) {
    ...
    /* JADX WARN: Classes with same name are omitted:
      classes6.dex
     */
    /* renamed from: io.grpc.netty.shaded.io.netty.handler.codec.http2.WeightedFairQueueByteDistributor$2 */
    /* loaded from: classes7.dex */
    static /* synthetic */ class C65762 {
    ...
    public final class State implements PriorityQueueNode {
        ...
        State(WeightedFairQueueByteDistributor weightedFairQueueByteDistributor, Http2Stream http2Stream, int i) {
            this(http2Stream.mo3916id(), http2Stream, i);
        }

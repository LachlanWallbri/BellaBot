...
public abstract class ReferenceCountedOpenSslContext extends SslContext implements ReferenceCounted {
    ...
    public ReferenceCountedOpenSslContext(Iterable<String> iterable, CipherSuiteFilter cipherSuiteFilter, OpenSslApplicationProtocolNegotiator openSslApplicationProtocolNegotiator, long j, long j2, int i, Certificate[] certificateArr, ClientAuth clientAuth, String[] strArr, boolean z, boolean z2, boolean z3) throws SSLException {
        ...
        this.unmodifiableCiphers = Arrays.asList(((CipherSuiteFilter) ObjectUtil.checkNotNull(cipherSuiteFilter, "cipherFilter")).filterCipherSuites(iterable, OpenSsl.DEFAULT_CIPHERS, OpenSsl.availableJavaCipherSuites()));
                ...
                try {
                    try {
                        if (this.unmodifiableCiphers.isEmpty()) {
                            ...
                            CipherSuiteConverter.convertToCipherStrings(this.unmodifiableCiphers, sb, sb2, OpenSsl.isBoringSSL());
                        ...
                        if (!protocols.isEmpty()) {
                            ...
                            int i2 = C66443.f8416xc16482e4[openSslApplicationProtocolNegotiator.protocol().ordinal()];
                            if (i2 == 1) {
    ...
    private static int opensslSelectorFailureBehavior(ApplicationProtocolConfig.SelectorFailureBehavior selectorFailureBehavior) {
        int i = C66443.f8418xb32e3251[selectorFailureBehavior.ordinal()];
        if (i == 1) {
            return 0;
        }
        if (i == 2) {
    ...
    public static OpenSslApplicationProtocolNegotiator toNegotiator(ApplicationProtocolConfig applicationProtocolConfig) {
        ...
        int i = C66443.f8416xc16482e4[applicationProtocolConfig.protocol().ordinal()];
        if (i != 1 && i != 2 && i != 3) {
            if (i == 4) {
                return NONE_PROTOCOL_NEGOTIATOR;
            }
        ...
        int i2 = C66443.f8417xcbdfafc1[applicationProtocolConfig.selectedListenerFailureBehavior().ordinal()];
        if (i2 == 1 || i2 == 2) {
            int i3 = C66443.f8418xb32e3251[applicationProtocolConfig.selectorFailureBehavior().ordinal()];
            if (i3 == 1 || i3 == 2) {
    ...
    /* JADX WARN: Classes with same name are omitted:
      classes6.dex
     */
    /* renamed from: io.grpc.netty.shaded.io.netty.handler.ssl.ReferenceCountedOpenSslContext$3 */
    /* loaded from: classes7.dex */
    public static /* synthetic */ class C66443 {

        /* renamed from: $SwitchMap$io$netty$handler$ssl$ApplicationProtocolConfig$Protocol */
        static final /* synthetic */ int[] f8416xc16482e4;

        /* renamed from: $SwitchMap$io$netty$handler$ssl$ApplicationProtocolConfig$SelectedListenerFailureBehavior */
        static final /* synthetic */ int[] f8417xcbdfafc1 = new int[ApplicationProtocolConfig.SelectedListenerFailureBehavior.values().length];

        /* renamed from: $SwitchMap$io$netty$handler$ssl$ApplicationProtocolConfig$SelectorFailureBehavior */
        static final /* synthetic */ int[] f8418xb32e3251;

        static {
            try {
                f8417xcbdfafc1[ApplicationProtocolConfig.SelectedListenerFailureBehavior.CHOOSE_MY_LAST_PROTOCOL.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f8417xcbdfafc1[ApplicationProtocolConfig.SelectedListenerFailureBehavior.ACCEPT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            f8418xb32e3251 = new int[ApplicationProtocolConfig.SelectorFailureBehavior.values().length];
            try {
                f8418xb32e3251[ApplicationProtocolConfig.SelectorFailureBehavior.NO_ADVERTISE.ordinal()] = 1;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f8418xb32e3251[ApplicationProtocolConfig.SelectorFailureBehavior.CHOOSE_MY_LAST_PROTOCOL.ordinal()] = 2;
            } catch (NoSuchFieldError unused4) {
            }
            f8416xc16482e4 = new int[ApplicationProtocolConfig.Protocol.values().length];
            try {
                f8416xc16482e4[ApplicationProtocolConfig.Protocol.NPN.ordinal()] = 1;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f8416xc16482e4[ApplicationProtocolConfig.Protocol.ALPN.ordinal()] = 2;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f8416xc16482e4[ApplicationProtocolConfig.Protocol.NPN_AND_ALPN.ordinal()] = 3;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f8416xc16482e4[ApplicationProtocolConfig.Protocol.NONE.ordinal()] = 4;

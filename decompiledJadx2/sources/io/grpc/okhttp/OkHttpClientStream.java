...
public class OkHttpClientStream extends AbstractClientStream {
    ...
    public class TransportState extends Http2ClientStreamTransportState {
        ...
        public void start(int i) {
            Preconditions.checkState(OkHttpClientStream.this.f8433id == -1, "the stream has been started with id %s", i);
            OkHttpClientStream.this.f8433id = i;
            OkHttpClientStream.this.state.onStreamAllocated();
            if (this.canStart) {
                this.frameWriter.synStream(OkHttpClientStream.this.useGet, false, OkHttpClientStream.this.f8433id, 0, this.requestHeaders);
                OkHttpClientStream.this.statsTraceCtx.clientOutboundHeaders();
                this.requestHeaders = null;
                if (this.pendingData.size() > 0) {
                    this.outboundFlow.data(this.pendingDataHasEndOfStream, OkHttpClientStream.this.f8433id, this.pendingData, this.flushPendingData);
                }
                this.canStart = false;
            }
        }
        ...
        public void bytesRead(int i) {
            ...
            if (f <= i3 * 0.5f) {
                ...
                this.frameWriter.windowUpdate(OkHttpClientStream.this.m3922id(), i4);
            }
        }
        ...
        public void transportDataReceived(Buffer buffer, boolean z) {
            ...
            if (this.window < 0) {
                this.frameWriter.rstStream(OkHttpClientStream.this.m3922id(), ErrorCode.FLOW_CONTROL_ERROR);
                this.transport.finishStream(OkHttpClientStream.this.m3922id(), Status.INTERNAL.withDescription("Received data size exceeded our receiving window size"), ClientStreamListener.RpcProgress.PROCESSED, false, null, null);
            } else {
        ...
        private void onEndOfStream() {
            if (!isOutboundClosed()) {
                this.transport.finishStream(OkHttpClientStream.this.m3922id(), null, ClientStreamListener.RpcProgress.PROCESSED, false, ErrorCode.CANCEL, null);
            } else {
                this.transport.finishStream(OkHttpClientStream.this.m3922id(), null, ClientStreamListener.RpcProgress.PROCESSED, false, null, null);
            }
        }
        ...
        public void cancel(Status status, boolean z, Metadata metadata) {
            ...
            this.transport.finishStream(OkHttpClientStream.this.m3922id(), status, ClientStreamListener.RpcProgress.PROCESSED, z, ErrorCode.CANCEL, metadata);
        }
        ...
        public void sendBuffer(Buffer buffer, boolean z, boolean z2) {
            ...
            if (this.canStart) {
                ...
                Preconditions.checkState(OkHttpClientStream.this.m3922id() != -1, "streamId should be set");
                this.outboundFlow.data(z, OkHttpClientStream.this.m3922id(), buffer, z2);
            }
        }

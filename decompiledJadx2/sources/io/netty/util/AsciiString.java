...
public final class AsciiString implements CharSequence, Comparable<CharSequence> {
    ...
    public int indexOf(CharSequence charSequence, int i) {
        ...
        int i3 = this.offset;
        int i4 = ((i3 + i) + this.length) - length;
    ...
    public int lastIndexOf(CharSequence charSequence, int i) {
        ...
        int i3 = this.offset;
        int i4 = i3 + i;
        for (int i5 = ((i3 + i) + this.length) - length; i5 >= i4; i5--) {
            if (this.value[i5] == c2b0) {
                int i6 = 0;
                int i7 = i5;
                do {
                    ...
                    i7++;
                } while (b2c(this.value[i7]) == charSequence.charAt(i6));
                if (i6 == length) {
                    return i5 - this.offset;
                }
            }
    ...
    public boolean regionMatches(boolean z, int i, CharSequence charSequence, int i2, int i3) {
        ...
        while (arrayOffset < i4) {
            ...
            int i6 = i2 + 1;
            if (!equalsIgnoreCase(b2c, charSequence.charAt(i2))) {
                return false;
            }
            i2 = i6;
            arrayOffset = i5;
    ...
    /* renamed from: of */
    public static AsciiString m3944of(CharSequence charSequence) {

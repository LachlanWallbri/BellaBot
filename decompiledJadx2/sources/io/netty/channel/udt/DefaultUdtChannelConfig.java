...
public class DefaultUdtChannelConfig extends DefaultChannelConfig implements UdtChannelConfig {
    ...
    /* renamed from: K */
    private static final int f8459K = 1024;

    /* renamed from: M */
    private static final int f8460M = 1048576;
    ...
    public DefaultUdtChannelConfig(UdtChannel udtChannel, ChannelUDT channelUDT, boolean z) throws IOException {
        super(udtChannel);
        this.protocolReceiveBufferSize = OSSConfig.DEFAULT_MULTI_PART_UPLOAD_SIZE;
        this.protocolSendBufferSize = OSSConfig.DEFAULT_MULTI_PART_UPLOAD_SIZE;

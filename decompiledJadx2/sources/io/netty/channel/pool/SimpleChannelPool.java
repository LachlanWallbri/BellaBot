...
public class SimpleChannelPool implements ChannelPool {
    ...
    public SimpleChannelPool(Bootstrap bootstrap, final ChannelPoolHandler channelPoolHandler, ChannelHealthChecker channelHealthChecker, boolean z, boolean z2) {
        ...
        Bootstrap mo4505clone = ((Bootstrap) ObjectUtil.checkNotNull(bootstrap, "bootstrap")).mo4505clone();
        this.bootstrap = mo4505clone;
        mo4505clone.handler(new ChannelInitializer<Channel>() { // from class: io.netty.channel.pool.SimpleChannelPool.1
            static final /* synthetic */ boolean $assertionsDisabled = false;
    ...
    private Future<Channel> acquireHealthyFromPoolOrNew(final Promise<Channel> promise) {
        ...
        if (pollChannel == null) {
            Bootstrap mo4505clone = this.bootstrap.mo4505clone();
            mo4505clone.attr(POOL_KEY, this);
            ChannelFuture connectChannel = connectChannel(mo4505clone);
    ...
    /* JADX WARN: Classes with same name are omitted:
      classes4.dex
     */
    /* renamed from: io.netty.channel.pool.SimpleChannelPool$7 */
    /* loaded from: classes5.dex */
    class C70667 extends IllegalStateException {
        C70667(String str) {
            super(str);
        }

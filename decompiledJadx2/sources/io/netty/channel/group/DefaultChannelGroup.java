...
public class DefaultChannelGroup extends AbstractSet<Channel> implements ChannelGroup {
    ...
    public boolean add(Channel channel) {
        boolean z = (channel instanceof ServerChannel ? this.serverChannels : this.nonServerChannels).putIfAbsent(channel.mo3929id(), channel) == null;
        if (z) {
    ...
    public boolean remove(Object obj) {
        ...
        if (obj instanceof ChannelId) {
            ...
            if (channel2 instanceof ServerChannel) {
                channel = this.serverChannels.remove(channel2.mo3929id());
            } else {
                channel = this.nonServerChannels.remove(channel2.mo3929id());
            }
        } else {
            channel = null;
        }

...
public abstract class SocketWritableByteChannel implements WritableByteChannel {
    ...
    public final int write(ByteBuffer byteBuffer) throws IOException {
        ...
        if (byteBuffer.isDirect()) {
            write = this.f8462fd.write(byteBuffer, position, byteBuffer.limit());
        } else {
            ...
            try {
                ...
                write = this.f8462fd.write(internalNioBuffer, internalNioBuffer.position(), internalNioBuffer.limit());
            } finally {
                if (byteBuf != null) {
                    byteBuf.release();
                }

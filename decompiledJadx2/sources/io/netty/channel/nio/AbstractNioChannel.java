...
public abstract class AbstractNioChannel extends AbstractChannel {
    ...
    /* renamed from: ch */
    private final SelectableChannel f8453ch;
    ...
    public AbstractNioChannel(Channel channel, SelectableChannel selectableChannel, int i) {
        ...
        this.f8453ch = selectableChannel;
    ...
    public SelectableChannel mo4506javaChannel() {
        return this.f8453ch;
    }
    ...
    public abstract class AbstractNioUnsafe extends AbstractChannel.AbstractUnsafe implements NioUnsafe {
        ...
        /* renamed from: ch */
        public final SelectableChannel mo3935ch() {
            return AbstractNioChannel.this.mo4506javaChannel();
        }
    ...
    protected void doRegister() throws Exception {
        ...
        while (true) {
            try {
                this.selectionKey = mo4506javaChannel().register(eventLoop().unwrappedSelector(), 0, this);
                return;

...
public final class Base64 {
    ...
    private static void encode3to4BigEndian(int i, int i2, ByteBuf byteBuf, int i3, byte[] bArr) {
        if (i2 == 1) {
            byteBuf.setInt(i3, (bArr[(i >>> 12) & 63] << 16) | (bArr[i >>> 18] << 24) | 15616 | 61);
        } else if (i2 == 2) {
    ...
    public static final class Decoder implements ByteProcessor {
        ...
        public boolean process(byte b) throws Exception {
            ...
            this.sbiDecode = b3;
            if (b3 < -5) {
                throw new IllegalArgumentException("invalid bad Base64 input character: " + ((int) ((short) (b & 255))) + " (decimal)");
            }
            if (b3 < -1) {
                return true;
            }
            byte[] bArr2 = this.f8467b4;
            int i = this.b4Posn;
            int i2 = i + 1;
            this.b4Posn = i2;
            bArr2[i] = b2;

...
public class SocksCmdResponseDecoder extends ReplayingDecoder<State> {
    ...
    static /* synthetic */ class C72661 {
        ...
        static final /* synthetic */ int[] f8524x5919eb68;
        ...
        static {
            ...
            try {
                f8524x5919eb68[State.READ_CMD_HEADER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f8524x5919eb68[State.READ_CMD_ADDRESS.ordinal()] = 3;
    ...
    */
    protected void decode(ChannelHandlerContext channelHandlerContext, ByteBuf byteBuf, List<Object> list) throws Exception {
        int i;
        int i2 = C72661.f8524x5919eb68[state().ordinal()];
        if (i2 != 1) {
            if (i2 != 2) {
                if (i2 != 3) {
                    throw new Error();
                }
                i = C72661.$SwitchMap$io$netty$handler$codec$socks$SocksAddressType[this.addressType.ordinal()];
                if (i != 1) {

...
public abstract class HttpContentEncoder extends MessageToMessageCodec<HttpRequest, HttpObject> {
    ...
    /* JADX WARN: Classes with same name are omitted:
      ...
      classes8.dex
     */
    /* renamed from: io.netty.handler.codec.http.HttpContentEncoder$1 */
    /* loaded from: classes.dex */
    ...
    protected void encode2(ChannelHandlerContext channelHandlerContext, HttpObject httpObject, List<Object> list) throws Exception {
        ...
        int i = C71421.$SwitchMap$io$netty$handler$codec$http$HttpContentEncoder$State[this.state.ordinal()];
        if (i == 1) {

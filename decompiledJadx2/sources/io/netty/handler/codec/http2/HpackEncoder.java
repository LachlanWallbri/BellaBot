...
final class HpackEncoder {
    ...
    /* JADX WARN: Classes with same name are omitted:
      ...
      classes8.dex
     */
    /* renamed from: io.netty.handler.codec.http2.HpackEncoder$1 */
    /* loaded from: classes.dex */
    public static /* synthetic */ class C72091 {
    ...
    private void encodeLiteral(ByteBuf byteBuf, CharSequence charSequence, CharSequence charSequence2, HpackUtil.IndexType indexType, int i) {
        boolean z = i != -1;
        int i2 = C72091.$SwitchMap$io$netty$handler$codec$http2$HpackUtil$IndexType[indexType.ordinal()];
        if (i2 == 1) {
            if (!z) {
                i = 0;
            }

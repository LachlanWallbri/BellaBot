...
public final class Http2MultiplexHandler extends Http2ChannelDuplexHandler {
    ...
    public void userEventTriggered(ChannelHandlerContext channelHandlerContext, Object obj) throws Exception {
        ...
        if (obj instanceof Http2FrameStreamEvent) {
            ...
            if (http2FrameStreamEvent.type() == Http2FrameStreamEvent.Type.State) {
                int i = C72363.$SwitchMap$io$netty$handler$codec$http2$Http2Stream$State[defaultHttp2FrameStream.state().ordinal()];
                if (i != 1) {
                    if (i != 2 && i != 3) {
                ...
                } else if (defaultHttp2FrameStream.mo3941id() != 1) {
                    return;
                }
                if (defaultHttp2FrameStream.attachment != null) {
                    return;
                }
                if (defaultHttp2FrameStream.mo3941id() == 1 && !isServer(channelHandlerContext)) {
    ...
    /* JADX WARN: Classes with same name are omitted:
      classes5.dex
     */
    /* renamed from: io.netty.handler.codec.http2.Http2MultiplexHandler$3 */
    /* loaded from: classes8.dex */
    static /* synthetic */ class C72363 {
        ...
        try {
            ...
            forEachActiveStream(new Http2FrameStreamVisitor() { // from class: io.netty.handler.codec.http2.Http2MultiplexHandler.2
                ...
                public boolean visit(Http2FrameStream http2FrameStream) {
                    ...
                    if (mo3941id <= http2GoAwayFrame.lastStreamId() || !Http2CodecUtil.isStreamIdValid(mo3941id, isServer)) {
                        return true;
                    }

...
public class DefaultHttp2ConnectionDecoder implements Http2ConnectionDecoder {
    ...
    public final class FrameReadListener implements Http2FrameListener {
        ...
        /* synthetic */ FrameReadListener(DefaultHttp2ConnectionDecoder defaultHttp2ConnectionDecoder, C71941 c71941) {
            this();
        }
        ...
        public int onDataRead(ChannelHandlerContext channelHandlerContext, int i, ByteBuf byteBuf, int i2, boolean z) throws Http2Exception {
            ...
            try {
                ...
                int i3 = C71941.$SwitchMap$io$netty$handler$codec$http2$Http2Stream$State[stream.state().ordinal()];
                if (i3 != 1 && i3 != 2) {
                    if (i3 == 3 || i3 == 4) {
                        http2Exception = Http2Exception.streamError(stream.mo3940id(), Http2Error.STREAM_CLOSED, "Stream %d in unexpected state: %s", Integer.valueOf(stream.mo3940id()), stream.state());
                    } else {
                        http2Exception = Http2Exception.streamError(stream.mo3940id(), Http2Error.PROTOCOL_ERROR, "Stream %d in unexpected state: %s", Integer.valueOf(stream.mo3940id()), stream.state());
                    }
                }
        ...
        public void onHeadersRead(ChannelHandlerContext channelHandlerContext, int i, Http2Headers http2Headers, int i2, short s, boolean z, int i3, boolean z2) throws Http2Exception {
            ...
            int i4 = C71941.$SwitchMap$io$netty$handler$codec$http2$Http2Stream$State[http2Stream.state().ordinal()];
            if (i4 != 1 && i4 != 2) {
                if (i4 != 3) {
                    if (i4 == 4) {
                        throw Http2Exception.streamError(http2Stream.mo3940id(), Http2Error.STREAM_CLOSED, "Stream %d in unexpected state: %s", Integer.valueOf(http2Stream.mo3940id()), http2Stream.state());
                    }
                    if (i4 == 5) {
                        http2Stream.open(z2);
                    } else {
                        throw Http2Exception.connectionError(Http2Error.PROTOCOL_ERROR, "Stream %d in unexpected state: %s", Integer.valueOf(http2Stream.mo3940id()), http2Stream.state());
                    }
                } else if (!z3) {
                    throw Http2Exception.streamError(http2Stream.mo3940id(), Http2Error.STREAM_CLOSED, "Stream %d in unexpected state: %s", Integer.valueOf(http2Stream.mo3940id()), http2Stream.state());
                }
        ...
        public void onRstStreamRead(ChannelHandlerContext channelHandlerContext, int i, long j) throws Http2Exception {
            ...
            int i2 = C71941.$SwitchMap$io$netty$handler$codec$http2$Http2Stream$State[stream.state().ordinal()];
            if (i2 != 4) {
                if (i2 == 6) {
        ...
        public void onPushPromiseRead(ChannelHandlerContext channelHandlerContext, int i, int i2, Http2Headers http2Headers, int i3) throws Http2Exception {
            if (!DefaultHttp2ConnectionDecoder.this.connection().isServer()) {
                ...
                int i4 = C71941.$SwitchMap$io$netty$handler$codec$http2$Http2Stream$State[stream.state().ordinal()];
                if (i4 == 1 || i4 == 2) {
                ...
                throw Http2Exception.connectionError(Http2Error.PROTOCOL_ERROR, "Stream %d in unexpected state for receiving push promise: %s", Integer.valueOf(stream.mo3940id()), stream.state());
            }
    ...
    /* loaded from: classes.dex */
    public static /* synthetic */ class C71941 {
    ...
    private final class PrefaceFrameListener implements Http2FrameListener {
        ...
        /* synthetic */ PrefaceFrameListener(DefaultHttp2ConnectionDecoder defaultHttp2ConnectionDecoder, C71941 c71941) {
            this();
        }
        ...
        public void onSettingsRead(ChannelHandlerContext channelHandlerContext, Http2Settings http2Settings) throws Http2Exception {
            if (!DefaultHttp2ConnectionDecoder.this.prefaceReceived()) {
                DefaultHttp2ConnectionDecoder.this.internalFrameListener = new FrameReadListener(DefaultHttp2ConnectionDecoder.this, null);
            }

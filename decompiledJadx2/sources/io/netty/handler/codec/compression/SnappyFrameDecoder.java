...
public class SnappyFrameDecoder extends ByteToMessageDecoder {
    ...
    protected void decode(ChannelHandlerContext channelHandlerContext, ByteBuf byteBuf, List<Object> list) throws Exception {
        ...
        try {
            ...
            int i = C71291.f8481xce0a49f3[mapChunkType.ordinal()];
            if (i == 1) {
    ...
    static /* synthetic */ class C71291 {
        ...
        static {
            ...
            try {
                f8481xce0a49f3[ChunkType.RESERVED_SKIPPABLE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f8481xce0a49f3[ChunkType.RESERVED_UNSKIPPABLE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f8481xce0a49f3[ChunkType.UNCOMPRESSED_DATA.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f8481xce0a49f3[ChunkType.COMPRESSED_DATA.ordinal()] = 5;

...
public final class PoolThreadCache {
    ...
    /* JADX WARN: Classes with same name are omitted:
      ...
      classes7.dex
     */
    /* renamed from: io.netty.buffer.PoolThreadCache$1 */
    /* loaded from: classes.dex */
    public static /* synthetic */ class C69101 {
    ...
    private MemoryRegionCache<?> cache(PoolArena<?> poolArena, int i, PoolArena.SizeClass sizeClass) {
        int i2 = C69101.$SwitchMap$io$netty$buffer$PoolArena$SizeClass[sizeClass.ordinal()];
        if (i2 == 1) {

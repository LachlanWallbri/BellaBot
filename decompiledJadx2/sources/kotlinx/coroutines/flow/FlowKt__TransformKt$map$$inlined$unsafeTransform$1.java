...
public final class FlowKt__TransformKt$map$$inlined$unsafeTransform$1<R> implements Flow<R> {
        ...
        public Object emit$$forInline(Object obj, Continuation continuation) {
            ...
            new ContinuationImpl(continuation) { // from class: kotlinx.coroutines.flow.FlowKt__TransformKt$map$.inlined.unsafeTransform.1.2.1
                ...
                public final Object invokeSuspend(Object obj2) {
                    ...
                    return C79262.this.emit(null, this);
                }
            };
            InlineMarker.mark(5);
    ...
    public Object collect(FlowCollector flowCollector, Continuation continuation) {
        Object collect = this.$this_unsafeTransform$inlined.collect(new C79262(flowCollector, this), continuation);
    ...
    public Object collect$$forInline(FlowCollector flowCollector, Continuation continuation) {
        ...
        C79262 c79262 = new C79262(flowCollector, this);
        InlineMarker.mark(0);
        flow.collect(c79262, continuation);
        InlineMarker.mark(2);
        InlineMarker.mark(1);

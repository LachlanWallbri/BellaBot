...
@Metadata(m3959bv = {1, 0, 3}, m3960d1 = {"\u0000\u0012\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\u0004\b\u0001\u0010\u0003*\u00020\u0004H\u008a@¢\u0006\u0004\b\u0005\u0010\u0006"}, m3961d2 = {"<anonymous>", "", ExifInterface.GPS_DIRECTION_TRUE, "R", "Lkotlinx/coroutines/CoroutineScope;", "invoke", "(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;"}, m3962k = 3, m3963mv = {1, 1, 16})
@DebugMetadata(m3969c = "kotlinx.coroutines.flow.internal.ChannelFlowTransformLatest$flowCollect$3", m3970f = "Merge.kt", m3971i = {0, 0, 0}, m3972l = {99}, m3973m = "invokeSuspend", m3974n = {"$this$flowScope", "previousFlow", "$this$collect$iv"}, m3975s = {"L$0", "L$1", "L$2"})
...
public final class ChannelFlowTransformLatest$flowCollect$3 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        ...
        channelFlowTransformLatest$flowCollect$3.f8874p$ = (CoroutineScope) obj;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            CoroutineScope coroutineScope = this.f8874p$;
            Ref.ObjectRef objectRef = new Ref.ObjectRef();
            objectRef.element = (Job) 0;
            Flow<S> flow = this.this$0.flow;
            C7976xfa64eeb5 c7976xfa64eeb5 = new C7976xfa64eeb5(this, coroutineScope, objectRef);
            this.L$0 = coroutineScope;
            this.L$1 = objectRef;
            this.L$2 = flow;
            this.label = 1;
            if (flow.collect(c7976xfa64eeb5, this) == coroutine_suspended) {

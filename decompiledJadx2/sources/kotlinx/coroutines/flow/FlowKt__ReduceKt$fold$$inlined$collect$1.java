...
public final class FlowKt__ReduceKt$fold$$inlined$collect$1<T> implements FlowCollector<T> {
    ...
    @DebugMetadata(m3969c = "kotlinx.coroutines.flow.FlowKt__ReduceKt$fold$$inlined$collect$1", m3970f = "Reduce.kt", m3971i = {0, 0, 0, 0}, m3972l = {137}, m3973m = "emit", m3974n = {"this", ES6Iterator.VALUE_PROPERTY, "continuation", ES6Iterator.VALUE_PROPERTY}, m3975s = {"L$0", "L$1", "L$2", "L$3"})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ReduceKt$fold$$inlined$collect$1$1 */
    /* loaded from: classes2.dex */
    public static final class C79131 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        Object L$2;
        Object L$3;
        ...
        public C79131(Continuation continuation) {
            super(continuation);
        }
    ...
    */
    public Object emit(Object obj, Continuation continuation) {
        ...
        if (continuation instanceof C79131) {
            c79131 = (C79131) continuation;
            if ((c79131.label & Integer.MIN_VALUE) != 0) {
                c79131.label -= Integer.MIN_VALUE;
                T t = (T) c79131.result;
                ...
                if (i != 0) {
                    ...
                    c79131.L$2 = c79131;
                    c79131.L$3 = obj;
                    c79131.L$4 = objectRef2;
                    c79131.label = 1;
                    t = (T) function3.invoke(t2, obj, c79131);
                    ...
                    objectRef = (Ref.ObjectRef) c79131.L$4;
                    Object obj2 = c79131.L$3;
                    Object obj3 = c79131.L$1;
                    ResultKt.throwOnFailure(t);
                }
                objectRef.element = t;
        ...
        c79131 = new C79131(continuation);
        T t3 = (T) c79131.result;

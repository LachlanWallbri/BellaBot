...
@DebugMetadata(m3969c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$$inlined$combineTransform$2", m3970f = "Zip.kt", m3971i = {0}, m3972l = {265}, m3973m = "invokeSuspend", m3974n = {"$this$flow"}, m3975s = {"L$0"})
/* loaded from: classes2.dex */
public final class FlowKt__ZipKt$combineTransform$$inlined$combineTransform$2<R> extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        ...
        flowKt__ZipKt$combineTransform$$inlined$combineTransform$2.f8858p$ = (FlowCollector) obj;
        return flowKt__ZipKt$combineTransform$$inlined$combineTransform$2;
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(Object obj, Continuation<? super Unit> continuation) {
        return ((FlowKt__ZipKt$combineTransform$$inlined$combineTransform$2) create(obj, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    @DebugMetadata(m3969c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$$inlined$combineTransform$2$2", m3970f = "Zip.kt", m3971i = {}, m3972l = {}, m3973m = "invokeSuspend", m3974n = {}, m3975s = {})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$$inlined$combineTransform$2$2 */
    /* loaded from: classes2.dex */
    public static final class C79642 extends SuspendLambda implements Function3<FlowCollector<? super R>, Object[], Continuation<? super Unit>, Object> {
        Object L$0;
        Object L$1;
        int label;

        /* renamed from: p$ */
        private FlowCollector f8859p$;
        private Object[] p$0;

        public C79642(Continuation continuation) {
        ...
        public final Continuation<Unit> create(FlowCollector<? super R> flowCollector, Object[] objArr, Continuation<? super Unit> continuation) {
            C79642 c79642 = new C79642(continuation);
            c79642.f8859p$ = flowCollector;
            c79642.p$0 = objArr;
            return c79642;
        }
        ...
        public final Object invoke(Object obj, Object[] objArr, Continuation<? super Unit> continuation) {
            return ((C79642) create((FlowCollector) obj, objArr, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            FlowCollector flowCollector = this.f8859p$;
            Object[] objArr = this.p$0;
            FlowKt__ZipKt$combineTransform$$inlined$combineTransform$2.this.$transform$inlined.invoke(flowCollector, objArr[0], objArr[1], objArr[2], this);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            FlowCollector flowCollector = this.f8858p$;
            Flow[] flowArr = this.$flows;
            C79631 c79631 = new C79631();
            C79642 c79642 = new C79642(null);
            this.L$0 = flowCollector;
            this.label = 1;
            if (CombineKt.combineInternal(flowCollector, flowArr, c79631, c79642, this) == coroutine_suspended) {
    ...
    /* loaded from: classes2.dex */
    public static final class C79631 extends Lambda implements Function0<Object[]> {
        public C79631() {
            super(0);
        }
    ...
    public final Object invokeSuspend$$forInline(Object obj) {
        ...
        C79642 c79642 = new C79642(null);
        InlineMarker.mark(0);
        CombineKt.combineInternal(flowCollector, flowArr, c79631, c79642, this);
        InlineMarker.mark(2);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }

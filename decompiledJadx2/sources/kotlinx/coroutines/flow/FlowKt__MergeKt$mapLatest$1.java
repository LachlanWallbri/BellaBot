...
@DebugMetadata(m3969c = "kotlinx.coroutines.flow.FlowKt__MergeKt$mapLatest$1", m3970f = "Merge.kt", m3971i = {0, 0, 1, 1}, m3972l = {214, 214}, m3973m = "invokeSuspend", m3974n = {"$this$transformLatest", "it", "$this$transformLatest", "it"}, m3975s = {"L$0", "L$1", "L$0", "L$1"})
...
public final class FlowKt__MergeKt$mapLatest$1<R, T> extends SuspendLambda implements Function3<FlowCollector<? super R>, T, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(FlowCollector<? super R> flowCollector, T t, Continuation<? super Unit> continuation) {
        ...
        flowKt__MergeKt$mapLatest$1.f8834p$ = flowCollector;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            FlowCollector flowCollector3 = this.f8834p$;

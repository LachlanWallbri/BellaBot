...
public final class FlowKt__TransformKt$filterIsInstance$$inlined$filter$1 implements Flow<Object> {
        ...
        public Object emit$$forInline(Object obj, Continuation continuation) {
            ...
            new ContinuationImpl(continuation) { // from class: kotlinx.coroutines.flow.FlowKt__TransformKt$filterIsInstance$.inlined.filter.1.2.1
                ...
                public final Object invokeSuspend(Object obj2) {
                    ...
                    return C79212.this.emit(null, this);
                }
            };
            InlineMarker.mark(5);
            FlowCollector flowCollector = this.$this_unsafeFlow$inlined;
    ...
    public Object collect(FlowCollector<? super Object> flowCollector, Continuation continuation) {
        ...
        Object collect = flow.collect(new C79212(flowCollector, this), continuation);
    ...
    public Object collect$$forInline(FlowCollector flowCollector, Continuation continuation) {
        ...
        Flow flow = this.$this_unsafeTransform$inlined;
        Intrinsics.needClassReification();
        C79212 c79212 = new C79212(flowCollector, this);
        InlineMarker.mark(0);
        flow.collect(c79212, continuation);
        InlineMarker.mark(2);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }

...
@DebugMetadata(m3969c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$7", m3970f = "Zip.kt", m3971i = {0}, m3972l = {299}, m3973m = "invokeSuspend", m3974n = {"$this$flow"}, m3975s = {"L$0"})
...
public final class FlowKt__ZipKt$combineTransform$7<R> extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        ...
        flowKt__ZipKt$combineTransform$7.f8868p$ = (FlowCollector) obj;
    ...
    /* loaded from: classes2.dex */
    public static final class C79721<T> extends Lambda implements Function0<T[]> {
        public C79721() {
            super(0);
        }
    ...
    @DebugMetadata(m3969c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$7$2", m3970f = "Zip.kt", m3971i = {0, 0}, m3972l = {299}, m3973m = "invokeSuspend", m3974n = {"$receiver", "it"}, m3975s = {"L$0", "L$1"})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$7$2 */
    /* loaded from: classes2.dex */
    public static final class C79732<T> extends SuspendLambda implements Function3<FlowCollector<? super R>, T[], Continuation<? super Unit>, Object> {
        Object L$0;
        Object L$1;
        int label;

        /* renamed from: p$ */
        private FlowCollector f8869p$;
        private Object[] p$0;

        public C79732(Continuation continuation) {
        ...
        public final Continuation<Unit> create(FlowCollector<? super R> flowCollector, T[] tArr, Continuation<? super Unit> continuation) {
            C79732 c79732 = new C79732(continuation);
            c79732.f8869p$ = flowCollector;
            c79732.p$0 = tArr;
            return c79732;
        }
        ...
        public final Object invoke(Object obj, Object obj2, Continuation<? super Unit> continuation) {
            return ((C79732) create((FlowCollector) obj, (Object[]) obj2, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                FlowCollector flowCollector = this.f8869p$;
        ...
        public final Object invokeSuspend$$forInline(Object obj) {
            FlowKt__ZipKt$combineTransform$7.this.$transform.invoke(this.f8869p$, this.p$0, this);
            return Unit.INSTANCE;
        }
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            FlowCollector flowCollector = this.f8868p$;
            Flow[] flowArr = this.$flowArray;
            Intrinsics.needClassReification();
            C79721 c79721 = new C79721();
            C79732 c79732 = new C79732(null);
            this.L$0 = flowCollector;
            this.label = 1;
            if (CombineKt.combineInternal(flowCollector, flowArr, c79721, c79732, this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else {
            if (i != 1) {
    ...
    public final Object invokeSuspend$$forInline(Object obj) {
        ...
        C79732 c79732 = new C79732(null);
        InlineMarker.mark(0);
        CombineKt.combineInternal(flowCollector, flowArr, c79721, c79732, this);
        InlineMarker.mark(2);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }

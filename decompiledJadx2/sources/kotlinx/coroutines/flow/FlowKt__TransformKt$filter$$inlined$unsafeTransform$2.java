...
public final class FlowKt__TransformKt$filter$$inlined$unsafeTransform$2<T> implements Flow<T> {
        ...
        public Object emit$$forInline(Object obj, Continuation continuation) {
            ...
            new ContinuationImpl(continuation) { // from class: kotlinx.coroutines.flow.FlowKt__TransformKt$filter$.inlined.unsafeTransform.2.2.1
                ...
                public final Object invokeSuspend(Object obj2) {
                    ...
                    return C79192.this.emit(null, this);
                }
            };
            InlineMarker.mark(5);
            FlowCollector flowCollector = this.$this_unsafeFlow$inlined;
    ...
    public Object collect(FlowCollector flowCollector, Continuation continuation) {
        Object collect = this.$this_unsafeTransform$inlined.collect(new C79192(flowCollector, this), continuation);
    ...
    public Object collect$$forInline(FlowCollector flowCollector, Continuation continuation) {
        ...
        C79192 c79192 = new C79192(flowCollector, this);
        InlineMarker.mark(0);
        flow.collect(c79192, continuation);
        InlineMarker.mark(2);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }

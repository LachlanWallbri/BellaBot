...
@DebugMetadata(m3969c = "kotlinx.coroutines.flow.FlowKt__MigrationKt$combine$$inlined$unsafeFlow$3$lambda$2", m3970f = "Zip.kt", m3971i = {0, 0}, m3972l = {251}, m3973m = "invokeSuspend", m3974n = {"$receiver", "it"}, m3975s = {"L$0", "L$1"})
/* loaded from: classes2.dex */
public final class FlowKt__MigrationKt$combine$$inlined$unsafeFlow$3$lambda$2<R, T> extends SuspendLambda implements Function3<FlowCollector<? super R>, T[], Continuation<? super Unit>, Object> {
    Object L$0;
    Object L$1;
    Object L$2;
    int label;
    ...
    public final Continuation<Unit> create(FlowCollector<? super R> flowCollector, T[] tArr, Continuation<? super Unit> continuation) {
        ...
        flowKt__MigrationKt$combine$$inlined$unsafeFlow$3$lambda$2.f8840p$ = flowCollector;
        flowKt__MigrationKt$combine$$inlined$unsafeFlow$3$lambda$2.p$0 = tArr;
    ...
    public final Object invoke(Object obj, Object obj2, Continuation<? super Unit> continuation) {
        return ((FlowKt__MigrationKt$combine$$inlined$unsafeFlow$3$lambda$2) create((FlowCollector) obj, (Object[]) obj2, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            FlowCollector flowCollector = this.f8840p$;

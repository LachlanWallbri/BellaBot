...
@DebugMetadata(m3969c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$$inlined$combineTransform$3", m3970f = "Zip.kt", m3971i = {0}, m3972l = {265}, m3973m = "invokeSuspend", m3974n = {"$this$flow"}, m3975s = {"L$0"})
...
public final class FlowKt__ZipKt$combineTransform$$inlined$combineTransform$3<R> extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        ...
        flowKt__ZipKt$combineTransform$$inlined$combineTransform$3.f8860p$ = (FlowCollector) obj;
    ...
    @DebugMetadata(m3969c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$$inlined$combineTransform$3$2", m3970f = "Zip.kt", m3971i = {}, m3972l = {}, m3973m = "invokeSuspend", m3974n = {}, m3975s = {})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$$inlined$combineTransform$3$2 */
    /* loaded from: classes2.dex */
    public static final class C79662 extends SuspendLambda implements Function3<FlowCollector<? super R>, Object[], Continuation<? super Unit>, Object> {
        Object L$0;
        Object L$1;
        int label;

        /* renamed from: p$ */
        private FlowCollector f8861p$;
        private Object[] p$0;

        public C79662(Continuation continuation) {
        ...
        public final Continuation<Unit> create(FlowCollector<? super R> flowCollector, Object[] objArr, Continuation<? super Unit> continuation) {
            C79662 c79662 = new C79662(continuation);
            c79662.f8861p$ = flowCollector;
            c79662.p$0 = objArr;
            return c79662;
        }
        ...
        public final Object invoke(Object obj, Object[] objArr, Continuation<? super Unit> continuation) {
            return ((C79662) create((FlowCollector) obj, objArr, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            FlowCollector flowCollector = this.f8861p$;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            FlowCollector flowCollector = this.f8860p$;
            Flow[] flowArr = this.$flows;
            C79651 c79651 = new C79651();
            C79662 c79662 = new C79662(null);
            this.L$0 = flowCollector;
            this.label = 1;
            if (CombineKt.combineInternal(flowCollector, flowArr, c79651, c79662, this) == coroutine_suspended) {
    ...
    /* loaded from: classes2.dex */
    public static final class C79651 extends Lambda implements Function0<Object[]> {
        public C79651() {
            super(0);
        }
    ...
    public final Object invokeSuspend$$forInline(Object obj) {
        ...
        C79662 c79662 = new C79662(null);
        InlineMarker.mark(0);
        CombineKt.combineInternal(flowCollector, flowArr, c79651, c79662, this);
        InlineMarker.mark(2);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }

...
public final class FlowKt__DistinctKt$distinctUntilChangedBy$$inlined$unsafeFlow$2<T> implements Flow<T> {
    ...
    public Object collect(FlowCollector flowCollector, Continuation continuation) {
        ...
        Object collect = this.$this_distinctUntilChangedBy$inlined.collect(new C7864x4e1b3e0c(flowCollector, objectRef, this), continuation);
        return collect == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? collect : Unit.INSTANCE;
    }

    public Object collect$$forInline(FlowCollector flowCollector, Continuation continuation) {
        InlineMarker.mark(4);
        new ContinuationImpl(continuation) { // from class: kotlinx.coroutines.flow.FlowKt__DistinctKt$distinctUntilChangedBy$$inlined$unsafeFlow$2.1
            int label;
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                return FlowKt__DistinctKt$distinctUntilChangedBy$$inlined$unsafeFlow$2.this.collect(null, this);
            }
        };
        InlineMarker.mark(5);
        Ref.ObjectRef objectRef = new Ref.ObjectRef();
        ...
        C7864x4e1b3e0c c7864x4e1b3e0c = new C7864x4e1b3e0c(flowCollector, objectRef, this);
        InlineMarker.mark(0);
        flow.collect(c7864x4e1b3e0c, continuation);
        InlineMarker.mark(2);
        InlineMarker.mark(1);

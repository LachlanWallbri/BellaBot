...
public final class FlowKt__MergeKt$unsafeTransform$$inlined$unsafeFlow$1<R> implements Flow<R> {
    ...
    public FlowKt__MergeKt$unsafeTransform$$inlined$unsafeFlow$1(Flow flow, Function3 function3) {
    ...
    public Object collect(FlowCollector flowCollector, Continuation continuation) {
        Object collect = this.$this_unsafeTransform$inlined.collect(new FlowKt__MergeKt$unsafeTransform$$inlined$unsafeFlow$1$lambda$1(flowCollector, this), continuation);
    ...
    public Object collect$$forInline(FlowCollector flowCollector, Continuation continuation) {
        ...
        FlowKt__MergeKt$unsafeTransform$$inlined$unsafeFlow$1$lambda$1 flowKt__MergeKt$unsafeTransform$$inlined$unsafeFlow$1$lambda$1 = new FlowKt__MergeKt$unsafeTransform$$inlined$unsafeFlow$1$lambda$1(flowCollector, this);
        InlineMarker.mark(0);
        flow.collect(flowKt__MergeKt$unsafeTransform$$inlined$unsafeFlow$1$lambda$1, continuation);
        InlineMarker.mark(2);
        InlineMarker.mark(1);

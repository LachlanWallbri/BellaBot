...
/* renamed from: kotlinx.coroutines.flow.FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$3$lambda$1 */
/* loaded from: classes2.dex */
public final class C7938xc1e60f5c<T> implements FlowCollector<T> {
    final /* synthetic */ FlowCollector $this_unsafeFlow$inlined;
    final /* synthetic */ FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$3 this$0;

    public C7938xc1e60f5c(FlowCollector flowCollector, FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$3 flowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$3) {
    ...
    public Object emit$$forInline(Object obj, Continuation continuation) {
        ...
        new ContinuationImpl(continuation) { // from class: kotlinx.coroutines.flow.FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$3$lambda$1.1
            ...
            public final Object invokeSuspend(Object obj2) {
                ...
                return C7938xc1e60f5c.this.emit(null, this);
            }
        };
        InlineMarker.mark(5);
        return this.this$0.$transform$inlined.invoke(this.$this_unsafeFlow$inlined, obj, continuation);

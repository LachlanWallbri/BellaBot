...
public final class FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$7<R> implements Flow<R> {
    ...
    public Object collect(FlowCollector flowCollector, Continuation continuation) {
        Object collect = this.$this_unsafeTransform$inlined.collect(new C7946x930bd3d8(flowCollector, this), continuation);
    ...
    public Object collect$$forInline(FlowCollector flowCollector, Continuation continuation) {
        ...
        new ContinuationImpl(continuation) { // from class: kotlinx.coroutines.flow.FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$7.1
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                return FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$7.this.collect(null, this);
            }
        };
        InlineMarker.mark(5);
        Flow flow = this.$this_unsafeTransform$inlined;
        C7946x930bd3d8 c7946x930bd3d8 = new C7946x930bd3d8(flowCollector, this);
        InlineMarker.mark(0);
        flow.collect(c7946x930bd3d8, continuation);
        InlineMarker.mark(2);
        InlineMarker.mark(1);

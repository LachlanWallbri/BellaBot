...
public final class FlowKt__ZipKt$combine$$inlined$unsafeFlow$2<R> implements Flow<R> {
    ...
    public Object collect(FlowCollector flowCollector, Continuation continuation) {
        ...
        Intrinsics.needClassReification();
        Object combineInternal = CombineKt.combineInternal(flowCollector, flowArr, new FlowKt__ZipKt$combine$$inlined$unsafeFlow$2$lambda$1(this), new FlowKt__ZipKt$combine$$inlined$unsafeFlow$2$lambda$2(null, this), continuation);
    ...
    public Object collect$$forInline(FlowCollector flowCollector, Continuation continuation) {
        ...
        InlineMarker.mark(0);
        CombineKt.combineInternal(flowCollector, flowArr, flowKt__ZipKt$combine$$inlined$unsafeFlow$2$lambda$1, flowKt__ZipKt$combine$$inlined$unsafeFlow$2$lambda$2, continuation);
        InlineMarker.mark(2);
        InlineMarker.mark(1);

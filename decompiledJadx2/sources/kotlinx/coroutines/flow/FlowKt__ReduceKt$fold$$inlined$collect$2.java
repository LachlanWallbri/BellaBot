...
public final class FlowKt__ReduceKt$fold$$inlined$collect$2<T> implements FlowCollector<T> {
    ...
    @DebugMetadata(m3969c = "kotlinx.coroutines.flow.FlowKt__ReduceKt$fold$$inlined$collect$2", m3970f = "Reduce.kt", m3971i = {0, 0, 0, 0}, m3972l = {137}, m3973m = "emit", m3974n = {"this", ES6Iterator.VALUE_PROPERTY, "continuation", ES6Iterator.VALUE_PROPERTY}, m3975s = {"L$0", "L$1", "L$2", "L$3"})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ReduceKt$fold$$inlined$collect$2$1 */
    /* loaded from: classes2.dex */
    public static final class C79141 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        Object L$2;
        Object L$3;
        ...
        public C79141(Continuation continuation) {
            super(continuation);
        }
    ...
    */
    public Object emit(Object obj, Continuation continuation) {
        ...
        if (continuation instanceof C79141) {
            c79141 = (C79141) continuation;
            if ((c79141.label & Integer.MIN_VALUE) != 0) {
                c79141.label -= Integer.MIN_VALUE;
                T t = (T) c79141.result;
                ...
                if (i != 0) {
                    ...
                    c79141.L$2 = c79141;
                    c79141.L$3 = obj;
                    c79141.L$4 = objectRef2;
                    c79141.label = 1;
                    t = (T) function3.invoke(t2, obj, c79141);
                    ...
                    objectRef = (Ref.ObjectRef) c79141.L$4;
                    Object obj2 = c79141.L$3;
                    Object obj3 = c79141.L$1;
                    ResultKt.throwOnFailure(t);
                }
                objectRef.element = t;
        ...
        c79141 = new C79141(continuation);
        T t3 = (T) c79141.result;

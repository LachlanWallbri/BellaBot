...
public final class FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$4<R> implements Flow<R> {
    ...
    public Object collect(FlowCollector flowCollector, Continuation continuation) {
        Object collect = this.$this_unsafeTransform$inlined.collect(new C7940xb62f807b(flowCollector, this), continuation);
    ...
    public Object collect$$forInline(FlowCollector flowCollector, Continuation continuation) {
        ...
        new ContinuationImpl(continuation) { // from class: kotlinx.coroutines.flow.FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$4.1
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                return FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$4.this.collect(null, this);
            }
        };
        InlineMarker.mark(5);
        Flow flow = this.$this_unsafeTransform$inlined;
        C7940xb62f807b c7940xb62f807b = new C7940xb62f807b(flowCollector, this);
        InlineMarker.mark(0);
        flow.collect(c7940xb62f807b, continuation);
        InlineMarker.mark(2);
        InlineMarker.mark(1);

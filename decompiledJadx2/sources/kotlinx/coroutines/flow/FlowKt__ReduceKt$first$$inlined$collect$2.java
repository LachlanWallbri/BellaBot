...
public final class FlowKt__ReduceKt$first$$inlined$collect$2<T> implements FlowCollector<T> {
    ...
    @DebugMetadata(m3969c = "kotlinx.coroutines.flow.FlowKt__ReduceKt$first$$inlined$collect$2", m3970f = "Reduce.kt", m3971i = {0, 0, 0, 0}, m3972l = {137}, m3973m = "emit", m3974n = {"this", ES6Iterator.VALUE_PROPERTY, "continuation", ES6Iterator.VALUE_PROPERTY}, m3975s = {"L$0", "L$1", "L$2", "L$3"})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ReduceKt$first$$inlined$collect$2$1 */
    /* loaded from: classes2.dex */
    public static final class C79111 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        Object L$2;
        Object L$3;
        ...
        public C79111(Continuation continuation) {
            super(continuation);
        }
    ...
    */
    public Object emit(Object obj, Continuation continuation) {
        ...
        if (continuation instanceof C79111) {
            c79111 = (C79111) continuation;
            if ((c79111.label & Integer.MIN_VALUE) != 0) {
                c79111.label -= Integer.MIN_VALUE;
                obj2 = c79111.result;
                ...
                if (i != 0) {
                    ...
                    c79111.L$3 = obj;
                    c79111.label = 1;
                    obj2 = function2.invoke(obj, c79111);
                    ...
                    obj = (T) c79111.L$3;
                    Object obj3 = c79111.L$1;
                    flowKt__ReduceKt$first$$inlined$collect$2 = (FlowKt__ReduceKt$first$$inlined$collect$2) c79111.L$0;
                    ResultKt.throwOnFailure(obj2);
                }
        ...
        c79111 = new C79111(continuation);
        obj2 = c79111.result;

...
public final class FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$2<R> implements Flow<R> {
    ...
    public FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$2(Flow flow, Function3 function3) {
    ...
    public Object collect(FlowCollector flowCollector, Continuation continuation) {
        Object collect = this.$this_unsafeTransform$inlined.collect(new C7936xcd9c9e3d(flowCollector, this), continuation);
    ...
    public Object collect$$forInline(FlowCollector flowCollector, Continuation continuation) {
        ...
        new ContinuationImpl(continuation) { // from class: kotlinx.coroutines.flow.FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$2.1
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                return FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$2.this.collect(null, this);
            }
        };
        InlineMarker.mark(5);
        Flow flow = this.$this_unsafeTransform$inlined;
        C7936xcd9c9e3d c7936xcd9c9e3d = new C7936xcd9c9e3d(flowCollector, this);
        InlineMarker.mark(0);
        flow.collect(c7936xcd9c9e3d, continuation);
        InlineMarker.mark(2);
        InlineMarker.mark(1);

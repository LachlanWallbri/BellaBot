...
public final class FlowKt__MergeKt$map$$inlined$unsafeTransform$1<R> implements Flow<R> {
    ...
    public static final class C78832<T> implements FlowCollector<T> {
        ...
        public Object emit$$forInline(Object obj, Continuation continuation) {
            InlineMarker.mark(4);
            new ContinuationImpl(continuation) { // from class: kotlinx.coroutines.flow.FlowKt__MergeKt$map$.inlined.unsafeTransform.1.2.1
                int label;
                ...
                public final Object invokeSuspend(Object obj2) {
                    ...
                    return C78832.this.emit(null, this);
                }
            };
            InlineMarker.mark(5);
    ...
    public Object collect(FlowCollector flowCollector, Continuation continuation) {
        Object collect = this.$this_unsafeTransform$inlined.collect(new C78832(flowCollector, this), continuation);
    ...
    public Object collect$$forInline(FlowCollector flowCollector, Continuation continuation) {
        ...
        new ContinuationImpl(continuation) { // from class: kotlinx.coroutines.flow.FlowKt__MergeKt$map$$inlined$unsafeTransform$1.1
            ...
            public final Object invokeSuspend(Object obj) {
                this.result = obj;
                this.label |= Integer.MIN_VALUE;
                return FlowKt__MergeKt$map$$inlined$unsafeTransform$1.this.collect(null, this);
            }
        };
        InlineMarker.mark(5);
        Flow flow = this.$this_unsafeTransform$inlined;
        C78832 c78832 = new C78832(flowCollector, this);
        InlineMarker.mark(0);
        flow.collect(c78832, continuation);
        InlineMarker.mark(2);
        InlineMarker.mark(1);

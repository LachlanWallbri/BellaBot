...
public class ExperimentalCoroutineDispatcher extends ExecutorCoroutineDispatcher {
    ...
    public void mo5558dispatch(CoroutineContext context, Runnable block) {
        try {
            ...
            DefaultExecutor.INSTANCE.mo5558dispatch(context, block);
        }
    }
    ...
    public final CoroutineDispatcher blocking(int parallelism) {
        ...
        return new LimitingDispatcher(this, parallelism, 1);
    }
    ...
    public final CoroutineDispatcher limited(int parallelism) {
        ...
        return new LimitingDispatcher(this, parallelism, 0);
    }

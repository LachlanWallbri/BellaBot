...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    public final Object receiveOrClosed(Continuation<? super ValueOrClosed<? extends E>> continuation) {
        ...
        if (!(pollInternal instanceof Closed)) {
            ...
            m5536constructorimpl = ValueOrClosed.m5536constructorimpl(pollInternal);
        } else {
            ValueOrClosed.Companion companion2 = ValueOrClosed.INSTANCE;
            m5536constructorimpl = ValueOrClosed.m5536constructorimpl(new ValueOrClosed.Closed(((Closed) pollInternal).closeCause));
        }
        return ValueOrClosed.m5535boximpl(m5536constructorimpl);
    }
        ...
        while (true) {
            ...
            if (prevNode instanceof LockFreeLinkedListHead) {
                ...
                if (!(m5550constructorimpl$default instanceof ArrayList)) {
                    ((Send) m5550constructorimpl$default).resumeSendClosed(closedForSend);
                    return;
                }
                if (m5550constructorimpl$default != null) {
            ...
            if (!prevNode.remove()) {
                ...
                m5550constructorimpl$default = InlineList.m5555plusimpl(m5550constructorimpl$default, (Send) prevNode);
            }
        }
    }
     ...
     */
    /* compiled from: AbstractChannel.kt */
    @Metadata(m3959bv = {1, 0, 3}, m3960d1 = {"\u00004\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0004\u0018\u0000*\u0004\b\u0001\u0010\u00012\u0012\u0012\u0004\u0012\u00020\u00030\u0002j\b\u0012\u0004\u0012\u00020\u0003`\u0004B\r\u0012\u0006\u0010\u0005\u001a\u00020\u0006¢\u0006\u0002\u0010\u0007J\u0012\u0010\b\u001a\u0004\u0018\u00010\t2\u0006\u0010\n\u001a\u00020\u000bH\u0014J\u0016\u0010\f\u001a\u0004\u0018\u00010\t2\n\u0010\r\u001a\u00060\u000ej\u0002`\u000fH\u0016¨\u0006\u0010"}, m3961d2 = {"Lkotlinx/coroutines/channels/AbstractChannel$TryPollDesc;", ExifInterface.LONGITUDE_EAST, "Lkotlinx/coroutines/internal/LockFreeLinkedListNode$RemoveFirstDesc;", "Lkotlinx/coroutines/channels/Send;", "Lkotlinx/coroutines/internal/RemoveFirstDesc;", "queue", "Lkotlinx/coroutines/internal/LockFreeLinkedListHead;", "(Lkotlinx/coroutines/internal/LockFreeLinkedListHead;)V", "failure", "", "affected", "Lkotlinx/coroutines/internal/LockFreeLinkedListNode;", "onPrepare", "prepareOp", "Lkotlinx/coroutines/internal/LockFreeLinkedListNode$PrepareOp;", "Lkotlinx/coroutines/internal/PrepareOp;", "kotlinx-coroutines-core"}, m3962k = 1, m3963mv = {1, 1, 16})
    /* loaded from: classes2.dex */
    ...
    private final <R> void tryStartBlockUnintercepted(Function2<Object, ? super Continuation<? super R>, ? extends Object> function2, SelectInstance<? super R> selectInstance, int i, Object obj) {
        ...
        if (!z) {
            ...
            ValueOrClosed.Companion companion = ValueOrClosed.INSTANCE;
            if (z) {
                m5536constructorimpl = ValueOrClosed.m5536constructorimpl(new ValueOrClosed.Closed(((Closed) obj).closeCause));
            } else {
                m5536constructorimpl = ValueOrClosed.m5536constructorimpl(obj);
            }
            UndispatchedKt.startCoroutineUnintercepted(function2, ValueOrClosed.m5535boximpl(m5536constructorimpl), selectInstance.getCompletion());
            return;
        }
        if (i == 0) {
        ...
        if (i != 1) {
            if (i == 2 && selectInstance.trySelect()) {
                ValueOrClosed.Companion companion2 = ValueOrClosed.INSTANCE;
                UndispatchedKt.startCoroutineUnintercepted(function2, ValueOrClosed.m5535boximpl(ValueOrClosed.m5536constructorimpl(new ValueOrClosed.Closed(((Closed) obj).closeCause))), selectInstance.getCompletion());
                return;
            }
            return;
        }
            ...
            while (true) {
                ...
                if (pollInternal instanceof Closed) {
                    ...
                    if (closed.closeCause == null) {
                        ...
                        cancellableContinuationImpl.resumeWith(Result.m4510constructorimpl(boxBoolean));
                    } else {
                        Throwable receiveException = closed.getReceiveException();
                        Result.Companion companion2 = Result.INSTANCE;
                        cancellableContinuationImpl.resumeWith(Result.m4510constructorimpl(ResultKt.createFailure(receiveException)));
                    }
                } else if (pollInternal != AbstractChannelKt.POLL_FAILED) {
                    Boolean boxBoolean2 = Boxing.boxBoolean(true);
                    Result.Companion companion3 = Result.INSTANCE;
                    cancellableContinuationImpl.resumeWith(Result.m4510constructorimpl(boxBoolean2));
                    break;
                }
            }
     ...
     */
    /* compiled from: AbstractChannel.kt */
    @Metadata(m3959bv = {1, 0, 3}, m3960d1 = {"\u0000B\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0002\u0018\u0000*\u0006\b\u0001\u0010\u0001 \u00002\b\u0012\u0004\u0012\u0002H\u00010\u0002B\u001d\u0012\u000e\u0010\u0003\u001a\n\u0012\u0006\u0012\u0004\u0018\u00010\u00050\u0004\u0012\u0006\u0010\u0006\u001a\u00020\u0007¢\u0006\u0002\u0010\bJ\u0015\u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00028\u0001H\u0016¢\u0006\u0002\u0010\fJ\u0014\u0010\r\u001a\u00020\n2\n\u0010\u000e\u001a\u0006\u0012\u0002\b\u00030\u000fH\u0016J\u0015\u0010\u0010\u001a\u0004\u0018\u00010\u00052\u0006\u0010\u000b\u001a\u00028\u0001¢\u0006\u0002\u0010\u0011J\b\u0010\u0012\u001a\u00020\u0013H\u0016J!\u0010\u0014\u001a\u0004\u0018\u00010\u00152\u0006\u0010\u000b\u001a\u00028\u00012\b\u0010\u0016\u001a\u0004\u0018\u00010\u0017H\u0016¢\u0006\u0002\u0010\u0018R\u0018\u0010\u0003\u001a\n\u0012\u0006\u0012\u0004\u0018\u00010\u00050\u00048\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\u0006\u001a\u00020\u00078\u0006X\u0087\u0004¢\u0006\u0002\n\u0000\u0082\u0002\u0004\n\u0002\b\u0019¨\u0006\u0019"}, m3961d2 = {"Lkotlinx/coroutines/channels/AbstractChannel$ReceiveElement;", ExifInterface.LONGITUDE_EAST, "Lkotlinx/coroutines/channels/Receive;", "cont", "Lkotlinx/coroutines/CancellableContinuation;", "", "receiveMode", "", "(Lkotlinx/coroutines/CancellableContinuation;I)V", "completeResumeReceive", "", ES6Iterator.VALUE_PROPERTY, "(Ljava/lang/Object;)V", "resumeReceiveClosed", "closed", "Lkotlinx/coroutines/channels/Closed;", "resumeValue", "(Ljava/lang/Object;)Ljava/lang/Object;", "toString", "", "tryResumeReceive", "Lkotlinx/coroutines/internal/Symbol;", "otherOp", "Lkotlinx/coroutines/internal/LockFreeLinkedListNode$PrepareOp;", "(Ljava/lang/Object;Lkotlinx/coroutines/internal/LockFreeLinkedListNode$PrepareOp;)Lkotlinx/coroutines/internal/Symbol;", "kotlinx-coroutines-core"}, m3962k = 1, m3963mv = {1, 1, 16})
    /* loaded from: classes2.dex */
    public static final class ReceiveElement<E> extends Receive<E> {
        ...
        public final Object resumeValue(E value) {
            ...
            ValueOrClosed.Companion companion = ValueOrClosed.INSTANCE;
            return ValueOrClosed.m5535boximpl(ValueOrClosed.m5536constructorimpl(value));
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.receiveMode == 1 && closed.closeCause == null) {
                ...
                if (this.receiveMode != 2) {
                    ...
                    Throwable receiveException = closed.getReceiveException();
                    Result.Companion companion2 = Result.INSTANCE;
                    cancellableContinuation2.resumeWith(Result.m4510constructorimpl(ResultKt.createFailure(receiveException)));
                    return;
                }
                ...
                ValueOrClosed m5535boximpl = ValueOrClosed.m5535boximpl(ValueOrClosed.m5536constructorimpl(new ValueOrClosed.Closed(closed.closeCause)));
                Result.Companion companion4 = Result.INSTANCE;
                cancellableContinuation3.resumeWith(Result.m4510constructorimpl(m5535boximpl));
            }
        }
    ...
    public static final class ReceiveSelect<R, E> extends Receive<E> implements DisposableHandle {
        ...
        public void completeResumeReceive(E value) {
            ...
            if (this.receiveMode == 2) {
                ValueOrClosed.Companion companion = ValueOrClosed.INSTANCE;
                value = (E) ValueOrClosed.m5535boximpl(ValueOrClosed.m5536constructorimpl(value));
            }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.select.trySelect()) {
                ...
                Function2<Object, Continuation<? super R>, Object> function2 = this.block;
                ValueOrClosed.Companion companion = ValueOrClosed.INSTANCE;
                ContinuationKt.startCoroutine(function2, ValueOrClosed.m5535boximpl(ValueOrClosed.m5536constructorimpl(new ValueOrClosed.Closed(closed.closeCause))), this.select.getCompletion());
            }
        }
        ...
        if (cancellableContinuationImpl != null) {
            ...
            while (true) {
                ...
                if (pollInternal != AbstractChannelKt.POLL_FAILED) {
                    ...
                    Result.Companion companion = Result.INSTANCE;
                    cancellableContinuationImpl.resumeWith(Result.m4510constructorimpl(resumeValue));
                    break;
                }
            }
            Object result = orCreateCancellableContinuation.getResult();

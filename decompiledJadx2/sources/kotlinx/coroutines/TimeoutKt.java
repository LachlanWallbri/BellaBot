        ...
        if (continuation instanceof TimeoutKt$withTimeoutOrNull$1) {
            ...
            if ((timeoutKt$withTimeoutOrNull$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    objectRef2.element = (T) ((TimeoutCoroutine) null);
                    try {
                        ...
                        ?? r3 = (T) new TimeoutCoroutine(j, timeoutKt$withTimeoutOrNull$1);
                        objectRef2.element = r3;
                        Object obj2 = setupTimeout(r3, function2);
